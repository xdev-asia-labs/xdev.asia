...
title: 第 15 課：即時協作 - 共享工作區
slug: bai-15-real-time-collaboration-shared-workspace
description: 即時協作編輯（CRDT/OT）。共享程式碼編輯器。協作白板。團體項目。同行程式設計會議。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：即時協作 - 共享</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：協作與社區</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 15 課：即時協作 - 共享工作區](/storage/uploads/2026/03/edtech-bai-15-diagram.png)

## 簡介

即時協作編輯（CRDT/OT）。共享程式碼編輯器。協作白板。團體項目。同行程式設計會議。
...
即時協作編輯（CRDT/OT）是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
