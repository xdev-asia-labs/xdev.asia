...
title: 第 25 課：案例研究 - Coursera、Udemy、Duolingo 和 Khan Academy
slug: bai-25-case-studies-coursera-udemy-duolingo-khan-academy
description: 分析實際的教育科技平台：Coursera（學位課程）、Udemy（市場）、Duolingo（遊戲化）、Khan Academy（免費教育）。吸取的教訓。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 25 課：個案研究 - Coursera、Udemy、</tspan>
      <tspan x="60" dy="42">Duolingo 和可汗學院</tspan>
  </text>
...
![第 25 課：案例研究 - Coursera、Udemy、Duolingo 和 Khan Academy](/storage/uploads/2026/03/edtech-bai-25-diagram.png)

## 簡介

分析實際的教育科技平台：Coursera（學位課程）、Udemy（市場）、Duolingo（遊戲化）、Khan Academy（免費教育）。吸取的教訓。

---

## 1. 實際教育科技平台分析：Coursera（學位課程）、Udemy（市場）、Duolingo（遊戲化）、Khan Academy（免費教育）

### 1.1 基本概念

分析實際的教育科技平台：Coursera（學位課程）、Udemy（市場）、Duolingo（遊戲化）、Khan Academy（免費教育）是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了案例研究 - Coursera、Udemy、Duolingo 和 Khan Academy。要點：
