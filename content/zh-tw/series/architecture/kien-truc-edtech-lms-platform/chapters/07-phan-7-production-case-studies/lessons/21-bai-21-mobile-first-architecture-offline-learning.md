...
title: 第 21 課：行動優先架構與離線學習
slug: bai-21-mobile-first-architecture-offline-learning
description: 行動學習管理系統架構。離線內容下載。進度同步。推播通知。本機應用程式與混合應用程式。響應式視訊播放器。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 21
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ 建築 — 第 21 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 21 課：行動優先架構 &</tspan>
      <tspan x="60" dy="42">線下學習</tspan>
  </text>
...
![第 21 課：行動優先架構與離線學習](/storage/uploads/2026/03/edtech-bai-21-diagram.png)

## 簡介

行動學習管理系統架構。離線內容下載。進度同步。推播通知。本機應用程式與混合應用程式。響應式視訊播放器。
...
行動LMS架構是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
