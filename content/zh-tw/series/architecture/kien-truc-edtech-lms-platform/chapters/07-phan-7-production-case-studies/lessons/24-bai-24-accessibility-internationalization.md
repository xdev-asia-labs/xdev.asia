...
title: 第 24 課：可近性和國際化
slug: bai-24-accessibility-internationalization
description: 符合 WCAG 2.1。螢幕閱讀器支援。鍵盤導航。多語言平台（i18n）。 RTL 支援。自動翻譯。在地化內容。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 24
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 24 課：輔助功能與</tspan>
      <tspan x="60" dy="42">國際化</tspan>
  </text>
...
![第 24 課：可近性和國際化](/storage/uploads/2026/03/edtech-bai-24-diagram.png)

## 簡介

符合 WCAG 2.1。螢幕閱讀器支援。鍵盤導航。多語言平台（i18n）。 RTL 支援。自動翻譯。在地化內容。
...
WCAG 2.1 合規性是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
