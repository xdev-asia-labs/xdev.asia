...
title: 第 18 課：學習分析 - 追蹤與見解
slug: bai-18-learning-analytics-tracking-insights
description: 學習分析：完成率、參與度指標、評量表現。學生高危險檢測。教練儀表板。 xAPI 分析。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ 建築 — 第 18 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 18 課：學習分析 - 追蹤和</tspan>
      <tspan x="60" dy="42">見解</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 6 部分：分析與業務</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 18 課：學習分析 - 追蹤與見解](/storage/uploads/2026/03/edtech-bai-18-diagram.png)

## 簡介

學習分析：完成率、參與度指標、評量表現。學生高危險檢測。教練儀表板。 xAPI 分析。

---

## 1. 學習分析：完成率、參與度指標、評估績效

### 1.1 基本概念

學習分析：完成率、參與度指標、評估績效是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
