...
title: 第 2 課：LMS 平台架構 - 微服務與 DDD
slug: bai-2-lms-platform-architecture-microservices-ddd
description: LMS 平台概述架構。有界上下文：課程、使用者、評估、內容、分析。服務拓撲和通訊模式。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 2
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 课：LMS 平台架构 -</tspan>
      <tspan x="60" dy="42">微服务和领域驱动设计</tspan>
  </text>
...
![第 2 課：LMS 平台架構 - 微服務與 DDD](/storage/uploads/2026/03/edtech-bai-2-diagram.png)

## 簡介

LMS 平台概述架構。有界上下文：課程、使用者、評估、內容、分析。服務拓撲和通訊模式。
...
LMS 平台概述架構是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們學習了 LMS 平台架構 - 微服務和 DDD。要點：
