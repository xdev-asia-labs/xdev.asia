...
title: 第 6 課：視訊傳輸 - HLS、DASH 和自適應串流媒體
slug: bai-6-video-delivery-hls-dash-adaptive-streaming
description: 視訊平台架構：轉碼管道、自適應位元率流（HLS/DASH）。 CDN 分發。視訊播放器整合。 DRM 保護。字幕管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 6 課：視訊傳輸 - HLS、DASH 和</tspan>
      <tspan x="60" dy="42">自適應串流媒體</tspan>
  </text>
...
視訊平台架構：轉碼管道、自適應位元率流（HLS/DASH）。 CDN 分發。視訊播放器整合。 DRM 保護。字幕管理。

---

## 1.視訊平台架構：轉碼管道、自適應位元率串流（HLS/DASH）

### 1.1 基本概念

視訊平台架構：轉碼管道、自適應位元率流（HLS/DASH）是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們學習了視訊傳輸 - HLS、DASH 和自適應串流媒體。要點：
