...
title: 第 5 課：內容創作與富媒體
slug: bai-5-content-authoring-rich-media
description: 内容创作工具：富文本编辑器、拖放构建器。互動內容：H5P、嵌入式模擬。內容版本控制。多格式支援。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 5
section_title: 第 2 部分：課程與內容管理
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 5 課：內容創作與富媒體</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 2 部分：課程與內容管理</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 5 課：內容創作與富媒體](/storage/uploads/2026/03/edtech-bai-5-diagram.png)

## 簡介

內容創作工具：富文本編輯器、拖放建構器。互動內容：H5P、嵌入式模擬。內容版本控制。多格式支援。

---

## 1. 內容創作工具：富文本編輯器、拖放建構器

### 1.1 基本概念

內容創作工具：富文本編輯器、拖放建構器是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
