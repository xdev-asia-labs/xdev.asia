...
description: 電子郵件範本系統：MJML、Handlebars、React Email。範本版本控制、A/B 測試、動態內容個人化、內容管道、預先渲染、快取。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：模板引擎和內容管道</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 3 部分：電子郵件基礎設施和交付引擎</text>
...
當發送 1000 萬封電子郵件時，每封電子郵件可能需要**不同的**內容 - 名稱、建議產品、唯一折扣代碼。模板引擎是負責**快速**和**個性化**呈現數百萬封電子郵件的組件。
...
|技術 |文法 |輸出|反應靈敏 |學習曲線|
|------------|--------|--------|------------|---------------|
| MJML |類別 XML | HTML 電子郵件 | ✅ 內建 |簡單|
|車把 | `{{var}}` | HTML/文字 |手冊|簡單|
|反應電子郵件 | JSX | HTML 電子郵件 | ✅ 元件 |中等|
|液體| `{{var}}` | HTML/文字 |手冊|簡單|
|電子JS | `<%= var %>` | HTML/文字 |手冊|簡單|
