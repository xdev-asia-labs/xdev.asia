...
description: 扇出模式、生產者-消費者模式、優先權佇列模式。用於通知工作流程的斷路器、隔板、寄件箱模式、Saga 模式。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：電子郵件系統的設計模式</tspan>
      <tspan x="60" dy="42">大規模</tspan>
  </text>
...
設計大型電子郵件系統不僅僅是編寫程式碼，而是應用正確的**設計模式**來使系統可靠、可擴展和可維護。本文將介紹 6 個最重要的模式。
...
需要保證：資料庫寫入+佇列發布是**原子的**。如果發布成功但資料庫崩潰→不一致。
