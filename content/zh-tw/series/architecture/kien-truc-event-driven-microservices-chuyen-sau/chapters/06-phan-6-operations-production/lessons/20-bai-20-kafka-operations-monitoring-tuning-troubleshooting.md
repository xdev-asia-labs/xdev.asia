...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 20 课：Kafka 操作 - 监控、</tspan>
      <tspan x="60" dy="42">調整和故障排除</tspan>
  </text>
...
![第 20 課：Kafka 操作 - 監控、調整與故障排除](/storage/uploads/2026/03/edm-bai-20-diagram.png)

## 簡介

Kafka 操作：監控（JMX、Prometheus）、效能調優。消費者滯後監控。分區重新平衡。經紀人維護。解決常見問題。

---

## 1. Kafka操作：監控（JMX、Prometheus）、效能調優

### 1.1 基本概念

Kafka操作：監控（JMX、Prometheus）、效能調優是該領域最重要的議題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了 Kafka 操作 - 監控、調整和故障排除。要點：
