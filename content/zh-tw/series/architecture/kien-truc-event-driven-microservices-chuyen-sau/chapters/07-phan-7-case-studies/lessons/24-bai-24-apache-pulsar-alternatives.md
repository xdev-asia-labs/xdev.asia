...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">🏗️ 建築 — 第 24 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 24 課：Apache Pulsar 及替代方案</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 7 部分：個案研究</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 24 課：Apache Pulsar 及替代方案](/storage/uploads/2026/03/edm-bai-24-diagram.png)

## 簡介

Apache Pulsar：多租戶、分層儲存、異地複製。 Pulsar 與 Kafka 比較。 NATS JetStream。小熊貓。亞馬遜事件橋。選擇正確的平台。

---

## 1. Apache Pulsar：多租戶、分層儲存、異地複製

### 1.1 基本概念

Apache Pulsar：多租戶、分層儲存、地理複製是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了 Apache Pulsar 和替代方案。要點：
