...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 23 課：遷移到事件驅動 -</tspan>
      <tspan x="60" dy="42">扼殺者無花果圖案</tspan>
  </text>
...
![第 23 課：遷移到事件驅動 - Strangler Fig 模式](/storage/uploads/2026/03/edm-bai-23-diagram.png)

## 簡介

從整體遷移到事件驅動：扼殺者無花果模式。並行運行策略。活動是新舊之間的橋樑。逐步遷移。風險管理。

---

## 1. 從整體遷移到事件驅動：strangler Fig 模式

### 1.1 基本概念

從整體遷移到事件驅動：扼殺者無花果模式是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了遷移到事件驅動 - Strangler Fig 模式。要點：
