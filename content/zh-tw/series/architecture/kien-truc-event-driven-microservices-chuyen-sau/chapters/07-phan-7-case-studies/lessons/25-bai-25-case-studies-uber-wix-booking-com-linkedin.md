...
description: >-
  實際事件驅動分析：Uber（事件採購乘車匹配）、Wix（事件驅動平台）、Booking.com（大規模 Kafka）、LinkedIn（Kafka
  起源）。吸取的教訓。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 25
section_title: 第 7 部分：個案研究
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ 建築 — 第 25 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 25 課：個案研究 - Uber、Wix、</tspan>
      <tspan x="60" dy="42">Booking.com 和 LinkedIn</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 7 部分：個案研究</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 25 課：案例研究 - Uber、Wix、Booking.com 和 LinkedIn](/storage/uploads/2026/03/edm-bai-25-diagram.png)

## 簡介

實際事件驅動分析：Uber（事件採購乘車匹配）、Wix（事件驅動平台）、Booking.com（大規模 Kafka）、LinkedIn（Kafka 起源）。吸取的教訓。

---

## 1. 實際事件驅動分析：Uber（事件採購乘車匹配）、Wix（事件驅動平台）、Booking.com（大規模 Kafka）、LinkedIn（Kafka 起源）

### 1.1 基本概念

實際事件驅動分析：Uber（事件採購乘車匹配）、Wix（事件驅動平台）、Booking.com（大規模Kafka）、LinkedIn（Kafka起源）是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了案例研究 - Uber、Wix、Booking.com 和 LinkedIn。要點：
