...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 1 課：事件驅動架構概述</tspan>
      <tspan x="60" dy="42">- 為什麼活動很重要</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：事件驅動基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 1 課：事件驅動架構概述 - 為什麼事件很重要](/storage/uploads/2026/03/edm-bai-1-diagram.png)

## 簡介

事件驅動架構 (EDA) 基礎知識。事件、命令、查詢。時間耦合與事件解耦。 EDA 的優點和權衡。
...
事件驅動架構 (EDA) 基礎知識是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了事件驅動架構概述 - 為什麼事件很重要。要點：
