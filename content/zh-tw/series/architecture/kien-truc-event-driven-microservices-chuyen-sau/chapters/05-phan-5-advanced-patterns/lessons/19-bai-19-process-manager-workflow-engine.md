...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：流程管理器和工作流引擎</tspan>
  </text>
...
![第 19 課：流程管理器和工作流引擎](/storage/uploads/2026/03/edm-bai-19-diagram.png)

## 簡介

流程管理器模式：將長期運作的業務流程作為狀態機。 Temporal.io 工作流引擎。持久的執行力。補償。

---

## 1.流程管理器模式：將長期運作的業務流程作為狀態機

### 1.1 基本概念

流程管理器模式：作為狀態機的長期運作的業務流程是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
