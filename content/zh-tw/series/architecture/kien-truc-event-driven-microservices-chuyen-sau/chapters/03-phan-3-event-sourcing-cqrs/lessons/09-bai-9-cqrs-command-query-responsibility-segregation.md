...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：CQRS - 指令查詢職責</tspan>
...
![第 9 課：CQRS - 指令查詢職責分離](/storage/uploads/2026/03/edm-bai-9-diagram.png)

## 簡介

CQRS 模式：單獨的讀取/寫入模型。命令處理程序和網域邏輯。閱讀模型預測。最終一致性。何時使用 CQRS。

---

## 1. CQRS 模式：單獨的讀取/寫入模型

### 1.1 基本概念

CQRS 模式：分離的讀取/寫入模型是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
