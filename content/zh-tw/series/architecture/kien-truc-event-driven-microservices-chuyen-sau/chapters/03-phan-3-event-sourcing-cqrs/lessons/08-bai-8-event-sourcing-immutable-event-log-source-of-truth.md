...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 8 課：事件溯源 - 不可變事件</tspan>
      <tspan x="60" dy="42">記錄為事實來源</tspan>
  </text>
...
事件溯源基礎：事件儲存、事件重播、快照。聚合重建。時態查詢。審計追蹤自然而然。事件版本控制。

---

## 1. 事件溯源基礎：事件儲存、事件重播、快照

### 1.1 基本概念

事件溯源基礎：事件儲存、事件重播、快照是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了事件溯源 - 不可變事件日誌作為事實來源。要點：
