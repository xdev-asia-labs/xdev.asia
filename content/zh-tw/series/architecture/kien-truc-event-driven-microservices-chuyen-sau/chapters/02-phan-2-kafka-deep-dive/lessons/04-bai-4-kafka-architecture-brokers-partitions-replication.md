...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🏗️ 建築 — 第 4 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：Kafka 架構 - 經紀人，</tspan>
      <tspan x="60" dy="42">分區和複製</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 2 部分：Apache Kafka 深入探究</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 4 課：Kafka 架構 - 代理、分區和複製](/storage/uploads/2026/03/edm-bai-4-diagram.png)

## 簡介

Kafka 內部架構：代理架構、主題分區、複製因子。 ISR（同步副本）。領導人選舉。日誌段。控制器仲裁 (KRaft)。

---

## 1. Kafka 內部架構：代理架構、主題分區、複製因子

### 1.1 基本概念

Kafka 內部結構：代理架構、主題分區、複製因子是該領域中一些最重要的主題。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了 Kafka 架構 - 代理、分區和複製。要點：
