...
description: >-
  架構註冊表：Avro、Protobuf、JSON 架構。模式演化規則。相容模式。模式驗證。 Confluence Schema Registry 與
  Apicurio。
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 7 課：架構註冊表和數據</tspan>
...
![第 7 課：模式註冊表和資料序列化](/storage/uploads/2026/03/edm-bai-7-diagram.png)

## 簡介

架構註冊表：Avro、Protobuf、JSON 架構。模式演化規則。相容模式。模式驗證。 Confluence Schema Registry 與 Apicurio。

---

## 1. 架構登錄：Avro、Protobuf、JSON 架構

### 1.1 基本概念

Schema 註冊表：Avro、Protobuf、JSON Schema 是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
