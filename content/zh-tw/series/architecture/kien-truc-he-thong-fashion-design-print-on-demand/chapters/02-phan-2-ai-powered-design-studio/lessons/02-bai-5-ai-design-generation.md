...
title: 第 5 課：人工智慧設計生成 — 文字到圖像、風格遷移和時尚即時工程
slug: bai-5-ai-design-generation
description: 整合穩定擴散/SDXL、時尚專業提示工程、ControlNet、風格傳輸、LoRA 微調、修復、修復、大量生成管道、內容審核、GPU 基礎設施。
duration_minutes: 150
is_free: true
video_url: null
sort_order: 5
section_title: 第 2 部分：人工智慧驅動的設計工作室
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Decorations -->
  <g>
    <circle cx="1035" cy="75" r="28" fill="#fb923c" opacity="0.1"/>
    <circle cx="970" cy="90" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="905" cy="105" r="18" fill="#fb923c" opacity="0.1"/>
    <circle cx="840" cy="120" r="13" fill="#fb923c" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🏗️ 建築 — 第 5 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 5 課：AI 設計生成 —</tspan>
      <tspan x="60" dy="42">文字轉圖像、風格轉換和提示</tspan>
      <tspan x="60" dy="42">時尚工程</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 2 部分：人工智慧驅動的設計工作室</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-ai-design-pipeline"><strong>1. AI設計生成流程</strong></h2>
...
<h2 id="2-prompt-engineering"><strong>2. 時尚領域的快速工程</strong></h2>
...
<h2 id="3-model-architecture"><strong>3. 模型架構與微調</strong></h2>

<h3 id="lora-training"><strong>LoRA 針對品牌特定風格進行微調</strong></h3>
...
<h3 id="controlnet"><strong>用於結構引導生成的 ControlNet</strong></h3>
...
<h2 id="4-ip-adapter"><strong>4. IP 適配器和風格傳輸</strong></h2>
...
<h2 id="5-gpu-infrastructure"><strong>5.GPU基礎設施和作業佇列</strong></h2>
...
<h2 id="6-post-processing"><strong>6. 後處理流程</strong></h2>
...
<h2 id="7-batch-generation"><strong>7. 批次產生和變化</strong></h2>
...
<tbody>
<tr><td>基本型號</td><td>SDXL 1.0</td><td>高品質 1024x1024 生成</td></tr>
<tr><td>微調</td><td>洛拉（排名 32）</td><td>品牌特定風格適配</td></tr>
<tr><td>結構控制</td><td>控制網</td><td>從草圖到設計，姿勢引導</td></tr>
<tr><td>風格轉移</td><td>IP適配器</td><td>基於參考的風格匹配</td></tr>
<tr><td>升級</td><td>真實 ESRGAN 4x</td><td>1024 → 4096 用於列印 (300 DPI)</td></tr>
<tr><td>背景去除劑</td><td>U2-Net/REMBG</td><td>POD 透明背景</td></tr>
<tr><td>內容審核</td><td>CLIP + NSFW 分類器</td><td>安全性和 IP 合規性</td></tr>
<tr><td>作業佇列</td><td>BullMQ + Redis</td><td>Priority queue, retry, batch</td></tr>
<tr><td>GPU基礎設施</td><td>A100/H100 + 自動縮放</td><td>經濟高效的 GPU 分配</td></tr>
<tr><td>及時工程</td><td>時尚專用模板</td><td>領域優化生成</td></tr>
</tbody>
</table>
