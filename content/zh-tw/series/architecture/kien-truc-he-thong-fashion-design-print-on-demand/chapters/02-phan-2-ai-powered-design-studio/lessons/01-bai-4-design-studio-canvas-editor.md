...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ 建築 — 第 4 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：設計工作室與畫布編輯器 — Web</tspan>
      <tspan x="60" dy="42">編輯器、模板引擎和資源庫</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 2 部分：人工智慧驅動的設計工作室</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-design-studio-overview"><strong>1. 設計工作室架構</strong></h2>

<p>設計工作室是 <strong>核心創意工具</strong> POD 平台 — 讓設計人員直接在網頁瀏覽器中建立、編輯和匯出設計。</p>
...
<h2 id="2-canvas-renderer"><strong>2. Canvas渲染器架構</strong></h2>
...
<h3 id="rendering-pipeline"><strong>渲染管線</strong></h3>
...
<h2 id="3-layer-system"><strong>3. 圖層系統</strong></h2>
...
<h2 id="4-template-engine"><strong>4. 模板引擎</strong></h2>
...
<h2 id="5-asset-library"><strong>5. 資源庫和字體管理</strong></h2>
...
<h2 id="6-export-pipeline"><strong>6. 出口管道</strong></h2>
...
<h2 id="7-undo-redo"><strong>7. 撤銷/重做和狀態管理</strong></h2>
...
<ul>
<li><p><strong>畫布引擎</strong> — WebGL/Canvas 2D 渲染、髒矩形優化、60fps 目標</p></li>
<li><p><strong>圖層系統</strong> — Z 順序、混合模式、分組、可見性/鎖定</p></li>
<li><p><strong>模板引擎</strong> — 具有列印區域、佔位符、安全區的產品特定模板</p></li>
<li><p><strong>資源庫</strong> — 剪貼畫、圖示、圖案、字體、AI 生成的資源</p></li>
<li><p><strong>出口管道</strong> — 預覽 (72 DPI WebP) → 模型 (150 DPI PNG) → 列印（300 DPI 列印就緒）</p></li>
<li><p><strong>撤銷/重做</strong> — 命令模式，50步驟歷史記錄</p></li>
</ul>
