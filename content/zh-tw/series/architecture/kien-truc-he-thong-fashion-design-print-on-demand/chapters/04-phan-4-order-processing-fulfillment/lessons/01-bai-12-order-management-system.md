...
title: 第 12 課：訂單管理系統 — 狀態機、Saga 模式與訂單編排
slug: bai-12-order-management-system
description: 用於 POD 的 OMS 架構、訂單狀態機、分散式交易的 Saga 模式、分割訂單（多供應商）、訂單編排、補償邏輯、訂單事件來源、冪等性。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 12
section_title: 第 4 部分：訂單處理與履行
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ 建築 — 第 12 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Order Management System — State</tspan>
      <tspan x="60" dy="42">機器、Saga 模式和訂單</tspan>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 4 部分：訂單處理與履行</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-order-lifecycle"><strong>1.POD訂單生命週期</strong></h2>
...
<h2 id="2-state-machine"><strong>2. 訂單狀態機</strong></h2>
...
<h2 id="3-saga-pattern"><strong>3. Saga模式－訂單編排</strong></h2>
...
<h2 id="4-split-orders"><strong>4. 拆分訂單（多供應商）</strong></h2>
...
<h2 id="5-event-sourcing"><strong>5. 訂單事件溯源</strong></h2>
...
<table>
<thead>
<tr><th>圖案</th><th>目的</th><th>POD 上下文</th></tr>
</thead>
<tbody>
<tr><td>狀態機</td><td>強制執行有效的訂單轉換</td><td>超過 15 個特定於 POD 生產流程的狀態</td></tr>
<tr><td>傳奇模式</td><td>分散式事務協調</td><td>付款 → 列印文件 → 供應商 → 通知回滾</td></tr>
<tr><td>分割訂單</td><td>多供應商履行</td><td>1 個客戶訂單 → N 個供應商子訂單</td></tr>
<tr><td>事件溯源</td><td>完整的審計追踪</td><td>從事件歷史記錄中重建訂單狀態</td></tr>
<tr><td>冪等性</td><td>處理重複的 webhook/重試</td><td>每個操作的冪等鍵</td></tr>
</tbody>
</table>
