...
title: 第 9 課：多通路銷售 — Shopify、Etsy、Amazon、TikTok Shop 和 API 集成
slug: bai-9-multi-channel-sales-integration
description: >-
  POD 的多通路銷售架構，與 Shopify、Etsy、Amazon、TikTok Shop、WooCommerce
  整合、產品清單同步、訂單路由、庫存同步、webhook 處理、通路特定要求。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 9
section_title: 第三部分：產品及電商平台
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ 建築 — 第 9 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：多通路銷售 — Shopify，</tspan>
      <tspan x="60" dy="42">Etsy、亞馬遜、TikTok 商店和 API</tspan>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第三部分：產品及電商平台</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-multi-channel-architecture"><strong>1. 多通道架構</strong></h2>
...
<h2 id="2-channel-connector"><strong>2. 通道連接器接口</strong></h2>
...
<h2 id="3-product-sync"><strong>3.產品清單同步</strong></h2>
...
<h2 id="4-order-routing"><strong>4. 通道的訂單路由</strong></h2>
...
<h2 id="5-webhook-handling"><strong>5.Webhook 處理</strong></h2>
...
<h2 id="6-channel-comparison"><strong>6. 渠道比較</strong></h2>

<table>
<thead>
<tr><th>特點</th><th>購物</th><th>埃特西</th><th>亞馬遜</th><th>抖音商店</th><th>WooCommerce</th></tr>
</thead>
<tbody>
<tr><td>API類型</td><td>GraphQL + REST</td><td>休息v3</td><td>原料藥</td><td>休息</td><td>休息v3</td></tr>
<tr><td>授權</td><td>OAuth 2.0</td><td>OAuth 2.0</td><td>IAM + OAuth</td><td>OAuth 2.0</td><td>API金鑰</td></tr>
<tr><td>最大影像數</td><td>250</td><td>10</td><td>9</td><td>9</td><td>無限</td></tr>
<tr><td>最大變體</td><td>100</td><td>各不相同</td><td>每個類別</td><td>各不相同</td><td>無限</td></tr>
<tr><td>網路鉤子</td><td>是（HMAC）</td><td>有限公司</td><td>社群網路服務/社群網路服務</td><td>是的</td><td>是（智威湯遜）</td></tr>
<tr><td>佣金</td><td>0%</td><td>6.5%</td><td>8-15%</td><td>5%</td><td>0%</td></tr>
<tr><td>訂單流程</td><td>推送（網路鉤子）</td><td>拉（民意調查）</td><td>拉動（SP-API）</td><td>推</td><td>推送（網路鉤子）</td></tr>
</tbody>
</table>
