...
title: 第 8 課：產品目錄和 SKU 架構 - 變體管理和設計 - 產品綁定
slug: bai-8-product-catalog-sku-architecture
description: POD的產品目錄架構、SKU管理策略、基礎產品+設計=可銷售產品、變體矩陣（尺寸×顏色×設計）、無庫存模型、產品資料模型、多通路產品同步。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 8 課：產品目錄和 SKU 架構</tspan>
      <tspan x="60" dy="42">— 變體管理與設計-產品</tspan>
      <tspan x="60" dy="42">裝訂</tspan>
  </text>
...
<h2 id="1-pod-product-model"><strong>1.POD產品資料模型</strong></h2>

<p>在 POD 中，產品不存在於庫存中（無庫存）—僅在有訂單時生產。產品型號為 <strong>基礎產品 × 設計 = 可銷售產品</strong>。</p>
...
<h2 id="2-data-model"><strong>2. 領域資料模型</strong></h2>
...
<h2 id="3-sku-strategy"><strong>3. SKU生成策略</strong></h2>
...
<h2 id="4-variant-matrix"><strong>4. 變體矩陣與無庫存模型</strong></h2>
...
<h2 id="5-product-search"><strong>5. 產品搜尋和發現</strong></h2>
...
<table>
<thead>
<tr><th>概念</th><th>POD方法</th><th>傳統電商</th></tr>
</thead>
<tbody>
<tr><td>產品創造</td><td>基礎產品 × 設計 = SKU</td><td>倉庫固定 SKU</td></tr>
<tr><td>庫存</td><td>虛擬（無庫存）</td><td>實際庫存數量</td></tr>
<tr><td>SKU 數量</td><td>潛在數百萬（組合）</td><td>數百至數千</td></tr>
<tr><td>產品圖片</td><td>自動產生的模型</td><td>手動攝影</td></tr>
<tr><td>定價</td><td>基本成本 + 每個變體的利潤</td><td>每個 SKU 的固定價格</td></tr>
<tr><td>可用性</td><td>始終可用（供應商授權）</td><td>可能缺貨</td></tr>
<tr><td>搜尋</td><td>AI標籤+語意+關鍵字</td><td>手動分類</td></tr>
</tbody>
</table>
