...
description: 金融科技的安全架構。端對端加密。硬體安全模組 (HSM)。 PAN 資料的標記化。 PCI-DSS 網路分段。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 22 課：安全架構 -</tspan>
      <tspan x="60" dy="42">加密、HSM 和令牌化</tspan>
  </text>
...
![第 22 課：安全架構 - 加密、HSM 和令牌化](/storage/uploads/2026/03/fintech-bai-22-diagram.png)

## 簡介

金融科技的安全架構。端對端加密。硬體安全模組 (HSM)。 PAN 資料的標記化。 PCI-DSS 網路分段。
...
金融科技的安全架構是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
