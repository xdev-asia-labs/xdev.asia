...
description: 支付系統的基礎設施設計。多區域部署。主動-主動 DR。資料庫複製。零停機部署。 99.99%+ SLA。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 23 課：基礎設施和高可用性</tspan>
      <tspan x="60" dy="42">- 多區域和災難復原</tspan>
  </text>
...
支付系統的基礎設施設計。多區域部署。主動-主動 DR。資料庫複製。零停機部署。 99.99%+ SLA。
...
支付系統的基礎設施設計是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們學習了基礎設施和高可用性 - 多區域和災難復原。要點：
