...
description: 為金融科技設計數據管道。使用 Kafka 進行事件流處理。更改帳本複製的資料擷取。金融資料的資料湖架構。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 19
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：金融資料管道 - 事件</tspan>
      <tspan x="60" dy="42">串流媒體和 CDC</tspan>
  </text>
...
![第 19 課：金融資料管道 - 事件流和 CDC](/storage/uploads/2026/03/fintech-bai-19-diagram.png)

## 簡介

為金融科技設計數據管道。使用 Kafka 進行事件流處理。更改帳本複製的資料擷取。金融資料的資料湖架構。
...
金融科技的數據管道設計是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
