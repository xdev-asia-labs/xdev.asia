...
description: 利息計算引擎設計：單利/複利、日計數約定。攤銷時間表。預付款、罰款、寬限期。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 18
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 18 課：利息計算 &</tspan>
      <tspan x="60" dy="42">攤銷引擎</tspan>
  </text>
...
![第 18 課：利息計算與攤銷引擎](/storage/uploads/2026/03/fintech-bai-18-diagram.png)

## 簡介

利息計算引擎設計：單利/複利、日計數約定。攤銷時間表。預付款、罰款、寬限期。

---

## 1.利息計算引擎設計：單利/複利、日數約定

### 1.1 基本概念

利息計算引擎設計：單利/複利、日數約定是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
