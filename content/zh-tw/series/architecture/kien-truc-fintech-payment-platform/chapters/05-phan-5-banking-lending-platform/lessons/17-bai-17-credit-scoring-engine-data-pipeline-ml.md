...
description: 建立信用評分引擎。替代資料來源。特色工程管道。用於信用風險評估的機器學習模型。與 CIC 越南整合。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 17
section_title: 第 5 部分：銀行和借貸平台
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ 建築 — 第 17 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：信用評分引擎 - 數據</tspan>
      <tspan x="60" dy="42">管道和機器學習</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：銀行和借貸平台</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 17 課：信用評分引擎 - 資料管道和機器學習](/storage/uploads/2026/03/fintech-bai-17-diagram.png)

## 簡介

建立信用評分引擎。替代資料來源。特色工程管道。用於信用風險評估的機器學習模型。與 CIC 越南整合。
...
建立信用評分引擎是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
