...
description: 詐欺檢測系統架構。具有動態規則的基於規則的引擎。用於詐欺偵測的機器學習模型。即時評分管道。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 12 課：詐欺偵測系統 - 規則</tspan>
      <tspan x="60" dy="42">引擎和機器學習模型</tspan>
  </text>
...
![第 12 課：詐欺偵測系統 - 規則引擎和 ML 模型](/storage/uploads/2026/03/fintech-bai-12-diagram.png)

## 簡介

詐欺檢測系統架構。具有動態規則的基於規則的引擎。用於詐欺偵測的機器學習模型。即時評分管道。
...
詐欺偵測系統架構是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了詐欺偵測系統 - 規則引擎和機器學習模型。要點：
