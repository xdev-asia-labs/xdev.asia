...
description: KYC管路設計：身份驗證、文件驗證。 AML 篩檢：制裁名單、PEP 篩檢。可疑活動報告。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 13 課：反洗錢 (AML) 和 KYC</tspan>
...
![第 13 課：反洗錢 (AML) 和 KYC 流程](/storage/uploads/2026/03/fintech-bai-13-diagram.png)

## 簡介

KYC管路設計：身份驗證、文件驗證。 AML 篩檢：制裁名單、PEP 篩檢。可疑活動報告。
...
KYC管道設計：身份驗證、文件驗證是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了反洗錢 (AML) 和 KYC 管道。要點：
