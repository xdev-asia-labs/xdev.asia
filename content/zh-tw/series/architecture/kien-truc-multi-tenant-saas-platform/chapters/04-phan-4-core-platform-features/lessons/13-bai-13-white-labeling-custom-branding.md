...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 13 課：白標與客製化品牌</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 4 部分：核心平台功能</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 13 課：白標與客製化品牌](/storage/uploads/2026/03/saas-bai-13-diagram.png)

## 簡介

白標架構：自訂網域、標誌、顏色、電子郵件範本。 CSS 主題引擎。經銷商/合作夥伴計畫支援。自訂登入頁面。

---

## 1. 白標架構：自訂網域、標誌、顏色、電子郵件模板

### 1.1 基本概念

白標架構：自訂網域、商標、顏色、電子郵件範本是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
