...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 14 課：通知與溝通</tspan>
...
![第 14 課：通知與通訊引擎](/storage/uploads/2026/03/saas-bai-14-diagram.png)

## 簡介

多頻道通知：電子郵件、推播、應用程式內、簡訊、Slack。模板引擎。偏好管理。摘要/批次處理。交貨追蹤。

---

## 1. 多頻道通知：電子郵件、推播、應用程式內、簡訊、Slack

### 1.1 基本概念

多管道通知：電子郵件、推播、應用程式內、簡訊、Slack 是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
