...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ 建築 — 第 12 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 12 課：外掛程式和擴充架構 -</tspan>
      <tspan x="60" dy="42">市場</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 4 部分：核心平台功能</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 12 課：外掛程式和擴展架構 - 市場](/storage/uploads/2026/03/saas-bai-12-diagram.png)

## 簡介

設計插件系統：擴充點、鉤子、沙盒執行。市場插件。第三方整合。網路鉤子系統。 OAuth 應用程式平台。

---

## 1.設計插件系統：擴充點、鉤子、沙盒執行

### 1.1 基本概念

外掛系統設計：擴充點、鉤子、沙盒執行是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了外掛程式和擴充架構 - Marketplace。要點：
