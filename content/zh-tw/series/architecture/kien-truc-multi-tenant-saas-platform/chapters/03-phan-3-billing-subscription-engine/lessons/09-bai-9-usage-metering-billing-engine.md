...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：使用計量和計費引擎</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 3 部分：計費和訂閱引擎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 9 課：使用計量和計費引擎](/storage/uploads/2026/03/saas-bai-9-diagram.png)

## 簡介

基於使用情況的計費：計量基礎設施、聚合管道。發票產生。升級/降級按比例分配。稅金計算。條紋/槳整合。

---

## 1. 基於使用情況的計費：計量基礎設施、聚合管道

### 1.1 基本概念

基於使用情況的計費：計量基礎設施、聚合管道是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
