...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 8 課：訂閱引擎 - 計畫、</tspan>
      <tspan x="60" dy="42">定價和生命週期</tspan>
  </text>
...
![第 8 課：訂閱引擎 - 計畫、定價與生命週期](/storage/uploads/2026/03/saas-bai-8-diagram.png)

## 簡介

訂閱系統設計：計畫管理、定價等級、試用期。訂閱生命週期：建立、升級、降級、取消、暫停。祖父。

---

## 1.設計訂閱系統：計畫管理、定價等級、試用期

### 1.1 基本概念

訂閱系統設計：計畫管理、定價等級、試用期是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
