...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 10 課：權利系統與功能</tspan>
      <tspan x="60" dy="42">門控</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 3 部分：計費和訂閱引擎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 10 課：權利系統與功能門控](/storage/uploads/2026/03/saas-bai-10-diagram.png)

## 簡介

權利引擎：基於計劃的功能存取。用於漸進式推出的功能標誌。每個計劃的速率限制。配額管理。超額處理。
...
權利引擎：基於計劃的功能存取是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
