...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 21 課：租戶意識 CI/CD &</tspan>
      <tspan x="60" dy="42">基礎設施自動化</tspan>
  </text>
...
![第 21 課：租戶感知 CI/CD 和基礎設施自動化](/storage/uploads/2026/03/saas-bai-21-diagram.png)

## 簡介

SaaS 的 CI/CD：零停機部署。每個租用戶群組的 Canary 版本。用於租戶配置的基礎設施即代碼。 GitOps 工作流程。

---

## 1. SaaS 的 CI/CD：零停機部署

### 1.1 基本概念

SaaS 的 CI/CD：零停機部署是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了租戶感知的 CI/CD 和基礎設施自動化。要點：
