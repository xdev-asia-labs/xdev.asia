...
video_url: null
sort_order: 17
section_title: 第 5 部分：資料和 API 平台
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：每位租戶的搜尋與分析</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">多租戶SaaS平台架構</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：資料和 API 平台</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 17 課：每位租戶的搜尋與分析](/storage/uploads/2026/03/saas-bai-17-diagram.png)

## 簡介

多租戶全文搜尋（Elasticsearch/Meilisearch）。搜尋索引中的租戶資料隔離。應用內分析儀表板。數據導出。

---

## 1.多租用戶全文搜尋（Elasticsearch/Meilisearch）

### 1.1 基本概念

多租戶全文搜尋（Elasticsearch/Meilisearch）是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
