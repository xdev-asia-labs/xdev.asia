...
description: SaaS 商業模式（B2B、B2C、PLG、銷售主導）。關鍵指標：MRR、ARR、流失率、LTV、CAC。 SaaS 架構模式以及從本地到雲端原生的演進。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 1
section_title: 第 1 部分：SaaS 基礎
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ 建築 — 第 1 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 1 課：SaaS 概述 - 商業模式、</tspan>
      <tspan x="60" dy="42">指標和架構模式</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：SaaS 基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 1 課：SaaS 概述 - 商業模型、指標與架構模式](/storage/uploads/2026/03/saas-bai-1-diagram.png)

## 簡介

SaaS 商業模式（B2B、B2C、PLG、銷售主導）。關鍵指標：MRR、ARR、流失率、LTV、CAC。 SaaS 架構模式以及從本地到雲端原生的演進。

---

## 1. SaaS 商業模式（B2B、B2C、PLG、銷售主導）

### 1.1 基本概念

SaaS 商業模式（B2B、B2C、PLG、銷售主導）是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了 SaaS 概述 - 業務模型、指標和架構模式。要點：
