...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ 建築 — 第 3 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：平台架構概述 -</tspan>
      <tspan x="60" dy="42">適用於 SaaS 的 DDD 和微服務</tspan>
  </text>
...
![第 3 課：平台架構概述 - DDD 和 SaaS 微服務](/storage/uploads/2026/03/saas-bai-3-diagram.png)

## 簡介

SaaS平台整體架構設計。有界上下文：租戶、身分、計費、產品。共享服務與租戶特定服務。
...
整體SaaS平台架構設計是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了平台架構概述 - DDD 和 SaaS 微服務。要點：
