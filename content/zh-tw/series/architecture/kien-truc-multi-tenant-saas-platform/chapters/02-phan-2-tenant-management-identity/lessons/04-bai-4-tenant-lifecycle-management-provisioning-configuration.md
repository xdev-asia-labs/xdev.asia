...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：租戶生命週期管理 -</tspan>
      <tspan x="60" dy="42">供應和配置</tspan>
  </text>
...
![第 4 課：租戶生命週期管理 - 供應和配置](/storage/uploads/2026/03/saas-bai-4-diagram.png)

## 簡介

租戶配置自動化：基礎設施設定、資料庫建立、配置。租戶感知路由。每個租戶的自訂網域和品牌。

---

## 1. 租戶配置自動化：基礎設施設定、資料庫建立、配置

### 1.1 基本概念

租戶配置自動化：基礎設施設定、資料庫建立、配置是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
