...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 7 課：資料隔離與多租戶</tspan>
      <tspan x="60" dy="42">資料庫模式</tspan>
  </text>
...
![第 7 課：資料隔離與多租戶資料庫模式](/storage/uploads/2026/03/saas-bai-7-diagram.png)

## 簡介

PostgreSQL 的行級安全性 (RLS)。租戶上下文傳播。查詢過濾模式。跨租戶資料保護。租戶感知的遷移。

---

## 1. PostgreSQL 的行級安全性 (RLS)

### 1.1 基本概念

PostgreSQL 的行級安全性 (RLS) 是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
