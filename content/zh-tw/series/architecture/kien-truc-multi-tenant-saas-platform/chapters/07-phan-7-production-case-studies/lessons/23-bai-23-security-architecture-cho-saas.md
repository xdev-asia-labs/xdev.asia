...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ 建築 — 第 23 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 23 課：SaaS 的安全架構</tspan>
  </text>
...
![第 23 課：SaaS 的安全架構](/storage/uploads/2026/03/saas-bai-23-diagram.png)

## 簡介

SaaS 安全性：租用戶資料加密、每個租用戶的金鑰管理。漏洞管理。滲透測試。 SOC 2、ISO 27001 合規性。

---

## 1. SaaS 安全性：租用戶資料加密、每個租用戶的金鑰管理

### 1.1 基本概念

SaaS安全：租戶資料加密、每個租戶的金鑰管理是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
