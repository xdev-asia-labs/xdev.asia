...
description: 統一可觀測性：OpenTelemetry、Prometheus、Grafana、Loki、Tempo。自助服務儀表板。警報路由。待命管理整合。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 19
section_title: 第 6 部分：可觀測性平台
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ 建築 — 第 19 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：可觀測平台 - 指標，</tspan>
      <tspan x="60" dy="42">紀錄和痕跡</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 6 部分：可觀測性平台</text>
...
## 1.統一可觀測性：OpenTelemetry、Prometheus、Grafana、Loki、Tempo

### 1.1 基本概念

統一可觀測性：OpenTelemetry、Prometheus、Grafana、Loki、Tempo 是該領域最重要的主題。了解核心概念將幫助您從一開始就設計出正確的系統。
