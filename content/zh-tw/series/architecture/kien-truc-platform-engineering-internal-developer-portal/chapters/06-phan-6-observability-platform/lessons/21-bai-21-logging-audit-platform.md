...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ 建築 — 第 21 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 21 課：日誌記錄與稽核平台</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">架構平台工程和內部開發者門戶</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 6 部分：可觀測性平台</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 21 課：日誌記錄與稽核平台](/storage/uploads/2026/03/pe-bai-21-diagram.png)

## 簡介

集中式日誌記錄：ELK/EFK、Loki。大規模日誌聚合。審計日誌平台。基於日誌的警報。合規性日誌記錄要求。

---

## 1.集中日誌記錄：ELK/EFK、Loki

### 1.1 基本概念

集中式日誌記錄：ELK/EFK、Loki是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
