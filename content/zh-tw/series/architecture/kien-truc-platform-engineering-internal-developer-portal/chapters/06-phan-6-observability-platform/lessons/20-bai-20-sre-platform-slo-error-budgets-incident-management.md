...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 20 課：SRE 平台 - SLO、錯誤預算</tspan>
      <tspan x="60" dy="42">& 事件管理</tspan>
  </text>
...
![第 20 課：SRE 平台 - SLO、錯誤預算與事件管理](/storage/uploads/2026/03/pe-bai-20-diagram.png)

## 簡介

SRE 實務：SLI/SLO/SLA 定義。預算追蹤錯誤。事件管理平台。事後自動化。混沌工程整合。

---

## 1. SRE 實務：SLI/SLO/SLA 定義

### 1.1 基本概念

SRE 實踐：SLI/SLO/SLA 定義是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了 SRE 平台 - SLO、錯誤預算和事件管理。要點：
