...
![第 3 課：平台架構概述 - 層和元件](/storage/uploads/2026/03/pe-bai-3-diagram.png)

## 簡介

IDP 架構層：UI Portal、API、編排、整合。平台能力圖。建構與購買決策。平台成熟度模型。

---

## 1. IDP 架構層：UI Portal、API、編排、集成

### 1.1 基本概念

IDP架構層：UI Portal、API、編排、整合是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
