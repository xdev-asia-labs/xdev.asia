...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 課：開發者體驗 (DX) -</tspan>
      <tspan x="60" dy="42">衡量與改進</tspan>
  </text>
...
![第 2 課：開發者體驗 (DX) - 衡量與改進](/storage/uploads/2026/03/pe-bai-2-diagram.png)

## 簡介

開發者體驗：認知負荷、心流狀態、回饋循環。 DORA 指標，SPACE 框架。開發商調查。入職時間。首次部署時間。

---

## 1. 開發者體驗：認知負荷、心流狀態、回饋循環

### 1.1 基本概念

開發者體驗：認知負荷、心流狀態、回饋循環是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
