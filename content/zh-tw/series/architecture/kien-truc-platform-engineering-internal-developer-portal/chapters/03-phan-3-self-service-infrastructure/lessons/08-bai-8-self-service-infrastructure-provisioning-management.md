...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 8 課：自助服務基礎設施 -</tspan>
      <tspan x="60" dy="42">配置與管理</tspan>
  </text>
...
![第 8 課：自助服務基礎設施 - 配置和管理](/storage/uploads/2026/03/pe-bai-8-diagram.png)

## 簡介

自助服務基礎設施：要求→核准→提供→管理。基礎設施抽象層。資源目錄。每個請求的成本可見性。

---

## 1. 自助服務基礎設施：請求→批准→提供→管理

### 1.1 基本概念

自助服務基礎設施：請求→批准→提供→管理是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
