...
description: 實際平台工程分析：Spotify（後台起源）、Netflix（全週期開發）、Airbnb（服務網格）、Mercado Libre（規模化平台）。吸取的教訓。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🏗️ 建築 — 第 25 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 25 課：案例研究 - Spotify、Netflix、</tspan>
      <tspan x="60" dy="42">愛彼迎和自由市場</tspan>
  </text>
...
![第 25 課：案例研究 - Spotify、Netflix、Airbnb 和 Mercado Libre](/storage/uploads/2026/03/pe-bai-25-diagram.png)

## 簡介

實際平台工程分析：Spotify（後台起源）、Netflix（全週期開發）、Airbnb（服務網格）、Mercado Libre（規模化平台）。吸取的教訓。

---

## 1. 實際平台工程分析：Spotify（後台起源）、Netflix（全週期開發）、Airbnb（服務網格）、Mercado Libre（規模化平台）

### 1.1 基本概念

實用平台工程分析：Spotify（後台起源）、Netflix（全週期開發）、Airbnb（服務網格）、Mercado Libre（大規模平台）是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了案例研究 - Spotify、Netflix、Airbnb 和 Mercado Libre。要點：
