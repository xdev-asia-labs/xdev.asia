...
description: API 目錄：發現、文件、版本控制。 OpenAPI/AsyncAPI/GraphQL 規格。 API 治理。自動產生 API 文件。 API健康監控。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 6
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 6 課：API 入口網站和文檔</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 2 部分：開發者門戶</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 6 課：API 入口網站和文檔](/storage/uploads/2026/03/pe-bai-6-diagram.png)

## 簡介

API 目錄：發現、文件、版本控制。 OpenAPI/AsyncAPI/GraphQL 規格。 API 治理。自動產生 API 文件。 API健康監控。
...
API目錄：發現、文件、版本控制是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
