...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：後台 - 內部開發人員</tspan>
      <tspan x="60" dy="42">入口網站</tspan>
  </text>
...
![第 4 課：後台 - 內部開發者門戶](/storage/uploads/2026/03/pe-bai-4-diagram.png)

## 簡介

Spotify Backstage：架構、外掛、目錄。軟體目錄：元件、API、資源。技術文檔整合。客製化和插件開發。

---

## 1. Spotify Backstage：架構、外掛、目錄

### 1.1 基本概念

Spotify Backstage：架構、外掛、目錄是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了 Backstage - 內部開發者入口網站。要點：
