...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 5 課：服務目錄與軟體</tspan>
      <tspan x="60" dy="42">範本</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 2 部分：開發者門戶</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 5 課：服務目錄與軟體模板](/storage/uploads/2026/03/pe-bai-5-diagram.png)

## 簡介

服務目錄：註冊、發現、管理服務。軟體模板（鷹架）：新服務的黃金路徑。模板定制。 API 文件。
...
服務目錄：註冊、發現、管理服務是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
