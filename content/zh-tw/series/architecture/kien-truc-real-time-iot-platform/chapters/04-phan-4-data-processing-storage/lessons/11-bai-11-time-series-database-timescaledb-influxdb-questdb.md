...
description: 時間序列資料模式。 TimescaleDB：超表、連續聚合。 InfluxDB：Flux 查詢語言。 QuestDB：用於時間序列的 SQL。比較和選擇。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 11
section_title: 第 4 部分：資料處理與存儲
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 11 課：時間序列資料庫 -</tspan>
      <tspan x="60" dy="42">TimescaleDB、InfluxDB 與 QuestDB</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="244" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">即時架構與物聯網平台</text>

  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 4 部分：資料處理與存儲</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 11 課：時間序列資料庫 - TimescaleDB、InfluxDB 和 QuestDB](/storage/uploads/2026/03/iot-bai-11-diagram.png)

## 簡介

時間序列資料模式。 TimescaleDB：超表、連續聚合。 InfluxDB：Flux 查詢語言。 QuestDB：用於時間序列的 SQL。比較和選擇。
...
時間序列資料模式是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了時間序列資料庫 - TimescaleDB、InfluxDB 和 QuestDB。要點：
