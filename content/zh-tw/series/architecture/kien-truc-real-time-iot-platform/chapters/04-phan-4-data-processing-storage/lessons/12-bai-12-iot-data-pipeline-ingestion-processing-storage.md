...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 12 課：物聯網資料管道 - 攝取，</tspan>
      <tspan x="60" dy="42">加工與儲存</tspan>
  </text>
...
![第 12 課：物聯網資料管道 - 攝取、處理和儲存](/storage/uploads/2026/03/iot-bai-12-diagram.png)

## 簡介

物聯網資料管道架構。高吞吐量攝取（數百萬條訊息/秒）。流處理：過濾、豐富、聚合。熱/溫/冷儲存。
...
物聯網資料管道架構是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了物聯網資料管道 - 攝取、處理和儲存。要點：
