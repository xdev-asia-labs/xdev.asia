...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 13 課：規則引擎與複雜事件</tspan>
      <tspan x="60" dy="42">加工</tspan>
  </text>
...
![第 13 課：規則引擎與複雜事件處理](/storage/uploads/2026/03/iot-bai-13-diagram.png)

## 簡介

物聯網規則引擎：事件-條件-動作。複雜事件處理（CEP）。模式檢測。警報管道。動態規則管理。
...
物聯網規則引擎：事件-條件-動作是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
