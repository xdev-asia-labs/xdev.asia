...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ 建築 — 第 23 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 23 課：物聯網資料分析與機器</tspan>
...
![第 23 課：物聯網資料分析與機器學習](/storage/uploads/2026/03/iot-bai-23-diagram.png)

## 簡介

物聯網分析架構。感測器數據的批量分析。 IoT 的 ML 管道：時間序列的特徵工程。用於預測模型的 AutoML。
...
物聯網分析架構是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
