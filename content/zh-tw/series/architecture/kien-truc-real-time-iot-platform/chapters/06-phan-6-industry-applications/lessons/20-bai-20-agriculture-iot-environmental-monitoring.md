...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 20 課：農業物聯網與環境</tspan>
...
![第 20 課：農業物聯網與環境監測](/storage/uploads/2026/03/iot-bai-20-diagram.png)

## 簡介

農業科技物聯網：土壤感測器、氣象站、灌溉控制。精準農業。環境監測：空氣品質、水質。 LoRaWAN 用於農業。

---

## 1. 農業科技物聯網：土壤感測器、氣象站、灌溉控制

### 1.1 基本概念

農業科技物聯網：土壤感測器、氣象站、灌溉控制是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
