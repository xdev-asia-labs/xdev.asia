...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ 建築 — 第 9 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：邊緣 AI 與裝置端推理</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 3 部分：邊緣運算</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 9 課：邊緣 AI 與裝置端推理](/storage/uploads/2026/03/iot-bai-9-diagram.png)

## 簡介

邊緣人工智慧：TensorRT、ONNX 執行時間、TFLite。模型優化：量化、剪枝。設備端推理與雲端推理的權衡。視野在邊緣。

---

## 1. 邊緣人工智慧：TensorRT、ONNX 執行時間、TFLite

### 1.1 基本概念

Edge AI：TensorRT、ONNX Runtime、TFLite 是該領域最重要的一些主題。了解核心概念將幫助您從一開始就設計出正確的系統。
