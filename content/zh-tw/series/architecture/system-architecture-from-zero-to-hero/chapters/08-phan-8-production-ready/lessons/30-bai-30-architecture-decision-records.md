...
description: 架構決策記錄（ADR）：格式、何時編寫、實例。生產準備清單。系統設計面試綜合框架。系統架構師的職業道路。資源和後續步驟。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 30
section_title: 第 8 部分：生產就緒架構
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ 建築 — 第 30 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 30 課：架構決策記錄與</tspan>
      <tspan x="60" dy="42">生產清單</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 8 部分：生產就緒架構</text>
...
最後一課 - 將學到的所有知識綜合到實用工具中：**架構決策記錄**用於記錄決策，**生產清單**用於確保系統準備就緒，以及**系統設計框架**用於訪談。
