...
title: 第 24 課：案例研究 - 設計 URL 縮短器
slug: bai-24-case-study-thiet-ke-url-shortener
description: 系統設計面試經典：URL Shortener (bit.ly)。需求收集。估計（QPS、儲存）。短 URL 產生策略。資料庫設計。緩存層。分析和重定向流程。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ 建築 — 第 24 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 24 課：案例研究 - URL 設計</tspan>
      <tspan x="60" dy="42">起酥油</tspan>
  </text>
...
1. 如果需要支援 1M URL/秒（100x 規模），如何更改架構？

2. 設計自訂別名功能：驗證、衝突處理、保留高階名稱。
