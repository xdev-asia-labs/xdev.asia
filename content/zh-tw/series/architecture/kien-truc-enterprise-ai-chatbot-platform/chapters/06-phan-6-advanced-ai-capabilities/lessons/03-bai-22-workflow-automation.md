...
title: 第 22 課：工作流程自動化 — 聊天機器人觸發的工作流程與流程編排
slug: bai-22-workflow-automation
description: 聊天機器人觸發的工作流程、審批流程、與 n8n/Temporal 整合、事件驅動的自動化、人機互動工作流程、長期運作的流程。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 22
section_title: 第六部分：高階人工智慧能力
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 22 課：工作流程自動化 —</tspan>
      <tspan x="60" dy="42">聊天機器人觸發的工作流程與流程</tspan>
      <tspan x="60" dy="42">編排</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第六部分：高階人工智慧能力</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-workflow-overview"><strong>1. 聊天機器人觸發的工作流程－概述</strong></h2>

<p>聊天機器人企業不只是回答問題——它應該 <strong>執行業務流程</strong>。從「建立 Jira 票證」、「批准休假申請」到「入職新員工」—您所需的一切 <strong>工作流程引擎</strong> 堅強的背後。</p>
...
<h2 id="2-workflow-engine"><strong>2. 工作流引擎設計</strong></h2>
...
<h2 id="3-workflow-definitions"><strong>3. 預建工作流程模板</strong></h2>
...
<h2 id="4-temporal-integration"><strong>4. 時間整合－持久的工作流程</strong></h2>
...
<h2 id="5-chatbot-workflow-bridge"><strong>5. 聊天機器人 ↔ 工作流程橋</strong></h2>
...
<h2 id="6-event-driven"><strong>6. 事件驅動的自動化</strong></h2>
...
<h2 id="tong-ket"><strong>第 22 課總結</strong></h2>

<ul>
<li><strong>工作流程引擎</strong>：具有動作、條件、批准、等待、平行步驟的狀態機方法</li>
<li><strong>審批流程</strong>：暫停工作流程 → 通知審核者 → 復原審核事件</li>
<li><strong>時間整合</strong>：適用於長時間運作流程（數天/數週）的耐用工作流程</li>
<li><strong>聊天機器人橋</strong>：映射意圖→工作流程、檢查狀態、傳送進度更新</li>
<li><strong>事件驅動</strong>：自動觸發業務事件的工作流程（票證、部署、SLA）</li>
</ul>

<p><strong>下一篇：</strong> GPU 基礎架構與模型服務 — 自寄 LLM 部署、vLLM/TGI、GPU 叢集管理、模型快取、自動擴充推理。</p>
