...
title: 第 15 課：分析和可觀察性 — 對話分析、LLM 指標和成本跟踪
slug: bai-15-analytics-observability
description: 對話分析、LLM 可觀察性（延遲、令牌、成本）、追蹤管道、儀表板設計、警報、A/B 測試指標、投資回報率測量。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 15
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ 建築 — 第 15 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：分析與可觀察性 —</tspan>
      <tspan x="60" dy="42">對話分析、法學碩士指標與成本</tspan>
      <tspan x="60" dy="42">追蹤</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 4 部分：企業功能與安全</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-observability-stack"><strong>1. AI 聊天機器人的可觀察性堆疊</strong></h2>
...
<h2 id="2-conversation-analytics"><strong>2. 對話分析－關鍵指標</strong></h2>
...
<tr>
<td><strong>電腦輔助能力測試</strong></td>
<td>客戶滿意度（贊成/反對）</td>
<td>>4.0/5.0</td>
</tr>
<tr>
<td><strong>平均匝數</strong></td>
<td>每次對話的平均訊息數</td>
<td><8</td>
</tr>
<tr>
<td><strong>首次回應時間</strong></td>
<td>第一個令牌的時間 (TTFT)</td>
<td><500ms</td>
</tr>
<tr>
<td><strong>升級率</strong></td>
<td>% 轉移給人工代理</td>
<td><30%</td>
</tr>
<tr>
<td><strong>遏制率</strong></td>
<td>% 完全由機器人處理</td>
<td>>60%</td>
</tr>
<tr>
<td><strong>每次對話成本</strong></td>
<td>LLM + 每次轉換的基礎設施總成本。</td>
<td><$0.05</td>
</tr>
<tr>
<td><strong>幻覺率</strong></td>
<td>沒有支持的主張的答覆百分比</td>
<td><5%</td>
</tr>
</tbody>
...
<h2 id="3-llm-tracing"><strong>3. LLM 呼叫追蹤 — Langfuse 集成</strong></h2>
...
<h2 id="4-cost-tracking"><strong>4. 成本追蹤與最佳化</strong></h2>
...
<h2 id="5-alerting"><strong>5. 警報和異常檢測</strong></h2>
...
<h2 id="tong-ket"><strong>第 15 課總結</strong></h2>

<ul>
<li><strong>3 支柱</strong>：痕跡（Langfuse）、指標（Prometheus/Grafana）、日誌（ELK/Loki）</li>
<li><strong>關鍵指標</strong>：解決率、CSAT、成本/對話、幻覺率、延遲</li>
<li><strong>法學碩士追踪</strong>：Langfuse 追蹤每個呼叫的跨度（RAG、guardrail、LLM）+ 成本評分</li>
<li><strong>成本追蹤</strong>：每個模型的成本、每日報告、最佳化建議</li>
<li><strong>警報</strong>：錯誤率、延遲高峰、成本超支、品質下降的自動警報</li>
</ul>

<p><strong>下一篇：</strong> 多通路整合 — 全通路閘道、Facebook Messenger、Zalo OA、Web Widget、LINE、Slack、Teams。
</p>
