...
title: 第 13 課：知識庫管理 — 文件攝取、生命週期與存取控制
slug: bai-13-knowledge-base-management
description: 文件攝取管道、多格式解析（PDF/DOCX/HTML/Confluence）、知識生命週期管理、版本控制、每個文件的存取控制、增量同步、過時內容檢測。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 13
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ 建築 — 第 13 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 13 課：知識庫管理 —</tspan>
      <tspan x="60" dy="42">文件攝取、生命週期和訪問</tspan>
      <tspan x="60" dy="42">控制</tspan>
  </text>
...
<h2 id="1-knowledge-management"><strong>1.知識庫管理－超越RAG</strong></h2>

<p>RAG 管道（第 5 課）解決 <strong>檢索。檢索</strong>。但企業需要管理 <strong>生命週期</strong> 知識－從多個來源取得、版本控制、存取控制、過時內容偵測、多租戶隔離。</p>
...
<h2 id="2-connector-framework"><strong>2. 連接器框架－多源攝取</strong></h2>
...
<h2 id="3-document-processor"><strong>3. 多格式文件處理器</strong></h2>
...
<h2 id="4-access-control"><strong>4. 文件級存取控制</strong></h2>
...
<h2 id="5-stale-detection"><strong>5. 過時內容偵測與生命週期管理</strong></h2>
...
<h2 id="tong-ket"><strong>第 13 課總結</strong></h2>

<ul>
<li><strong>連接器框架</strong>：Confluence、SharePoint、Google Drive — 完全同步 + 增量同步</li>
<li><strong>文件處理</strong>：多重格式解析→清除→分塊→嵌入→索引</li>
<li><strong>存取控制</strong>：文檔級ACL（使用者/群組/角色），從來源系統同步</li>
<li><strong>生命週期管理</strong>：過時檢測（基於時間、來源刪除、低相關性）→ 存檔</li>
<li><strong>增量同步</strong>：僅處理更改，無需每次同步時完全重新索引</li>
</ul>

<p><strong>下一篇：</strong> 多租戶架構－租戶隔離、每個租戶的配置、資源配額、計費計量。</p>
