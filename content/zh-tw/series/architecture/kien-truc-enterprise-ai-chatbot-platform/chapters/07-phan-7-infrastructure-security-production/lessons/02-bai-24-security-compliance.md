...
title: 第 24 課：安全性與合規性 — AI 聊天機器人平台的端到端安全性
slug: bai-24-security-compliance
description: 端對端加密、稽核日誌記錄、GDPR/HIPAA 合規性、AI 系統滲透測試、即時注入防禦、資料保留策略。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 24
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 24 課：安全性與合規性 — 安全性</tspan>
      <tspan x="60" dy="42">端到端的人工智慧聊天機器人平台</tspan>
  </text>
...
<h2 id="1-threat-model"><strong>1. AI聊天機器人威脅模型</strong></h2>

<p>AI聊天機器人平台有 <strong>更廣泛的攻擊面</strong> 傳統應用程式－因為透過 LLM（即時注入、資料擷取、模型操作）產生額外的攻擊向量。</p>
...
<h2 id="2-encryption"><strong>2. 端對端加密</strong></h2>
...
<h2 id="3-audit-logging"><strong>3. 不可變的稽核日誌記錄</strong></h2>
...
<h2 id="4-gdpr-compliance"><strong>4. GDPR 與資料隱私合規性</strong></h2>
...
<h2 id="5-data-retention"><strong>5. 資料保留政策</strong></h2>
...
<h2 id="6-rbac"><strong>6. RBAC 和 API 安全</strong></h2>
...
<h2 id="tong-ket"><strong>第 24 課總結</strong></h2>

<ul>
<li><strong>威脅模型</strong>：AI聊天機器人透過提示注入、PII提取、模型中毒等方式增加攻擊面</li>
<li><strong>加密</strong>：用於對話資料的 AES-256-GCM，金鑰包裝（DEK/KEK 模式）</li>
<li><strong>審計日誌記錄</strong>：哈希鏈不可變日誌、AI 特定事件（推理、資料存取）</li>
<li><strong>一般資料保護條例</strong>：刪除權（第 17 條）、資料可攜性（第 20 條）、保留政策</li>
<li><strong>RBAC</strong>：4 個角色（使用者 → 平台管理員），具有前綴標識的範圍 API 金鑰</li>
</ul>

<p><strong>下一篇：</strong> 案例研究－真實的企業人工智慧聊天機器人實施、架構決策、經驗教訓、投資報酬率分析。</p>
