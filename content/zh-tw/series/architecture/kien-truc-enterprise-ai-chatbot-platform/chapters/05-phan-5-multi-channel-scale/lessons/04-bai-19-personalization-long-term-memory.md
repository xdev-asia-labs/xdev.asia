...
title: 第 19 課：個人化與長期記憶－使用者分析、偏好學習與記憶鞏固
slug: bai-19-personalization-long-term-memory
description: 使用者分析、偏好學習、情境個人化、長期記憶架構、記憶鞏固、遺忘策略、隱私意識個人化。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 19
section_title: 第 5 部分：多通路與規模
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：個人化與長期記憶</tspan>
      <tspan x="60" dy="42">— 使用者分析、偏好學習 &</tspan>
      <tspan x="60" dy="42">記憶鞏固</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：多通路與規模</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-memory-architecture"><strong>1. 長期記憶架構</strong></h2>

<p>人們透過許多對話記住上下文——聊天機器人也需要這一點。長期記憶有助於聊天機器人 <strong>記住偏好、歷史、關係</strong> 跨會話的使用者數。</p>
...
<h2 id="2-memory-types"><strong>2. 內存類型和存儲</strong></h2>
...
<h2 id="3-memory-extraction"><strong>3. 記憶提取－從對話中學習</strong></h2>
...
<h2 id="4-memory-retrieval"><strong>4. 上下文感知記憶體檢索</strong></h2>
...
<h2 id="5-memory-consolidation"><strong>5. 記憶鞏固與遺忘</strong></h2>
...
<h2 id="6-privacy"><strong>6. 隱私感知記憶體（GDPR 合規性）</strong></h2>
...
<h2 id="tong-ket"><strong>第 19 課總結</strong></h2>

<ul>
<li><strong>3 種記憶體類型</strong>：情境（事件）、語意（事實）、程序（偏好）</li>
<li><strong>萃取</strong>：LLM從對話中提取記憶，去重+矛盾處理</li>
<li><strong>檢索</strong>：混合評分=語意（40%）+新近度（20%）+重要性（30%）+訪問（10%）</li>
<li><strong>整合</strong>：每日 cron — 合併相似、存檔過時、刪除過期（GDPR 1 年）</li>
<li><strong>隱私</strong>：使用者可以查看/刪除記憶－被遺忘權合規性</li>
</ul>

<p><strong>下一篇：</strong> 特定領域的人工智慧——醫療保健、金融、法律聊天機器人合規性、領域知識微調。</p>
