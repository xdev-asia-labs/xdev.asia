...
title: 第 16 課：多通路整合 — 全通路閘道、Messenger、Zalo、Web Widget
slug: bai-16-multi-channel-integration
description: >-
  全通路閘道架構、通路適配器模式、Facebook Messenger、Zalo OA、Web Widget、LINE、Slack、Microsoft
  Teams、行動 SDK、訊息規範化。
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 16 課：多通路整合 —</tspan>
      <tspan x="60" dy="42">全通路網關、Messenger、Zalo、Web</tspan>
      <tspan x="60" dy="42">小部件</tspan>
  </text>
...
<h2 id="1-omnichannel-architecture"><strong>1. 全通路網關架構</strong></h2>

<p>企業聊天機器人需要努力 <strong>多個通道同時</strong> — Web、Messenger、Zalo、Slack、Teams — 以及 <strong>統一對話</strong> 跨通路。</p>
...
<h2 id="2-channel-adapter"><strong>2. 通道適配器模式</strong></h2>
...
<h2 id="3-messenger-adapter"><strong>3.Facebook Messenger 轉接器</strong></h2>
...
<h2 id="4-zalo-adapter"><strong>4. Zalo OA 轉接器（越南專用）</strong></h2>
...
<h2 id="5-web-widget"><strong>5. 可嵌入的Web Widget</strong></h2>
...
<h2 id="tong-ket"><strong>第 16 課總結</strong></h2>

<ul>
<li><strong>通道適配器模式</strong>：每個通道都有自己的適配器－規範化→統一訊息→聊天引擎</li>
<li><strong>反應適應</strong>：根據頻道功能自動調整輸出（markdown、按鈕、文字長度）</li>
<li><strong>使者</strong>：Webhook驗證、快速回覆、輪播模板</li>
<li><strong>札洛OA</strong>：MAC驗證、文字+圖片訊息、清單範本（以越南為主）</li>
<li><strong>網頁小工具</strong>：基於WebSocket，完整markdown+檔案上傳+語音，1行嵌入</li>
</ul>

<p><strong>下一篇：</strong> 人工切換與混合支援 — 升級觸發器、代理路由、即時聊天整合、無縫切換使用者體驗。</p>
