...
title: 第 9 課：多代理編排 — Supervisor、路由和切換協議
slug: bai-9-multi-agent-orchestration
description: 代理路由、主管模式、代理切換協定、共享記憶體、代理專業化、對話分支、並發代理執行。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 9
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：多代理編排 —</tspan>
      <tspan x="60" dy="42">主管，路由和切換協議</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 3 部分：代理架構</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-multi-agent-overview"><strong>1. Why Multi-Agent? — 單一代理限制</strong></h2>

<p>擁有 50 多個工具的單一代理程式將會遇到問題： <strong>工具混亂</strong> （選擇錯誤的工具）， <strong>上下文超載</strong> （系統提示太長），以及 <strong>專業化程度差</strong>。多代理分為專門的代理，每個代理只處理一個域。</p>
...
<h2 id="2-agent-definition"><strong>2. 代理的定義和專業化</strong></h2>
...
<h2 id="3-supervisor-pattern"><strong>3. Supervisor模式－智慧路由</strong></h2>
...
<h2 id="4-handoff-protocol"><strong>4. 代理切換協議</strong></h2>
...
<h2 id="5-orchestrator"><strong>5. Agent Orchestrator－將它們放在一起</strong></h2>
...
<h2 id="6-shared-memory"><strong>6. Agent之間共享內存</strong></h2>
...
<h2 id="tong-ket"><strong>第 9 課總結</strong></h2>

<ul>
<li><strong>多Agent</strong>：將聊天機器人分為專門的代理，每個代理都有自己的工具+提示</li>
<li><strong>主管模式</strong>：基於LLM的路由器決定處理哪個代理，回退到嵌入相似性</li>
<li><strong>切換協定</strong>：透過摘要+系統訊息在代理之間傳輸上下文</li>
<li><strong>共享記憶體</strong>：基於Redis的共享上下文（客戶資訊、收集的資料、代理註釋）</li>
<li><strong>主題變化偵測</strong>：自動偵測使用者何時改變主題 → 切換代理</li>
</ul>

<p><strong>下一篇：</strong> 規劃與反思－ReAct 模式、自我反思循環、複雜任務的規劃-執行-審查循環。</p>
