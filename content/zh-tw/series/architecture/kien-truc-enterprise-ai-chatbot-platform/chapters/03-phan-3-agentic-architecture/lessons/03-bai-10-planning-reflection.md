...
title: 第 10 課：規劃與反思－ReAct、自我修正與複雜任務分解
slug: bai-10-planning-reflection
description: ReAct 模式（推理 + 行動）、計劃-執行-審查循環、自我反思循環、任務分解、錯誤恢復、幻覺檢測、置信度評分。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 10
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 10 課：規劃與反思 — ReAct，</tspan>
      <tspan x="60" dy="42">自我修正和複雜的任務</tspan>
...
<h2 id="1-react-pattern"><strong>1.ReAct模式——推理+行動</strong></h2>

<p>ReAct（理性 + 行動）是代理 AI 最強的模式 — LLM <strong>行動前思考</strong>, 和 <strong>收到結果後回饋</strong>。與簡單的函數呼叫不同，ReAct 創建思想痕跡來幫助偵錯和改進代理。</p>
...
<h2 id="2-plan-execute"><strong>2. 計劃-執行-審查週期</strong></h2>
...
<h2 id="3-self-reflection"><strong>3.自我反思與錯誤修復</strong></h2>
...
<h2 id="4-hallucination-detection"><strong>4. 幻覺偵測</strong></h2>
...
<h2 id="5-confidence-scoring"><strong>5. 信賴度評分框架</strong></h2>
...
<h2 id="tong-ket"><strong>第 10 課總結</strong></h2>

<ul>
<li><strong>反應</strong>：思想→行動→觀察循環－智能體在行動前思考</li>
<li><strong>計劃-執行-審查</strong>：制定計劃→逐步執行→審核結果→失敗重新規劃</li>
<li><strong>自我反省</strong>：代理自我評估品質、檢測問題、改進回應（最多 N 次嘗試）</li>
<li><strong>幻覺偵測</strong>：提取聲明→檢查來源→標記不受支援的聲明</li>
<li><strong>置信度評分</strong>：≥0.8 回應，≥0.5 新增警告，≥0.3 升級，<0.3 拒絕</li>
</ul>

<p><strong>下一篇：</strong> 結構化資料查詢－文字到 SQL、知識圖查詢、資料庫代理程式、結果格式化。</p>
