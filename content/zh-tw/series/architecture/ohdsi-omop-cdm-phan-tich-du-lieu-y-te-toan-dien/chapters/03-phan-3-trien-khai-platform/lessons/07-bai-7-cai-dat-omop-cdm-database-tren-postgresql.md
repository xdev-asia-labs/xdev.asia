...
description: >-
  在 PostgreSQL 上建立 OMOP CDM 架構、匯入 DDL 腳本、從 Athena 載入標準化詞彙、建立索引和約束、配置 OMOP
  查詢的效能調整以及設定過程的腳本自動化。
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ 建築 — 第 7 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 7 課：安裝上面的 OMOP CDM 資料庫</tspan>
