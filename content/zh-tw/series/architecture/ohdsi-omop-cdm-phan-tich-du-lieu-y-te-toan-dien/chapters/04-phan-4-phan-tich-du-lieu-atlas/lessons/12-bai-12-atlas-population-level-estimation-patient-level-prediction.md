...
description: 人群層級效應估計（傾向評分配對、陰性對照結果）、患者層級預測（LASSO、梯度提升、ROC/AUC）、從 ATLAS 產生 R 研究套件並評估結果。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 12 課：ATLAS — 人口層面</tspan>
      <tspan x="60" dy="42">估計和患者層面預測</tspan>
  </text>
...
![第 12 課：人群水準估計與病患層級預測](/storage/uploads/2026/03/ohdsi-bai-12-estimation-prediction.png)

## 簡介

本文重點介紹 ATLAS 的兩個最先進的分析功能：
- **人群層級效應估計 (PLE)**：估計人群層級的藥物有效性/副作用
- **病患層級預測 (PLP)**：預測每位病患發生結果的機率
...
|特點|輸入|輸出|應用 |
|------------|---------|--------|----------|
|估計|目標與比較→結果|危險比 + CI |比較藥物有效性/安全性 |
|預測|目標→結果（時間窗口）|每位患者的風險分數 |預測個人風險 |
| PS配對|協變數 |均衡的群體|減少混淆 |
|陰性對照|已知無效效應 |經驗校準 |檢測系統偏差 |

**下一篇文章**：ACHILLES — 資料表徵與來源分析
