...
description: 零信任架構原則、服務間的雙向 TLS (mTLS)、自動憑證管理、Service Mesh 中的授權策略、Kubernetes 中的網路策略。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 14
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 14 課：零信任安全與 mTLS</tspan>
  </text>
...
![第 14 課：零信任安全與 mTLS](/storage/uploads/2026/03/cn-bai-14-diagram.png)

## 簡介

In the traditional model, security relies on **perimeter defense** — trusting everything within the network. In cloud native, network boundaries are blurred, services can run in many places. **Zerories are blurred, services can run in many places. **Zero 休authorized.
