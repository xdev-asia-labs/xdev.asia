...
description: Data Lakehouse：結合了 DW 和 Data Lake 的優點。阿帕契冰山、三角洲湖、阿帕契胡迪。表格式、物件儲存上的 ACID 事務。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 2
section_title: 第 1 部分：資料平台基礎
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 課：資料 Lakehouse 架構 -</tspan>
      <tspan x="60" dy="42">冰山、三角洲湖和 Hudi</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：資料平台基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 2 課：資料湖屋架構 - Iceberg、Delta Lake 和 Hudi](/storage/uploads/2026/03/dp-bai-2-diagram.png)

## 簡介

Data Lakehouse：結合了 DW 和 Data Lake 的優點。阿帕契冰山、三角洲湖、阿帕契胡迪。表格式、物件儲存上的 ACID 事務。

---

## 1. Data Lakehouse：結合了 DW 和 Data Lake 的優點

### 1.1 基本概念

Data Lakehouse：結合 DW 和 Data Lake 的優點是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了 Data Lakehouse 架構 - Iceberg、Delta Lake 和 Hudi。要點：
