...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ 建築 — 第 1 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 1 課：數據平台概述 - 演化</tspan>
      <tspan x="60" dy="42">& 建築模式</tspan>
  </text>
...
![第 1 課：資料平台概述 - 演進與架構模式](/storage/uploads/2026/03/dp-bai-1-diagram.png)

## 簡介

演變：資料倉儲→資料湖→資料湖屋→資料格。現代資料堆疊。資料平台架構模式和團隊拓撲。

---

## 1.演進：資料倉儲→資料湖→資料湖屋→資料格

### 1.1 基本概念

演變：資料倉儲→資料湖→資料湖屋→資料格是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
