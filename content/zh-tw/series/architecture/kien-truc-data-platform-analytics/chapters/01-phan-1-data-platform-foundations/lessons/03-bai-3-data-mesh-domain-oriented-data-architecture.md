...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：資料網格 - 面向領域的數據</tspan>
...
![第 3 課：資料網格 - 面向領域的資料架構](/storage/uploads/2026/03/dp-bai-3-diagram.png)

## 簡介

資料網格原則：域所有權、資料即產品、自助平台、聯邦治理。實施模式。數據合約。

---

## 1. Data Mesh原則：領域所有權、資料即產品、自助平台、聯邦治理

### 1.1 基本概念

資料網格原則：域所有權、資料即產品、自助平台、聯邦治理是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
