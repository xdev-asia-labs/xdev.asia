...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：語意層 - 指標儲存和</tspan>
      <tspan x="60" dy="42">業務邏輯</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：分析與語意層</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 15 課：語意層 - 儲存指標與業務邏輯](/storage/uploads/2026/03/dp-bai-15-diagram.png)

## 簡介

語意層：指標的單一事實來源。 Cube.js、MetricFlow (dbt)。指標定義、維度、措施。無頭商業智慧。
...
語意層：指標的單一事實來源是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
