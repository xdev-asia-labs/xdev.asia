...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 16 課：BI 和視覺化 - 儀表板</tspan>
...
![第 16 課：BI 和視覺化 - 儀表板架構](/storage/uploads/2026/03/dp-bai-16-diagram.png)

## 簡介

BI平台架構：Metabase、Superset、Looker。嵌入式分析。儀表板性能優化。自助分析。

---

## 1.BI平台架構：Metabase、Superset、Looker

### 1.1 基本概念

BI平台架構：Metabase、Superset、Looker是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
