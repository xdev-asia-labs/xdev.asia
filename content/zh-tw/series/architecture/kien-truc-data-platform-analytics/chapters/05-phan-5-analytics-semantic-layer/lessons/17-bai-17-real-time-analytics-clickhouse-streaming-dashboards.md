...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ 建築 — 第 17 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：即時分析 - ClickHouse &</tspan>
      <tspan x="60" dy="42">串流儀表板</tspan>
  </text>
...
![第 17 課：即時分析 - ClickHouse 和串流儀表板](/storage/uploads/2026/03/dp-bai-17-diagram.png)

## 簡介

即時 OLAP：ClickHouse、Apache Druid。流式聚合。即時儀表板。近似查詢處理。抽樣策略。

---

## 1.即時OLAP：ClickHouse、Apache Druid

### 1.1 基本概念

即時OLAP：ClickHouse、Apache Druid是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課程中，我們了解了即時分析 - ClickHouse 和串流儀表板。要點：
