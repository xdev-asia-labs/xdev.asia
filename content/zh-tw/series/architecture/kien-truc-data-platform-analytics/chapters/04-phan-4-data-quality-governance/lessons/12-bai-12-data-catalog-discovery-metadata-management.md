...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 12 課：資料目錄與發現 -</tspan>
      <tspan x="60" dy="42">元資料管理</tspan>
  </text>
...
![第 12 課：資料目錄與發現 - 元資料管理](/storage/uploads/2026/03/dp-bai-12-diagram.png)

## 簡介

資料目錄：DataHub、OpenMetadata、Amundsen。元資料管理。數據沿襲追蹤。數據發現和搜尋。商業術語表。

---

## 1.資料目錄：DataHub、OpenMetadata、Amundsen

### 1.1 基本概念

資料目錄：DataHub、OpenMetadata、Amundsen 是該領域最重要的主題。了解核心概念將幫助您從一開始就設計出正確的系統。
