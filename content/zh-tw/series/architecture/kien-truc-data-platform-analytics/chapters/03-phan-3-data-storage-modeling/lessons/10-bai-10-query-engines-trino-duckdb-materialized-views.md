...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 10 課：查詢引擎 - Trino、DuckDB 和</tspan>
      <tspan x="60" dy="42">物化視圖</tspan>
  </text>
...
![第 10 課：查詢引擎 - Trino、DuckDB 和物化視圖](/storage/uploads/2026/03/dp-bai-10-diagram.png)

## 簡介

與 Trino/Presto 的共同查詢。用於嵌入式分析的 DuckDB。物化視圖和增量計算。查詢優化。

---

## 1. 使用 Trino/Presto 進行聯合查詢

### 1.1 基本概念

Trino/Presto 聯合查詢是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了查詢引擎 - Trino、DuckDB 和物化視圖。要點：
