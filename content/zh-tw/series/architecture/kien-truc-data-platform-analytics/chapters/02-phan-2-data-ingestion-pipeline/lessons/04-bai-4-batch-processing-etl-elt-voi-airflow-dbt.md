...
description: ETL 與 ELT 模式。 Apache Airflow：DAG、運算子、調度。 dbt（資料建構工具）：模型、測試、文件。資料轉換最佳實踐。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：批次 - ETL/ELT</tspan>
      <tspan x="60" dy="42">氣流和 DBT</tspan>
  </text>
...
![第 4 課：批次 - 使用 Airflow 和 dbt 的 ETL/ELT](/storage/uploads/2026/03/dp-bai-4-diagram.png)

## 簡介

ETL 與 ELT 模式。 Apache Airflow：DAG、運算子、調度。 dbt（資料建構工具）：模型、測試、文件。資料轉換最佳實踐。
...
ETL 與 ELT 模式是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
...
在本課中，我們學習了批次 - 使用 Airflow 和 dbt 的 ETL/ELT。要點：
