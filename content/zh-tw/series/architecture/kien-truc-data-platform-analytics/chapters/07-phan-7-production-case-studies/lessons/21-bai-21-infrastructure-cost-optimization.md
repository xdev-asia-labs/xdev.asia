...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🏗️ 建築 — 第 21 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 21 課：基礎設施與成本優化</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">資料平台與分析架構</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 7 部分：製作與案例研究</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

![第 21 課：基礎設施與成本優化](/storage/uploads/2026/03/dp-bai-21-diagram.png)

## 簡介

資料平台基礎設施：Kubernetes、K8s 上的 Spark。成本優化：現貨實例、自動擴充、儲存分層。數據團隊的 FinOps。

---

## 1. 資料平台基礎設施：Kubernetes、Spark on K8s

### 1.1 基本概念

資料平台基礎架構：Kubernetes、K8s 上的 Spark 是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
