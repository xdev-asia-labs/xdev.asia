...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 22 課：資料平台安全與隱私</tspan>
  </text>
...
![第 22 課：資料平台安全與隱私](/storage/uploads/2026/03/dp-bai-22-diagram.png)

## 簡介

資料平台安全：加密、存取控制、稽核日誌記錄。隱私工程：差分隱私、k-匿名。數據屏蔽管道。

---

## 1.資料平台安全：加密、存取控制、稽核日誌記錄

### 1.1 基本概念

資料平台安全：加密、存取控制、稽核日誌記錄是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
