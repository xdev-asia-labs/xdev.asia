...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 23 課：資料營運與平台工程</tspan>
  </text>
...
![第 23 課：資料營運與平台工程](/storage/uploads/2026/03/dp-bai-23-diagram.png)

## 簡介

DataOps 實務：用於資料管路、測試、監控的 CI/CD。自助數據平台。開發者經驗。平台團隊拓撲。

---

## 1. DataOps 實務：用於資料管道、測試、監控的 CI/CD

### 1.1 基本概念

DataOps實踐：資料管道、測試、監控的CI/CD是該領域最重要的主題之一。了解核心概念將幫助您從一開始就設計出正確的系統。
