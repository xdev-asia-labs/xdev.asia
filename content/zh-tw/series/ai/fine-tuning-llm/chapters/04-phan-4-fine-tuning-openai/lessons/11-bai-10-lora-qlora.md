...
description: LoRA理論：低秩矩陣分解。 QLoRA：量化+LoRA。使用 Hugging Face PEFT 親自微調 LLaMA 3。谷歌 Colab 是免費的。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🧠 人工智慧與機器學習 — 第 9 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 10 課：LoRA 和 QLoRA — 微調</tspan>
      <tspan x="60" dy="42">開源模型</tspan>
  </text>
...
LoRA 和 QLoRA 是**最經濟的**微調技術 - 僅更新 0.1-1% 的參數，在免費 GPU 上運行 (Colab T4)。
...
3. 嘗試排名 r=8 vs r=16 vs r=32 — 比較質量
4.合併LoRA適配器並匯出完整模型
