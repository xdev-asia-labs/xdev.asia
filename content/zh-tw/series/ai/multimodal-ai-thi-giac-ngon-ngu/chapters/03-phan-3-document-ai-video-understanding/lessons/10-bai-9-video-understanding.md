...
title: 第 9 課：影片理解與時序 AI
slug: bai-9-video-understanding
description: 影片分類。時間建模。品質檢查視頻。視訊字幕。動作辨識。視訊LLM、視訊LLaVA。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：影片理解與時序 AI</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 3 部分：記錄 AI 和視訊理解</text>
...
影片分類。時間建模。品質檢查視頻。視訊字幕。動作辨識。視訊LLM、視訊LLaVA。
