...
title: 第 4 課：圖像字幕－從 Attention 到 Transformer
slug: bai-4-image-captioning
description: 表演-出席-講述。基於 Transformer 的字幕。 BLIP，BLIP-2。蘋果酒、流星指標。越南語影像字幕。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🧠 人工智慧與機器學習 — 第 3 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：圖像字幕－從注意力到</tspan>
      <tspan x="60" dy="42">變壓器</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 2 部分：視覺語言模型 (VLM)</text>
...
表演-出席-講述。基於 Transformer 的字幕。 BLIP，BLIP-2。蘋果酒、流星指標。越南語影像字幕。
...
圖片字幕－從 Attention 到 Transformer 是現代人工智慧領域的一個重要課題。
