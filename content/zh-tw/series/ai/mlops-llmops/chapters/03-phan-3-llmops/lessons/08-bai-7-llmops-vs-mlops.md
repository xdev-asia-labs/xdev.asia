...
description: LLMOps 範式：與傳統 MLOps 的差異。法學碩士特定挑戰：即時工程、評估、幻覺、成本管理。 LLMOps 堆疊概述。何時進行微調與提示工程師。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 7 課：LLMOps 與 MLOps — 典範轉移</tspan>
  </text>
...
1. **堆疊分析：** 您的團隊使用哪種法學碩士？列出生產所需的組件。
2. **評估：** 建立包含 20 個測試案例的評估資料集。以法官身分運行法學碩士。報告成績。
3. **生產包裝器：** 使用快取、重試、回退、成本追蹤來包裝 OpenAI API 呼叫。
4. **決策矩陣：** 對於 3 個用例，決定：提示、RAG 與微調。解釋。
