...
description: >-
  端到端的文字分類管道。情緒分析：二元、多類、基於面向。針對越南語分類微調 BERT/PhoBERT。評價：準確率、F1、混淆矩陣。使用 FastAPI
  部署模型。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🧠 人工智慧與機器學習 — 第 12 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 13 課：文本分類與情感</tspan>
...
**文字分類**是最受歡迎的 NLP 問題——從垃圾郵件檢測、情緒分析到支持票證分類。本文從 A-Z 進行指導：準備資料 → 選擇模型 → 訓練 → 評估 → 部署。
