...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🧠 人工智慧與機器學習 — 第 5 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 6 課：代理循環 —</tspan>
      <tspan x="60" dy="42">思想-行動-觀察循環</tspan>
  </text>
...
這是本系列中最重要的課程 - 您將**從頭開始實現完整的代理循環**，而不使用任何框架。深入理解這個循環將有助於您在以後使用該框架時更有效地調試和優化代理。
...
1. 使用 5+ 工具實作 SimpleAgent 類
2.添加代幣預算管理
3.新增對話歷史記錄持久化（從檔案儲存/載入）
4. 測試需要 5 個以上步驟的複雜任務
