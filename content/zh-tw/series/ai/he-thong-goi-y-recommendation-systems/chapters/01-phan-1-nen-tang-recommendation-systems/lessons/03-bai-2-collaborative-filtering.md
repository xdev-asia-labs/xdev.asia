...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🧠 人工智慧與機器學習 — 第 1 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 課：協同過濾 —</tspan>
      <tspan x="60" dy="42">基於使用者和基於項目</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：推薦系統平台</text>
...
基於使用者的 CF：相似性度量。基於項目的 CF。鄰域方法。餘弦相似度、皮爾遜相關。冷啟動問題。
...
協同過濾－基於使用者和基於專案是現代人工智慧領域的一個重要主題。
