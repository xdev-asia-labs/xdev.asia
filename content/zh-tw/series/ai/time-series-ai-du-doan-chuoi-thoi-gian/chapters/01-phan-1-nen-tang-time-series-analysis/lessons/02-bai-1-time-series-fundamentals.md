...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 1 課：時間序列基礎 — EDA 和</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：時間序列分析基礎</text>
...
時間序列成分：趨勢、季節性、殘差。 STL分解。平穩性檢定：ADF、KPSS。 ACF/PACF 圖。熊貓時間序列。
...
時間序列基礎知識－EDA 和分解是現代人工智慧領域的一個重要主題。
