...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🧠 人工智慧與機器學習 — 第 15 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 16 課：身體估計 — 身體預測</tspan>
      <tspan x="60" dy="42">根據照片和測量得出形狀</tspan>
  </text>
...
虛擬試穿從**了解使用者的體型**開始。本文介紹了三種身體資料輸入方法——從最簡單的（身高/體重）到最精確的（上傳影像）——以及如何將它們全部轉換為 3D 身體參數。
...
1. **3種輸入模式** — 基本（身高/體重）、詳細（測量值）、照片
2. **統計估計** — BMI 和身高迴歸
3. **MediaPipe Pose** — 來自真實人物照片的 33 個地標
4. **SMPL 映射** — 轉換測量值 → 10 個 β 參數
5. **統一管道** — 根據可用資料自動選擇最佳模式

下一篇文章：**3D 頭像產生** — 根據 SMPL 參數建立頭像。
