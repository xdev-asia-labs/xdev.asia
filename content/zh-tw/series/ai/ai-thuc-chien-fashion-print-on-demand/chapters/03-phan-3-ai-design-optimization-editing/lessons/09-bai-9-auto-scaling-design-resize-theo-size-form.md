...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：自動縮放設計 — 調整資訊大小</tspan>
      <tspan x="60" dy="42">請遵循襯衫的尺寸和款式</tspan>
  </text>
...
當使用者選擇 S 號襯衫，然後將其更改為 XL 號，或從修身版更改為超大號時，設計必須**自我調整**。這不是簡單的比例問題，而是你必須了解上下文：如果設計有文字，文字必須仍然可讀，全正面設計必須相應擴大，左胸印花必須保持小比例。
...
1. **服裝規格** — 每個尺寸/款式的準確模型數據
2. **縮放比例** — 每個列印區域的不同計算
3. **內容感知** — 縮放時保持文字可讀、臉部比例
4. **DPI管理** — 當DPI不足以列印時自動放大

下一篇文章：**人工智慧編輯助手** — 使用自然語言編輯設計。
