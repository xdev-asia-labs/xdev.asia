...
title: 第 21 課：AI 自動標記 — 自動標記與分類設計
slug: bai-21-ai-auto-tagging-gan-tag-phan-loai
description: 用於設計標記、多標籤分類（風格、主題、顏色、季節）的 CLIP 零樣本分類。訓練自訂分類器。整合到清單工作流程。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🧠 人工智慧與機器學習 — 第 20 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 21 課：AI 自動標記 — 標記和分類</tspan>
      <tspan x="60" dy="42">自動設計類型</tspan>
  </text>
...
賣家上傳了設計，但**不想手動標記它**。人工智慧自動標記會自動按風格、主題、調色板、季節對設計進行分類，使設計更容易找到並更準確地推薦。
...
1. **CLIP 零樣本** — 根據 5 種分類法對設計進行分類，無需訓練數據
2. **顏色分析**——K-means聚類，最接近命名顏色匹配
3. **自訂分類器** - ResNet50 多標籤，在設計資料集上進行訓練
4. **Pipeline** — 合併 3 個標記器的結果

下一篇文章：**AI 產品產生** — 自動產生標題、描述和模型。
