...
title: 第 23 課：趨勢偵測與內容審核
slug: bai-23-trending-detection-xu-huong-content-moderation
description: 從參與度指標中檢測設計趨勢：趨勢評分演算法、季節性檢測。內容審核：NSFW 偵測、版權檢查、品牌安全。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🧠 人工智慧與機器學習 — 第 22 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 23 課：趨勢偵測與內容</tspan>
      <tspan x="60" dy="42">適度</tspan>
  </text>
...
該平台需要兩個重要模組：(1) **檢測趨勢設計**以提高可見性，(2) **內容審核**以過濾違規設計。本文建構了評分演算法和人工智慧分類。
...
4. **NSFW偵測**－影像分類模型
5. **文字掃描** — OCR + 分塊模式匹配
6. **審核工作流程** — 自動核准/佇列審核/拒絕

下一篇（最後）文章：**生產部署 — MLOps 管道和 GPU 擴充**。
