...
description: 音樂生成：MusicGen、Suno AI、Udio。聲音效果生成。語音合成和基本語音克隆。視聽同步。用於視訊旁白的文字轉語音。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🧠 人工智慧與機器學習 — 第 12 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 13 課：音訊與音樂產生 — 創造聲音</tspan>
      <tspan x="60" dy="42">人工智慧酒吧</tspan>
  </text>
...
|--------|---------|--------|--------|
|音樂生成小| 300M |好 |快|
|音樂生成媒體 | 1.5B | 1.5B更好 |中|
|音樂生成大 | 3.3B|最佳|慢|
|音樂生成旋律 | 1.5B | 1.5B旋律調節|中|
