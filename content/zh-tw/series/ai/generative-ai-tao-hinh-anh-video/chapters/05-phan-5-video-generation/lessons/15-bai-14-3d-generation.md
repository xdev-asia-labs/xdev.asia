...
description: >-
  文字轉 3D：DreamFusion、Magic3D、Point-E。影像轉 3D 模型。 3D 高斯潑濺。 AI頭像：會說話的頭部、全身。 NeRF
  基礎知識。遊戲和 VR 的 3D 資產生成。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 14 課：3D 生成與 Avatar AI</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：視訊生成和多模式</text>
...
3D 生成正在快速發展 — 從**文字到 3D**（DreamFusion、Magic3D）、**圖像到 3D**（TripoSR、InstantMesh），到 **3D 高斯潑濺**和 **AI 頭像**。這是繼影像和視訊生成之後的下一個前沿。
...
> 📌 **下一篇文章：** ComfyUI Mastery — AI 藝術的視覺工作流程。
