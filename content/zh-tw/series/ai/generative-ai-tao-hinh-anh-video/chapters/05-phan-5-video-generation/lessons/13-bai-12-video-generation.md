...
description: >-
  ...
  進行影片編輯。時間一致性挑戰。 API 整合模式。
duration_minutes: 150
is_free: true
video_url: null
sort_order: 11
section_title: 第 5 部分：視訊生成和多模式
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🧠 人工智慧與機器學習 — 第 11 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 12 課：影片產生 — Sora、Runway、</tspan>
      <tspan x="60" dy="42">克林與皮卡</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：視訊生成和多模式</text>
...
|平台|開發商|優勢 |最長持續時間 |
|----------|------------|------------|----------|
|索拉 |開放人工智慧 |照相寫實主義，物理學| 60 年代 |
|跑道 Gen-3 |跑道 |創意控制、編輯| 10-40 秒 |
|克林 |快手|運動品質，價格實惠| 10 秒 |
|皮卡 |皮卡實驗室 |速度快，易用性| 10 秒 |
|盧瑪夢想機|魯瑪人工智慧| 3D 一致性 | 5-10 秒 |
|視訊穩定 |穩定性人工智慧 |開源| 4s|
...
|平台|每 10 秒的成本 |品質 |速度|
|----------|-------------|--------|--------|
|索拉 | ~$0.50-2.00 |最佳|約 2 分鐘 |
|跑道 Gen-3 | ~$0.25-0.50 |太棒了|約 1 分鐘 |
|克林 | ~$0.10-0.20 |好 | 〜30秒|
|皮卡 | ~$0.05-0.15 |好 | ~20 秒 |
| SVD（本地）|僅 GPU 成本 |體面|約 5 分鐘 |
