...
description: 修復：編輯影像中的特定區域。外畫：將圖像向外擴展。基於指令的編輯：InstructPix2Pix。背景去除和替換。親身體驗穩定擴散修復管道。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 8 課：修復、修復與影像</tspan>
      <tspan x="60" dy="42">人工智慧編輯</tspan>
  </text>
...
**修復**允許您使用 AI 編輯照片中的特定區域 - 更改物件、刪除浮水印或新增細節。 **外畫**將影像擴展到原始框架之外。這是人工智慧圖像編輯的基礎。
...
|修復 |編輯遮罩區域 |物件替換 |
|外塗|展開照片 |擴充構圖|
|指導Pix2Pix |用文字編輯 |風格轉變 |
|背景去除|分割前景|產品照片|
|物件移除|刪除物件 |清理影像 |

> 📌 **下一篇文章：** LoRA 和自訂模型訓練 — 創建您自己的風格。
