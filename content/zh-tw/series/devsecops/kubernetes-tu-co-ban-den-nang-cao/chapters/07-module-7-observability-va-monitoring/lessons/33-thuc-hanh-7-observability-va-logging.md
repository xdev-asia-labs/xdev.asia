...
title: 第 32 課：實作－可觀察性與日誌記錄
slug: thuc-hanh-7-observability-va-logging
description: >-
  第 7 單元練習：部署 kube-prometheus-stack，安裝 Loki + Grafana Alloy，使用 OTel 自動偵測安裝
  Tempo，建立 Grafana 儀表板測量指標/日誌/跟踪，建立警報規則。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🔒 DevSecOps — 第 32 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 32 課：實踐－可觀察性和</tspan>
...
<h2>🎯 练习课的目的</h2>
<ul>
  <li>使用 kube-prometheus-stack + Loki + Tempo 部署完整的 PLG 堆疊</li>
  <li>使用 Grafana Alloy 收集日誌</li>
  <li>使用 OpenTelemetry Operator 的自動儀器應用</li>
  <li>建立警報規則和 Slack 通知</li>
  <li>使用相關可觀測性進行調試</li>
</ul>

<h2>實驗 1：部署 kube-prometheus-stack</h2>
...
<h2>實驗 2：為自訂應用程式建立 ServiceMonitor</h2>
...
<h2>實驗 3：AlertManager — Slack 通知</h2>
...
<h2>實驗室 4：部署 Loki + Grafana 合金</h2>
...
<h2>實驗 6：部署 Tempo 和 OTel 自動儀表</h2>
...
<ul>
  ...
  <li>✅ 用於自訂應用程式指標的 ServiceMonitor</li>
  <li>✅ AlertManager：路由+Slack 通知</li>
  <li>✅ Loki + Grafana Alloy：日誌聚合</li>
  <li>✅ LogQL 查詢範圍從簡單到複雜</li>
  <li>✅ Tempo + OTel 自動偵測</li>
  <li>✅ 相關可觀察性：日誌 ↔ 痕跡</li>
</ul>
