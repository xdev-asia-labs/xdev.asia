...
title: '第14課：NGINX 微服務與服務網格'
slug: bai-14-microservices-va-service-mesh-trong-nginx
description: >-
  關於 NGINX 微服務與服務網格的課程——服務探索、API 閘道模式、每服務速率限制、斷路器、重試策略、分散式追蹤、服務網格整合（Consul、Istio）、Sidecar 模式、金絲雀部署與藍綠部署。
duration_minutes: 245
is_free: true
video_url: null
sort_order: 14
section_title: "第5部分：正式環境與進階主題"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 14: 微服務與服務網格</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第5部分：正式環境與進階主題</text>
