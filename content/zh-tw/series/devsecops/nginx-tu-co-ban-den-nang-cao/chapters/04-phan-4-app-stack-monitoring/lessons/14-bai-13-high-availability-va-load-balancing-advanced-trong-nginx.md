...
title: '第13課：NGINX 高可用性與進階負載平衡'
slug: bai-13-high-availability-va-load-balancing-advanced-trong-nginx
description: >-
  健康檢查（主動/被動）、會話持久性、黏性會話、故障轉移策略、用於虛擬 IP 的 Keepalived、主動-主動與主動-被動架構、資料庫負載平衡、地理分佈、災難復原規劃及 HA 設定測試。
