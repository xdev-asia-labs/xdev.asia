...
description: >-
  關於 NGINX 安全性的課程——使用 limit_req/limit_conn 進行速率限制、IP 封鎖、基本驗證、ModSecurity WAF 整合、DDoS 防護及安全標頭（CSP、X-Frame-Options、CORS）。保護伺服器免受攻擊的最佳實踐與正式環境安全強化指南。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第9課：NGINX 安全性</tspan>
  </text>
...
<h2 id="1-rate-limiting-v%E1%BB%9Bi-limitreq-v%C3%A0-limitconn"><strong>1. 使用 limit_req 與 limit_conn 進行速率限制</strong></h2><p>速率限制透過限制單一客戶端的請求數量，保護伺服器免受濫用、暴力攻擊和 DDoS 的侵害。</p><h3 id="11-rate-limiting-basics-limitreq"><strong>1.1. Rate Limiting Basics (limit_req)</strong></h3><pre><code class="language-nginx">http {
