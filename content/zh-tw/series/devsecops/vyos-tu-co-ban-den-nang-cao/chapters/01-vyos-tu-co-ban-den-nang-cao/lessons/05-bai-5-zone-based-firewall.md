...
description: >-
  學習 VyOS 的區域型防火牆：設計 LAN/WAN/DMZ/GUEST 區域、區域間規則、與介面型防火牆的比較，以及3個區域的實作練習。
...
<h3>Bước 1: 建立防火牆規則集 (ipv4 name)</h3>
...
<h2>實作練習: Zone-policy 3 Zones cho Home Network</h2>
...
<ul>
  ...
  <li>實作練習: Xây dựng hệ thống 3 zones (WAN/LAN/DMZ) hoàn chỉnh</li>
</ul>
