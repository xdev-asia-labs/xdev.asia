...
description: >-
  Node.js 內建測試運行器 (node:test)。 Vitest 用於單元/整合測試。用於 HTTP 測試的 Supertest。用於 HTTP
  模擬的 Nock。測試容器，程式碼覆蓋率（c8/istanbul）。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：測試 Node.js 應用程式</tspan>
  </text>
...
<h2 id="1-node-test"><strong>1.內建測試運行器（節點：測試）</strong></h2>
...
<h2 id="2-vitest"><strong>2.維泰斯特</strong></h2>
...
<h2 id="3-supertest"><strong>3.HTTP測試（超級測試）</strong></h2>
...
<h2 id="4-nock"><strong>4. HTTP 模擬（Nock）</strong></h2>
...
<h2 id="5-testcontainers"><strong>5. 測試容器</strong></h2>
...
<p>下一篇： <strong>性能分析和優化</strong> — V8 分析器、火焰圖、Clinic.js。</p>
