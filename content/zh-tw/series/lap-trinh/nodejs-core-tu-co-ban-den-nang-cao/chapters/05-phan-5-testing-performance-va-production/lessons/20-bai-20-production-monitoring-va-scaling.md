...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 程式設計 — 第 20 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 20 課：生產監控與擴展</tspan>
  </text>
...
<h2 id="1-pino"><strong>1.結構化日誌記錄（Pino）</strong></h2>
...
<h2 id="2-otel"><strong>2.開放遙測</strong></h2>
...
<h2 id="5-graceful-shutdown"><strong>5. 正常關機</strong></h2>
...
<h2 id="6-scaling"><strong>6. 生產檢查表</strong></h2>

<table>
<thead><tr><th>類別</th><th>清單</th></tr></thead>
<tbody>
<tr><td>記錄</td><td>Pino 結構、請求 ID、日誌級別</td></tr>
<tr><td>監控</td><td>普羅米修斯 + Grafana、OpenTelemetry</td></tr>
<tr><td>錯誤追蹤</td><td>Sentry，未處理的拒絕處理程序</td></tr>
<tr><td>健康檢查</td><td>/健康端點，就緒探針</td></tr>
<tr><td>優雅關機</td><td>SIGTERM 處理程序，連線耗盡</td></tr>
<tr><td>安全性</td><td>頭盔、CORS、速率限制、輸入驗證</td></tr>
<tr><td>效能</td><td>Cluster/PM2、連線池、快取</td></tr>
</tbody>
</table>

<p>🎉 完成該系列 <strong>Node.js 核心：從基礎到高級</strong>！</p>
