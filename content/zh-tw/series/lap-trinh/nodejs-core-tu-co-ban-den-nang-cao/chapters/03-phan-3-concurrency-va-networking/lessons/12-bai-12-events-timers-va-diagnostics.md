...
description: EventEmitter 模式、自訂事件、記憶體洩漏偵測。中止控制器/中止訊號。診斷通道，async_hooks。 Node.js 檢查器，堆疊快照。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 12 課：事件、計時器和診斷</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 3 部分：並發與網絡</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-eventemitter"><strong>1.EventEmitter模式</strong></h2>
...
<h2 id="2-abort"><strong>2.AbortController 和 AbortSignal</strong></h2>
...
<h2 id="3-diagnostics"><strong>3. 診斷通道</strong></h2>
...
<h2 id="4-memory-leak"><strong>4.內存洩漏檢測</strong></h2>
...
<h2 id="5-inspector"><strong>5.Node.js 檢查器 API</strong></h2>
...
<p>下一篇： <strong>從頭開始建立 HTTP 框架</strong> — 路由器、中介軟體管道。</p>
