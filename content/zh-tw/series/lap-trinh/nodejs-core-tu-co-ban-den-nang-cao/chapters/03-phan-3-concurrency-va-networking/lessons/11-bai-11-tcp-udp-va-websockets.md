...
description: net 模組（TCP 伺服器/客戶端）、dgram (UDP)。帶有 ws 庫的 WebSocket 伺服器。連線管理，二進位協定。協議設計，定制線路格式。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 11 課：TCP、UDP 和 WebSocket</tspan>
  </text>
...
<h2 id="1-tcp"><strong>1. TCP 伺服器和客戶端</strong></h2>
...
<h2 id="3-websocket"><strong>3.WebSocket伺服器（ws）</strong></h2>
...
<h2 id="4-rooms"><strong>4. 基於房間的模式</strong></h2>
...
<h2 id="5-binary"><strong>5. 二進位協議</strong></h2>
...
<p>下一篇： <strong>事件、定時器和診斷</strong> — EventEmitter、AbortController、async_hooks。</p>
