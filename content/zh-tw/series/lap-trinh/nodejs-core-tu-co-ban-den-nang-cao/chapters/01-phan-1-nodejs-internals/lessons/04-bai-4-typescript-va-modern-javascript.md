...
description: >-
  Node.js、tsx/ts-node 的 TypeScript 設定。類型安全配置、路徑別名。 ESBuild/SWC 編譯。 Node.js
  類型剝離（--experimental-strip-types）。裝飾器、元資料。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 4
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：TypeScript 和現代 JavaScript</tspan>
      <tspan x="60" dy="42">在 Node.js 中</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：Node.js 內部結構</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-ts-setup"><strong>1. Node.js 的 TypeScript 設定</strong></h2>
...
<h2 id="2-type-stripping"><strong>2. Node.js 類型剝離 (22+)</strong></h2>
...
<h2 id="3-tsx"><strong>3. tsx — TypeScript 執行</strong></h2>
...
<h2 id="4-path-aliases"><strong>4. 路徑別名</strong></h2>
...
<h2 id="5-esbuild"><strong>5. 使用 ESBuild/SWC 構建</strong></h2>
...
<h2 id="6-decorators"><strong>6. 裝飾器（第 3 階段）</strong></h2>
...
<p>下一篇： <strong>檔案系統和路徑</strong> — fs/promises、檔案監視、原子寫入。</p>
