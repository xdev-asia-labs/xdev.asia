...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 程式設計 — 第 2 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 課：事件循環與非同步模式</tspan>
  </text>
...
<h2 id="1-event-loop"><strong>1. 事件循環階段</strong></h2>
...
<h2 id="2-microtasks"><strong>2. 微任務與巨集任務</strong></h2>
...
<h2 id="3-nexttick"><strong>3. process.nextTick 與queueMicrotask</strong></h2>

<table>
<thead><tr><th>應用程式介面</th><th>佇列</th><th>訂單</th><th>何時使用</th></tr></thead>
<tbody>
<tr><td>process.nextTick</td><td>下一個Tick隊列</td><td>最高</td><td>確保當前操作後立即運行</td></tr>
<tr><td>隊列微任務</td><td>微任務佇列</td><td>下一個Tick之後</td><td>符合標準、相容網絡</td></tr>
<tr><td>承諾然後</td><td>微任務佇列</td><td>下一個Tick之後</td><td>非同步連結</td></tr>
<tr><td>設定超時(fn, 0)</td><td>定時器階段</td><td>巨集任務</td><td>延後到下一個事件循環迭代</td></tr>
<tr><td>設定立即</td><td>檢查階段</td><td>巨集任務</td><td>I/O 輪詢後執行</td></tr>
</tbody>
</table>

<h2 id="4-async-patterns"><strong>4. 非同步模式的演變</strong></h2>
...
<h2 id="5-promise-combinators"><strong>5. Promise 組合器</strong></h2>
...
<h2 id="6-abort"><strong>6. 中止控制器</strong></h2>
...
<p>下一篇： <strong>模組系統和套件管理</strong> — CJS 與 ESM、npm、pnpm。</p>
