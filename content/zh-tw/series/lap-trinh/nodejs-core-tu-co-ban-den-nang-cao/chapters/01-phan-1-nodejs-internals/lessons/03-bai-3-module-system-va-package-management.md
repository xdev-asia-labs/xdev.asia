...
description: >-
  CommonJS vs ES Modules，模組解析演算法。 Package.json欄位匯出，條件匯出。 npm、pnpm 工作區。 Node.js
  內建測試運行器、權限模型。
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 程式設計 — 第 3 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：模組系統與套件管理</tspan>
  </text>
...
<h2 id="1-cjs-vs-esm"><strong>1. CommonJS 與 ES 模組</strong></h2>

<table>
<thead><tr><th>特點</th><th>CommonJS (CJS)</th><th>ES 模組 (ESM)</th></tr></thead>
<tbody>
<tr><td>文法</td><td>require() / module.exports</td><td>進口/出口</td></tr>
<tr><td>載入中</td><td>同步</td><td>非同步</td></tr>
<tr><td>頂級等待</td><td>否</td><td>是的</td></tr>
<tr><td>__目錄名</td><td>是的</td><td>import.meta.dirname（節點 21+）</td></tr>
<tr><td>JSON導入</td><td>需要('./data.json')</td><td>使用 { type: 'json' } 從 './data.json' 匯入數據</td></tr>
<tr><td>搖樹</td><td>否</td><td>是（靜態分析）</td></tr>
</tbody>
</table>
...
<h2 id="2-package-json"><strong>2.Package.json導出Field</strong></h2>
...
<h2 id="3-pnpm"><strong>3.pnpm 工作區</strong></h2>
...
<h2 id="4-permission-model"><strong>4. 權限模型（Node.js 22+）</strong></h2>
...
<h2 id="5-built-in-test"><strong>5. 內建測試運行器</strong></h2>
...
<p>下一篇： <strong>TypeScript 和現代 JavaScript</strong> — tsx、ts-node、型別剝離。</p>
