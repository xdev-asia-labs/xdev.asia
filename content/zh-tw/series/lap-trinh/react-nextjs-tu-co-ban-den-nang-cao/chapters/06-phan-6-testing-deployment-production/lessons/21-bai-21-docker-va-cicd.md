...
title: 第 21 課：Docker 與 CI/CD
slug: bai-21-docker-va-cicd
description: Dockerize Next.js 應用程式。多階段構建，獨立輸出。 GitHub Actions CI/CD 管道。維塞爾部署。環境變數管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">💻 程式設計 — 第 21 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 21 課：Docker 與 CI/CD</tspan>
  </text>
...
<h2 id="1-dockerfile"><strong>1.Dockerfile多階段</strong></h2>
...
<h2 id="2-next-config"><strong>2. 獨立輸出配置</strong></h2>
...
<h2 id="3-docker-compose"><strong>3.Docker 組合</strong></h2>
...
<h2 id="5-vercel"><strong>5.Vercel部署</strong></h2>
...
<h2 id="6-env"><strong>6. 環境變數</strong></h2>
...
<p>下一篇： <strong>生產最佳實務和監控</strong> — 日誌記錄、錯誤追蹤、健康檢查。</p>
