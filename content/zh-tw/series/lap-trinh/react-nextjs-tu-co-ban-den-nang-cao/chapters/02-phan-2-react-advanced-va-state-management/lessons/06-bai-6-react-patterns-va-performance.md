...
title: 第 6 課：React 模式與效能
slug: bai-6-react-patterns-va-performance
description: >-
  高階元件、複合元件、渲染道具。 React.memo、useMemo、useCallback 最佳化。 React DevTools
  Profiler，效能反模式。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 程式設計 — 第 6 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 6 課：React 模式與效能</tspan>
  </text>
...
<h2 id="2-hoc"><strong>2. 高階組件（HOC）</strong></h2>
...
<h2 id="3-render-props"><strong>3. 渲染道具</strong></h2>
...
<h2 id="4-performance-patterns"><strong>4. 性能模式</strong></h2>
...
<h2 id="5-code-splitting"><strong>5. 程式碼分割和延遲載入</strong></h2>
...
<h2 id="6-profiling"><strong>6.React DevTools 分析器</strong></h2>

<ul>
<li>開啟 React DevTools → Profiler 選項卡</li>
<li>點擊“錄製”→“互動”→“停止”</li>
<li>查看火焰圖：哪些元件渲染時間最長</li>
<li>請參閱“為什麼要渲染？”對於每個組件</li>
<li><strong>突出顯示更新</strong>：設定→反白更新→查看哪些元件重新渲染</li>
</ul>

<p>下一篇： <strong>樣式和 UI 元件</strong> — Tailwind CSS、shadcn/ui 和 Framer Motion 動畫。</p>
