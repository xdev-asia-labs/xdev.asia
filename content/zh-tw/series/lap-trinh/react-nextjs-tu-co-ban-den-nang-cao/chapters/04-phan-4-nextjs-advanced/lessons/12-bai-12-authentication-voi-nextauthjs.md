...
title: 第 12 課：使用 NextAuth.js 進行身份驗證
slug: bai-12-authentication-voi-nextauthjs
description: >-
  NextAuth.js (Auth.js) 設定。 OAuth 提供者（Google、GitHub）。憑證提供者，JWT
  與會話。中間件保護，基於角色的存取控制。
duration_minutes: 150
is_free: true
video_url: null
sort_order: 12
section_title: 第 4 部分：Next.js 高級
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 程式設計 — 第 12 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 12 課：使用 NextAuth.js 進行身份驗證</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 4 部分：Next.js 高級</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-setup-authjs"><strong>1. 設定 Auth.js (NextAuth v5)</strong></h2>
...
<h2 id="2-route-handler"><strong>2. 路由處理程序</strong></h2>
...
<h2 id="3-middleware"><strong>3. 中介軟體保護</strong></h2>
...
<h2 id="4-server-component"><strong>4. 在伺服器元件中使用</strong></h2>
...
<h2 id="5-client-component"><strong>5. 在客戶端元件中使用</strong></h2>
...
<h2 id="6-rbac"><strong>6. 基於角色的存取控制</strong></h2>
...
<h2 id="7-login-form"><strong>7. 帶有伺服器操作的登入表單</strong></h2>
...
<p>下一篇： <strong>中介軟體、API 路由和路由處理程序</strong> — 進階請求/回應處理。</p>
