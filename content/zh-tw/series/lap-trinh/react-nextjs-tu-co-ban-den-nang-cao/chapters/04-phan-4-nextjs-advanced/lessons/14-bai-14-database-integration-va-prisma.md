...
title: 第 14 課：資料庫整合與 Prisma
slug: bai-14-database-integration-va-prisma
description: Prisma ORM 設定、模式設計。遷徙、播種。關係（1-1、1-N、M-N）。進階查詢、交易。 Prisma 客戶端擴充。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 14 課：資料庫整合與 Prisma</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. 設定 Prisma</strong></h2>

<pre><code class="language-bash">npm install prisma @prisma/client
npx prisma init --datasource-provider postgresql
</code></pre>

<h2 id="2-schema"><strong>2. 架構設計</strong></h2>
...
<h2 id="3-migration"><strong>3. 遷移和播種</strong></h2>
...
<h2 id="4-singleton"><strong>4.Prisma 客戶端單例</strong></h2>
...
<h2 id="5-queries"><strong>5. 進階查詢</strong></h2>
...
<h2 id="6-server-component"><strong>6. 在伺服器元件中使用</strong></h2>
...
<p>下一篇： <strong>國際化和搜尋引擎優化</strong> — 多語言、元資料、結構化資料。</p>
