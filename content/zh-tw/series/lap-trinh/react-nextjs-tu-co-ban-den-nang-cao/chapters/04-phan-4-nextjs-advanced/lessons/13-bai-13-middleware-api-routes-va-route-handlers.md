...
title: 第 13 課：中介軟體、API 路由與路由處理程序
slug: bai-13-middleware-api-routes-va-route-handlers
description: Next.js 中間件深入研究。路由處理程序（GET、POST、PUT、DELETE）。請求/響應助手。速率限制、CORS。串流響應、網路鉤子。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 13 課：中介軟體、API 路由與路由</tspan>
      <tspan x="60" dy="42">處理程式</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 4 部分：Next.js 高級</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-middleware"><strong>1. 中介軟體深入研究</strong></h2>
...
<h2 id="2-route-handlers"><strong>2. 路由處理程序</strong></h2>
...
<h2 id="3-dynamic-route"><strong>3. 動態路由處理程序</strong></h2>
...
<h2 id="5-streaming"><strong>5. 串流響應</strong></h2>
...
<h2 id="6-webhooks"><strong>6. 網路鉤子</strong></h2>
...
<p>下一篇： <strong>資料庫整合和 Prisma</strong> — ORM、遷移、關係、查詢。</p>
