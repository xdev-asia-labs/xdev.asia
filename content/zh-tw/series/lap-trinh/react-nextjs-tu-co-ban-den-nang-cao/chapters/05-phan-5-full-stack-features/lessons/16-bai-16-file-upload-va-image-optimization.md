...
title: 第 16 課：文件上傳和圖像優化
slug: bai-16-file-upload-va-image-optimization
description: 使用伺服器操作上傳檔案。 next/image 元件，響應式影像。雲端儲存（S3、Cloudinary）。影像優化策略。
duration_minutes: 100
is_free: true
video_url: null
sort_order: 16
section_title: 第 5 部分：全端功能
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 程式設計 — 第 16 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 16 課：文件上傳和圖像優化</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：全端功能</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-upload-server-action"><strong>1. 使用伺服器操作上傳文件</strong></h2>
...
<h2 id="2-upload-form"><strong>2.上傳表單元件</strong></h2>
...
<h2 id="3-next-image"><strong>3. next/image 元件</strong></h2>
...
<h2 id="4-next-config"><strong>4. 圖片配置</strong></h2>
...
<h2 id="5-s3-upload"><strong>5.上傳到S3</strong></h2>
...
<p>下一篇： <strong>實時和 WebSocket</strong> ——即時互動。</p>
