...
title: 第 17 課：實時和 WebSocket
slug: bai-17-real-time-va-websockets
description: 伺服器發送的事件 (SSE)。 WebSockets 與 Socket.io。即時通知、聊天。推桿，巧妙整合。樂觀的 UI 模式。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">💻 程式設計 — 第 17 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：實時和 WebSocket</tspan>
  </text>
...
<h2 id="1-sse"><strong>1. 伺服器發送事件（SSE）</strong></h2>
...
<h2 id="2-socket-io"><strong>2.WebSockets 與 Socket.io</strong></h2>
...
<h2 id="3-chat-client"><strong>3. 聊天元件</strong></h2>
...
<h2 id="4-pusher"><strong>4. 推播器集成</strong></h2>
...
<p>下一篇： <strong>電子郵件、付款和第三方</strong> — 重新發送、Stripe、OAuth。</p>
