...
title: 第 4 課：事件處理、表單與條件渲染
slug: bai-4-event-handling-forms-va-conditional-rendering
description: 事件處理、合成事件。受控/非受控元件、表單庫（React Hook Form、Zod 驗證）。列表、鍵、條件渲染模式。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：事件處理、表單與條件</tspan>
      <tspan x="60" dy="42">渲染</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：React 基礎知識</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-event-handling"><strong>1. 事件處理</strong></h2>
...
<h2 id="2-controlled-forms"><strong>2. 受控形式</strong></h2>
...
<h2 id="3-react-hook-form-zod"><strong>3.React Hook形式+Zod</strong></h2>
...
<h2 id="4-conditional-rendering"><strong>4. 條件渲染模式</strong></h2>
...
<h2 id="5-lists-keys"><strong>5. 列表和鍵</strong></h2>
...
<p>下一篇： <strong>上下文 API 和狀態管理</strong> — Zustand、TanStack 查詢和狀態管理策略。</p>
