...
title: 第 2 課：組件、Props 和 TypeScript
slug: bai-2-components-props-va-typescript
description: 功能組件、道具、兒童。 TypeScript 與 React，輸入 props、事件、refs。元件組成，渲染道具模式。 React.FC 與函數宣告。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 2
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 課：組件、Props 和 TypeScript</tspan>
  </text>
...
<h2 id="1-functional-components"><strong>1. 功能組件</strong></h2>
...
<h2 id="2-props"><strong>2.道具</strong></h2>
...
<h2 id="3-children-prop"><strong>3. 兒童道具</strong></h2>
...
<h2 id="4-typescript-patterns"><strong>4. React 的 TypeScript 模式</strong></h2>

<h3 id="4-1-event-typing"><strong>4.1.事件類型</strong></h3>
...
<h3 id="4-2-generic-components"><strong>4.2.通用組件</strong></h3>
...
<h3 id="4-3-discriminated-unions"><strong>4.3.受歧視的工會</strong></h3>
...
<h2 id="5-component-composition"><strong>5. 組件構成</strong></h2>
...
<p>下一篇： <strong>鉤子深潛</strong> — useState、useEffect、useRef、useMemo、useCallback 和自訂掛鉤。</p>
