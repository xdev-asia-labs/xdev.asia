...
title: 第 3 課：Hook 深入探究
slug: bai-3-hooks-deep-dive
description: >-
  useState、useEffect、useRef、useMemo、useCallback。自訂鉤子，鉤子規則。使用Reducer 處理複雜狀態。
  React 19 use() 鉤子、useTransition、useDeferredValue。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：Hook 深入探究</tspan>
  </text>
...
<h2 id="1-usestate"><strong>1. 使用狀態</strong></h2>
...
<h2 id="2-useeffect"><strong>2.使用效果</strong></h2>
...
<h2 id="5-usereducer"><strong>5.使用Reducer</strong></h2>
...
<h2 id="6-custom-hooks"><strong>6. 自訂掛鉤</strong></h2>
...
<p>下一篇： <strong>事件處理、表單和條件渲染</strong> — 受控表單、React Hook Form 和 Zod 驗證。</p>
