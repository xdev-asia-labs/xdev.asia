...
title: 第 18 課：Inertia.js 和 Vue/React 集成
slug: bai-18-inertiajs-va-vue-react
description: >-
  Inertia.js 整體架構。 Laravel + Vue/React SPA。共享資料、表單助理、文件上傳。伺服器端渲染。
  Inertia、Livewire 與傳統 SPA。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 18
section_title: 第 5 部分：現代全端
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 程式設計 — 第 18 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 18 課：Inertia.js 和 Vue/React 集成</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：現代全端</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-setup"><strong>1.Inertia.js 設定</strong></h2>
...
<h2 id="2-vue-pages"><strong>2.Vue頁面</strong></h2>
...
<h2 id="4-shared-data"><strong>4. 共享數據</strong></h2>
...
<h2 id="5-comparison"><strong>5.Livewire 與 Inertia</strong></h2>

<table>
<thead><tr><th>特點</th><th>活線</th><th>慣性</th></tr></thead>
<tbody>
<tr><td>前端</td><td>刀片 + Alpine.js</td><td>Vue/React</td></tr>
<tr><td>水療感覺</td><td>好</td><td>很好</td></tr>
<tr><td>學習曲線</td><td>低</td><td>平均</td></tr>
<tr><td>JS生態系統</td><td>限制</td><td>滿</td></tr>
<tr><td>固態繼電器</td><td>自動</td><td>需要設定</td></tr>
</tbody>
</table>

<p>下一篇： <strong>在 Laravel 中測試</strong>。</p>
