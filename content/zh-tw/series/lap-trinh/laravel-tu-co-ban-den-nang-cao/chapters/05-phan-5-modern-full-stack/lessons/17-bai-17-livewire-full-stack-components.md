...
title: 第 17 課：Livewire — 全端組件
slug: bai-17-livewire-full-stack-components
description: Livewire 3，電線：模型，電線：點選。組件生命週期、反應性屬性。文件上傳、分頁。延遲載入、輪詢。 Alpine.js 整合。 SPA般的體驗。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：Livewire — 全端組件</tspan>
  </text>
...
<h2 id="3-actions"><strong>3. 行動與事件</strong></h2>
...
<h2 id="4-file-upload"><strong>4. 文件上傳</strong></h2>
...
<h2 id="5-alpine"><strong>5.Alpine.js 集成</strong></h2>
...
<p>下一篇： <strong>Inertia.js 和 Vue/React 集成</strong>。</p>
