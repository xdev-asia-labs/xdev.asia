...
title: 第 10 課：授權 — 門禁與策略
slug: bai-10-authorization-gates-va-policies
description: 大門、政策、權限。 Spatie Laravel 權限包。資源授權、策略自動發現。刀片 @can 指令。超管理員，角色層次。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 程式設計 — 第 10 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 10 課：授權 — 門禁與策略</tspan>
  </text>
...
<h2 id="1-gates"><strong>1.蓋茨</strong></h2>
...
<h2 id="2-policies"><strong>2、政策</strong></h2>
...
<h2 id="3-spatie-permission"><strong>3. Spatie Laravel 權限</strong></h2>
...
<h2 id="4-blade"><strong>4. 刀片授權</strong></h2>
...
<p>下一篇： <strong>OAuth2、護照和社交名流</strong>。</p>
