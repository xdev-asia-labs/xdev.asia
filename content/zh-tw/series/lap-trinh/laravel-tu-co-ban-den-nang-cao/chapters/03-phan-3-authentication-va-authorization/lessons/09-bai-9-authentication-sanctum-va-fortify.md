...
title: 第 9 課：身份驗證 — Sanctum 和 Fortify
slug: bai-9-authentication-sanctum-va-fortify
description: >-
  Laravel Sanctum（SPA 驗證、API 令牌）。
  Fortify（註冊、登入、電子郵件驗證、2FA）。密碼哈希，記住我。自訂守衛，多重身份驗證。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：身份驗證 — Sanctum 和 Fortify</tspan>
  </text>
...
<h2 id="1-sanctum"><strong>1. Laravel 聖所</strong></h2>
...
<h2 id="2-spa-auth"><strong>2.SPA認證</strong></h2>
...
<h2 id="4-multi-auth"><strong>4. 多重身分驗證（守衛）</strong></h2>
...
<p>下一篇： <strong>授權－門禁與政策</strong>。</p>
