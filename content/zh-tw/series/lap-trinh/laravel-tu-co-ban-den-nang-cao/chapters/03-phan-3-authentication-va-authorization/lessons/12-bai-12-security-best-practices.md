...
description: CSRF防護，XSS防護。 SQL注入、批次賦值保護。速率限制、加密。 CORS 配置。 HTTPS 強制執行、安全標頭。 Laravel 的 OWASP。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 12
...
<h2 id="1-csrf-xss"><strong>1. CSRF和XSS預防</strong></h2>
...
<h2 id="2-sql-injection"><strong>2. SQL注入&批量賦值</strong></h2>
...
<h2 id="3-encryption"><strong>3. 加密和雜湊</strong></h2>
...
<h2 id="4-security-headers"><strong>4. 安全標頭和 HTTPS</strong></h2>
