...
description: 刀片語法、元件、佈局。刀片指令、自訂指令。資產捆綁（Vite）。 Tailwind CSS 整合。匿名組件、動態組件。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 3
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：刀片模板和前端</tspan>
  </text>
...
<h2 id="1-blade-syntax"><strong>1. 刀片語法</strong></h2>
...
<h2 id="2-layouts"><strong>2. 佈局和元件</strong></h2>
...
<h2 id="3-components"><strong>3. 葉片組件</strong></h2>
...
<p>下一篇： <strong>Eloquent ORM 與關係</strong>。</p>
