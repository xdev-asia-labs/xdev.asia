...
title: 第 4 課：雄辯的 ORM 和關係
slug: bai-4-eloquent-orm-va-relationships
description: >-
  雄辯的模型、批次分配、軟刪除。關係式（hasOne、hasMany、belongsTo、belongsToMany、morphMany）。預先載入、查詢範圍、存取器/修改器。演員表。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：雄辯的 ORM 和關係</tspan>
  </text>
...
<h2 id="1-eloquent-model"><strong>1. 雄辯模型</strong></h2>
...
<h2 id="2-relationships"><strong>2. 關係</strong></h2>
...
<h2 id="3-eager-loading"><strong>3. 預加載</strong></h2>
...
<h2 id="4-scopes"><strong>4. 查詢範圍</strong></h2>
...
<p>下一篇： <strong>遷移、播種和查詢產生器</strong>。</p>
