...
description: 驗證規則，自訂驗證。表單請求類別、授權。錯誤訊息，本地化。文件驗證、條件驗證。自訂驗證規則。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 6
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 6 課：驗證與表單請求</tspan>
  </text>
...
<h2 id="1-validation"><strong>1. 基本驗證</strong></h2>
...
<h2 id="2-form-request"><strong>2. 表格請求</strong></h2>
...
<h2 id="3-custom-rule"><strong>3. 自訂驗證規則</strong></h2>
...
<h2 id="4-conditional"><strong>4. 條件驗證</strong></h2>
...
<p>下一篇： <strong>API 資源和回應</strong>。</p>
