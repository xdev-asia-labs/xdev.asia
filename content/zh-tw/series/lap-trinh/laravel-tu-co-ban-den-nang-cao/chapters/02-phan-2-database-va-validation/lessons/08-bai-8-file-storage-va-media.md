...
description: 檔案系統抽象（本地、S3、GCS）。文件上傳、驗證。斯帕蒂媒體庫。影像處理（幹預影像）。臨時 URL、串流下載。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 8
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">💻 程式設計 — 第 8 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 8 課：文件儲存與媒體</tspan>
  </text>
...
<h2 id="1-filesystem"><strong>1. 檔案系統</strong></h2>
...
<h2 id="2-upload"><strong>2. 文件上傳</strong></h2>
...
<h2 id="3-spatie-media"><strong>3.Spatie媒體庫</strong></h2>
...
<h2 id="4-image-manipulation"><strong>4. 幹預影像</strong></h2>
...
<p>下一篇： <strong>身份驗證——Sanctum & Fortify</strong>。</p>
