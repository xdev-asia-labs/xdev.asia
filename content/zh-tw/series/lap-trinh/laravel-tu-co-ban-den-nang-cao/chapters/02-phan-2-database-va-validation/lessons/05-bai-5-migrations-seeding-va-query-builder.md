...
title: 第 5 課：遷移、播種與查詢產生器
slug: bai-5-migrations-seeding-va-query-builder
description: 資料庫遷移、模式建構器。工廠（樣品工廠）、播種者。查詢產生器、原始查詢、分頁。資料庫事務、資料庫測試。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 5 課：遷移、播種與查詢產生器</tspan>
  </text>
...
<h2 id="1-migrations"><strong>1. 遷移</strong></h2>
...
<h2 id="2-factories"><strong>2. 模型工廠</strong></h2>
...
<h2 id="3-seeders"><strong>3. 播種機</strong></h2>
...
<h2 id="4-query-builder"><strong>4. 查詢產生器</strong></h2>
