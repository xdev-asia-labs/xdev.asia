...
description: >-
  佇列驅動程式（Redis、SQS、資料庫）。工作類別、調度、連結。作業批次、速率限制。作業失敗，請重試。 Laravel Horizo​​n
  監控。隊列優先權。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 13 課：佇列和作業</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. 隊列設定</strong></h2>
...
<h2 id="2-jobs"><strong>2. 工作類別</strong></h2>
...
<h2 id="3-chaining-batching"><strong>3. 作業鍊和批次處理</strong></h2>
...
<h2 id="4-horizon"><strong>4.Laravel地平線</strong></h2>
...
<p>下一篇： <strong>活動、聽眾及廣播</strong>。</p>
