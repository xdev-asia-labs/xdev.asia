...
title: 第 15 課：通知、郵件和日程安排
slug: bai-15-notifications-mail-va-scheduler
description: >-
  通知頻道（郵件、資料庫、Slack、簡訊）。 Markdown 郵件，Mailables。任務調度、自訂 Artisan 命令。用於 DTO 的
  laravel-data。服務容器深入研究。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：通知、郵件和日程安排</tspan>
  </text>
...
<h2 id="1-notifications"><strong>1. 通知</strong></h2>
...
<h2 id="2-mailables"><strong>2. 郵寄物品</strong></h2>
...
<h2 id="3-scheduler"><strong>3. 任務調度</strong></h2>
...
<h2 id="4-artisan"><strong>4. 自訂 Artisan 指令</strong></h2>
...
<p>下一篇： <strong>緩存、會話和效能</strong>。</p>
