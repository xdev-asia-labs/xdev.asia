...
title: 第 9 課：Nuxt 3 和基於檔案的路由
slug: bai-9-nuxt-3-va-file-based-routing
description: Nuxt 3 概述、自動導入、基於檔案的路由。佈局、頁面、錯誤處理。 nuxt.config.ts，執行階段配置。 Nuxt 開發工具。目錄結構。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 程式設計 — 第 9 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：Nuxt 3 和基於檔案的路由</tspan>
  </text>
...
<h2 id="1-setup"><strong>1.創建Nuxt 3項目</strong></h2>
...
<h2 id="2-structure"><strong>2. 目錄結構</strong></h2>
...
<h2 id="3-routing"><strong>3. 基於檔案的路由</strong></h2>
...
<h2 id="6-auto-imports"><strong>6. 自動導入</strong></h2>
...
<h2 id="7-error"><strong>7. 錯誤處理</strong></h2>
...
<p>下一篇： <strong>數據獲取和SSR</strong> — useFetch、useAsyncData、渲染模式。</p>
