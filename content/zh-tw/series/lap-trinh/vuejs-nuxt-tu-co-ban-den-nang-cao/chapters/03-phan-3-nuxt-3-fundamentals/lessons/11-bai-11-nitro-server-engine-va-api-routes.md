...
title: 第 11 課：Nitro 伺服器引擎和 API 路由
slug: bai-11-nitro-server-engine-va-api-routes
description: Nitro 伺服器引擎、伺服器路由、事件處理程序。伺服器中間件，伺服器插件。伺服器儲存、KV儲存。資料庫整合（Drizzle ORM）。伺服器實用程式。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">💻 程式設計 — 第 11 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 11 課：Nitro 伺服器引擎和 API 路由</tspan>
  </text>
...
<h2 id="1-server-routes"><strong>1. 伺服器路由</strong></h2>
...
<h2 id="2-validation"><strong>2. 輸入驗證</strong></h2>
...
<h2 id="3-middleware"><strong>3. 伺服器中間件</strong></h2>
...
<h2 id="4-drizzle"><strong>4. 使用 Drizzle ORM 的資料庫</strong></h2>
...
<h2 id="5-storage"><strong>5、伺服器存儲</strong></h2>
...
<h2 id="6-server-plugins"><strong>6. 伺服器插件</strong></h2>
...
<p>下一篇： <strong>中介軟體、插件和模組</strong> — 路由中間件、Nuxt 模組生態系。</p>
