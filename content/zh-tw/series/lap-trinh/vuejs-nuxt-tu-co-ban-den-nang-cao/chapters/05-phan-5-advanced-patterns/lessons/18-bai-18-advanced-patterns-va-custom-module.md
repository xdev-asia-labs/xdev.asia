...
title: 第 18 課：進階模式與自訂模組
slug: bai-18-advanced-patterns-va-custom-module
description: 無渲染元件、高階元件。 Vue 虛擬 DOM，渲染功能。建立 Nuxt 模組、套件實用程式。 Nuxt 層，擴充 Nuxt 應用程式。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 18 課：進階模式與自訂模組</tspan>
  </text>
...
<h2 id="1-renderless"><strong>1. 無渲染元件</strong></h2>
...
<h2 id="2-render-functions"><strong>2. 渲染函數</strong></h2>
...
<h2 id="3-hoc"><strong>3. 高階組件</strong></h2>
...
<h2 id="4-custom-module"><strong>4.創建Nuxt模組</strong></h2>
...
<h2 id="5-layers"><strong>5.Nuxt層</strong></h2>
...
<p>下一篇： <strong>測試 Vue 和 Nuxt</strong> — Vitest，Vue Test Utils，劇作家。</p>
