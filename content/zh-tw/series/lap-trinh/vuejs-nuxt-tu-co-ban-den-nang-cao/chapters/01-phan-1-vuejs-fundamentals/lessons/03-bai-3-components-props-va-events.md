...
title: 第 3 課：組件、道具與事件
slug: bai-3-components-props-va-events
description: 組件註冊，道具驗證。 v-model，自訂事件，發出。插槽（預設、命名、範圍）。提供/注入、組件生命週期掛鉤。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：組件、道具與事件</tspan>
  </text>
...
<h2 id="1-component"><strong>1. 組件註冊</strong></h2>
...
<h2 id="2-v-model"><strong>2. v-model & 自訂事件</strong></h2>
...
<h2 id="3-slots"><strong>3. 老虎機</strong></h2>
...
<h2 id="4-scoped-slots"><strong>4. 作用域槽</strong></h2>
...
<h2 id="6-lifecycle"><strong>6. 生命週期掛鉤</strong></h2>
...
<p>下一篇： <strong>指令、渲染和模板參考</strong> — 自訂指令、渲染函數、傳送。</p>
