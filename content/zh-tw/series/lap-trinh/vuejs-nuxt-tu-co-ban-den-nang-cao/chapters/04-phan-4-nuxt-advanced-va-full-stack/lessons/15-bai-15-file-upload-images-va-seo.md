...
title: 第 15 課：文件上傳、圖像和 SEO
slug: bai-15-file-upload-images-va-seo
description: >-
  文件上傳處理、S3 儲存。 @nuxt/image，響應式映像，延遲載入。 SEO 使用 useSeoMeta、useHead。網站地圖、OG
  標籤、結構化資料 (JSON-LD)。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：文件上傳、圖像和 SEO</tspan>
  </text>
...
<h2 id="1-upload"><strong>1. 文件上傳</strong></h2>
...
<h2 id="2-nuxt-image"><strong>2.@nuxt/圖片</strong></h2>
...
<h2 id="3-seo"><strong>3. 使用 useSeoMeta 進行 SEO</strong></h2>
...
<h2 id="4-sitemap"><strong>4. 網站地圖生成</strong></h2>
...
<p>下一篇： <strong>實時、WebSocket 和 i18n</strong> — 即時互動與多語言。</p>
