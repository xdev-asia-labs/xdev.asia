...
title: 第 14 課：Nuxt 中的資料庫和 ORM
slug: bai-14-database-va-orm-trong-nuxt
description: >-
  毛毛雨 ORM，Nuxt 的 Prisma。資料庫遷移、播種。適用於 D1/R2 (Cloudflare) 的 nuxt-hub。儲存庫模式，伺服器端
  CRUD。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 14 課：Nuxt 中的資料庫和 ORM</tspan>
  </text>
...
<h2 id="1-drizzle-setup"><strong>1.Drizzle ORM 設定</strong></h2>
...
<h2 id="2-migrations"><strong>2. 遷移</strong></h2>
...
<h2 id="3-crud"><strong>3.增刪改查操作</strong></h2>
...
<p>下一篇： <strong>文件上傳、圖像和 SEO</strong> — 上傳，@nuxt/image，元資料。</p>
