...
title: 第 19 課：測驗 Vue 和 Nuxt
slug: bai-19-testing-vue-va-nuxt
description: >-
  Vitest 用於單元測試。 Vue Test Utils，元件測試。 @nuxt/test-utils，Playwright E2E 測試。用於 API
  模擬的 MSW。測試可組合項目、Pinia 商店。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：測驗 Vue 和 Nuxt</tspan>
  </text>
...
<h2 id="1-vitest-setup"><strong>1. 設定Vitest</strong></h2>
...
<h2 id="2-component-testing"><strong>2. 使用 Vue Test Utils 進行元件測試</strong></h2>
...
<h2 id="3-composable-testing"><strong>3. 測試可組合項</strong></h2>
...
<h2 id="4-pinia-testing"><strong>4. 測試 Pinia 商店</strong></h2>
...
<h2 id="5-msw"><strong>5. 使用 MSW 進行 API 模擬</strong></h2>
...
<h2 id="7-e2e"><strong>7. 與 Playwright 進行端對端測試</strong></h2>
...
<p>下一篇： <strong>效能最佳化</strong> — 套件分析、程式碼分割、快取。</p>
