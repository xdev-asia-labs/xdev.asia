...
title: 第 5 課：Vue Router 深入探究
slug: bai-5-vue-router-deep-dive
description: >-
  Vue Router
  4，路由定義，動態路由。導航守衛（beforeEach、beforeRouteEnter）。延遲載入、嵌套路由。滾動行為、路線元、路線轉換。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 5 課：Vue Router 深入探究</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. 路由器設定</strong></h2>
...
<h2 id="2-dynamic-routes"><strong>2. 動態路由</strong></h2>
...
<h2 id="3-guards"><strong>3. 導航衛士</strong></h2>
...
<h2 id="4-transitions"><strong>4. 路線轉換</strong></h2>
...
<p>下一篇： <strong>Pinia 的狀態管理</strong> — 儲存、擷取器、操作、插件。</p>
