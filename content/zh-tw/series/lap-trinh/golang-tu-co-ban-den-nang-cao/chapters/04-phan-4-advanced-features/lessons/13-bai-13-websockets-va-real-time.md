...
description: gorilla/websocket，連結生命週期。聊天室，廣播模式。即時通知、心跳和重新連線。擴充 WebSocket。
...
<h2 id="1-websocket-fundamentals"><strong>1.WebSocket 基礎知識</strong></h2>

<p>WebSocket 通过单个 TCP 连接在客户端和服务器之间提供全双工连接。与 HTTP 请求/响应不同，WebSocket 允许服务器主动将数据推送到客户端。</p>

<table>
<thead><tr><th>特點</th><th>HTTP協定</th><th>WebSockets</th></tr></thead>
<tbody>
<tr><td>連接。連接方式</td><td>短暫的</td><td>持久的</td></tr>
<tr><td>方向</td><td>客戶端→伺服器</td><td>雙向</td></tr>
<tr><td>協定</td><td>HTTP/1.1、HTTP/2</td><td>ws://，wss://</td></tr>
<tr><td>開賣</td><td>每個請求的標頭</td><td>最小幀頭</td></tr>
<tr><td>使用案例</td><td>休息API</td><td>聊天、通知、即時數據</td></tr>
</tbody>
</table>

<h2 id="2-gorilla-websocket-setup"><strong>2. gorilla/websocket 设置</strong></h2>

<pre><code class="language-bash">go get github.com/gorilla/websocket
</code></pre>

<h3 id="2-1-basic-echo-server"><strong>2.1.基本迴聲伺服器</strong></h3>
...
<h2 id="3-chat-room-pattern"><strong>3. 聊天室——Hub模式</strong></h2>

<h3 id="3-1-hub"><strong>3.1.集线器（连接管理）</strong></h3>
...
<h3 id="3-2-client"><strong>3.2.客戶</strong></h3>
...
<h3 id="3-3-handler"><strong>3.3.使用 Gin 的 WebSocket 处理程序</strong></h3>
...
<h2 id="4-heartbeat-reconnection"><strong>4. 心跳與重連</strong></h2>
...
<h2 id="5-scaling-websockets"><strong>5. 使用 Redis Pub/Sub 扩展 WebSocket</strong></h2>
...
<p>下一篇： <strong>gRPC 和協定緩衝區</strong> — 高性能 RPC 通信。</p>
