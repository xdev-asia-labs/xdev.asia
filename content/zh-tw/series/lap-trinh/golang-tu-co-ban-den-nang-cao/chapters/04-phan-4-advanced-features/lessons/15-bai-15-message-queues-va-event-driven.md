...
description: RabbitMQ 與 Go、交換器和佇列。卡夫卡生產者/消費者。事件驅動的架構模式。傳奇模式，寄件箱模式。死信隊列和重試策略。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：訊息佇列和事件驅動</tspan>
  </text>
...
<h2 id="1-message-queue-overview"><strong>1. 訊息佇列概述</strong></h2>

<table>
<thead><tr><th>特點</th><th>RabbitMQ</th><th>卡夫卡</th><th>NATS</th></tr></thead>
<tbody>
<tr><td>型號</td><td>訊息代理</td><td>事件日誌</td><td>發布/訂閱</td></tr>
<tr><td>訂購</td><td>每個隊列</td><td>每個分區</td><td>沒有保證</td></tr>
<tr><td>堅持</td><td>可選</td><td>始終（保留）</td><td>可選（噴射流）</td></tr>
<tr><td>吞吐量</td><td>~50K 訊息/秒</td><td>~1M 訊息/秒</td><td>~10M 訊息/秒</td></tr>
<tr><td>使用案例</td><td>任務隊列、RPC</td><td>事件流</td><td>微服務、物聯網</td></tr>
<tr><td>複雜性</td><td>中等</td><td>高</td><td>低</td></tr>
</tbody>
</table>

<h2 id="2-rabbitmq-voi-go"><strong>2.RabbitMQ 與 Go</strong></h2>

<h3 id="2-1-setup"><strong>2.1.設置</strong></h3>

<pre><code class="language-bash">go get github.com/rabbitmq/amqp091-go
</code></pre>

<h3 id="2-2-connection-manager"><strong>2.2.連接管理器</strong></h3>
...
<h3 id="2-3-publisher"><strong>2.3.出版商</strong></h3>
...
<h2 id="3-kafka"><strong>3.卡夫卡與Go</strong></h2>
...
<h2 id="4-event-driven-patterns"><strong>4. 事件驅動模式</strong></h2>

<h3 id="4-1-event-bus"><strong>4.1.領域事件</strong></h3>
...
<h3 id="4-2-outbox-pattern"><strong>4.2.寄件箱模式（事務寄件匣）</strong></h3>
...
<h2 id="5-retry-strategies"><strong>5. 重試策略</strong></h2>
...
<p>下一篇： <strong>快取、檔案上傳和效能</strong> — Redis 快取、檔案上傳和最佳化。</p>
