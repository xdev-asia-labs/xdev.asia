...
description: 單元測試，表驅動測試。嘲笑目擊者，嘲笑。與測試容器的整合測試。 HTTP 處理程序測試。基準測試，模糊測試。測試覆蓋率、CI 整合。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 程式設計 — 第 18 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 18 課：Go 測試</tspan>
  </text>
...
<h2 id="1-testing-basics"><strong>1. 測試基礎知識</strong></h2>
...
<h2 id="2-table-driven-tests"><strong>2. 表驅動測試</strong></h2>
...
<h2 id="3-testify"><strong>3.作證－斷言和模擬</strong></h2>
...
<h3 id="3-1-interface-mocking"><strong>3.1.介面模擬</strong></h3>
...
<h2 id="4-http-handler-testing"><strong>4. HTTP 處理程序測試</strong></h2>
...
<h2 id="5-integration-tests"><strong>5. 使用測試容器進行整合測試</strong></h2>
...
<h2 id="6-fuzzing"><strong>6.模糊測試</strong></h2>
...
<h2 id="7-test-commands"><strong>7. 測試命令</strong></h2>
...
<p>下一篇： <strong>Docker、CI/CD 和 DevOps</strong> — 容器化、管道化和部署自動化。</p>
