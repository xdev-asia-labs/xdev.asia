...
description: >-
  JWT 與 golang-jwt、bcrypt 密碼雜湊。存取令牌、刷新令牌、令牌輪換。 OAuth2 流程，使用 Google/GitHub
  進行社群登入。會話管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 11 課：身份驗證 - JWT 和 OAuth2</tspan>
  </text>
...
<h2 id="1-password-hashing"><strong>1. 使用 bcrypt 進行密碼雜湊處理</strong></h2>
...
<h2 id="2-jwt-authentication"><strong>2.JWT認證</strong></h2>
...
<h3 id="2-2-token-service"><strong>2.2.服務令牌</strong></h3>
...
<h2 id="4-auth-middleware"><strong>4. 認證中介軟體</strong></h2>
...
<h2 id="5-auth-handlers"><strong>5. 身份驗證處理程序</strong></h2>
...
<h2 id="6-security-best-practices"><strong>6. 安全最佳實踐</strong></h2>

<ul>
<li><strong>密碼</strong>：bcrypt（成本≥10），不單獨使用md5/sha256</li>
<li><strong>智威湯遜</strong>：短期訪問令牌（15 分鐘），長期刷新令牌（7 天）</li>
<li><strong>代幣輪換</strong>：刷新時發出新的令牌對</li>
<li><strong>秘密</strong>：使用環境變量，程式碼中沒有硬編碼</li>
<li><strong>HTTPS</strong>：在生產中始終使用 HTTPS</li>
<li><strong>速率限制</strong>：限制登入嘗試（暴力保護）</li>
<li><strong>錯誤訊息</strong>：通用“無效憑證”，不顯示電子郵件存在</li>
</ul>

<p>下一篇： <strong>授權、安全和中介軟體</strong> — RBAC、Casbin 與進階安全性。</p>
