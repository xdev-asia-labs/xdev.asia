...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 程式設計 — 第 2 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 課：變數、類型和控制流</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：Go 基礎知識</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-variables"><strong>1.Go中宣告變數</strong></h2>

<p>Go 有多種宣告變數的方法，每種方法都適合不同的上下文：</p>

<h3 id="1-1-var-keyword"><strong>1.1.使用 <code>變數</code></strong></h3>
...
<h3 id="1-2-short-declaration"><strong>1.2.簡短聲明 <code>:=</code></strong></h3>
...
<p><strong>使用規則</strong>：使用 <code>:=</code> 在功能上（簡短）。使用 <code>變數</code> 在包級別或需要零值時。</p>

<h3 id="1-3-constants"><strong>1.3.常數等 <code>伊奧塔</code></strong></h3>
...
<h2 id="2-primitive-types"><strong>2. 原始類型</strong></h2>

<h3 id="2-1-numeric"><strong>2.1.數字類型</strong></h3>

<table>
<thead>
<tr><th>類型</th><th>尺寸</th><th>範圍</th><th>零值</th></tr>
</thead>
<tbody>
<tr><td><code>整數8</code></td><td>1位元組</td><td>-128 → 127</td><td>0</td></tr>
<tr><td><code>整數16</code></td><td>2位元組</td><td>-32768 → 32767</td><td>0</td></tr>
<tr><td><code>整數32</code> / <code>符文</code></td><td>4位元組</td><td>-2^31 → 2^31-1</td><td>0</td></tr>
<tr><td><code>整數64</code></td><td>8位元組</td><td>-2^63 → 2^63-1</td><td>0</td></tr>
<tr><td><code>整數</code></td><td>4或8位元組</td><td>平台相關</td><td>0</td></tr>
<tr><td><code>uint8</code> / <code>位元組</code></td><td>1位元組</td><td>0 → 255</td><td>0</td></tr>
<tr><td><code>uint16</code></td><td>2位元組</td><td>0 → 65535</td><td>0</td></tr>
<tr><td><code>uint32</code></td><td>4位元組</td><td>0 → 2^32-1</td><td>0</td></tr>
<tr><td><code>uint64</code></td><td>8位元組</td><td>0 → 2^64-1</td><td>0</td></tr>
<tr><td><code>浮動32</code></td><td>4位元組</td><td>IEEE-754</td><td>0.0</td></tr>
<tr><td><code>浮動64</code></td><td>8位元組</td><td>IEEE-754</td><td>0.0</td></tr>
<tr><td><code>複雜64</code></td><td>8位元組</td><td>浮點32 + 浮點32i</td><td>(0+0i)</td></tr>
<tr><td><code>複雜128</code></td><td>16字節</td><td>浮點64 + 浮點64i</td><td>(0+0i)</td></tr>
</tbody>
</table>
...
<h3 id="2-2-string"><strong>2.2.字串</strong></h3>
...
<h3 id="2-3-bool"><strong>2.3.布林值</strong></h3>
...
<h2 id="3-composite-types"><strong>3. 複合類型</strong></h2>

<h3 id="3-1-array"><strong>3.1.數組（固定大小）</strong></h3>
...
<h3 id="3-2-slice"><strong>3.2.切片（動態數組）－最重要！</strong></h3>
...
<h3 id="3-3-map"><strong>3.3.地圖（鍵值）</strong></h3>
...
<h3 id="3-4-struct"><strong>3.4.結構體</strong></h3>
...
<h2 id="4-pointers"><strong>4. 指針</strong></h2>
...
<h2 id="5-zero-values"><strong>5. 零值</strong></h2>

<p>如果沒有賦值，Go 中的每個變數都會被初始化為零值：</p>

<table>
<thead>
<tr><th>類型</th><th>零值</th></tr>
</thead>
<tbody>
<tr><td><code>整數、float64、...</code></td><td><code>0</code></td></tr>
<tr><td><code>布林值</code></td><td><code>假的</code></td></tr>
<tr><td><code>字串.字串</code></td><td><code>””</code> （空字串）</td></tr>
<tr><td><code>指標、切片、映射、函數、介面、通道</code></td><td><code>無</code></td></tr>
<tr><td><code>數組。陣列</code></td><td>零值數組</td></tr>
<tr><td><code>結構體</code></td><td>具有零值欄位的結構</td></tr>
</tbody>
</table>
...
<h2 id="6-control-flow"><strong>6. 控制流程</strong></h2>

<h3 id="6-1-if-else"><strong>6.1.如果/否則</strong></h3>
...
<h3 id="6-2-switch"><strong>6.2.開關</strong></h3>
...
<h3 id="6-3-for"><strong>6.3. For 循環</strong></h3>
...
<h2 id="7-type-system"><strong>7. 類型斷言和轉換</strong></h2>
...
<p>Go 有一個簡單但完整的類型系統。需要記住的重點：</p>

<ul>
<li><strong>使用 <code>:=</code></strong> 對於局部變數， <code>變數</code> 對於包級別或零值</li>
<li><strong>切片</strong> 使用次數多於數組，始終使用 <code>附加。追加</code> 新增元素</li>
<li><strong>地圖</strong> 對 <code>使</code> 寫入之前（零映射→恐慌）</li>
<li><strong>指針</strong> 當您需要修改值或避免大型副本時使用</li>
<li><strong>零值</strong> 這是一個重要的功能，有助於使程式碼更安全</li>
<li><strong>對於</strong> 是唯一的循環，使用 <code>範圍。範圍</code> 迭代</li>
<li><strong>類型轉換</strong> 始終顯式，無隱式轉換</li>
</ul>

<p>下一篇： <strong>函數、介面和錯誤處理</strong> — Go 程式設計的三大支柱。</p>
