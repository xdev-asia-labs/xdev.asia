...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 程式設計 — 第 4 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：泛型、套件和模組</tspan>
  </text>
...
<h2 id="1-generics"><strong>1.Go中的泛型（Go 1.18+）</strong></h2>

<p>泛型允許編寫與許多不同類型一起使用的函數和類型，同時仍然保持類型安全。在 Go 1.18之前，必須使用 <code>介面{}</code> 或代碼生成。</p>

<h3 id="1-1-generic-functions"><strong>1.1.通用函數</strong></h3>
...
<h3 id="1-2-constraints"><strong>1.2.類型約束</strong></h3>
...
<h3 id="1-3-generic-types"><strong>1.3.通用類型（結構體、介面）</strong></h3>
...
<h3 id="1-4-slices-maps-package"><strong>1.4.切片和地圖包（Go 1.21+）</strong></h3>
...
<h2 id="2-packages"><strong>2. 套餐</strong></h2>

<h3 id="2-1-package-basics"><strong>2.1.封裝基礎知識</strong></h3>
...
<h3 id="2-2-package-structure"><strong>2.2.包裝組織</strong></h3>
...
<h3 id="2-3-init-function"><strong>2.3. init() 函數</strong></h3>
...
<h3 id="2-4-import"><strong>2.4.導入模式</strong></h3>
...
<h2 id="3-go-modules"><strong>3.Go模組</strong></h2>

<h3 id="3-1-module-basics"><strong>3.1.模組基礎知識</strong></h3>
...
<h3 id="3-2-dependency-management"><strong>3.2.依賴管理</strong></h3>
...
<h3 id="3-3-versioning"><strong>3.3.語意版本控制</strong></h3>
...
<h3 id="3-4-workspace"><strong>3.4.工作區模式（Go 1.18+）</strong></h3>
...
<h3 id="3-5-replace-directive"><strong>3.5.替換指令</strong></h3>
...
<h2 id="4-build-tags"><strong>4. 建置標籤和條件編譯</strong></h2>
...
<ul>
<li><strong>泛型</strong>：類型參數、限制條件（任意、可比較、cmp.Ordered）、通用結構</li>
<li><strong>切片/貼圖包</strong>：集合的通用輔助函數（Go 1.21+）</li>
<li><strong>套餐</strong>：大寫 = 導出，小寫 = 未導出，小且集中</li>
<li><strong>Go 模組</strong>：go.mod、語意版本控制、go mod tidy、供應商模式</li>
<li><strong>工作空間</strong>：多模組開發，go.work</li>
</ul>

<p>下一部分： <strong>Goroutine 和通道</strong> — Go 的並發能力，使其成為高效能係統的首選。</p>
