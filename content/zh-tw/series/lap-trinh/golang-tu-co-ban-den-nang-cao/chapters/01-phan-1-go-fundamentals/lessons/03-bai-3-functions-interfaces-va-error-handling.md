...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">💻 程式設計 — 第 3 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：函數、介面與錯誤</tspan>
...
<h2 id="1-functions"><strong>1. Go 中的函數</strong></h2>

<p>函數是 Go 中的基本建構塊。與其他語言相比，Go 函數有許多獨特的功能。</p>

<h3 id="1-1-basic-functions"><strong>1.1.基本功能</strong></h3>
...
<h3 id="1-2-variadic-functions"><strong>1.2.可變參數函數</strong></h3>
...
<h3 id="1-3-first-class-functions"><strong>1.3.一流的功能</strong></h3>
...
<h3 id="1-4-defer"><strong>1.4.推遲</strong></h3>
...
<h2 id="2-interfaces"><strong>2. 介面</strong></h2>

<p>Go 中的介面有 <strong>隱式.隱式</strong> ——類型只需要實作方法，不需要宣告「implements」。與Java/C#相比，這是一個很大的差異。</p>

<h3 id="2-1-basic-interface"><strong>2.1.介面定義</strong></h3>
...
<h3 id="2-2-common-interfaces"><strong>2.2. Go 中的常用介面</strong></h3>
...
<h3 id="2-3-interface-composition"><strong>2.3.介面組合（嵌入）</strong></h3>
...
<h3 id="2-4-empty-interface"><strong>2.4.空接口和任何</strong></h3>
...
<p>Go 也不例外（try-catch）。使用的錯誤處理 <strong>明確傳回值</strong> ——這是一個有意的設計選擇。</p>

<h3 id="3-1-basic-error"><strong>3.1.基本錯誤處理</strong></h3>
...
<h3 id="3-2-custom-errors"><strong>3.2.自訂錯誤</strong></h3>
...
<h3 id="3-3-error-wrapping"><strong>3.3.錯誤包裝（Go 1.13+）</strong></h3>
...
<h3 id="3-4-panic-recover"><strong>3.4.恐慌與恢復</strong></h3>
...
<h3 id="3-5-error-patterns"><strong>3.5.常用的錯誤處理模式</strong></h3>
...
<h2 id="4-struct-embedding"><strong>4. 結構嵌入（組合）</strong></h2>
...
<ul>
<li><strong>功能</strong>：多個回傳值、一流、閉包、延遲</li>
<li><strong>介面</strong>：隱式實作、小介面、組合</li>
<li><strong>錯誤處理</strong>：顯式錯誤、換行（%w）、errors.Is/As、自訂錯誤</li>
<li><strong>成分</strong>：結構嵌入而不是繼承</li>
<li><strong>恐慌/恢復</strong>：僅針對不可恢復的錯誤，不適用於業務邏輯</li>
</ul>

<p>下一篇： <strong>泛型、套件和模組</strong> — Go 中的類型參數系統和代碼管理。</p>
