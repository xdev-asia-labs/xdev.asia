...
description: >-
  單元測試、整合測試、文件測試。 rstest（夾具、參數化）、mockall。使用 reqwest 進行 API 測試。 Criterion.rs
  基準測試。基於屬性的測試，模糊測試。代碼覆蓋率。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：測試和基準測試</tspan>
  </text>
...
<h2 id="1-unit"><strong>1. 單元測試</strong></h2>
...
<h2 id="2-rstest"><strong>2. rstest — 夾具和參數化</strong></h2>
...
<h2 id="3-mockall"><strong>3. 使用mockall進行模擬</strong></h2>
...
<h2 id="4-benchmark"><strong>4. 標準基準測試</strong></h2>
...
<p>下一篇： <strong>Rust 的 Docker 和 CI/CD</strong>。</p>
