...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 程式設計 — 第 17 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：WebAssembly 與 Rust</tspan>
  </text>
...
<h2 id="1-setup"><strong>1.WASM設定</strong></h2>
...
<h2 id="2-js-interop"><strong>2. JavaScript 互通</strong></h2>
...
<h2 id="3-web-sys"><strong>3. 使用 web-sys 操作 DOM</strong></h2>
...
<h2 id="4-leptos"><strong>4.樂浦前端框架</strong></h2>
...
<p>下一篇： <strong>FFI 和不安全 Rust</strong>。</p>
