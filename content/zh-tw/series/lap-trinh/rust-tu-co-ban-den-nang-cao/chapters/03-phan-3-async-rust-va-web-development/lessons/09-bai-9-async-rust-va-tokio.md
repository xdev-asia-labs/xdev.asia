...
description: >-
  非同步/等待、未來特徵、Pin。 Tokio 運作時、spawn、JoinHandle。東京頻道（mpsc、廣播、觀看）。 tokio::選擇！
  、tokio::sync。異步流。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：異步 Rust 和 Tokio</tspan>
  </text>
...
<h2 id="1-async-await"><strong>1. 異步/等待基礎知識</strong></h2>
...
<h2 id="2-tokio"><strong>2. Tokio 運行時和任務</strong></h2>
...
<h2 id="3-channels"><strong>3. 東京頻道</strong></h2>
...
<h2 id="4-semaphore"><strong>4. 信號量和速率限制</strong></h2>
...
<p>下一篇： <strong>Axum 框架和 REST API</strong>。</p>
