...
description: 使用 deadpool-redis 進行 Redis 快取。帶有 clap 的命令列工具。過程宏、派生宏。 Serde 自訂序列化。配置管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 16 課：快取、CLI 工具和宏</tspan>
  </text>
...
<h2 id="1-redis"><strong>1.Redis緩存</strong></h2>
...
<h2 id="2-clap"><strong>2.帶有 Clap 的 CLI 工具</strong></h2>
...
<h2 id="3-macros"><strong>3. 聲明式宏</strong></h2>
...
<h2 id="4-config"><strong>4. 配置管理</strong></h2>
...
<p>下一篇： <strong>使用 Rust 進行 WebAssembly</strong>。</p>
