...
description: 協定緩衝區，prost 程式碼產生。 Tonic gRPC 框架，一元/流 RPC。攔截器、TLS、負載平衡。用於瀏覽器客戶端的 gRPC-web。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 程式設計 — 第 14 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 14 課：gRPC 與 Tonic</tspan>
  </text>
...
<h2 id="1-proto"><strong>1. 協定緩衝區</strong></h2>
...
<h2 id="2-server"><strong>2.gRPC伺服器</strong></h2>
...
<h2 id="3-client"><strong>3.gRPC客戶端</strong></h2>
...
<p>下一篇： <strong>訊息佇列和背景作業</strong>。</p>
