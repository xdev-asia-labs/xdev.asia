...
description: 使用 Multer、S3 儲存上傳檔案。使用 Redis 進行快取。使用@nestjs/schedule 進行任務調度。與公牛一起排隊。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 程式設計 — 第 16 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 16 課：文件上傳、快取和任務</tspan>
      <tspan x="60" dy="42">調度</tspan>
  </text>
...
<h2 id="1-file-upload"><strong>1. 使用Multer上傳文件</strong></h2>
...
<h2 id="2-caching"><strong>2.Redis緩存</strong></h2>
...
<h2 id="3-scheduling"><strong>3. 任務調度</strong></h2>
...
<h2 id="4-queue"><strong>4. 與 Bull 一起排隊</strong></h2>
...
<ul>
<li><strong>文件上傳</strong>：Multer 用於本地，S3 用於生產，驗證文件類型+大小</li>
<li><strong>快取</strong>：Redis 支援的快取、快取失效、自訂裝飾器</li>
<li><strong>調度</strong>：後台任務的 Cron 作業、間隔、逾時</li>
<li><strong>佇列</strong>：Bull + Redis 用於非同步作業處理（電子郵件、圖像、報告）</li>
</ul>

<p>下一篇文章將探討 <strong>NestJS 微服務</strong>。</p>
