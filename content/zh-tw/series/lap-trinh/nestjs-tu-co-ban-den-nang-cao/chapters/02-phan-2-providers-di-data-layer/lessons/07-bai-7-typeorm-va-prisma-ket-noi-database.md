...
description: >-
  使用 TypeORM 和 Prisma 連接 PostgreSQL/MySQL。實體、儲存庫、關係、遷移、播種。比較 TypeORM 與 Prisma
  以及何時使用哪一種。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 程式設計 — 第 7 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 7 課：TypeORM 和 Prisma - 連接</tspan>
      <tspan x="60" dy="42">資料庫</tspan>
  </text>
...
<h2 id="1-typeorm-setup"><strong>1. TypeORM — 使用 NestJS 設定</strong></h2>
...
<h2 id="2-entities"><strong>2. 實體的定義</strong></h2>
...
<h2 id="3-repository-pattern"><strong>3. 儲存庫模式</strong></h2>
...
<h2 id="4-migrations"><strong>4. 遷移</strong></h2>
...
<h2 id="5-prisma-setup"><strong>5. Prisma — 使用 NestJS 設置</strong></h2>
...
<h3 id="prisma-service"><strong>NestJS 中的 Prisma 服務</strong></h3>
...
<h2 id="6-so-sanh"><strong>6.TypeORM 與 Prisma</strong></h2>

<table>
<thead>
<tr><th>標準</th><th>類型ORM</th><th>棱鏡</th></tr>
</thead>
<tbody>
<tr><td>模式定義</td><td>TypeScript 裝飾器</td><td>Prisma 模式語言</td></tr>
<tr><td>類型安全</td><td>平均</td><td>非常高（自動產生）</td></tr>
<tr><td>查詢介面</td><td>儲存庫 + 查詢產生器</td><td>Prisma 用戶端（流暢的 API）</td></tr>
<tr><td>遷移</td><td>TypeORM 遷移</td><td>棱鏡遷移</td></tr>
<tr><td>原始SQL</td><td>簡單</td><td>$queryRaw / $executeRaw</td></tr>
<tr><td>關係</td><td>基於裝飾器</td><td>基於模式</td></tr>
<tr><td>效能</td><td>好</td><td>非常好（Rust 引擎）</td></tr>
<tr><td>圖形使用者介面工具</td><td>否</td><td>棱鏡工作室</td></tr>
<tr><td>NestJS 集成</td><td>@nestjs/typebug（官方）</td><td>手動 Prisma 服務</td></tr>
<tr><td>適合</td><td>熟悉 Active Record/Data Mapper</td><td>現代，類型安全第一</td></tr>
</tbody>
</table>
...
<ul>
<li><strong>類型ORM</strong>：官方集成，基於裝飾器的實體，用於複雜查詢的QueryBuilder</li>
<li><strong>棱鏡</strong>：類型安全的自動產生客戶端、模式優先、Prisma Studio GUI</li>
<li>兩者都支援 PostgreSQL、MySQL、SQLite、SQL Server</li>
<li>生產總是使用它 <strong>遷移</strong>，請勿使用 <code>同步：真</code></li>
</ul>

<p>下一篇文章將探討 <strong>驗證、管道和異常過濾器</strong>。</p>
