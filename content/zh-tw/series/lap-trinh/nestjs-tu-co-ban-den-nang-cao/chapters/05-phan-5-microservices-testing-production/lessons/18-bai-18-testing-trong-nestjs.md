...
description: NestJS 中的單元測試、整合測試、E2E 測試。玩笑、超級測試、測試模組、模擬提供者、資料庫測試。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 18 課：在 NestJS 進行測試</tspan>
  </text>
...
<h2 id="1-setup"><strong>1.NestJS測試</strong></h2>

<p>NestJS 内置并提供了 Jest <code>@nestjs/測試</code> 測試模組的包。</p>
...
<h2 id="2-unit-testing"><strong>2. 單元測試服務</strong></h2>
...
<h2 id="3-unit-testing-controllers"><strong>3. 單元測試控制器</strong></h2>
...
<h2 id="4-testing-guards"><strong>4. 测试防护装置和管道</strong></h2>
...
<h2 id="5-e2e-testing"><strong>5. 端對端測試</strong></h2>
...
<h2 id="6-database-testing"><strong>6. 使用测试容器进行数据库测试</strong></h2>
...
<ul>
<li><strong>單元測試</strong>：模拟依赖，测试逻辑隔离</li>
<li><strong>控制器測試</strong>：模拟服务，测试路由/验证</li>
<li><strong>防護罩/管道測試</strong>：模拟执行上下文、反射器</li>
<li><strong>端對端測試</strong>：超級測試，真實的HTTP請求，測試完整的管道</li>
<li><strong>資料庫測試</strong>：内存中的 SQLite 或 TestContainers</li>
</ul>

<p>下一篇文章將探討 <strong>适用于 NestJS 的 Dockerize 和 CI/CD</strong>。</p>
