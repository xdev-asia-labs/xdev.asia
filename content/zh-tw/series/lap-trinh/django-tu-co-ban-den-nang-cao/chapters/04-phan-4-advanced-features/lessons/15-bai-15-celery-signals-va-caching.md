...
description: >-
  Celery 與 Redis/RabbitMQ、非同步任務、定期任務 (Celery Beat)。 Django
  訊號（post_save、pre_delete）。快取框架（Redis、每個視圖、模板片段、查詢快取）。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：Celery、訊號與緩存</tspan>
  </text>
...
<h2 id="1-celery-setup"><strong>1.芹菜設置</strong></h2>
...
<h2 id="2-tasks"><strong>2.芹菜任務</strong></h2>
...
<h2 id="3-celery-beat"><strong>3. 週期性任務（Celery Beat）</strong></h2>
...
<h2 id="4-signals"><strong>4.Django訊號</strong></h2>
...
<h2 id="5-caching"><strong>5.Django緩存</strong></h2>
...
<p>下一篇： <strong>文件儲存、電子郵件和通知</strong>。</p>
