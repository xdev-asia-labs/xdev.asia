...
description: Django 檔案儲存（本地、帶有 django-storages 的 S3）。電子郵件後端（SMTP、SES）。推播通知、應用程式內通知、通知首選項。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 16 課：文件儲存、電子郵件和</tspan>
...
<h2 id="1-file-storage"><strong>1. 文件存儲</strong></h2>
...
<h2 id="2-custom-storage"><strong>2. 自訂儲存後端</strong></h2>
...
<h2 id="3-email"><strong>3. 電子郵件後端</strong></h2>
...
<h2 id="4-notifications"><strong>4. 應用程式內通知</strong></h2>
...
<p>下一篇： <strong>在 Django 中測試</strong>。</p>
