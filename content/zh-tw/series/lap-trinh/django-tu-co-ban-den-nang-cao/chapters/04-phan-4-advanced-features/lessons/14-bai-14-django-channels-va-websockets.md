...
description: Django 頻道設定、ASGI 配置。 WebSocket 消費者、Redis 通道層。即時通知、聊天應用、廣播模式。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 程式設計 — 第 14 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 14 課：Django 通道和 WebSocket</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. 頻道設定</strong></h2>
...
<h2 id="2-consumer"><strong>2.WebSocket消費者</strong></h2>
...
<h2 id="3-notifications"><strong>3. 即時通知</strong></h2>
...
<h2 id="4-frontend"><strong>4. 前端WebSocket</strong></h2>
...
<p>下一篇： <strong>Celery、訊號和緩存</strong>。</p>
