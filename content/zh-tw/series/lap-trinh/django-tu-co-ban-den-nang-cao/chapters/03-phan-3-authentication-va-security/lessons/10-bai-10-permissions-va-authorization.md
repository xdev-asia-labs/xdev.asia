...
description: >-
  DRF 權限（IsAuthenticated、IsAdminUser、自訂）。物件級權限，django-guardian。基於角色的存取控制
  (RBAC)、Django 群組。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 程式設計 — 第 10 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 10 課：權限與授權</tspan>
  </text>
...
<h2 id="1-drf-permissions"><strong>1.DRF內建權限</strong></h2>
...
<h2 id="2-custom-permissions"><strong>2. 自訂權限</strong></h2>
...
<h2 id="3-django-groups"><strong>3. Django 群組和權限</strong></h2>
...
<h2 id="4-object-level"><strong>4. 物件級權限</strong></h2>
...
<h2 id="5-rbac"><strong>5. 基於角色的存取控制</strong></h2>
...
<p>下一篇： <strong>社交身份驗證和 OAuth2</strong>。</p>
