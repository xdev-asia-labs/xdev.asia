...
description: >-
  使用 django-allauth 進行社交驗證（Google、GitHub、Facebook）。帶有 django-oauth-toolkit 的
  OAuth2 提供者。 SSO 整合、帳戶連結、自訂社交適配器。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 11 課：社交身分驗證與 OAuth2</tspan>
  </text>
...
<h2 id="1-allauth"><strong>1. django-allauth 設定</strong></h2>
...
<h2 id="2-google-oauth"><strong>2.GoogleOAuth2</strong></h2>
...
<h2 id="3-custom-adapter"><strong>3. 自訂社交適配器</strong></h2>
...
<h2 id="4-oauth2-provider"><strong>4.OAuth2提供者</strong></h2>
...
<h2 id="5-drf-social"><strong>5.DRF中的社交認證</strong></h2>
