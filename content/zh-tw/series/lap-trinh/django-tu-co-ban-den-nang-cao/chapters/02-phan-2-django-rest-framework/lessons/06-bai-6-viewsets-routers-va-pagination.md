...
description: >-
  ViewSets（ModelViewSet、ReadOnlyModelViewSet、自訂操作）。
  DefaultRouter，嵌套路由器。分頁樣式、過濾、使用 django-filter 排序。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 程式設計 — 第 6 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 6 課：視圖集、路由器和分頁</tspan>
  </text>
...
<h2 id="1-viewsets"><strong>1. 視圖集</strong></h2>
...
<h2 id="2-router"><strong>2. 路由器</strong></h2>
...
<h2 id="3-pagination"><strong>3. 分頁</strong></h2>
...
<h2 id="4-filtering"><strong>4. 過濾和排序</strong></h2>
...
<p>下一篇： <strong>高級序列化器和驗證</strong>。</p>
