...
description: Django 偵錯工具列，查詢最佳化。 N+1查詢問題，select_lated/prefetch_lated。資料庫索引、查詢分析。連線池、唯讀副本。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 18
section_title: 第 5 部分：測試、部署和生產
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">💻 程式設計 — 第 18 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 18 課：效能優化</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：測試、部署和生產</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-debug-toolbar"><strong>1.Django調試工具列</strong></h2>
...
<h2 id="2-query-optimization"><strong>2. 查詢最佳化</strong></h2>
...
<h2 id="3-aggregation"><strong>3. 聚合與標註</strong></h2>
...
<h2 id="4-indexing"><strong>4. 資料庫索引</strong></h2>
...
<h2 id="5-connection-pooling"><strong>5. 連線池和唯讀副本</strong></h2>
...
<p>下一篇： <strong>適用於 Django 的 Docker 和 CI/CD</strong>。</p>
