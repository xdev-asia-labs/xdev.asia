...
description: >-
  Dockerize Django 應用程式。 Docker Compose（Django + PostgreSQL + Redis + Celery）。
  GitHub Actions CI/CD 管道。多階段建置、環境管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：Django 的 Docker 和 CI/CD</tspan>
  </text>
...
<h2 id="1-dockerfile"><strong>1.Dockerfile（多階段）</strong></h2>
...
<h2 id="4-env-management"><strong>4、環境管理</strong></h2>
