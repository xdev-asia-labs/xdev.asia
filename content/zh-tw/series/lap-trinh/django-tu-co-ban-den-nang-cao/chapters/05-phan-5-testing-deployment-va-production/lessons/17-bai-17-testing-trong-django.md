...
description: >-
  Django 測試用例，pytest-django。單元測試模型、視圖、序列化器。使用 APIClient 進行 API
  測試。工廠男孩、固定裝置、嘲笑、報道報告。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：在 Django 中測試</tspan>
  </text>
...
<h2 id="1-test-setup"><strong>1. 使用 pytest-django 進行測試設置</strong></h2>
...
<h2 id="2-factory"><strong>2. 工廠男孩</strong></h2>
...
<h2 id="3-model-tests"><strong>3. 單元測試模型</strong></h2>
...
<h2 id="4-api-tests"><strong>4.API測試</strong></h2>
...
<h2 id="5-mocking"><strong>5. 嘲笑</strong></h2>
