...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 程式設計 — 第 2 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 課：模型和 Django ORM</tspan>
  </text>
...
<h2 id="1-model-fields"><strong>1. 模型字段</strong></h2>
...
<h2 id="3-queryset"><strong>3.查詢集API</strong></h2>
...
<h2 id="4-managers"><strong>4. 定制經理</strong></h2>
...
<p>下一篇： <strong>視圖、URL 和模板</strong> — FBV、URL 路由、模板語言。</p>
