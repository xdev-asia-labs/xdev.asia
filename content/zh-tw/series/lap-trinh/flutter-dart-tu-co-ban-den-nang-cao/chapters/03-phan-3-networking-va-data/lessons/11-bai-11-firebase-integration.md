...
description: >-
  使用 FlutterFire CLI 設定 Firebase。 Cloud Firestore CRUD，即時偵聽器。 Firebase
  驗證、雲端儲存、雲端訊息傳遞。分析、Crashlytics。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 11 課：Firebase 集成</tspan>
  </text>
...
<h2 id="1-setup"><strong>1.Firebase 設定</strong></h2>
...
<h2 id="2-firestore"><strong>2. 雲端Firestore</strong></h2>
...
<h2 id="3-storage"><strong>3、雲端儲存</strong></h2>
...
<h2 id="4-crashlytics"><strong>4.Crashlytics 和分析</strong></h2>
