...
description: Firebase 驗證：電子郵件/密碼、Google 登入、Apple 登入。 JWT 令牌管理。身份驗證狀態持久性。基於角色的存取控制。生物特徵認證。
...
<h2 id="1-firebase-auth"><strong>1.Firebase 身份驗證</strong></h2>
...
<h2 id="2-auth-state"><strong>2. 使用 Riverpod 驗證狀態</strong></h2>
...
<h2 id="3-jwt"><strong>3. JWT 代幣管理</strong></h2>
...
<h2 id="4-biometric"><strong>4. 生物辨識認證</strong></h2>
