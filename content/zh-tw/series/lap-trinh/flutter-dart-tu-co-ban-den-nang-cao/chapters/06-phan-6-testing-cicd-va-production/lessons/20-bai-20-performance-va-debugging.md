...
description: >-
  開發工具：時間軸、記憶體、網路。小部件優化重建。 const
  建構子、RepaintBoundary。圖片快取、延遲載入。用於繁重計算的隔離。樹搖晃，延遲載入。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 20 課：效能與調試</tspan>
  </text>
...
<h2 id="1-devtools"><strong>1.Flutter開發工具</strong></h2>
...
<table>
<thead><tr><th>選項卡</th><th>功能</th></tr></thead>
<tbody>
<tr><td>小部件檢查器</td><td>查看小部件樹、屬性</td></tr>
<tr><td>時間軸</td><td>幀渲染、卡頓檢測</td></tr>
<tr><td>記憶體</td><td>記憶體洩漏、分配跟踪</td></tr>
<tr><td>網路</td><td>HTTP 請求監控</td></tr>
<tr><td>效能</td><td>CPU分析、火焰圖</td></tr>
</tbody>
</table>

<h2 id="2-rebuild"><strong>2.優化Widget重建</strong></h2>
...
<h2 id="3-isolates"><strong>3. 繁重計算的隔離</strong></h2>
...
<h2 id="4-image"><strong>4. 影像優化</strong></h2>
...
<p>下一篇： <strong>CI/CD 和應用程式簽名</strong>。</p>
