...
description: 使用測試包進行單元測試。小工具測試、查找器、匹配器。集成測試。用無酒精雞尾酒/mockito 進行嘲笑。黃金測試。測試覆蓋率、CI 整合。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 程式設計 — 第 19 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：Flutter 中的測試</tspan>
  </text>
...
<h2 id="1-unit-test"><strong>1. 單元測試</strong></h2>
...
<h2 id="2-widget-test"><strong>2. 小部件測試</strong></h2>
...
<h2 id="3-bloc-test"><strong>3. 測試塊/肘</strong></h2>
...
<h2 id="4-integration"><strong>4. 整合測試</strong></h2>
