...
description: >-
  Android 金鑰庫和應用程式簽署。 iOS 憑證和設定檔。 Flutter 的 GitHub 操作。快車道自動化。
  Codemagic、應用程式中心。風味/環境配置。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 程式設計 — 第 21 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 21 課：CI/CD 和應用程式簽名</tspan>
  </text>
...
<h2 id="1-android-signing"><strong>1.Android應用程式簽名</strong></h2>
...
<h2 id="2-flavors"><strong>2. 創造風味</strong></h2>
...
<h2 id="4-fastlane"><strong>4. 快車道自動化</strong></h2>
...
<p>下一篇： <strong>發佈到 App Store 和 Google Play</strong>。</p>
