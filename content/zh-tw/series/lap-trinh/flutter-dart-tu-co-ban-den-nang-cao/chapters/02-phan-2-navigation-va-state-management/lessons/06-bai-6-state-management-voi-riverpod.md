...
description: >-
  ...
  2.0：Provider、StateProvider、StateNotifierProvider、FutureProvider、StreamProvider。自動處置，系列修改器。代碼生成。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 程式設計 — 第 6 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 6 課：使用 Riverpod 進行狀態管理</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. Riverpod 設定</strong></h2>
...
<h2 id="2-providers"><strong>2. 提供者類型</strong></h2>
...
<h2 id="3-consuming"><strong>3. 消費提供者</strong></h2>
...
<h2 id="4-family-autodispose"><strong>4. 家庭和自動處置</strong></h2>
