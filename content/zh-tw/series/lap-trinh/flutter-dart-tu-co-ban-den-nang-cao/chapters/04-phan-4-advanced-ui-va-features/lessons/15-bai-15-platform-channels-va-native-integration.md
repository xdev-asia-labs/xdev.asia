...
description: 方法通道、事件通道。從 Flutter (iOS/Android) 呼叫本機程式碼。鴿子代碼生成。用於 C/C++ 函式庫的 FFI。插件開發。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：平台通路與原生</tspan>
...
<h2 id="1-method-channel"><strong>1.方法通道</strong></h2>
...
<h2 id="2-event-channel"><strong>2. EventChannel－來自 Native 的串流</strong></h2>
...
<h2 id="3-pigeon"><strong>3. Pigeon — 類型安全的代碼生成</strong></h2>
...
<h2 id="4-ffi"><strong>4. 達特FFI</strong></h2>
...
<p>下一篇： <strong>推播通知和後台任務</strong>。</p>
