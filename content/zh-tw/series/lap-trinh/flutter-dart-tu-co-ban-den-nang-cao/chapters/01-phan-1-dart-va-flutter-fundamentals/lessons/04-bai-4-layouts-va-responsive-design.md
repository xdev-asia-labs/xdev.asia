...
description: >-
  行、列、堆疊、擴充、靈活。容器、填充物、SizedBox。 ListView、GridView、CustomScrollView、Slivers。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 4 課：佈局與響應式設計</tspan>
  </text>
...
<h2 id="1-row-column"><strong>1. 列和行</strong></h2>
...
<h2 id="2-stack"><strong>2. 堆疊和定位</strong></h2>
...
<h2 id="3-listview-gridview"><strong>3. 清單視圖和網格視圖</strong></h2>
...
<h2 id="4-slivers"><strong>4. CustomScrollView 和 Slivers</strong></h2>
...
<h2 id="5-responsive"><strong>5.響應式設計</strong></h2>
