...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 程式設計 — 第 5 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 5 課：Pydantic V2 - 資料驗證和</tspan>
      <tspan x="60" dy="42">序列化</tspan>
  </text>
...
<h2 id="1-pydantic-v2-overview"><strong>1.Pydantic V2 - 概述</strong></h2>

<p>Pydantic V2 是最快的 Python 資料驗證函式庫，以 Rust (pydantic-core) 重寫了核心。 FastAPI 使用 Pydantic 處理所有事情：要求驗證、回應序列化、設定管理。</p>

<h3 id="v1-vs-v2"><strong>從 V1 到 V2 的主要變化：</strong></h3>

<ul>
<li>用 Rust 寫的核心 → 速度提高 5-50 倍</li>
<li><code>模型_驗證（）</code> 相反 <code>解析_obj()</code></li>
<li><code>模型轉儲（）</code> 相反 <code>.dict()</code></li>
<li><code>model_dump_json()</code> 相反 <code>.json()</code></li>
<li><code>模型配置</code> 相反 <code>類別配置</code></li>
<li><code>@field_validator</code> 相反 <code>@驗證器</code></li>
<li><code>@model_validator</code> 相反 <code>@root_validator</code></li>
</ul>

<h2 id="2-basemodel"><strong>2. 基本BaseModel</strong></h2>
...
<h2 id="3-field-validators"><strong>3. 字段驗證器</strong></h2>
...
<h2 id="4-model-validators"><strong>4. 模型驗證器</strong></h2>
...
<h2 id="5-computed-fields"><strong>5. 計算域</strong></h2>
...
<h2 id="6-nested-models"><strong>6. 嵌套模式與受歧視的聯合</strong></h2>
...
<h2 id="7-custom-types"><strong>7. 自訂類型</strong></h2>
...
<h2 id="8-pydantic-settings"><strong>8. Pydantic 設定</strong></h2>
...
<p>Pydantic V2 是 FastAPI 的核心，提供：</p>

<ul>
<li><strong>基礎模型</strong>：帶有類型提示的資料驗證</li>
<li><strong>現場驗證器</strong>：每個欄位的自訂驗證邏輯</li>
<li><strong>模型驗證器</strong>：跨領域驗證</li>
<li><strong>計算字段</strong>：自動導出值</li>
<li><strong>嵌套模型</strong>：複雜的資料結構</li>
<li><strong>受歧視的工會</strong>：多型模型</li>
<li><strong>自訂類型</strong>：可重複使用的驗證邏輯</li>
<li><strong>設定</strong>：環境變數的設定管理</li>
</ul>

<p>下一篇文章將向您展示如何使用 SQLAlchemy 2.0 非同步連接資料庫。</p>
