...
description: >-
  SQLAlchemy 2.0 ORM 具有宣告式映射、關係式（1-1、1-N、N-N）、具有 asyncpg 的非同步引擎。會話管理，工作單元模式。連接
  PostgreSQL 和 MySQL。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 程式設計 — 第 6 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 6 課：SQLAlchemy 2.0 和非同步資料庫</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 2 部分：Pydantic、資料庫和 ORM</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-sqlalchemy-2-overview"><strong>1.SQLAlchemy 2.0 - 概述</strong></h2>

<p>SQLAlchemy 2.0 是一個新的主要版本，具有許多重要的變更：本機非同步支援、新型查詢 API 和改進的類型提示。這是Python生態系中最受歡迎的ORM。</p>
...
<h2 id="2-database-setup"><strong>2. 使用非同步引擎設定資料庫</strong></h2>
...
<h2 id="3-models"><strong>3. 模型定義</strong></h2>
...
<h2 id="4-async-queries"><strong>4. 非同步查詢</strong></h2>
...
<h2 id="5-fastapi-integration"><strong>5. 與FastAPI集成</strong></h2>
...
<h2 id="6-lifespan"><strong>6. 生命週期事件-資料庫初始化</strong></h2>
...
<ul>
<li><strong>非同步引擎</strong>：使用asyncpg連接資料庫，連接池</li>
<li><strong>聲明式模型</strong>：新的Mapped[]和mapped_column()樣式</li>
<li><strong>人際關係</strong>：一對一、一對多、多對多</li>
<li><strong>非同步查詢</strong>：select()、where()、join()、預先載入</li>
<li><strong>儲存庫模式</strong>：標準CRUD操作</li>
<li><strong>FastAPI集成</strong>：資料庫會話的 Depends()</li>
</ul>

<p>下一篇文章將指導 Alembic 遷移和資料庫播種。</p>
