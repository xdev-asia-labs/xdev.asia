...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 程式設計 — 第 16 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 16 課：文件上傳、快取和深度非同步</tspan>
      <tspan x="60" dy="42">潛水</tspan>
  </text>
...
<h2 id="1-file-upload"><strong>1. 文件上傳</strong></h2>
...
<h2 id="2-redis-caching"><strong>2.Redis緩存</strong></h2>
...
<h3 id="custom-cache"><strong>自訂緩存助手</strong></h3>
...
<h2 id="3-async-deep-dive"><strong>3. 非同步深入研究</strong></h2>

<h3 id="concurrent-tasks"><strong>並發任務</strong></h3>
...
<h3 id="semaphore"><strong>信號量 - 並發限制</strong></h3>
...
<h3 id="async-generator"><strong>用於串流媒體的非同步生成器</strong></h3>
...
<h2 id="4-httpx-client"><strong>4. httpx - 非同步 HTTP 用戶端</strong></h2>
...
<ul>
<li><strong>文件上傳</strong>：單張、多張、串流上傳</li>
<li><strong>Redis快取</strong>: fastapi-cache2 和自訂快取服務</li>
<li><strong>非同步深入研究</strong>：收集、信號量、非同步產生器</li>
<li><strong>httpx</strong>：可重複使用的非同步 HTTP 用戶端</li>
</ul>

<p>下一篇文章將討論大型應用程式的乾淨架構和專案結構。</p>
