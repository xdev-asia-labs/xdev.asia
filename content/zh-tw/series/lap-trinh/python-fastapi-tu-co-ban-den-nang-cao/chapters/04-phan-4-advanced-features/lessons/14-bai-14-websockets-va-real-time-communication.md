...
<h2 id="1-websocket-basics"><strong>1. FastAPI 中的 WebSocket 基礎知識</strong></h2>
...
<h2 id="2-connection-manager"><strong>2. 連接管理器</strong></h2>
...
<h2 id="3-chat-room"><strong>3. 即時聊天室</strong></h2>
...
<h2 id="4-notifications"><strong>4. 即時通知</strong></h2>
...
<h2 id="5-sse"><strong>5. 伺服器發送事件（SSE）</strong></h2>
...
<h2 id="6-websocket-vs-sse"><strong>6. WebSocket vs SSE vs 長輪詢</strong></h2>

<table>
<thead>
<tr><th>特點</th><th>WebSockets</th><th>上證所</th><th>長輪詢</th></tr>
</thead>
<tbody>
<tr><td>方向</td><td>雙向</td><td>伺服器→客戶端</td><td>請求-回應</td></tr>
<tr><td>協定</td><td>WS/WSS</td><td>HTTP協定</td><td>HTTP協定</td></tr>
<tr><td>重新連接</td><td>手冊</td><td>自動（瀏覽器）</td><td>手冊</td></tr>
<tr><td>二進位數據</td><td>是的</td><td>否（僅文字）</td><td>是的</td></tr>
<tr><td>代理支援</td><td>有時會出現問題</td><td>滿</td><td>滿</td></tr>
<tr><td>使用案例</td><td>聊天、遊戲</td><td>通知、提要</td><td>簡單的更新</td></tr>
</tbody>
</table>
...
<ul>
<li><strong>WebSocket 端點</strong>：雙向即時通訊</li>
<li><strong>連線管理器</strong>：管理連線、房間、用戶</li>
<li><strong>聊天室</strong>：即時聊天房間模式</li>
<li><strong>通知</strong>：透過WebSocket推播通知</li>
<li><strong>上證所</strong>：伺服器發送的單向流事件</li>
</ul>

<p>下一篇文章將了解後台任務和 Celery。</p>
