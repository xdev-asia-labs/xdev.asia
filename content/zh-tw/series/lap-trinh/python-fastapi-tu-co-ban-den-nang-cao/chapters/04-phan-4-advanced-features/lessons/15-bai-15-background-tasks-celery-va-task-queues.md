...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 程式設計 — 第 15 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：後台任務、Celery 和任務</tspan>
      <tspan x="60" dy="42">佇列</tspan>
  </text>
...
<h2 id="1-background-tasks"><strong>1.FastAPI後台任務</strong></h2>

<p>FastAPI 具有內建的背景任務，用於在發送回應後執行的輕量級任務：</p>
...
<h3 id="khi-nao-background-tasks"><strong>何時使用後台任務？</strong></h3>

<ul>
<li>✅ 輕量、快速的任務（幾秒鐘）：發送電子郵件、日誌、更新快取</li>
<li>❌ 繁重、耗時的任務（分鐘/小時）：ML 訓練、視訊處理 → 使用 Celery</li>
<li>❌ 任務需要重試、調度→使用Celery</li>
</ul>

<h2 id="2-celery-setup"><strong>2.芹菜設置</strong></h2>
...
<h2 id="3-celery-tasks"><strong>3.芹菜任務</strong></h2>
...
<h2 id="4-fastapi-celery"><strong>4. 將 Celery 與 FastAPI 集成</strong></h2>
...
<h2 id="5-celery-beat"><strong>5. Celery Beat - 規劃任務</strong></h2>
...
<h2 id="6-chay-celery"><strong>6.運行芹菜</strong></h2>
...
<ul>
<li><strong>後台任務</strong>：內建用於輕型任務</li>
<li><strong>芹菜</strong>：針對繁重任務的分散式任務佇列</li>
<li><strong>任務重試</strong>：指數退避重試策略</li>
<li><strong>任務進度</strong>：追蹤長時間運行任務的進度</li>
<li><strong>芹菜節拍</strong>：計劃和周期性任務</li>
<li><strong>Docker 組合</strong>：使用 FastAPI 運行 Celery</li>
</ul>

<p>下一篇文章將深入了解文件上傳、快取和非同步。</p>
