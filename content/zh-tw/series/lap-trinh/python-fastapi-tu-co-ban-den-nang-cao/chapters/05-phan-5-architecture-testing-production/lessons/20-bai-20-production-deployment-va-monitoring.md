...
description: >-
  使用 Nginx 反向代理將 FastAPI 部署到生產環境。使用 structlog 進行結構化日誌記錄。 Prometheus 指標和 Grafana
  儀表板。使用 Sentry 追蹤時出錯。效能調整和擴展策略。
duration_minutes: 160
is_free: true
video_url: null
sort_order: 20
section_title: 第 5 部分：架構、測試與生產
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 20 課：生產部署與監控</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：架構、測試與生產</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-nginx-reverse-proxy"><strong>1.Nginx反向代理</strong></h2>
...
<h2 id="2-structured-logging"><strong>2. 使用 structlog 進行結構化日誌記錄</strong></h2>
...
<h2 id="3-prometheus-metrics"><strong>3. 普羅米修斯指標</strong></h2>
...
<h2 id="4-grafana-dashboard"><strong>4.Grafana儀表板</strong></h2>
...
<h2 id="5-sentry"><strong>5. 使用 Sentry 進行錯誤追蹤</strong></h2>
...
<h2 id="6-health-check"><strong>6. 健康檢查端點</strong></h2>
...
<h2 id="7-performance-tuning"><strong>7. 效能調優</strong></h2>
...
<h2 id="8-scaling"><strong>8. 擴展策略</strong></h2>
...
<table>
<thead>
<tr><th>面積</th><th>策略</th></tr>
</thead>
<tbody>
<tr><td>應用程式介面</td><td>水平縮放（多個實例）</td></tr>
<tr><td>資料庫</td><td>讀取副本、連接池 (PgBouncer)</td></tr>
<tr><td>快取</td><td>Redis叢集、快取失效策略</td></tr>
<tr><td>後台工作</td><td>芹菜工自動秤</td></tr>
<tr><td>靜態文件</td><td>CDN（Cloudflare、CloudFront）</td></tr>
<tr><td>搜尋</td><td>Elasticsearch/美麗搜索</td></tr>
</tbody>
</table>

<h2 id="tong-ket"><strong>系列概要</strong></h2>

<p>透過 20 堂課，您已經掌握了使用 FastAPI 建立生產就緒的 REST API 所需的所有知識：</p>

<ul>
<li><strong>第 1 部分</strong>：Python平台、FastAPI核心、請求/回應</li>
<li><strong>第2部分</strong>：Pydantic V2、SQLAlchemy 2.0、Alembic、儲存庫模式</li>
<li><strong>第三部分</strong>：JWT 身份驗證、RBAC、安全、社交登錄</li>
<li><strong>第 4 部分</strong>：中間件、WebSockets、Celery、快取、非同步</li>
<li><strong>第五部分</strong>：清潔架構、測試、Docker、CI/CD、生產</li>
</ul>

<p>FastAPI 與強大的 Python 生態系統結合，可建立易於維護和擴展的高效能應用程式。</p>
