...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 程式設計 — 第 17 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 17 課：清潔架構與項目</tspan>
      <tspan x="60" dy="42">結構</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 5 部分：架構、測試與生產</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-clean-architecture"><strong>1. FastAPI 的簡潔架構</strong></h2>

<p>乾淨的架構（Uncle Bob）將應用程式分成獨立的層，使其易於測試、維護和擴展：</p>
...
<h2 id="2-project-structure"><strong>2. 模組化專案結構</strong></h2>
...
<h2 id="3-app-factory"><strong>3.應用工廠模式</strong></h2>
...
<h2 id="4-module-pattern"><strong>4. 模組模式</strong></h2>
...
<h2 id="5-api-versioning"><strong>5.API版本控制</strong></h2>
...
<ul>
<li><strong>乾淨的架構</strong>：4 個清晰分離的層</li>
<li><strong>模組化結構</strong>：基於功能的模組</li>
<li><strong>應用工廠</strong>：創建靈活、易於測試的應用程式</li>
<li><strong>模組模式</strong>：路由器→服務→儲存庫→模型</li>
<li><strong>API版本控制</strong>：基於 URL 的版本控制</li>
</ul>
