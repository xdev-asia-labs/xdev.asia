...
description: >-
  FastAPI 的 Docker 多階段建置。 Docker Compose 用於開發和生產。 GitHub Actions CI/CD
  管道。自動化測試、檢查和部署工作流程。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 19 課：FastAPI 的 Dockerize 與 CI/CD</tspan>
  </text>
...
<h2 id="1-dockerfile"><strong>1. Dockerfile多階段構建</strong></h2>
...
<h2 id="4-makefile"><strong>4. 開發者體驗的Makefile</strong></h2>
...
<h2 id="5-pre-commit"><strong>5. 預提交掛鉤</strong></h2>
...
<ul>
<li><strong>Docker 多階段</strong>：輕量級構建，生產就緒（非 root，健康檢查）</li>
<li><strong>Docker 組合</strong>：全端（App + DB + Redis + Celery）</li>
<li><strong>GitHub 操作</strong>：Lint → 測試 → 建置 → 部署管道</li>
<li><strong>產生檔案</strong>：開發者快捷方式</li>
<li><strong>預提交</strong>：在提交之前強制執行程式碼品質</li>
</ul>
