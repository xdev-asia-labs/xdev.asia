...
description: >-
  FastAPI、JWT 存取權杖和刷新令牌中的 OAuth2 密碼流。使用 Passlib/Bcrypt 進行密碼雜湊。令牌輪換、黑名單。 OpenAPI
  中的安全方案。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 程式設計 — 第 9 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 9 課：使用 OAuth2 和 JWT 進行身份驗證</tspan>
  </text>
...
<h2 id="1-auth-overview"><strong>1.FastAPI中的身份驗證</strong></h2>

<p>FastAPI 支援多種符合 OpenAPI/OAuth2 標準的身份驗證方案。在本文中，我們將實作基於 JWT 的身份驗證 - REST API 最受歡迎的方法。</p>

<h3 id="cai-dat"><strong>安裝依賴項</strong></h3>

<pre><code class="language-bash">uv add python-jose[cryptography] passlib[bcrypt] python-multipart
</code></pre>

<h2 id="2-password-hashing"><strong>2. 密碼哈希</strong></h2>
...
<h2 id="3-auth-schemas"><strong>3. 授權模式</strong></h2>
...
<h2 id="4-auth-dependencies"><strong>4. 身份驗證依賴項</strong></h2>
...
<h2 id="5-auth-routes"><strong>5. 認證路由</strong></h2>
...
<h2 id="6-protected-routes"><strong>6. 在路由中使用身份驗證</strong></h2>
...
<h2 id="7-token-blacklist"><strong>7. 代幣黑名單（高級）</strong></h2>
...
<p>在本文中，我們實作了完整的身份驗證：</p>

<ul>
<li><strong>密碼哈希</strong>：透過 Passlib 進行 Bcrypt</li>
<li><strong>JWT 令牌</strong>：訪問令牌+刷新令牌</li>
<li><strong>OAuth2</strong>：根據OpenAPI標準的密碼流程</li>
<li><strong>身份驗證依賴項</strong>：取得目前用戶、取得選用用戶</li>
<li><strong>代幣輪換</strong>：刷新token機制</li>
<li><strong>代幣黑名單</strong>：基於Redis的註銷</li>
</ul>

<p>下一篇文章將使用RBAC實現授權。</p>
