...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 10 課：授權 - RBAC 和權限</tspan>
  </text>
...
<h2 id="1-rbac-overview"><strong>1.基於角色的存取控制（RBAC）</strong></h2>

<p>RBAC是最受歡迎的權限模型，其中權限分配給角色，使用者分配給角色。 FastAPI 沒有內建 RBAC，但透過依賴注入部署非常簡單。</p>

<h2 id="2-role-models"><strong>2. RBAC 的資料庫模型</strong></h2>
...
<h2 id="3-rbac-dependencies"><strong>3.RBAC依賴關係</strong></h2>
...
<h2 id="4-su-dung-rbac"><strong>4. 在路由中使用 RBAC</strong></h2>
...
<h2 id="5-resource-ownership"><strong>5. 資源所有權檢查</strong></h2>
...
<h2 id="6-seed-permissions"><strong>6. 種子角色和權限</strong></h2>
...
<p>在這篇文章中，我們建立了一個完整的授權系統：</p>

<ul>
<li><strong>RBAC模型</strong>：使用者→角色→權限（多對多）</li>
<li><strong>角色檢查器</strong>：依賴性檢查角色</li>
<li><strong>權限檢查器</strong>：依賴檢查權限</li>
<li><strong>資源所有權</strong>：只有所有者或管理員可以編輯/刪除</li>
<li><strong>播種</strong>：腳本種子角色和權限</li>
</ul>

<p>下一篇文章將重點放在安全最佳實踐上。</p>
