...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 2 課：FastAPI 的 Python 基礎知識</tspan>
  </text>
...
<h2 id="1-type-hints"><strong>1. 類型提示－FastAPI 的基礎</strong></h2>

<p>類型提示是 FastAPI 所依賴的 Python 最重要的功能。 FastAPI 使用類型提示自動驗證資料、產生文件並提供編輯器支援。</p>

<h3 id="basic-types"><strong>基本類型</strong></h3>
...
<h3 id="collection-types"><strong>集合類型 (Python 3.9+)</strong></h3>
...
<h3 id="advanced-types"><strong>進階類型</strong></h3>
...
<h2 id="2-dataclasses"><strong>2. 資料類</strong></h2>

<p>Dataclasses 是 Pydantic 模型的前身，有助於建立整齊儲存資料的類別：</p>
...
<h2 id="3-decorators"><strong>3. 裝飾器</strong></h2>

<p>FastAPI 大量使用裝飾器（<code>@app.get()</code>, <code>@app.post()</code>，...）。需要了解裝飾器：</p>
...
<h2 id="4-context-managers"><strong>4. 上下文管理器</strong></h2>

<p>上下文管理器在 FastAPI 中對於資料庫會話、文件處理非常重要：</p>
...
<h2 id="5-generators"><strong>5. 生成器和非同步生成器</strong></h2>

<p>FastAPI 使用生成器進行依賴注入和流響應：</p>
...
<h2 id="6-async-await"><strong>6. 基本異步/等待</strong></h2>

<p>非同步/等待是FastAPI的核心功能。正確的理解將有助於編寫有效的程式碼：</p>
...
<h3 id="sync-vs-async"><strong>何時在 FastAPI 中使用非同步與同步？</strong></h3>
...
<h2 id="7-virtual-environments"><strong>7. 虛擬環境與依賴管理</strong></h2>

<h3 id="uv"><strong>紫外線（建議 - 2026）</strong></h3>
...
<h3 id="poetry"><strong>詩歌</strong></h3>
...
<h2 id="8-project-structure"><strong>8. 專案基本結構</strong></h2>
...
<p>在本文中，我們回顧了 FastAPI 使用的重要 Python 功能：</p>

<ul>
<li><strong>類型提示</strong>：自動驗證和文件平台</li>
<li><strong>資料類</strong>：Pydantic 模型的前身</li>
<li><strong>裝飾器</strong>：FastAPI 用於路由定義的模式</li>
<li><strong>內容管理器</strong>：管理資源（資料庫會話、文件）</li>
<li><strong>發電機</strong>：用於依賴注入和串流媒體</li>
<li><strong>異步/等待</strong>：FastAPI高性能的核心</li>
</ul>

<p>下一篇文章將指導您安裝和初始化實際的 FastAPI 專案。</p>
