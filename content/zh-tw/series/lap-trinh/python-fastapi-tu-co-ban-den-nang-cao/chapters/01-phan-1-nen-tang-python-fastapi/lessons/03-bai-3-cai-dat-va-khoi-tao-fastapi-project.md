...
description: 安裝FastAPI和Uvicorn，初始化專案結構，了解標準目錄結構。運行開發伺服器、Swagger UI、ReDoc 並編寫第一個 API 端點。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 3
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 程式設計 — 第 3 課</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 3 課：安裝並初始化 FastAPI 項目</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第 1 部分：Python 基礎和 FastAPI</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">亞洲開發網</text>
</svg>

<h2 id="1-cai-dat-moi-truong"><strong>1.安裝開發環境</strong></h2>

<h3 id="yeu-cau-he-thong"><strong>系統需求</strong></h3>

<ul>
<li><strong>Python 3.12+</strong> （建議3.12或3.13）</li>
<li><strong>紫外線</strong> 或 <strong>詩歌</strong> 用於依賴管理</li>
<li><strong>VS程式碼</strong> 或 <strong>皮查姆</strong> 帶有Python擴展</li>
<li><strong>git</strong> 用於版本控制</li>
</ul>

<h3 id="cai-dat-python"><strong>安裝Python 3.12+</strong></h3>
...
<h3 id="cai-dat-uv"><strong>UV 設定（建議）</strong></h3>
...
<h2 id="2-khoi-tao-project"><strong>2.初始化FastAPI項目</strong></h2>
...
<p>文件 <code>pyproject.toml</code> 初始化後：</p>
...
<h2 id="3-cau-truc-project"><strong>三、項目結構</strong></h2>
...
<h2 id="4-viet-fastapi-app"><strong>4. 編寫第一個 FastAPI 應用程式</strong></h2>

<h3 id="config"><strong>app/config.py - 配置</strong></h3>
...
<h3 id="schemas"><strong>app/schemas/item.py - Pydantic 模式</strong></h3>
...
<h3 id="routes"><strong>app/api/v1/items.py - 路由處理程序</strong></h3>
...
<h3 id="main"><strong>app/main.py - 入口點</strong></h3>
...
<h2 id="5-chay-server"><strong>5. 運行開發伺服器</strong></h2>
...
<h3 id="uvicorn-options"><strong>Uvicorn 選項很重要</strong></h3>
...
<h2 id="6-swagger-ui-redoc"><strong>6. 探索 Swagger UI 和 ReDoc</strong></h2>

<p>運行伺服器後，訪問：</p>

<ul>
<li><strong>招搖的使用者介面</strong>： <code>http://localhost:8000/docs</code> - 互動式API文檔</li>
<li><strong>重新文檔</strong>： <code>http://localhost:8000/redoc</code> - 替代文檔</li>
<li><strong>開放API JSON</strong>： <code>http://localhost:8000/openapi.json</code> - 原始 OpenAPI 規範</li>
</ul>

<h3 id="swagger-features"><strong>Swagger UI 允許：</strong></h3>

<ul>
<li>使用 HTTP 方法查看所有 API 端點</li>
<li>查看請求/回應模式</li>
<li><strong>“嘗試一下”</strong> - 直接從瀏覽器呼叫API</li>
<li>查看範例值和驗證規則</li>
</ul>

<h2 id="7-test-api"><strong>7. 使用curl測試API</strong></h2>
...
<h2 id="8-vscode-setup"><strong>8. FastAPI 的 VS Code 設定</strong></h2>
...
<ul>
<li>安裝Python、uv和FastAPI</li>
<li>使用標準目錄結構初始化項目</li>
<li>使用 Pydantic 模式編寫您的第一個 CRUD API 應用程式</li>
<li>運行開發伺服器並探索 Swagger UI</li>
<li>配置 VS Code 以進行 Python 開發</li>
</ul>

<p>下一篇文章將深入探討 FastAPI 中的路徑操作、請求和回應處理。</p>
