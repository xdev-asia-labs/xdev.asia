...
title: 第 15 課：Vibe 編碼全端應用 — 第 2 部分：前端
slug: bai-15-vibe-coding-full-stack-app-phan-2-frontend
description: >-
  使用 React + Next.js + TailwindCSS 和 Vibe Coding 建立前端。元件產生、響應式佈局、表單處理、API
  整合、狀態管理。使用人工智慧測試前端組件。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">💻 程式設計 — 第 15 課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">第 15 課：Vibe 編碼全端應用 — 部分</tspan>
      <tspan x="60" dy="42">2：前端</tspan>
  </text>
...
<h2 id="1-setup-frontend"><strong>1. 設定前端項目</strong></h2>
...
<p>代理模式自動運行 <code>npx 創建下一個應用程式</code>，安裝依賴項，配置TailwindCSS，以及腳手架專案結構。</p>

<h2 id="2-component-generation"><strong>2. 組件生成－Vibe Coding 的力量</strong></h2>
...
<h2 id="3-form-handling"><strong>3. AI 表單處理</strong></h2>
...
<h2 id="4-api-integration"><strong>4.API集成</strong></h2>
...
<h2 id="5-state-management"><strong>5. 使用 Zustand 進行狀態管理</strong></h2>
...
<h2 id="6-responsive-design"><strong>6.響應式設計</strong></h2>
...
<p>Copilot 根據螢幕尺寸產生反應斷點和條件渲染。</p>

<h2 id="7-dark-mode"><strong>7. 深色模式</strong></h2>
...
<h2 id="8-testing-frontend"><strong>8. 測試前端組件</strong></h2>
...
<h2 id="9-debug-voi-copilot"><strong>9. 使用 Copilot 調試前端</strong></h2>
...
<p>Copilot 分析錯誤、尋找根本原因並修復程式碼 - 通常會新增空檢查和載入狀態。</p>
...
<p>前端 Vibe 編碼非常強大，因為 UI 元件是 <strong>模式重複很多</strong> — AI 擅長產生重複的 UI 程式碼。</p>

<p>下一篇：擴展至 <strong>行動和跨平台</strong> — 使用 Vibe 編碼回應 Native 和 Flutter。</p>
