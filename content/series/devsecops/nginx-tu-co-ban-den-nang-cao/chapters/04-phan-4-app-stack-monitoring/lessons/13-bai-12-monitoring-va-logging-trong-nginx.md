...
description: >-
  Bài học về Monitoring và Logging trong Nginx - access logs analysis, custom
  log formats, log rotation với logrotate, real-time monitoring tools,
  Prometheus + Grafana integration, ELK Stack (Elasticsearch, Logstash, Kibana),
  alerting systems, performance metrics và troubleshooting.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 12: Monitoring và Logging trong NGINX</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 4: Application Stack &amp; Monitoring</text>
