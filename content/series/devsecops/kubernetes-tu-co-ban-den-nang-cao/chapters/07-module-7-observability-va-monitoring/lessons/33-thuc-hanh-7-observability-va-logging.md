...
title: 'BÀI 32: THỰC HÀNH — OBSERVABILITY VÀ LOGGING'
slug: thuc-hanh-7-observability-va-logging
description: >-
  Bài thực hành Module 7: Deploy kube-prometheus-stack, cài Loki + Grafana Alloy, cài Tempo với OTel
  auto-instrumentation, tạo Grafana dashboard correlated metrics/logs/traces, tạo alerting rule.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🔒 DevSecOps — Bài 32</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">BÀI 32: THỰC HÀNH — OBSERVABILITY VÀ</tspan>
...
<ul>
  <li>Deploy full PLG stack với kube-prometheus-stack + Loki + Tempo</li>
  <li>Thu thập logs với Grafana Alloy</li>
  <li>Auto-instrument ứng dụng với OpenTelemetry Operator</li>
  <li>Tạo alerting rule và Slack notification</li>
  <li>Debug bằng correlated observability</li>
</ul>
...
<h2>Lab 2: Tạo ServiceMonitor cho Custom App</h2>
...
<h2>Lab 3: AlertManager — Slack Notification</h2>
...
<h2>Lab 4: Deploy Loki + Grafana Alloy</h2>
...
<h2>Lab 5: Viết LogQL Queries</h2>
...
<h2>Lab 6: Deploy Tempo và OTel Auto-instrumentation</h2>
...
<ul>
  ...
  <li>✅ ServiceMonitor cho custom app metrics</li>
  <li>✅ AlertManager: routing + Slack notifications</li>
  <li>✅ Loki + Grafana Alloy: log aggregation</li>
  <li>✅ LogQL queries từ đơn giản đến phức tạp</li>
