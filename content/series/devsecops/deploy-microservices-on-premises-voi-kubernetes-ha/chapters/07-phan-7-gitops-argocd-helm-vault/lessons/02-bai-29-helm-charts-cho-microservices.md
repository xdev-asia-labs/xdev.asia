...
title: 'BÀI 29: HELM CHARTS CHO MICROSERVICES — TEMPLATE, VALUES, DEPENDENCIES'
slug: bai-29-helm-charts-cho-microservices
description: >-
  Build reusable Helm charts cho microservices: template functions,
  values management, chart dependencies, library charts,
  Helmfile multi-environment, và best practices.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🔒 DevSecOps — Bài 29</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">BÀI 29: HELM CHARTS CHO MICROSERVICES —</tspan>
...
<ul>
<li>✅ Helm chart structure và template engine</li>
<li>✅ Build reusable microservice base chart</li>
<li>✅ Values management: defaults, overrides, environments</li>
<li>✅ Chart dependencies và library charts</li>
<li>✅ Helmfile cho multi-environment deployment</li>
<li>✅ Best practices: linting, testing, packaging</li>
</ul>

<hr>

<h2 id="phan-1-structure">PHẦN 1: HELM CHART STRUCTURE</h2>
...
<h2 id="phan-2-templates">PHẦN 2: TEMPLATES CHI TIẾT</h2>
...
<h2 id="phan-3-multi-env">PHẦN 3: MULTI-ENVIRONMENT MANAGEMENT</h2>
...
<h2 id="phan-4-helmfile">PHẦN 4: HELMFILE — MULTI-SERVICE DEPLOYMENT</h2>
...
<h2 id="phan-5-testing">PHẦN 5: HELM TESTING & CI</h2>
...
<ol>
<li><strong>Base chart</strong>: 1 reusable chart cho tất cả microservices</li>
...
<li><strong>Testing</strong>: Lint + template + unit test trong CI</li>
</ol>
...
<h3 id="bt1">Bài tập 1: Build Base Chart</h3>
<ul>
<li>Create microservice Helm chart</li>
<li>Deploy 3 services using same chart with different values</li>
<li>Add HPA, PDB templates</li>
</ul>

<h3 id="bt2">Bài tập 2: Helmfile Multi-env</h3>
<ul>
...
<p>Trong <strong>Bài 30: Secrets Management với HashiCorp Vault</strong>, chúng ta sẽ cấu hình centralized secrets management.</p>
