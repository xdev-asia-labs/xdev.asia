...
title: 'BÀI 31: CI/CD PIPELINE — BUILD, TEST, DEPLOY VỚI GITOPS'
slug: bai-31-cicd-pipeline-build-test-deploy-voi-gitops
description: >-
  Xây dựng complete CI/CD pipeline: GitHub Actions build & test,
  container image build, vulnerability scanning, GitOps trigger,
  ArgoCD auto-deploy, và promotion workflow.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🔒 DevSecOps — Bài 31</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">BÀI 31: CI/CD PIPELINE — BUILD, TEST,</tspan>
      <tspan x="60" dy="42">DEPLOY VỚI GITOPS</tspan>
  </text>
...
<ul>
<li>✅ Thiết kế CI/CD pipeline cho microservices + GitOps</li>
<li>✅ GitHub Actions: build, test, lint, scan</li>
<li>✅ Container image build với multi-stage Dockerfile</li>
...
<h2 id="phan-1-pipeline-design">PHẦN 1: CI/CD + GITOPS PIPELINE DESIGN</h2>
...
<h2 id="phan-2-dockerfile">PHẦN 2: MULTI-STAGE DOCKERFILE</h2>
...
<h2 id="phan-3-github-actions">PHẦN 3: GITHUB ACTIONS CI PIPELINE</h2>
...
<h2 id="phan-4-promotion">PHẦN 4: ENVIRONMENT PROMOTION</h2>
...
<h2 id="phan-5-harbor">PHẦN 5: PRIVATE REGISTRY (HARBOR)</h2>
...
<h3 id="bt1">Bài tập 1: Complete Pipeline</h3>
<ul>
...
<h3 id="bt2">Bài tập 2: Promotion Workflow</h3>
<ul>
...
<p>Trong <strong>Bài 32: Prometheus Stack — Monitoring Infrastructure</strong>, chúng ta sẽ setup observability stack với Prometheus, Grafana, và Alertmanager.</p>
