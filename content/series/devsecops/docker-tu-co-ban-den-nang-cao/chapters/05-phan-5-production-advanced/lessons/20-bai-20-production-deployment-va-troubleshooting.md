...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5758" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5758)"/>

  <!-- Decorations -->
  <g>
    <circle cx="980" cy="90" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="860" cy="110" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="740" cy="130" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="620" cy="150" r="28" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🔒 DevSecOps — Bài 20</text>
