...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 Lập trình — Bài 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 16: File Upload, Caching &amp; Async Deep</tspan>
...
<h3 id="semaphore"><strong>Semaphore - Giới hạn concurrency</strong></h3>
...
<h3 id="async-generator"><strong>Async Generator cho Streaming</strong></h3>
...
<p>Trong bài này đã đi sâu vào:</p>

<ul>
<li><strong>File Upload</strong>: Single, multiple, streaming upload</li>
<li><strong>Redis Caching</strong>: fastapi-cache2 và custom cache service</li>
...
<p>Bài tiếp theo sẽ bàn về Clean Architecture và Project Structure cho large-scale apps.</p>
