...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 Lập trình — Bài 6</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 6: SQLAlchemy 2.0 &amp; Async Database</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 2: Pydantic, Database &amp; ORM</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-sqlalchemy-2-overview"><strong>1. SQLAlchemy 2.0 - Tổng quan</strong></h2>

<p>SQLAlchemy 2.0 là phiên bản major mới với nhiều thay đổi quan trọng: native async support, new-style query API, và improved type hints. Đây là ORM phổ biến nhất trong Python ecosystem.</p>
...
<h2 id="2-database-setup"><strong>2. Database Setup với Async Engine</strong></h2>
...
<h2 id="3-models"><strong>3. Định nghĩa Models</strong></h2>
...
<h2 id="5-fastapi-integration"><strong>5. Tích hợp với FastAPI</strong></h2>
...
<h2 id="6-lifespan"><strong>6. Lifespan Events - Khởi tạo Database</strong></h2>
...
<ul>
<li><strong>Async Engine</strong>: Kết nối database với asyncpg, connection pooling</li>
<li><strong>Declarative Models</strong>: Mapped[] và mapped_column() style mới</li>
...
<li><strong>Repository Pattern</strong>: CRUD operations chuẩn</li>
<li><strong>FastAPI Integration</strong>: Depends() cho database session</li>
</ul>

<p>Bài tiếp theo sẽ hướng dẫn Alembic migrations và database seeding.</p>
