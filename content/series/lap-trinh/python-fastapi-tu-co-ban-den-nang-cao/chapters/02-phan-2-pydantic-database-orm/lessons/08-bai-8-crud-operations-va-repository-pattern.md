...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 Lập trình — Bài 8</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 8: CRUD Operations &amp; Repository</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 2: Pydantic, Database &amp; ORM</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-dependency-injection"><strong>1. Dependency Injection trong FastAPI</strong></h2>

<p>FastAPI có hệ thống Dependency Injection (DI) mạnh mẽ thông qua <code>Depends()</code>. DI giúp tái sử dụng logic, tách concerns, và dễ dàng testing.</p>
...
<h2 id="3-specific-repository"><strong>3. Specific Repository (kế thừa Generic)</strong></h2>
...
<p>Trong bài này đã xây dựng kiến trúc hoàn chỉnh:</p>

<ul>
<li><strong>Dependency Injection</strong>: Depends() cho DI trong FastAPI</li>
<li><strong>Generic Repository</strong>: Base CRUD operations tái sử dụng</li>
<li><strong>Specific Repository</strong>: Custom queries kế thừa Generic</li>
<li><strong>Service Layer</strong>: Business logic tách biệt</li>
<li><strong>CRUD API</strong>: RESTful endpoints hoàn chỉnh</li>
<li><strong>Pagination</strong>: Generic paginated response</li>
<li><strong>Custom Exceptions</strong>: Structured error handling</li>
</ul>

<p>Bài tiếp theo sẽ triển khai Authentication với OAuth2 và JWT.</p>
