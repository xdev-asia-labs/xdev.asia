...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 4: Generics, Packages &amp; Modules</tspan>
  </text>
...
<h2 id="1-generics"><strong>1. Generics trong Go (Go 1.18+)</strong></h2>

<p>Generics cho phép viết functions và types hoạt động với nhiều types khác nhau mà vẫn giữ type safety. Trước Go 1.18, phải dùng <code>interface{}</code> hoặc code generation.</p>
...
<li><strong>slices/maps packages</strong>: Generic helper functions cho collections (Go 1.21+)</li>
...
<p>Phần tiếp theo: <strong>Goroutines & Channels</strong> — sức mạnh concurrency của Go, biến Go thành lựa chọn hàng đầu cho hệ thống hiệu suất cao.</p>
