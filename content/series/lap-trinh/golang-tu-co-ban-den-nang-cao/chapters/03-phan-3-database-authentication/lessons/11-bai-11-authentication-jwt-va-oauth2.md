...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 Lập trình — Bài 11</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 11: Authentication - JWT &amp; OAuth2</tspan>
  </text>
...
<h2 id="1-password-hashing"><strong>1. Password Hashing với bcrypt</strong></h2>
...
<h3 id="2-2-token-service"><strong>2.2. Token Service</strong></h3>
...
<ul>
<li><strong>Passwords</strong>: bcrypt (cost ≥ 10), KHÔNG md5/sha256 alone</li>
<li><strong>JWT</strong>: Short-lived access tokens (15 min), long-lived refresh tokens (7 days)</li>
<li><strong>Token rotation</strong>: Issue new token pair khi refresh</li>
<li><strong>Secrets</strong>: Dùng env vars, KHÔNG hardcode trong code</li>
<li><strong>HTTPS</strong>: Luôn dùng HTTPS trong production</li>
<li><strong>Rate limiting</strong>: Limit login attempts (brute force protection)</li>
<li><strong>Error messages</strong>: Generic "Invalid credentials", không tiết lộ email tồn tại</li>
</ul>

<p>Bài tiếp theo: <strong>Authorization, Security & Middleware</strong> — RBAC, Casbin, và security nâng cao.</p>
