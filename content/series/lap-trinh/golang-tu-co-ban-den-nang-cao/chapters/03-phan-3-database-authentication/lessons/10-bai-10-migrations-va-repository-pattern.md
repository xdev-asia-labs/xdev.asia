...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 10: Migrations &amp; Repository Pattern</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 3: Database &amp; Authentication</text>
...
<p>GORM AutoMigrate tiện cho development nhưng <strong>không phù hợp production</strong> vì không hỗ trợ rollback, không track version, không quản lý schema changes an toàn. Dùng migration tool chuyên dụng.</p>
...
<h3 id="1-2-migrate-in-code"><strong>1.2. Chạy migrations trong code</strong></h3>
...
<h3 id="1-3-makefile"><strong>1.3. Makefile cho migrations</strong></h3>
...
<p>Repository pattern tách biệt data access logic khỏi business logic, giúp code dễ test và maintain.</p>
...
<ul>
<li><strong>Migrations</strong>: golang-migrate cho version-controlled schema changes</li>
<li><strong>Repository pattern</strong>: Interface + implementation, tách data access</li>
<li><strong>Service layer</strong>: Business logic, validation, orchestration</li>
<li><strong>Dependency Injection</strong>: Manual (nhỏ), Wire/Fx (lớn)</li>
<li><strong>Clean Architecture</strong>: Handler → Service → Repository → Model</li>
</ul>

<p>Bài tiếp theo: <strong>Authentication - JWT & OAuth2</strong> — bảo mật API với JWT tokens.</p>
