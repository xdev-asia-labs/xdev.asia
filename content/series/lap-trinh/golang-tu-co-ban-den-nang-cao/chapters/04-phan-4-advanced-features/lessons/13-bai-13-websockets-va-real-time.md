...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 13: WebSockets &amp; Real-time</tspan>
  </text>
...
<p>WebSocket cung cấp kết nối full-duplex giữa client và server trên một TCP connection duy nhất. Khác với HTTP request/response, WebSocket cho phép server chủ động push data đến client.</p>

<table>
<thead><tr><th>Feature</th><th>HTTP</th><th>WebSocket</th></tr></thead>
<tbody>
<tr><td>Connection</td><td>Short-lived</td><td>Persistent</td></tr>
<tr><td>Direction</td><td>Client → Server</td><td>Bi-directional</td></tr>
<tr><td>Protocol</td><td>HTTP/1.1, HTTP/2</td><td>ws://, wss://</td></tr>
<tr><td>Overhead</td><td>Headers mỗi request</td><td>Minimal frame header</td></tr>
<tr><td>Use case</td><td>REST API</td><td>Chat, notifications, live data</td></tr>
</tbody>
</table>
...
<h3 id="3-1-hub"><strong>3.1. Hub (quản lý connections)</strong></h3>
...
<h3 id="3-3-handler"><strong>3.3. WebSocket Handler với Gin</strong></h3>
...
<h2 id="5-scaling-websockets"><strong>5. Scaling WebSockets với Redis Pub/Sub</strong></h2>
...
<p>Bài tiếp theo: <strong>gRPC & Protocol Buffers</strong> — high-performance RPC communication.</p>
