...
video_url: null
sort_order: 4
section_title: "Phần 2: Speech Recognition (ASR) — Nhận dạng Giọng nói"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🧠 AI &amp; ML — Bài 4</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 5: Whisper &amp; Modern ASR — OpenAI</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 2: Speech Recognition (ASR) — Nhận dạng Giọng nói</text>
...
Whisper & Modern ASR — OpenAI Whisper Deep Dive là một chủ đề quan trọng trong lĩnh vực AI hiện đại.
