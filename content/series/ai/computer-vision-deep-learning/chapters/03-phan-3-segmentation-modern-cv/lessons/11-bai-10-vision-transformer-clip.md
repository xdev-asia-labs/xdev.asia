...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🧠 AI &amp; ML — Bài 9</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 10: Vision Transformer (ViT) &amp; CLIP</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Computer Vision với Deep Learning: Từ CNN đến Vision Transformer</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 3: Segmentation &amp; Modern CV</text>
...
|--|-------------|-------------------|
| **Inductive bias** | Translation invariance, locality | Ít bias → cần nhiều data hơn |
| **Data cần** | Ít (<1M ảnh) | Nhiều (>10M ảnh) |
| **Scalability** | Đỉnh ở ~150 layers | Scale tốt: ViT-G (2B params) |
| **Global context** | Cần nhiều layers | Self-attention ngay (mọi patch nói chuyện) |
...
| Concept | Ghi nhớ |
|---------|---------|
| **ViT** | Transformer cho ảnh: chia patches → self-attention |
| **Patch Embedding** | Ảnh 224×224 → 196 patches (16×16 each) → embed |
| **CLIP** | Kết nối text + image trong cùng embedding space |
| **Zero-shot** | Classify ảnh KHÔNG cần train — chỉ cần text labels |
| **Image Search** | Encode ảnh + text → cosine similarity → tìm kiếm |
