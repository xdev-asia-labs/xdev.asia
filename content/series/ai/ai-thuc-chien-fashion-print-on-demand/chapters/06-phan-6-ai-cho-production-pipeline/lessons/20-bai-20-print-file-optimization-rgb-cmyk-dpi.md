...
title: 'Bài 20: Print File Optimization — RGB→CMYK, DPI, Super Resolution'
slug: bai-20-print-file-optimization-rgb-cmyk-dpi
description: >-
  Chuyển design từ screen (RGB) sang print-ready (CMYK),
  đảm bảo DPI, AI upscale với Real-ESRGAN, color profile
  management. ICC profile, gamut mapping.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 20: Print File Optimization —</tspan>
...
Design đẹp trên màn hình chưa chắc đẹp khi in. Bài này xử lý **print production pipeline**: convert RGB → CMYK đúng chuẩn, đảm bảo DPI tối thiểu 300, và AI upscale design low-res bằng Real-ESRGAN.
...
2. **Real-ESRGAN** — AI upscale 4x, multi-pass cho > 4x
3. **Color conversion** — ICC profile RGB→CMYK, gamut check
4. **Print export** — TIFF/PDF, 300 DPI, LZW compression

Bài tiếp theo: **AI Auto-Tagging** — tự động gắn tag và phân loại design.
