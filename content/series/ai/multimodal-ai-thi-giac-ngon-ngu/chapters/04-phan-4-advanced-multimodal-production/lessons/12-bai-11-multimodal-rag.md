...
title: "Bài 11: Multimodal RAG — Retrieval with Images & Documents"
slug: bai-11-multimodal-rag
description: >-
  Visual document retrieval. ColPali. Multimodal embeddings. Image + text RAG pipeline. PDF parsing + VLM.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 11: Multimodal RAG — Retrieval with</tspan>
      <tspan x="60" dy="42">Images &amp; Documents</tspan>
  </text>
...
Multimodal RAG — Retrieval with Images & Documents là một chủ đề quan trọng trong lĩnh vực AI hiện đại.
