...
title: "Bài 17: Multi-tenant RBAC — Tenant Isolation & Permissions"
slug: bai-17-multi-tenant-rbac
description: >-
  Multi-tenant architecture: tenant isolation, data partitioning.
  RBAC system: roles, permissions, policies. 60 granular permissions,
  4 system roles. Tenant settings, usage quotas, billing.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">🧠 AI &amp; ML — Bài 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 17: Multi-tenant RBAC — Tenant</tspan>
