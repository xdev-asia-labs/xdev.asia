...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6429" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6429)"/>

  <!-- Decorations -->
  <g>
    <circle cx="952" cy="86" r="20" fill="#f87171" opacity="0.11"/>
    <circle cx="804" cy="278" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="656" cy="210" r="32" fill="#f87171" opacity="0.13"/>
    <circle cx="1008" cy="142" r="8" fill="#f87171" opacity="0.09"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 4: Feature Engineering cho Time Series</tspan>
  </text>
