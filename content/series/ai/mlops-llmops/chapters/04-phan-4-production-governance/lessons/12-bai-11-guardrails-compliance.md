...
description: >-
  ...
  content filtering, hallucination detection. Compliance: GDPR, data
  retention. Responsible AI practices. NeMo Guardrails, Guardrails AI.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 11: Guardrails, Safety &amp; Compliance</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 4: Production &amp; Governance</text>
...
LLM có thể:
- 🔓 Bị **jailbreak** → output harmful content
- 🤥 **Hallucinate** → đưa thông tin sai
- 🔐 **Leak PII** → lộ thông tin cá nhân
- 💸 **Bị abuse** → tốn tiền API vô ích

**Guardrails** = hàng rào bảo vệ cho LLM applications. Bắt buộc trong production.

> 🎯 **Mục tiêu:** Implement input validation, output filtering, và safety checks cho LLM apps.
...
1. **Input Guards:** Implement prompt injection detector (regex + LLM-based). Test với 20 attack prompts.
2. **PII:** Build PII detector & masker cho Vietnamese (email, phone, CCCD). Test accuracy.
...
> **Bài tiếp theo:** Capstone — Xây ML Platform từ Scratch.
