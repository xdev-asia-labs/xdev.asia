...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 6: Xây dựng ETL Pipeline — Từ dữ liệu</tspan>
      <tspan x="60" dy="42">nguồn sang OMOP CDM</tspan>
  </text>
...
|------|----------|--------|
| Extract | SQL queries từ source DB | Raw data |
| Transform | Code mapping, type conversion, cleaning | CDM-ready data |
| Load | Insert vào OMOP CDM tables (đúng thứ tự FK) | OMOP CDM populated |
