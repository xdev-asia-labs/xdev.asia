...
title: 'Bài 9: Multi-channel Sales — Shopify, Etsy, Amazon, TikTok Shop & API Integration'
slug: bai-9-multi-channel-sales-integration
description: >-
  Kiến trúc multi-channel sales cho POD, integration với Shopify, Etsy, Amazon,
  TikTok Shop, WooCommerce, product listing sync, order routing,
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Kiến trúc — Bài 9</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 9: Multi-channel Sales — Shopify,</tspan>
...
<h2 id="4-order-routing"><strong>4. Order Routing từ Channels</strong></h2>
...
<table>
<thead>
<tr><th>Feature</th><th>Shopify</th><th>Etsy</th><th>Amazon</th><th>TikTok Shop</th><th>WooCommerce</th></tr>
</thead>
<tbody>
...
<tr><td>Webhook</td><td>Yes (HMAC)</td><td>Limited</td><td>SQS/SNS</td><td>Yes</td><td>Yes (JWT)</td></tr>
