...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-3987" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-3987)"/>

  <!-- Decorations -->
  <g>
    <circle cx="917" cy="281" r="20" fill="#a78bfa" opacity="0.060000000000000005"/>
    <circle cx="734" cy="278" r="11" fill="#a78bfa" opacity="0.07"/>
    <circle cx="1051" cy="275" r="32" fill="#a78bfa" opacity="0.08"/>
    <circle cx="868" cy="272" r="23" fill="#a78bfa" opacity="0.09"/>
    ...
    <polygon points="1063.5166604983954,228 1063.5166604983954,254 1041,267 1018.4833395016046,254 1018.4833395016046,228 1041,215" fill="none" stroke="#a78bfa" stroke-width="1" opacity="0.12"/>
  </g>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Kiến trúc — Bài 19</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 19: Noisy Neighbor &amp; Resource</tspan>
...
Noisy neighbor problem là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Noisy Neighbor & Resource Isolation. Các key takeaways:
