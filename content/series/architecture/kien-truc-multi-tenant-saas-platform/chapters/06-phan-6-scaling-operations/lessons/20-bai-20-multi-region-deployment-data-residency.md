...
video_url: null
sort_order: 20
section_title: "Phần 6: Scaling & Operations"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-9463" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-9463)"/>

  <!-- Decorations -->
  <g>
    <circle cx="830" cy="200" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1060" cy="170" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="790" cy="140" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1020" cy="110" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="750" cy="80" r="8" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Kiến trúc — Bài 20</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 20: Multi-region Deployment &amp; Data</tspan>
      <tspan x="60" dy="42">Residency</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 6: Scaling &amp; Operations</text>
...
## 1. Multi-region SaaS deployment

### 1.1 Khái niệm cơ bản

Multi-region SaaS deployment là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Data residency requirements (GDPR, local laws)
...
## 3. Tenant routing to nearest region
...
## 4. Cross-region replication strategies.
...
Trong bài học này, chúng ta đã tìm hiểu về Multi-region Deployment & Data Residency. Các key takeaways:
