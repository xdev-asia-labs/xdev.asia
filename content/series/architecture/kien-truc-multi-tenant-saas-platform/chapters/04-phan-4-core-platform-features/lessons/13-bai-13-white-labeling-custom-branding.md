...
## 1. White-label architecture: custom domains, logo, colors, email templates

### 1.1 Khái niệm cơ bản

White-label architecture: custom domains, logo, colors, email templates là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về White-labeling & Custom Branding. Các key takeaways:
