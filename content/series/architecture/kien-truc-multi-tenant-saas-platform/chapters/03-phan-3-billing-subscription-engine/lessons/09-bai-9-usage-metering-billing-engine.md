...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8863" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8863)"/>

  <!-- Decorations -->
  <g>
    <circle cx="801" cy="113" r="34" fill="#34d399" opacity="0.08"/>
    <circle cx="1002" cy="54" r="17" fill="#34d399" opacity="0.11"/>
    <circle cx="703" cy="255" r="30" fill="#34d399" opacity="0.14"/>
    <circle cx="904" cy="196" r="13" fill="#34d399" opacity="0.07"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 9: Usage Metering &amp; Billing Engine</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 3: Billing &amp; Subscription Engine</text>
...
## 1. Usage-based billing: metering infrastructure, aggregation pipelines

### 1.1 Khái niệm cơ bản

Usage-based billing: metering infrastructure, aggregation pipelines là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. Proration cho upgrades/downgrades
...
Trong bài học này, chúng ta đã tìm hiểu về Usage Metering & Billing Engine. Các key takeaways:
