...
video_url: null
sort_order: 16
section_title: "Phần 5: Data & API Platform"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 16: Data Import/Export &amp; Migration</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 5: Data &amp; API Platform</text>
...
## 1. Bulk data import với streaming

### 1.1 Khái niệm cơ bản

Bulk data import với streaming là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. Data migration từ competitor platforms
...
## 4. ETL pipelines cho tenant data.
...
Trong bài học này, chúng ta đã tìm hiểu về Data Import/Export & Migration Tools. Các key takeaways:
