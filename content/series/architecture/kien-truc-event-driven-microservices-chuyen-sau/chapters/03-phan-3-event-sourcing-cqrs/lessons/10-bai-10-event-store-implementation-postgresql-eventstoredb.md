...
video_url: null
sort_order: 10
section_title: "Phần 3: Event Sourcing & CQRS"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-9678" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-9678)"/>

  <!-- Decorations -->
  <g>
    <circle cx="819" cy="187" r="32" fill="#818cf8" opacity="0.12000000000000001"/>
    <circle cx="1038" cy="66" r="29" fill="#818cf8" opacity="0.09"/>
    <circle cx="757" cy="205" r="26" fill="#818cf8" opacity="0.060000000000000005"/>
    <circle cx="976" cy="84" r="23" fill="#818cf8" opacity="0.13"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 10: Event Store Implementation -</tspan>
      <tspan x="60" dy="42">PostgreSQL &amp; EventStoreDB</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="244" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Kiến trúc Event-Driven Microservices chuyên sâu</text>

  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 3: Event Sourcing &amp; CQRS</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Bài 10: Event Store Implementation - PostgreSQL & EventStoreDB](/storage/uploads/2026/03/edm-bai-10-diagram.png)
...
## 1. Implementing event store: PostgreSQL-based (outbox), EventStoreDB, Axon Server

### 1.1 Khái niệm cơ bản

Implementing event store: PostgreSQL-based (outbox), EventStoreDB, Axon Server là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Event Store Implementation - PostgreSQL & EventStoreDB. Các key takeaways:
