...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5020" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5020)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1010" cy="120" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="920" cy="150" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="830" cy="180" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="740" cy="210" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="650" cy="240" r="8" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Kiến trúc — Bài 7</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 7: Schema Registry &amp; Data</tspan>
...
## 1. Schema Registry: Avro, Protobuf, JSON Schema

### 1.1 Khái niệm cơ bản

Schema Registry: Avro, Protobuf, JSON Schema là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Schema Registry & Data Serialization. Các key takeaways:
