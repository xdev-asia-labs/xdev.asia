...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-74" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-74)"/>

  <!-- Decorations -->
  <g>
    <circle cx="846" cy="288" r="24" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="1092" cy="114" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="838" cy="200" r="10" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="1084" cy="286" r="18" fill="#2dd4bf" opacity="0.07"/>
    <circle cx="830" cy="112" r="26" fill="#2dd4bf" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🏗️ Kiến trúc — Bài 4</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 4: Kafka Architecture - Brokers,</tspan>
      <tspan x="60" dy="42">Partitions &amp; Replication</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 2: Apache Kafka Deep Dive</text>
...
## 1. Kafka internals: broker architecture, topic partitions, replication factor

### 1.1 Khái niệm cơ bản

Kafka internals: broker architecture, topic partitions, replication factor là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Kafka Architecture - Brokers, Partitions & Replication. Các key takeaways:
