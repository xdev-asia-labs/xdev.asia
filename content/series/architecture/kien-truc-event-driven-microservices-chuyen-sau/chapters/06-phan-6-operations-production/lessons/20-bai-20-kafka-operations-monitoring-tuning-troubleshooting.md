...
video_url: null
sort_order: 20
section_title: "Phần 6: Operations & Production"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-873" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-873)"/>

  <!-- Decorations -->
  <g>
    <circle cx="671" cy="143" r="14" fill="#34d399" opacity="0.08"/>
    <circle cx="742" cy="94" r="17" fill="#34d399" opacity="0.11"/>
    <circle cx="813" cy="45" r="20" fill="#34d399" opacity="0.14"/>
    <circle cx="884" cy="256" r="23" fill="#34d399" opacity="0.07"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 20: Kafka Operations - Monitoring,</tspan>
      <tspan x="60" dy="42">Tuning &amp; Troubleshooting</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 6: Operations &amp; Production</text>
...
## 1. Kafka operations: monitoring (JMX, Prometheus), performance tuning

### 1.1 Khái niệm cơ bản

Kafka operations: monitoring (JMX, Prometheus), performance tuning là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Kafka Operations - Monitoring, Tuning & Troubleshooting. Các key takeaways:
