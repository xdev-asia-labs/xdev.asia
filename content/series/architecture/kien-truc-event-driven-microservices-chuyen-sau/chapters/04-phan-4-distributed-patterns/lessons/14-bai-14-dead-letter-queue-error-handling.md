...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4760" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4760)"/>

  <!-- Decorations -->
  <g>
    <circle cx="769" cy="197" r="12" fill="#818cf8" opacity="0.12000000000000001"/>
    <circle cx="938" cy="166" r="29" fill="#818cf8" opacity="0.09"/>
    <circle cx="607" cy="135" r="16" fill="#818cf8" opacity="0.060000000000000005"/>
    <circle cx="776" cy="104" r="33" fill="#818cf8" opacity="0.13"/>
    <circle cx="945" cy="73" r="20" fill="#818cf8" opacity="0.1"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 14: Dead Letter Queue &amp; Error Handling</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 4: Distributed Patterns</text>
...
## 1. Dead Letter Queue (DLQ) patterns

### 1.1 Khái niệm cơ bản

Dead Letter Queue (DLQ) patterns là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Dead Letter Queue & Error Handling. Các key takeaways:
