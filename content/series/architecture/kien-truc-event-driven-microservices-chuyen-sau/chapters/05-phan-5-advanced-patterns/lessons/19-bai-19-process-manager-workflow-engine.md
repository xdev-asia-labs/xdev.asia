...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Decorations -->
  <g>
    <circle cx="960" cy="50" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="820" cy="230" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="680" cy="150" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1040" cy="70" r="18" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 19: Process Manager &amp; Workflow Engine</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 5: Advanced Patterns</text>
...
## 1. Process Manager pattern: long-running business processes as state machines

### 1.1 Khái niệm cơ bản

Process Manager pattern: long-running business processes as state machines là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Process Manager & Workflow Engine. Các key takeaways:
