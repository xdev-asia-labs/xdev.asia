...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8334" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8334)"/>

  <!-- Decorations -->
  <g>
    <circle cx="648" cy="134" r="26" fill="#fbbf24" opacity="0.09"/>
    <circle cx="696" cy="82" r="20" fill="#fbbf24" opacity="0.13"/>
    <circle cx="744" cy="30" r="14" fill="#fbbf24" opacity="0.07"/>
    <circle cx="792" cy="238" r="8" fill="#fbbf24" opacity="0.11"/>
    <circle cx="840" cy="186" r="32" fill="#fbbf24" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ Kiến trúc — Bài 18</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 18: Event Versioning &amp; Schema</tspan>
      <tspan x="60" dy="42">Evolution</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 5: Advanced Patterns</text>
...
## 1. Event versioning strategies: weak schema, upcasting, event adapters

### 1.1 Khái niệm cơ bản

Event versioning strategies: weak schema, upcasting, event adapters là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Event Versioning & Schema Evolution. Các key takeaways:
