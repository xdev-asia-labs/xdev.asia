...
## 1. Phân tích event-driven thực tế: Uber (event sourcing ride matching), Wix (event-driven platform), Booking.com (Kafka at scale), LinkedIn (Kafka origin)

### 1.1 Khái niệm cơ bản

Phân tích event-driven thực tế: Uber (event sourcing ride matching), Wix (event-driven platform), Booking.com (Kafka at scale), LinkedIn (Kafka origin) là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Case Studies - Uber, Wix, Booking.com & LinkedIn. Các key takeaways:
