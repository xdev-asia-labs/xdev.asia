...
video_url: null
sort_order: 24
section_title: "Phần 7: Case Studies"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8060" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8060)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1089" cy="57" r="12" fill="#818cf8" opacity="0.12000000000000001"/>
    <circle cx="1078" cy="66" r="29" fill="#818cf8" opacity="0.09"/>
    <circle cx="1067" cy="75" r="16" fill="#818cf8" opacity="0.060000000000000005"/>
    <circle cx="1056" cy="84" r="33" fill="#818cf8" opacity="0.13"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">🏗️ Kiến trúc — Bài 24</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 24: Apache Pulsar &amp; Alternatives</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Kiến trúc Event-Driven Microservices chuyên sâu</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 7: Case Studies</text>
...
## 1. Apache Pulsar: multi-tenancy, tiered storage, geo-replication

### 1.1 Khái niệm cơ bản

Apache Pulsar: multi-tenancy, tiered storage, geo-replication là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Apache Pulsar & Alternatives. Các key takeaways:
