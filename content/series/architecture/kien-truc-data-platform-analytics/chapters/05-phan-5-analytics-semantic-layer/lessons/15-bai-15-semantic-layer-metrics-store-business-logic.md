...
video_url: null
sort_order: 15
section_title: "Phần 5: Analytics & Semantic Layer"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2793" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2793)"/>

  <!-- Decorations -->
  <g>
    <circle cx="872" cy="106" r="20" fill="#f87171" opacity="0.11"/>
    <circle cx="644" cy="218" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="916" cy="70" r="32" fill="#f87171" opacity="0.13"/>
    <circle cx="688" cy="182" r="8" fill="#f87171" opacity="0.09"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 15: Semantic Layer - Metrics Store &amp;</tspan>
      <tspan x="60" dy="42">Business Logic</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 5: Analytics &amp; Semantic Layer</text>
...
## 1. Semantic layer: single source of truth for metrics

### 1.1 Khái niệm cơ bản

Semantic layer: single source of truth for metrics là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. Metric definitions, dimensions, measures
...
Trong bài học này, chúng ta đã tìm hiểu về Semantic Layer - Metrics Store & Business Logic. Các key takeaways:
