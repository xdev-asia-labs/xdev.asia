...
video_url: null
sort_order: 2
section_title: "Phần 1: Data Platform Foundations"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8103" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8103)"/>

  <!-- Decorations -->
  <g>
    <circle cx="904" cy="62" r="32" fill="#f472b6" opacity="0.07"/>
    <circle cx="708" cy="246" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="1012" cy="170" r="26" fill="#f472b6" opacity="0.11"/>
    <circle cx="816" cy="94" r="8" fill="#f472b6" opacity="0.13"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ Kiến trúc — Bài 2</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 2: Data Lakehouse Architecture -</tspan>
      <tspan x="60" dy="42">Iceberg, Delta Lake &amp; Hudi</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="244" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Kiến trúc Data Platform &amp; Analytics</text>

  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 1: Data Platform Foundations</text>
...
## 1. Data Lakehouse: kết hợp tốt nhất của DW và Data Lake

### 1.1 Khái niệm cơ bản

Data Lakehouse: kết hợp tốt nhất của DW và Data Lake là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Apache Iceberg, Delta Lake, Apache Hudi
...
## 3. Table formats, ACID transactions trên object storage.
...
Trong bài học này, chúng ta đã tìm hiểu về Data Lakehouse Architecture - Iceberg, Delta Lake & Hudi. Các key takeaways:
