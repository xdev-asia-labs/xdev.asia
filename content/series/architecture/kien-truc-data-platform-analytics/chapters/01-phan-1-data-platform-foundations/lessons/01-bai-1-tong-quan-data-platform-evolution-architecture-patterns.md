...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Kiến trúc — Bài 1</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 1: Tổng quan Data Platform - Evolution</tspan>
      <tspan x="60" dy="42">&amp; Architecture Patterns</tspan>
  </text>
...
Evolution: Data Warehouse → Data Lake → Data Lakehouse → Data Mesh là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. Data Platform architecture patterns và team topology.
...
Trong bài học này, chúng ta đã tìm hiểu về Tổng quan Data Platform - Evolution & Architecture Patterns. Các key takeaways:
