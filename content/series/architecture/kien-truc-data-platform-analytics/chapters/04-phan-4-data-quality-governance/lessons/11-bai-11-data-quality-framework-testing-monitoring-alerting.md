...
video_url: null
sort_order: 11
section_title: "Phần 4: Data Quality & Governance"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4233" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4233)"/>

  <!-- Decorations -->
  <g>
    <circle cx="864" cy="82" r="32" fill="#f472b6" opacity="0.07"/>
    <circle cx="628" cy="186" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="892" cy="30" r="26" fill="#f472b6" opacity="0.11"/>
    <circle cx="656" cy="134" r="8" fill="#f472b6" opacity="0.13"/>
    <circle cx="920" cy="238" r="20" fill="#f472b6" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ Kiến trúc — Bài 11</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 11: Data Quality Framework - Testing,</tspan>
      <tspan x="60" dy="42">Monitoring &amp; Alerting</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 4: Data Quality &amp; Governance</text>
...
## 1. Data quality dimensions: accuracy, completeness, timeliness

### 1.1 Khái niệm cơ bản

Data quality dimensions: accuracy, completeness, timeliness là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Great Expectations, dbt tests, Soda
...
Trong bài học này, chúng ta đã tìm hiểu về Data Quality Framework - Testing, Monitoring & Alerting. Các key takeaways:
