...
video_url: null
sort_order: 19
section_title: "Phần 6: ML & Data Platform"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Decorations -->
  <g>
    <circle cx="682" cy="276" r="20" fill="#f87171" opacity="0.11"/>
    <circle cx="764" cy="98" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="846" cy="180" r="32" fill="#f87171" opacity="0.13"/>
    <circle cx="928" cy="262" r="8" fill="#f87171" opacity="0.09"/>
    <circle cx="1010" cy="84" r="14" fill="#f87171" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Kiến trúc — Bài 19</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 19: ML Pipeline Integration - Training</tspan>
      <tspan x="60" dy="42">&amp; Serving Data</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 6: ML &amp; Data Platform</text>
...
## 1. Data platform cho ML: training data preparation, labeling pipelines

### 1.1 Khái niệm cơ bản

Data platform cho ML: training data preparation, labeling pipelines là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về ML Pipeline Integration - Training & Serving Data. Các key takeaways:
