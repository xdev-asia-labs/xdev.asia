...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Kiến trúc — Bài 5</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 5: Stream Processing - Kafka, Flink &amp;</tspan>
      <tspan x="60" dy="42">Real-time Pipeline</tspan>
  </text>
...
## 1. Apache Kafka deep-dive: partitions, consumer groups, exactly-once

### 1.1 Khái niệm cơ bản

Apache Kafka deep-dive: partitions, consumer groups, exactly-once là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Apache Flink: stateful stream processing, windowing, watermarks
...
Trong bài học này, chúng ta đã tìm hiểu về Stream Processing - Kafka, Flink & Real-time Pipeline. Các key takeaways:
