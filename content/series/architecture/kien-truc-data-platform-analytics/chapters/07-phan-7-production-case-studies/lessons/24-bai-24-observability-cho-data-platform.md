...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-3349" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-3349)"/>

  <!-- Decorations -->
  <g>
    <circle cx="905" cy="185" r="28" fill="#fb923c" opacity="0.1"/>
    <circle cx="710" cy="150" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="1015" cy="115" r="18" fill="#fb923c" opacity="0.1"/>
    <circle cx="820" cy="80" r="13" fill="#fb923c" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🏗️ Kiến trúc — Bài 24</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 24: Observability cho Data Platform</tspan>
  </text>
...
Data observability: pipeline monitoring, data freshness, volume anomalies là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. Incident response cho data issues
...
Trong bài học này, chúng ta đã tìm hiểu về Observability cho Data Platform. Các key takeaways:
