...
| Loại Test | Mô tả | Công cụ | Khi nào chạy |
|:---|:---|:---|:---|
| **SAST** | Static Application Security Testing — phân tích source code | SonarQube, Semgrep, SpotBugs | Mỗi commit/PR |
| **DAST** | Dynamic Application Security Testing — test running app | OWASP ZAP, Nuclei, Burp Suite | Mỗi release |
| **IAST** | Interactive — agent trong runtime | Contrast Security | Khi chạy integration tests |
| **SCA** | Software Composition Analysis — dependency check | Snyk, Dependabot, Trivy | Mỗi commit + scheduled |
...
|:---|---:|
| [Bài 22: Container & Kubernetes Security cho Healthcare Workloads](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-22-container-kubernetes-security-healthcare) | [Bài 24: Capstone — Xây dựng Secure Healthcare Microservices Platform](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-24-capstone-xay-dung-secure-healthcare-platform) |
<!-- SERIES-NAV:END -->
