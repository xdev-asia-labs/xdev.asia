...
video_url: null
sort_order: 1
section_title: "Phần 1: EdTech Foundations"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-7363" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-7363)"/>

  <!-- Decorations -->
  <g>
    <circle cx="727" cy="171" r="10" fill="#a78bfa" opacity="0.060000000000000005"/>
    <circle cx="854" cy="218" r="11" fill="#a78bfa" opacity="0.07"/>
    <circle cx="981" cy="265" r="12" fill="#a78bfa" opacity="0.08"/>
    <circle cx="608" cy="52" r="13" fill="#a78bfa" opacity="0.09"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 1: Tổng quan EdTech - Domain Analysis</tspan>
      <tspan x="60" dy="42">&amp; Business Models</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 1: EdTech Foundations</text>
...
## 1. EdTech landscape: MOOCs, corporate training, K-12, language learning

### 1.1 Khái niệm cơ bản

EdTech landscape: MOOCs, corporate training, K-12, language learning là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Business models: subscription, marketplace, freemium
...
Trong bài học này, chúng ta đã tìm hiểu về Tổng quan EdTech - Domain Analysis & Business Models. Các key takeaways:
