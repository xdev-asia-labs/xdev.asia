...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-3533" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-3533)"/>

  <!-- Decorations -->
  <g>
    <circle cx="653" cy="109" r="36" fill="#c084fc" opacity="0.14"/>
    <circle cx="706" cy="222" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="759" cy="75" r="34" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="812" cy="188" r="33" fill="#c084fc" opacity="0.11"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 14: Recommendation Engine - What to</tspan>
      <tspan x="60" dy="42">Learn Next</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 4: Personalization &amp; AI</text>
...
## 1. Course recommendation: collaborative filtering, content-based, hybrid

### 1.1 Khái niệm cơ bản

Course recommendation: collaborative filtering, content-based, hybrid là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Recommendation Engine - What to Learn Next. Các key takeaways:
