...
## 1. Nguyên lý kế toán kép trong FinTech

### 1.1 Khái niệm cơ bản

Nguyên lý kế toán kép trong FinTech là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Thiết kế ledger schema: accounts, journal entries, postings
...
## 4. Chart of Accounts design cho payment platform.
...
Trong bài học này, chúng ta đã tìm hiểu về Double-Entry Ledger System - Accounting Engine. Các key takeaways:
