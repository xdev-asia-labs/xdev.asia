---
id: 019d8a21-c510-70c5-d001-e1f2a3b4c510
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-741" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-741)"/>

  <!-- Decorations -->
  <g>
    <circle cx="833" cy="249" r="26" fill="#c084fc" opacity="0.14"/>
    <circle cx="1066" cy="62" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="799" cy="135" r="14" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="1032" cy="208" r="23" fill="#c084fc" opacity="0.11"/>
    <circle cx="765" cy="281" r="32" fill="#c084fc" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 10: Transaction Processing - ACID,</tspan>
      <tspan x="60" dy="42">Idempotency &amp; Saga Pattern</tspan>
  </text>
...
## 1. Đảm bảo consistency trong financial transactions

### 1.1 Khái niệm cơ bản

Đảm bảo consistency trong financial transactions là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. ACID properties, Saga pattern cho distributed transactions
...
## 3. Idempotency keys và deduplication
...
Trong bài học này, chúng ta đã tìm hiểu về Transaction Processing - ACID, Idempotency & Saga Pattern. Các key takeaways:
