...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 19: Financial Data Pipeline - Event</tspan>
...
## 1. Thiết kế data pipeline cho FinTech

### 1.1 Khái niệm cơ bản

Thiết kế data pipeline cho FinTech là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. Change Data Capture cho ledger replication
...
## 4. Data lake architecture cho financial data.
...
Trong bài học này, chúng ta đã tìm hiểu về Financial Data Pipeline - Event Streaming & CDC. Các key takeaways:
