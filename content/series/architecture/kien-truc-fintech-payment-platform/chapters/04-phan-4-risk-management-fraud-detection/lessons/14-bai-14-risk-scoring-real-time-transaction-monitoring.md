...
video_url: null
sort_order: 14
section_title: "Phần 4: Risk Management & Fraud Detection"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🏗️ Kiến trúc — Bài 14</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 14: Risk Scoring &amp; Real-time</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 4: Risk Management &amp; Fraud Detection</text>
...
## 1. Thiết kế Risk Scoring system

### 1.1 Khái niệm cơ bản

Thiết kế Risk Scoring system là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Real-time transaction monitoring với stream processing
...
Trong bài học này, chúng ta đã tìm hiểu về Risk Scoring & Real-time Transaction Monitoring. Các key takeaways:
