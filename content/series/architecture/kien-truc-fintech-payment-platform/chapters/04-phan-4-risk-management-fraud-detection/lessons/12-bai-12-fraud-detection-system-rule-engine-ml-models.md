---
id: 019d8a21-c512-70c5-d001-e1f2a3b4c512
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Decorations -->
  <g>
    <circle cx="850" cy="140" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="600" cy="90" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="850" cy="40" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="600" cy="250" r="28" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 12: Fraud Detection System - Rule</tspan>
      <tspan x="60" dy="42">Engine &amp; ML Models</tspan>
  </text>
...
## 1. Kiến trúc hệ thống phát hiện gian lận

### 1.1 Khái niệm cơ bản

Kiến trúc hệ thống phát hiện gian lận là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Rule-based engine với dynamic rules
...
## 3. Machine Learning models cho fraud detection
...
Trong bài học này, chúng ta đã tìm hiểu về Fraud Detection System - Rule Engine & ML Models. Các key takeaways:
