...
## 1. Thiết kế KYC pipeline: identity verification, document validation

### 1.1 Khái niệm cơ bản

Thiết kế KYC pipeline: identity verification, document validation là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Anti-Money Laundering (AML) & KYC Pipeline. Các key takeaways:
