---
id: 019d8a21-c516-70c5-d001-e1f2a3b4c516
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2490" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2490)"/>

  <!-- Decorations -->
  <g>
    <circle cx="832" cy="146" r="20" fill="#f87171" opacity="0.11"/>
    <circle cx="1064" cy="98" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="796" cy="50" r="32" fill="#f87171" opacity="0.13"/>
    <circle cx="1028" cy="262" r="8" fill="#f87171" opacity="0.09"/>
    <circle cx="760" cy="214" r="14" fill="#f87171" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 16: Lending Platform - Loan</tspan>
      <tspan x="60" dy="42">Origination &amp; Underwriting</tspan>
  </text>
...
## 1. Thiết kế Lending Platform end-to-end

### 1.1 Khái niệm cơ bản

Thiết kế Lending Platform end-to-end là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Loan origination system (LOS): application, verification, approval workflow
...
Trong bài học này, chúng ta đã tìm hiểu về Lending Platform - Loan Origination & Underwriting. Các key takeaways:
