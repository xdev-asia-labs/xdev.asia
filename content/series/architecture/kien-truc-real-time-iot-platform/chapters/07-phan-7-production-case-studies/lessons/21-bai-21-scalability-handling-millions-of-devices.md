...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Decorations -->
  <g>
    <circle cx="1094" cy="232" r="32" fill="#f472b6" opacity="0.07"/>
    <circle cx="1088" cy="126" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="1082" cy="280" r="26" fill="#f472b6" opacity="0.11"/>
    <circle cx="1076" cy="174" r="8" fill="#f472b6" opacity="0.13"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ Kiến trúc — Bài 21</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 21: Scalability - Handling Millions of</tspan>
      <tspan x="60" dy="42">Devices</tspan>
  </text>
...
## 1. Scaling IoT platform: connection management, message routing at scale

### 1.1 Khái niệm cơ bản

Scaling IoT platform: connection management, message routing at scale là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 4. Auto-scaling device connections.
...
Trong bài học này, chúng ta đã tìm hiểu về Scalability - Handling Millions of Devices. Các key takeaways:
