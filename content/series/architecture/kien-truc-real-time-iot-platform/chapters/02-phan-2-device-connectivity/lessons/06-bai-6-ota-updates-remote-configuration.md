...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2961" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2961)"/>

  <!-- Decorations -->
  <g>
    <circle cx="873" cy="169" r="26" fill="#c084fc" opacity="0.14"/>
    <circle cx="646" cy="42" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="919" cy="175" r="14" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="692" cy="48" r="23" fill="#c084fc" opacity="0.11"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ Kiến trúc — Bài 6</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 6: OTA Updates &amp; Remote Configuration</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 2: Device &amp; Connectivity</text>
...
## 1. Over-the-Air firmware updates: A/B partition, rollback

### 1.1 Khái niệm cơ bản

Over-the-Air firmware updates: A/B partition, rollback là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về OTA Updates & Remote Configuration. Các key takeaways:
