...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Decorations -->
  <g>
    <circle cx="605" cy="165" r="28" fill="#fb923c" opacity="0.1"/>
    <circle cx="610" cy="210" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="615" cy="255" r="18" fill="#fb923c" opacity="0.1"/>
    <circle cx="620" cy="40" r="13" fill="#fb923c" opacity="0.05"/>
    <circle cx="625" cy="85" r="8" fill="#fb923c" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 4: Device Management - Provisioning,</tspan>
      <tspan x="60" dy="42">Registry &amp; Lifecycle</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 2: Device &amp; Connectivity</text>
...
## 1. Device provisioning: zero-touch, certificate-based

### 1.1 Khái niệm cơ bản

Device provisioning: zero-touch, certificate-based là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. Device lifecycle: onboard, active, maintenance, decommission
...
Trong bài học này, chúng ta đã tìm hiểu về Device Management - Provisioning, Registry & Lifecycle. Các key takeaways:
