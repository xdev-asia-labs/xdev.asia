...
video_url: null
sort_order: 3
section_title: "Phần 1: IoT Foundations"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Kiến trúc — Bài 3</text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 1: IoT Foundations</text>
...
## 1. Thiết kế kiến trúc IoT Platform: cloud-edge hybrid

### 1.1 Khái niệm cơ bản

Thiết kế kiến trúc IoT Platform: cloud-edge hybrid là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Platform Architecture Overview - Cloud-Edge Hybrid. Các key takeaways:
