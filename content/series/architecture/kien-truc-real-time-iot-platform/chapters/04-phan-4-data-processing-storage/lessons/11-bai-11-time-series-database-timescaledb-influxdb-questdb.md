...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8821" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8821)"/>

  <!-- Decorations -->
  <g>
    <circle cx="931" cy="243" r="34" fill="#34d399" opacity="0.08"/>
    <circle cx="762" cy="54" r="17" fill="#34d399" opacity="0.11"/>
    <circle cx="1093" cy="125" r="30" fill="#34d399" opacity="0.14"/>
    <circle cx="924" cy="196" r="13" fill="#34d399" opacity="0.07"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ Kiến trúc — Bài 11</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 11: Time-Series Database -</tspan>
      <tspan x="60" dy="42">TimescaleDB, InfluxDB &amp; QuestDB</tspan>
  </text>
...
Time-series data patterns là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. InfluxDB: Flux query language
...
Trong bài học này, chúng ta đã tìm hiểu về Time-Series Database - TimescaleDB, InfluxDB & QuestDB. Các key takeaways:
