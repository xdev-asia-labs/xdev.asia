...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-9094" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-9094)"/>

  <!-- Decorations -->
  <g>
    <circle cx="819" cy="267" r="22" fill="#818cf8" opacity="0.12000000000000001"/>
    <circle cx="1038" cy="86" r="29" fill="#818cf8" opacity="0.09"/>
    <circle cx="757" cy="165" r="36" fill="#818cf8" opacity="0.060000000000000005"/>
    <circle cx="976" cy="244" r="13" fill="#818cf8" opacity="0.13"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 13: Rule Engine &amp; Complex Event</tspan>
...
## 1. IoT Rule Engine: event-condition-action

### 1.1 Khái niệm cơ bản

IoT Rule Engine: event-condition-action là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Rule Engine & Complex Event Processing. Các key takeaways:
