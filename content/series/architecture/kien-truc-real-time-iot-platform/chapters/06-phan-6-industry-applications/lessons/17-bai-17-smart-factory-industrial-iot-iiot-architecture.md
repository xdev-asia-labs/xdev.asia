...
video_url: null
sort_order: 17
section_title: "Phần 6: Industry Applications"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1450" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1450)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1077" cy="121" r="10" fill="#a78bfa" opacity="0.060000000000000005"/>
    <circle cx="1054" cy="238" r="11" fill="#a78bfa" opacity="0.07"/>
    <circle cx="1031" cy="95" r="12" fill="#a78bfa" opacity="0.08"/>
    <circle cx="1008" cy="212" r="13" fill="#a78bfa" opacity="0.09"/>
    <circle cx="985" cy="69" r="14" fill="#a78bfa" opacity="0.1"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Kiến trúc — Bài 17</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 17: Smart Factory - Industrial IoT</tspan>
      <tspan x="60" dy="42">(IIoT) Architecture</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 6: Industry Applications</text>
...
## 1. IIoT architecture: OPC UA, ISA-95 levels

### 1.1 Khái niệm cơ bản

IIoT architecture: OPC UA, ISA-95 levels là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 4. Quality control với vision AI
...
Trong bài học này, chúng ta đã tìm hiểu về Smart Factory - Industrial IoT (IIoT) Architecture. Các key takeaways:
