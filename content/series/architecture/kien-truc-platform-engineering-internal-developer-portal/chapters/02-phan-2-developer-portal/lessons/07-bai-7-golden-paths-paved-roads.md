...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2039" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2039)"/>

  <!-- Decorations -->
  <g>
    <circle cx="776" cy="218" r="24" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="952" cy="194" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="628" cy="170" r="10" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="804" cy="146" r="18" fill="#2dd4bf" opacity="0.07"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 7: Golden Paths &amp; Paved Roads</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 2: Developer Portal</text>
...
## 1. Golden paths: opinionated default workflows

### 1.1 Khái niệm cơ bản

Golden paths: opinionated default workflows là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 3. Service creation golden path
...
Trong bài học này, chúng ta đã tìm hiểu về Golden Paths & Paved Roads. Các key takeaways:
