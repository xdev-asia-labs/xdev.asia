...
video_url: null
sort_order: 14
section_title: "Phần 4: CI/CD Platform"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5537" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5537)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1032" cy="126" r="30" fill="#f87171" opacity="0.11"/>
    <circle cx="964" cy="158" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="896" cy="190" r="22" fill="#f87171" opacity="0.13"/>
    <circle cx="828" cy="222" r="18" fill="#f87171" opacity="0.09"/>
    <circle cx="760" cy="254" r="14" fill="#f87171" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 14: Container &amp; Image Management</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 4: CI/CD Platform</text>
...
## 1. Container registry (Harbor)

### 1.1 Khái niệm cơ bản

Container registry (Harbor) là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
## 2. Image scanning & signing (Cosign)
...
Trong bài học này, chúng ta đã tìm hiểu về Container & Image Management. Các key takeaways:
