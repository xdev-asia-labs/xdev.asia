...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-3122" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-3122)"/>

  <!-- Decorations -->
  <g>
    <circle cx="814" cy="152" r="12" fill="#f472b6" opacity="0.07"/>
    <circle cx="1028" cy="106" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="742" cy="60" r="16" fill="#f472b6" opacity="0.11"/>
    <circle cx="956" cy="274" r="18" fill="#f472b6" opacity="0.13"/>
    <circle cx="670" cy="228" r="20" fill="#f472b6" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 8: Self-service Infrastructure -</tspan>
      <tspan x="60" dy="42">Provisioning &amp; Management</tspan>
  </text>
...
## 1. Self-service infrastructure: request → approve → provision → manage

### 1.1 Khái niệm cơ bản

Self-service infrastructure: request → approve → provision → manage là một trong những chủ đề quan trọng nhất trong lĩnh vực này. Hiểu rõ các concepts cốt lõi sẽ giúp bạn thiết kế hệ thống đúng đắn ngay từ đầu.
...
Trong bài học này, chúng ta đã tìm hiểu về Self-service Infrastructure - Provisioning & Management. Các key takeaways:
