...
title: 'Bài 15: Analytics & Observability — Conversation Analytics, LLM Metrics & Cost Tracking'
slug: bai-15-analytics-observability
description: >-
  Conversation analytics, LLM observability (latency, tokens, cost), tracing
  pipelines, dashboard design, alerting, A/B testing metrics, ROI measurement.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 15
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Kiến trúc — Bài 15</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 15: Analytics &amp; Observability —</tspan>
      <tspan x="60" dy="42">Conversation Analytics, LLM Metrics &amp; Cost</tspan>
      <tspan x="60" dy="42">Tracking</tspan>
  </text>
...
<h2 id="1-observability-stack"><strong>1. Observability Stack cho AI Chatbot</strong></h2>
...
<h2 id="2-conversation-analytics"><strong>2. Conversation Analytics — Key Metrics</strong></h2>
...
<td>% conversations resolved without human</td>
<td>>70%</td>
</tr>
<tr>
<td><strong>CSAT</strong></td>
<td>Customer satisfaction (thumbs up/down)</td>
<td>>4.0/5.0</td>
</tr>
<tr>
<td><strong>Avg Turns</strong></td>
<td>Average messages per conversation</td>
<td><8</td>
</tr>
<tr>
...
<td>% transferred to human agent</td>
<td><30%</td>
</tr>
<tr>
<td><strong>Containment Rate</strong></td>
<td>% handled entirely by bot</td>
<td>>60%</td>
</tr>
<tr>
<td><strong>Cost per Conversation</strong></td>
<td>Total LLM + infra cost per conv.</td>
<td><$0.05</td>
</tr>
<tr>
...
<h2 id="3-llm-tracing"><strong>3. LLM Call Tracing — Langfuse Integration</strong></h2>
...
<h2 id="4-cost-tracking"><strong>4. Cost Tracking & Optimization</strong></h2>
...
<h2 id="5-alerting"><strong>5. Alerting & Anomaly Detection</strong></h2>
...
<h2 id="tong-ket"><strong>Tổng kết Bài 15</strong></h2>

<ul>
<li><strong>3 Pillars</strong>: Traces (Langfuse), Metrics (Prometheus/Grafana), Logs (ELK/Loki)</li>
<li><strong>Key Metrics</strong>: Resolution rate, CSAT, cost/conversation, hallucination rate, latency</li>
<li><strong>LLM Tracing</strong>: Langfuse traces mỗi call với spans (RAG, guardrail, LLM) + cost scoring</li>
<li><strong>Cost Tracking</strong>: Per-model cost, daily reports, optimization recommendations</li>
<li><strong>Alerting</strong>: Automated alerts cho error rate, latency spikes, cost overrun, quality drops</li>
</ul>

<p><strong>Bài tiếp theo:</strong> Multi-Channel Integration — Omnichannel gateway, Facebook Messenger, Zalo OA, Web Widget, LINE, Slack, Teams.
</p>
