...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Decorations -->
  <g>
    <circle cx="904" cy="42" r="32" fill="#f472b6" opacity="0.07"/>
    <circle cx="708" cy="46" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="1012" cy="50" r="26" fill="#f472b6" opacity="0.11"/>
    <circle cx="816" cy="54" r="8" fill="#f472b6" opacity="0.13"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">📝 Luyện thi — Bài 10</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 10: Cheat Sheet &amp; Chiến lược thi GCP</tspan>
      <tspan x="60" dy="42">MLE</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="244" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Luyện thi Google Cloud Professional Machine Learning Engineer</text>

  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Phần 5: Responsible AI &amp; Ôn tập</text>
