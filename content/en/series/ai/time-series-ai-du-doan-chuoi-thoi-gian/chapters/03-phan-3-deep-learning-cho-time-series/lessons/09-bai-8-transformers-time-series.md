...
title: 'Lesson 8: Transformers for Time Series — PatchTST, iTransformer'
slug: bai-8-transformers-time-series
description: >-
  Transformer adaptation for time series. PatchTST. iTransformer. Informer,
  Autoformer. Channel-independent vs channel-mixing.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Transformers for Time Series —</tspan>
...
Transformer adaptation for time series. PatchTST. iTransformer. Informer, Autoformer. Channel-independent vs channel-mixing.
...
Transformers for Time Series — PatchTST, iTransformer is an important topic in the field of modern AI.
