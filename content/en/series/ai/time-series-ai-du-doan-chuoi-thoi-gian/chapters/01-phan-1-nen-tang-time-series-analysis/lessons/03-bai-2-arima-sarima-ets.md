...
title: 'Lesson 2: Statistical Models — ARIMA, SARIMA & ETS'
slug: bai-2-arima-sarima-ets
description: >-
  ARIMA(p,d,q) model. Seasonal ARIMA. Exponential Smoothing (ETS). Model
  selection: AIC, BIC. statsmodels implementation.
duration_minutes: 150
is_free: true
video_url: null
sort_order: 1
section_title: 'Part 1: Time Series Analysis Foundation'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4317" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4317)"/>

  <!-- Decorations -->
  <g>
    <circle cx="985" cy="45" r="8" fill="#fb923c" opacity="0.1"/>
    <circle cx="870" cy="50" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="755" cy="55" r="8" fill="#fb923c" opacity="0.1"/>
    <circle cx="640" cy="60" r="23" fill="#fb923c" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🧠 AI & ML — Lesson 1</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Statistical Models — ARIMA, SARIMA</tspan>
      <tspan x="60" dy="42">& ETS</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: Time Series Analysis Foundation</text>
...
Statistical Models — ARIMA, SARIMA & ETS is an important topic in the field of modern AI.
