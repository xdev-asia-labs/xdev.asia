...
title: 'Lesson 11: Time Series Classification & Clustering'
slug: bai-11-classification-clustering
description: >-
  DTW distance. Shapelet-based. Rocket/MiniRocket. InceptionTime. Time series
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8755" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8755)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1005" cy="125" r="28" fill="#fb923c" opacity="0.1"/>
    <circle cx="910" cy="70" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="815" cy="275" r="18" fill="#fb923c" opacity="0.1"/>
    <circle cx="720" cy="220" r="13" fill="#fb923c" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: Time Series Classification &</tspan>
      <tspan x="60" dy="42">Clustering</tspan>
  </text>
...
Time Series Classification & Clustering is an important topic in the field of modern AI.
