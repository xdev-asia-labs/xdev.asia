...
title: 'Lesson 10: Anomaly Detection in Time Series'
slug: bai-10-anomaly-detection
description: >-
  Statistical methods: Z-score, IQR. Isolation Forest. Autoencoders for
  anomalies. Transformer-based detection. Real-time monitoring.
duration_minutes: 150
is_free: true
video_url: null
sort_order: 9
section_title: 'Part 4: Application & Production'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-19)"/>

  <!-- Decorations -->
  <g>
    <circle cx="880" cy="130" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="660" cy="250" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="940" cy="110" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="720" cy="230" r="28" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Anomaly Detection in Time</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Application & Production</text>
...
Statistical methods: Z-score, IQR. Isolation Forest. Autoencoders for anomalies. Transformer-based detection. Real-time monitoring.
...
Anomaly Detection in Time Series is an important topic in the field of modern AI.
