...
title: 'Lesson 13: Production Forecasting Pipeline'
slug: bai-13-production-pipeline
description: >-
  MLOps for forecasting. Model monitoring & retraining. Feature store. Batch vs
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Production Forecasting Pipeline</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Application & Production</text>
...
MLOps for forecasting. Model monitoring & retraining. Feature store. Batch vs real-time prediction. Uncertainty quantification.
