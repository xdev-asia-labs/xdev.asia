...
title: 'Lesson 20: Deploying LLMs — Ollama, vLLM, TGI & Evaluation'
slug: bai-20-deploying-llms-va-evaluation
description: >-
  Self-host LLMs with Ollama, vLLM, TGI. Inference optimization: quantization,
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🧠 AI & ML — Lesson 19</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 20: Deploying LLMs — Ollama, vLLM, TGI</tspan>
...
The final lesson of the series takes you into real production: self-host LLMs to control costs and privacy, optimize inference, and systematically evaluate model quality.

---

## 1. Why Self-hosted LLMs?

| | Cloud API | Self-hosted |
|---|---|---|
| Cost | Expensive to scale | Upfront hardware, then cheaper |
| Privacy | Data sent to provider | Data is in your infrastructure |
| Latency | Network dependent | Low latency (local) |
| Customization | Fine-tuned models are difficult to use | Use any model |
| Availability | Depends on provider uptime | Self-control |

**When should you self-host:**
- Healthcare, banking, legal — sensitive data
- Large scale (cost > $1000/month API)
- Need to use separate fine-tuned model

---

## 2. Ollama — Run LLM Local

Ollama is the simplest way to run LLM on laptop/server.
...
vLLM is a production-grade inference engine with **PagedAttention** — efficient KV cache management, high throughput.
...
### GGUF with llama.cpp (CPU-friendly)
...
## 5. Evaluation — LLM Evaluation

### 5.1 BLEU Score (translation, summarization)
...
Congratulations! You have completed **AI & LLM: From Basics to Advanced** — 20 lessons including:
...
**Next step:**
- Build a realistic RAG application for your domain
- Fine-tune an LLM with its own data
- Read papers: "Attention is All You Need", "BERT", "GPT-3", "Chinchilla"
- Join: Hugging Face community, LangChain Discord, AI Papers Club
