...
title: 'Lesson 19: LLM APIs — OpenAI, Anthropic Claude, Google Gemini'
slug: bai-19-llm-apis
description: >-
  Practical integration of LLM APIs: OpenAI GPT-4o, Anthropic Claude, Google
  Gemini. Streaming, structured outputs, vision, tool use, cost optimization.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🧠 AI & ML — Lesson 18</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: LLM APIs — OpenAI, Anthropic</tspan>
...
Instead of deploying the model yourself, you will often call LLM via the API. This article is a practical guide to the three largest providers: OpenAI, Anthropic and Google Gemini — covering streaming, vision, structured output and cost optimization.

---

## 1. Compare Providers (2025)

| Provider | Model | Context | Strengths |
|--------|-------|--------|-----------|
| OpenAI | GPT-4o, o3 | 128K | Tool use, coding, large ecosystem |
...
| Tasks | Hint |
|-------|-------|
| Coding, agents | GPT-4o or Claude Opus |
...
| Streaming UI | All support |

**Next article (end of series):** Deploying self-hosted LLMs with Ollama and vLLM, evaluation and production checklist.
