...
title: 'Lesson 18: AI Agents — Tool Use, Function Calling, Agentic Workflows'
slug: bai-18-ai-agents
description: >-
  Building autonomous AI Agents: Tool Use, Function Calling with OpenAI/Claude
  APIs, ReAct agent, multi-agent systems, memory management with
  LangChain/LangGraph.
duration_minutes: 210
is_free: true
video_url: null
sort_order: 17
section_title: 'Part 5: Building AI Applications'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🧠 AI & ML — Lesson 17</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 18: AI Agents — Tool Use, Function</tspan>
      <tspan x="60" dy="42">Calling, Agentic Workflows</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Building AI Applications</text>
...
AI Agent is an LLM equipped with **action capabilities** — call tools, search the web, run code, read files, call APIs. Instead of just responding, agents can **complete multi-step tasks** autonomously.
...
| Memory | In session | External memory, vector DB |
| Autonomy | Reply 1 time | Loop until task | is completed
| Use cases | Q&A, chat | Research, automation, coding |
...
## 3. Function Calling with Anthropic Claude
...
### 4.2 External Memory with Vector DB
...
LangGraph allows building **stateful agent workflows** with graphs:
...
**Next article:** LLM practical APIs — OpenAI, Anthropic Claude, Google Gemini with streaming, vision and cost optimization.
