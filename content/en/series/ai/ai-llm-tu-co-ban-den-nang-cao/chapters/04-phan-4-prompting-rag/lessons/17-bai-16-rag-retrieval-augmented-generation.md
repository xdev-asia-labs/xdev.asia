...
title: 'Lesson 16: RAG — Retrieval Augmented Generation from A to Z'
slug: bai-16-rag-retrieval-augmented-generation
description: >-
  Comprehensive understanding of the RAG pipeline — from document loading,
  chunking, embedding, vector store, retrieval to generation. Includes advanced
  techniques like HyDE, RAPTOR, Corrective RAG and complete code with LangChain
  + ChromaDB + OpenAI.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: RAG — Retrieval Augmented</tspan>
      <tspan x="60" dy="42">Generation from A to Z</tspan>
  </text>
