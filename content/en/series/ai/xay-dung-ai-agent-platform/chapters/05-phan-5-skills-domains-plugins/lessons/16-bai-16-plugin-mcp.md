...
title: 'Lesson 16: Plugin System & MCP Protocol'
slug: bai-16-plugin-mcp
description: >-
  Plugin architecture: load/unload, sandboxed execution, marketplace. MCP (Model
  Context Protocol): server implementation, tool exposure, resource management.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Plugin System & MCP Protocol</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Skills, Domains & Plugins</text>
