...
title: 'Lesson 12: Workflow Engine — Designing Node-based Automation'
slug: bai-12-workflow-engine
description: >-
  Workflow Engine design: DAG (Directed Acyclic Graph), node types (trigger,
  action, condition, loop). Template resolution, variable interpolation.
  Workflow schema & validation.
duration_minutes: 210
is_free: true
video_url: null
sort_order: 11
section_title: 'Part 4: Workflow Engine'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Workflow Engine — Design</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Workflow Engine</text>
...
Workflow Engine allows users to create automation using visual nodes — drag and drop, connect nodes, define complex logic without code. This article designs the engine from core concepts.
...
- **16 node types** — from LLM calls to HTTP requests
- **Template resolution** — `{{variable}}` interpolation
- **Sandboxed code** — VM isolation for custom code nodes
- **Composable** — sub-workflows for reusability

**Next article:** Workflow Validation & Execution — run end-to-end workflows.
