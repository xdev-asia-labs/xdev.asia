...
description: >-
  Design PostgreSQL schema with Drizzle ORM for config data. MongoDB driver for
  AI/chat data. Migrations, seed data, connection pooling. Database abstraction
  layer.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🧠 AI & ML — Lesson 2</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Dual-Database — PostgreSQL (Drizzle</tspan>
...
| Features | Drizzle | Prisma | TypeORM |
|--------|---------|--------|---------|
