...
title: 'Lesson 18: Chat Channels — Multi-platform Messaging'
slug: bai-18-chat-channels
description: >-
  Channel adapter pattern: Web Chat, Telegram, Slack, Discord, Zalo, Facebook
  Messenger, LINE, WhatsApp. Unified message format, channel-specific features,
  webhook handling.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🧠 AI & ML — Lesson 17</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 18: Chat Channels — Multi-platform</tspan>
