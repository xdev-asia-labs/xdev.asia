...
title: 'Lesson 9: Document Processor — Chunking & Parsing'
slug: bai-9-document-processor
description: >-
  Document processing for RAG: PDF/DOCX/CSV/Markdown parsing. Chunking
  strategies: fixed-size, semantic, recursive. Metadata extraction,
  deduplication.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Document Processor — Chunking &</tspan>
...
RAG (Retrieval-Augmented Generation) starts with document processing — breaking documents into small meaningful chunks for embedding and retrieval. This article implements Document Processor from scratch.
...
**Next article:** Embedding & Vector Store — Convert text into vectors.
