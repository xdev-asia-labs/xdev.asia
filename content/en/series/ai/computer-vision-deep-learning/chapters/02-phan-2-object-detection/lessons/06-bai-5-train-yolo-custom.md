...
description: >-
  End-to-end custom YOLO: collect images, label with Roboflow/CVAT, configure
  YAML dataset, train on Google Colab, evaluate mAP, export model. Use case:
  counting products, detecting production errors.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Training YOLO Custom — Label</tspan>
...
1. **Quick Project:** Load dataset from Roboflow Universe (e.g. "hard hat detection"). Train YOLOv11n. Achieved mAP@50 > 80%.
2. **Custom Dataset:** Take 100 photos of 1 object (for example: cup, pen, water bottle). Label on Roboflow. Train and test.
3. **Comparison:** Train the same dataset as yolo11n, yolo11s, yolo11m. Compare accuracy, speed, model size.
4. **Export Test:** Export to ONNX. Inference using ONNX Runtime. Compare speed with PyTorch.
