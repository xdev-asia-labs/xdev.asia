...
description: >-
  History of YOLO: from YOLOv3 to YOLOv11 (Ultralytics). YOLO architecture,
  anchor boxes, non-max suppression. Hands-on: detect objects with YOLOv8/v11
  pretrained models. Metrics: mAP, IoU, Precision, Recall.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 4: YOLO from v3 to v11 — Theory &</tspan>
      <tspan x="60" dy="42">Practice</tspan>
  </text>
...
| Version | Year | Main contributions | mAP (COCO) |
|--------|-----|----------------|-----------|
| YOLOv1 | 2016 | Original idea — 1 stage detection | 63.4 |
...
| YOLOv5 | 2020 | PyTorch, Ultralytics ecosystem, easy to use | 48.2 |
...
| Concepts | Remember |
|--------|--------|
| **Object Detection** | Find the location (bbox) + label (class) of objects |
| **YOLO** | 1-stage detector, real-time, SOTA |
| **IoU** | Measure overlap between predicted and ground truth box |
| **NMS** | Eliminate duplicate boxes, keep the best boxes |
| **mAP** | Main metric for detection: mean Average Precision |
| **Ultralytics** | Python Library for YOLO — 3 lines of detect code |
