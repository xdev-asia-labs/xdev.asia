...
description: >-
  Meta SAM & SAM2: segment any object without training. Prompt types: point,
  box, text. SAM + YOLO combo. Grounding DINO + SAM. Interactive segmentation
  tool.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🧠 AI & ML — Lesson 7</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: SAM (Segment Anything) — Zero-shot</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Segmentation & Modern CV</text>
...
**SAM — Segment Anything Model** (Meta AI, 2023) is a breakthrough in CV: segmenting **any object** in an image **without training**. Just 1 click (point), 1 box, or 1 text sentence → SAM segment immediately.

> 🎯 **SAM** is like ChatGPT but for segmentation: zero-shot, general-purpose, works on all types of images.

---

## 1. What is SAM?

### 1.1 SAM Architecture
...
| Model | Encoders | Params | Speed ​​| Quality |
|-------|--------|--------|-------|--------|
| SAM ViT-B | ViT-Base | 91M | ⚡ Fast | ⭐⭐⭐ |
| SAM ViT-L | ViT-Large | 308M | 🔥 Medium | ⭐⭐⭐⭐ |
| **SAM ViT-H** | ViT-Huge | **636M** | 🐌 Slow | **⭐⭐⭐⭐⭐** |
| **SAM 2** | Hiera | **Lighter** | **⚡ Faster** | **⭐⭐⭐⭐⭐** |

---

## 2. Hands-on: basic SAM
...
### 2.2 Point Prompt — Click to segment
...
### 2.3 Box Prompt — Draw box to segment
...
### 2.5 Automatic Mask Generation — Segment everything
...
### 4.1 Idea: YOLO detect → SAM segment
...
| **Point Prompt** | Click 1+ points → segment |
| **Box Prompt** | Draw bounding box → segment |
| **Auto Generate** | Segment every object automatically |
| **SAM 2** | 6× fast, video support |
| **YOLO + SAM** | YOLO detect (box) → SAM segment (mask) |

## General exercises

1. **Point Prompt:** Use SAM to segment 5 different objects in 1 image using point prompt.
2. **Auto Segment:** Run Automatic Mask Generation on 3 images. How many segments?
3. **YOLO + SAM:** Build pipeline YOLO detect → SAM segment. Visualize with colored masks.
4. **Background Removal:** Use SAM to separate the object from the background, save a transparent PNG image.

> **Next article:** Image Generation & Stable Diffusion — create images from text with AI.
