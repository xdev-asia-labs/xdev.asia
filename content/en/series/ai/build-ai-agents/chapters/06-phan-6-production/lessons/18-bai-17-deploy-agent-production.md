...
description: >-
  Wrap agent into API with FastAPI. Dockerize, CI/CD pipeline. Deploy to cloud
  (AWS/GCP). Scaling strategies, session management, caching. WebSocket for
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🧠 AI & ML — Lesson 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Deploy Agent to Production —</tspan>
      <tspan x="60" dy="42">FastAPI, Docker & Cloud</tspan>
  </text>
