...
description: >-
  Write an effective System Prompt for agents: define persona, boundary, output
  schema. Chain-of-Thought, few-shot, and format-compliant LLM pressing
  techniques. ReAct prompting pattern.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Prompt Engineering for Agents —</tspan>
...
ReAct = **Re**asoning + **Act**ing — the strongest pattern for agents.
