...
title: 'Lesson 5: Building Custom Tools — Web Search, Code Execution, API Integration'
slug: bai-5-xay-dung-custom-tools
description: >-
  Create complex tools: web scraping, Google Search, Python code sandbox,
  database query, REST API caller. Manage registry tools, error handling, and
  retry logic.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Building Custom Tools — Web Search,</tspan>
