...
title: 'Lesson 8: Medical Q&A & Medical Chatbot'
slug: bai-8-medical-qa-chatbot
description: >-
  Medical questions answered. RAG for healthcare: PubMed retrieval. Fine-tune
  LLM for medical domain. Guardrails, safety for medical chatbots.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🧠 AI & ML — Lesson 7</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Medical Q&A & Medical Chatbot</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Clinical NLP & Genomics AI</text>
