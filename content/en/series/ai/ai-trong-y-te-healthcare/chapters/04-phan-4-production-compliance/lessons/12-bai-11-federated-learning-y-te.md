...
title: 'Lesson 11: Federated Learning for Healthcare'
slug: bai-11-federated-learning-y-te
description: >-
  Federated Learning: train without sharing data. Privacy-preserving AI. Flower
  framework. Multi-hospital collaboration.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: Federated Learning for Healthcare</tspan>
  </text>
...
> 5 hospitals, 5 data silos. No one wants to share patient data. Federated Learning allows for general model training without the data ever leaving the hospital.

---

## 1. Problem: Data Silos in Healthcare
...
Federated Learning can still suffer from **gradient inversion attack**: from the gradient reconstructing the original data.
...
1. Implement FedAvg from scratch (don't use Flower). Simulate 3 hospitals with different dataset sizes (1000, 500, 2000). Compare global model vs best individual model.

2. Add Differential Privacy with Opacus. Train with ε = [0.1, 1.0, 10.0]. Plot accuracy vs ε curve.

3. Implement gradient inversion attack (Zhu et al., 2019) to demonstrate why DP is needed. Reconstruct 1 training image from gradients.

**Lesson 12**: Explainable AI — making doctors trust AI.
