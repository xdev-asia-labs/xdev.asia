...
title: 'Lesson 2: Medical Data — DICOM, HL7 FHIR & Privacy'
slug: bai-2-du-lieu-y-te-dicom-fhir
description: >-
  Medical data formats: DICOM images, HL7 FHIR. EHR systems. De-identification.
  HIPAA compliance. Data pipeline for medical AI.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Medical Data — DICOM, HL7 FHIR &</tspan>
...
1. Download a DICOM sample file from [TCIA (The Cancer Imaging Archive)](https://www.cancerimagingarchive.net/). Open with pydicom and print out the 10 most important tags.
