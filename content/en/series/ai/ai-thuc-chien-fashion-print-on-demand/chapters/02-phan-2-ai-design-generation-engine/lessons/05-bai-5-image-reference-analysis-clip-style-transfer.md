...
title: 'Lesson 5: Image Reference Analysis — CLIP, Style Transfer & Layout Detection'
slug: bai-5-image-reference-analysis-clip-style-transfer
description: >-
  Analyze reference images with CLIP embeddings: extract style, color palette,
  layout. IP-Adapter for style-consistent generation. Layout detection
  determines the design area on the shirt.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Image Reference Analysis — CLIP,</tspan>
