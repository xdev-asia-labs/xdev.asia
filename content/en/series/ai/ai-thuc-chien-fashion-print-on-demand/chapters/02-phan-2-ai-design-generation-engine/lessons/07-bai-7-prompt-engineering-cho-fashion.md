...
description: >-
  Build prompt template system for fashion design. Auto-enhance prompt with LLM.
  Bilingual support (EN/VI). Negative prompt optimization for print quality.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4104" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4104)"/>

  <!-- Decorations -->
  <g>
    <circle cx="807" cy="31" r="20" fill="#a78bfa" opacity="0.060000000000000005"/>
    <circle cx="1014" cy="118" r="11" fill="#a78bfa" opacity="0.07"/>
    <circle cx="721" cy="205" r="32" fill="#a78bfa" opacity="0.08"/>
    <circle cx="928" cy="32" r="23" fill="#a78bfa" opacity="0.09"/>
    <circle cx="635" cy="119" r="14" fill="#a78bfa" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: Prompt Engineering for Fashion —</tspan>
      <tspan x="60" dy="42">Optimize Prompt & Design Variations</tspan>
  </text>
...
Prompt is the interface between user and AI. A good prompt creates great design, a bad prompt creates garbage. This article builds a specialized **Prompt Engineering System** for fashion — including templates, auto-enhance, negative optimization prompt, and bilingual handling.

---

## 1. Fashion Prompt Anatomy

### Effective prompt structure for t-shirt design
...
Prompt Engineering System for fashion:

1. **Prompt anatomy** — structure [Style] + [Subject] + [Details] + [Quality] + [Print]
2. **Auto-enhance** — LLM automatically upgrades the prompt, adding fashion-specific keywords
3. **Template system** — templates for memes, gaming, minimal, streetwear, Japanese
4. **Negative prompt** — optimizes print quality, removes unwanted elements
5. **Variation strategies** — seed, style, color, composition variations

The next article begins **Part 3: AI Design Optimization & Editing** — ensuring designs can be printed realistically.
