...
title: 'Lesson 15: AI Size Recommendation — Body Measurement to Size Prediction'
slug: bai-15-ai-size-recommendation-body-measurement
description: >-
  ML model predicts size from height, weight, body ratio. Multi-fit
  recommendation (M regular, L oversize). Training data collection, model
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🧠 AI & ML — Lesson 14</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: AI Size Recommendation — Body</tspan>
...
1. **Multi-input** — basic height/weight, detailed measurements, or photos
2. **ML model** — GradientBoosting with feature engineering
3. **Multi-fit** — recommend both regular and oversize
4. **Estimation** — estimates measurements missing from height/weight
5. **Feedback loop** — retrain from return/exchange data
