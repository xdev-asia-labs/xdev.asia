...
description: >-
  ...
  recommendation engine. Text rendering pipeline: style transfer for fonts,
  auto-placement on print area.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: AI Typography — Generate Text,</tspan>
      <tspan x="60" dy="42">Font Style & Placement</tspan>
  </text>
...
1. **Text generation** — LLM creates quotes, meme text, slogans
2. **Font recommendation** — font suggestion according to design style
3. **Text rendering** — Pillow/Cairo renders high quality text
4. **Effects** — neon glow, shadow, outline, gradient
5. **Auto-placement** — finds suitable empty areas on the design
