...
description: >-
  Build an AI editor that receives English/Vietnamese commands: "make neon
  brighter", "move design higher", "change color to purple". InstructPix2Pix,
  Instruct-NeRF2NeRF for image editing. LLM routing intent.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: AI Editing Assistant — Edit</tspan>
      <tspan x="60" dy="42">Design in Natural Language</tspan>
  </text>
...
1. **Intent routing** — LLM classifies edit commands into 4 categories
2. **Layout editor** — programmatic move/resize/rotate/center
3. **Style editor** — InstructPix2Pix for AI-based style changes
4. **Color editor** — hue shift, brightness, vibrance adjustment
5. **Quality validation** — auto-check after each edit
