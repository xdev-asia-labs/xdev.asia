...
description: >-
  Run LLaVA, Gemma 3 Vision, Qwen VL on Apple Silicon. Image analysis, text
  reading, OCR, descriptions – all offline. Integrate mlx-vlm for high
  performance.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Vision models - Image analysis</tspan>
      <tspan x="60" dy="42">no need for cloud</tspan>
  </text>
