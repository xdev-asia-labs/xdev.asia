...
description: >-
  Comprehensive guide metrics: Perplexity, BLEU, ROUGE, METEOR, BERTScore, Exact
  Match, F1. When to use which metric? Code implements each metric.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🧠 AI & ML — Lesson 10</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: LLM Evaluation Metrics — From</tspan>
      <tspan x="60" dy="42">Perplexity to BERTScore</tspan>
  </text>
