...
description: >-
  Music generation: MusicGen, Suno AI, Udio. Sound effects generation. Voice
  synthesis and basic voice cloning. Audio-visual sync. Text-to-speech for video
  narration.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🧠 AI & ML — Lesson 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Audio & Music Generation — Creating Sounds</tspan>
      <tspan x="60" dy="42">bar with AI</tspan>
  </text>
...
Audio generation has evolved dramatically — from **MusicGen** (Meta) for music, **Suno/Udio** for complete songs, to **ElevenLabs** for voice cloning. This article summarizes tools and techniques for creating audio with AI.
...
## 5. Complete Audio Pipeline for Video
...
| Tools | Type | Open Source | Best For |
|-------|-------|-------------|----------|
...
> 📌 **Next article:** 3D Generation & Avatar AI.
