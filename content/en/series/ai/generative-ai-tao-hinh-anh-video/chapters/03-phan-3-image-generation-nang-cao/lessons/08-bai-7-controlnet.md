...
description: >-
  img2img pipeline: use reference image. ControlNet: canny edge, depth map, pose
  estimation, segmentation. IP-Adapter for style transfer. Hands-on image
  creation with layout control with ComfyUI and Diffusers.
duration_minutes: 150
is_free: true
video_url: null
sort_order: 6
section_title: 'Part 3: Practicing Advanced Image Generation'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🧠 AI & ML — Lesson 6</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: ControlNet & Image-to-Image — Check</tspan>
      <tspan x="60" dy="42">Output control</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Practicing Advanced Image Generation</text>
...
Text-to-image is powerful but difficult to control precisely the layout, pose, or style. **ControlNet** solves this problem: adds spatial conditioning (canny edge, depth, pose) to control output while preserving creativity.
...
> 📌 **Next article:** Inpainting, Outpainting & Image Editing with AI.
