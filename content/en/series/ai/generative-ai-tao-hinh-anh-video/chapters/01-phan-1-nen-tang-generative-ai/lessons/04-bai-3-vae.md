...
description: >-
  Autoencoder recap. VAE: ELBO, reparameterization trick, KL divergence. Latent
  space exploration and interpolation. Conditional VAE. VQ-VAE for discrete
  latents. Compare VAE vs GAN.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: VAE — Variational Autoencoders &</tspan>
      <tspan x="60" dy="42">Latent Space</tspan>
  </text>
