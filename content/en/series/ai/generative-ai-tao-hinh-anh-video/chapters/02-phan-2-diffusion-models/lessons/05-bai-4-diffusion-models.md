...
description: >-
  ...
  step-by-step. DDPM: denoising diffusion probabilistic models. Score-based
  models. Noise scheduling. Hands-on DDPM from scratch.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 4: Diffusion Models — Mathematics & Directivity</tspan>
      <tspan x="60" dy="42">sense</tspan>
  </text>
...
**Diffusion Models** is the foundation of Stable Diffusion, DALL-E 2/3, Midjourney — achieving superior image generation quality than GANs. Genius idea: **add noise gradually until the image is completely noisy, then learn how to reverse that process**.
...
## 2. Reverse Process — Denoise (Study)
...
| Reverse process | Learn denoise step-by-step |
| DDPM | Denoising Diffusion Probabilistic Models |
| UNet | Neural network predicts noise |
| DDIM | Deterministic sampling, fewer steps |
| Noise schedule | Linear vs cosine — quality influence |
| Score-based | Learn gradients of log-density |

> 📌 **Next article:** Stable Diffusion Deep Dive — latent diffusion, UNet, CLIP conditioning.
