...
description: >-
  Content safety: NSFW detection, prompt filtering. Deepfake detection and
  prevention. Copyright issues with AI-generated content. Watermarking AI images
  (C2PA). Responsible AI deployment guidelines.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🧠 AI & ML — Lesson 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: AI Safety, Ethics & Copyright</tspan>
      <tspan x="60" dy="42">in Generative AI</tspan>
  </text>
