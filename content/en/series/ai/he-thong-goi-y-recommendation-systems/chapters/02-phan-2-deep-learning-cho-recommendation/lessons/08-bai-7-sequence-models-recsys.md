...
description: >-
  Session-based recommendations. GRU4Rec. Self-Attention: SASRec, BERT4Rec.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-9008" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-9008)"/>

  <!-- Decorations -->
  <g>
    <circle cx="655" cy="95" r="18" fill="#fb923c" opacity="0.1"/>
    <circle cx="710" cy="30" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="765" cy="225" r="28" fill="#fb923c" opacity="0.1"/>
    <circle cx="820" cy="160" r="33" fill="#fb923c" opacity="0.05"/>
    <circle cx="875" cy="95" r="8" fill="#fb923c" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: Sequence Models — GRU4Rec, SASRec &</tspan>
      <tspan x="60" dy="42">Transformers</tspan>
  </text>
...
Session-based recommendations. GRU4Rec. Self-Attention: SASRec, BERT4Rec. Transformer for sequential recommendation.
...
Sequence Models — GRU4Rec, SASRec & Transformers is an important topic in the field of modern AI.
