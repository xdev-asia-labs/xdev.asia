...
description: >-
  Online vs offline metrics. A/B testing framework. Interleaving. Counterfactual
  evaluation. Business metrics alignment.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2590" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2590)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1013" cy="129" r="16" fill="#c084fc" opacity="0.14"/>
    <circle cx="926" cy="162" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="839" cy="195" r="24" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="752" cy="228" r="13" fill="#c084fc" opacity="0.11"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: A/B Testing & Evaluation for</tspan>
      <tspan x="60" dy="42">RecSys</tspan>
  </text>
...
A/B Testing & Evaluation for RecSys is an important topic in the field of modern AI.
