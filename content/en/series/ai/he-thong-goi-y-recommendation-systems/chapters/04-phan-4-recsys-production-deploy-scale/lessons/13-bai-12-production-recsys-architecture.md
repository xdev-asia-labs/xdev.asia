...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1999" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1999)"/>

  <!-- Decorations -->
  <g>
    <circle cx="620" cy="210" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="640" cy="270" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="660" cy="70" r="18" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Production RecSys Architecture</tspan>
  </text>
...
3-stage pipeline: candidate gen → scoring → re-ranking. Feature store. Real-time vs batch. System design for million-scale.
...
Production RecSys Architecture is an important topic in the field of modern AI.
