...
description: >-
  LLM as recommender. Conversational RecSys. Prompt-based recommendation. RAG
  for product search. LLM + traditional RecSys hybrid.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-564" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-564)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1000" cy="90" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="900" cy="110" r="8" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: LLM-powered Recommendations</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: RecSys Production — Deploy & Scale</text>
...
LLM as recommender. Conversational RecSys. Prompt-based recommendation. RAG for product search. LLM + traditional RecSys hybrid.
...
LLM-powered Recommendations is an important topic in the field of modern AI.
