...
description: >-
  Knowledge Graph embeddings. KGAT. Side information integration. Explainable
  recommendations via KG paths.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6493" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6493)"/>

  <!-- Decorations -->
  <g>
    <circle cx="830" cy="140" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1060" cy="90" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="790" cy="40" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1020" cy="250" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="750" cy="200" r="8" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Knowledge Graph Recommendation</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Recommendation Systems: From Basic to Production</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Advanced RecSys — Knowledge Graph, Multi-task & GNN</text>
...
Knowledge Graph embeddings. KGAT. Side information integration. Explainable recommendations via KG paths.
...
Knowledge Graph Recommendation is an important topic in the field of modern AI.
