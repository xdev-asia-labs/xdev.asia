...
description: >-
  Multi-task learning: CTR + CVR. MMOE, PLE architects. Re-ranking. Diversity,
  fairness, novelty objectives.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-888" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-888)"/>

  <!-- Decorations -->
  <g>
    <circle cx="687" cy="231" r="20" fill="#a78bfa" opacity="0.060000000000000005"/>
    <circle cx="774" cy="38" r="11" fill="#a78bfa" opacity="0.07"/>
    <circle cx="861" cy="105" r="32" fill="#a78bfa" opacity="0.08"/>
    <circle cx="948" cy="172" r="23" fill="#a78bfa" opacity="0.09"/>
    <circle cx="1035" cy="239" r="14" fill="#a78bfa" opacity="0.1"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🧠 AI & ML — Lesson 9</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Multi-task & Multi-objective</tspan>
      <tspan x="60" dy="42">Ranking</tspan>
  </text>
...
Multi-task learning: CTR + CVR. MMOE, PLE architects. Re-ranking. Diversity, fairness, novelty objectives.
...
Multi-task & Multi-objective Ranking is an important topic in the field of modern AI.
