...
description: >-
  User-based CF: similarity metrics. Item-based CF. Neighborhood methods. Cosine
  similarity, Pearson correlation. Cold-start problem.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🧠 AI & ML — Lesson 1</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Collaborative Filtering —</tspan>
...
Collaborative Filtering — User-based & Item-based is an important topic in the field of modern AI.
