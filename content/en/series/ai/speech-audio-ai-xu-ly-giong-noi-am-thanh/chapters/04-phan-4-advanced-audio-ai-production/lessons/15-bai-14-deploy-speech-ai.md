...
description: >-
  Optimization model: ONNX, TensorRT. Real-time serving architecture. WebSocket
  API. Edge deployment. Cost optimization. Monitoring.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5495" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5495)"/>

  <!-- Decorations -->
  <g>
    <circle cx="764" cy="82" r="12" fill="#f472b6" opacity="0.07"/>
    <circle cx="928" cy="186" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="1092" cy="30" r="16" fill="#f472b6" opacity="0.11"/>
    <circle cx="756" cy="134" r="18" fill="#f472b6" opacity="0.13"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🧠 AI & ML — Lesson 13</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 14: Deploy Speech AI — Production</tspan>
...
Optimization model: ONNX, TensorRT. Real-time serving architecture. WebSocket API. Edge deployment. Cost optimization. Monitoring.
...
Deploy Speech AI — Production Pipeline is an important topic in the field of modern AI.
