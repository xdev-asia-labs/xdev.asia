...
description: >-
  Sampling rate, bit depth, waveforms. Fourier Transform. Spectrogram, Mel
  spectrogram. librosa for audio processing. Audio I/O with Python.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 0
section_title: 'Part 1: Audio & Signal Processing Foundations'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🧠 AI & ML — Lesson 0</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 1: Digital Audio & Signal Processing</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: Audio & Signal Processing Foundations</text>
...
Sampling rate, bit depth, waveforms. Fourier Transform. Spectrogram, Mel spectrogram. librosa for audio processing. Audio I/O with Python.
...
Digital Audio & Signal Processing Fundamentals is an important topic in the field of modern AI.
