...
description: >-
  Whisper architecture. Multi-task: transcribe, translate, timestamps. Fine-tune
  Whisper for Vietnamese. Faster Whisper, WhisperX.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Whisper & Modern ASR — OpenAI</tspan>
      <tspan x="60" dy="42">Whisper Deep Dive</tspan>
  </text>
...
Whisper architecture. Multi-task: transcribe, translate, timestamps. Fine-tune Whisper for Vietnamese. Faster Whisper, WhisperX.
...
Whisper & Modern ASR — OpenAI Whisper Deep Dive is an important topic in the field of modern AI.
