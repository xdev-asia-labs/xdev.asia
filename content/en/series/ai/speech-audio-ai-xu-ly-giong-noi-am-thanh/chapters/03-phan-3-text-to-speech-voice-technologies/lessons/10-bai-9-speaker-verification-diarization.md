...
description: >-
  Speaker embeddings: d-vector, x-vector. Speaker verification pipeline. Speaker
  diarization. SpeechBrain framework. ECAPA-TDNN.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4146" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4146)"/>

  <!-- Decorations -->
  <g>
    <circle cx="741" cy="133" r="14" fill="#34d399" opacity="0.08"/>
    <circle cx="882" cy="254" r="17" fill="#34d399" opacity="0.11"/>
    <circle cx="1023" cy="115" r="20" fill="#34d399" opacity="0.14"/>
    <circle cx="664" cy="236" r="23" fill="#34d399" opacity="0.07"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Speaker Verification & Diarization</tspan>
  </text>
...
Speaker Verification & Diarization is an important topic in the field of modern AI.
