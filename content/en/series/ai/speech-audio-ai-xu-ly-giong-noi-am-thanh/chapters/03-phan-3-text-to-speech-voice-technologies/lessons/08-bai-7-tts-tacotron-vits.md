...
description: >-
  TTS pipeline: text → mel → waveform. Tacotron2 architecture. VITS end-to-end.
  Vocoder: HiFi-GAN. Coqui TTS, Bark.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1797" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1797)"/>

  <!-- Decorations -->
  <g>
    <circle cx="958" cy="224" r="26" fill="#fbbf24" opacity="0.09"/>
    <circle cx="816" cy="202" r="20" fill="#fbbf24" opacity="0.13"/>
    <circle cx="674" cy="180" r="14" fill="#fbbf24" opacity="0.07"/>
    <circle cx="1032" cy="158" r="8" fill="#fbbf24" opacity="0.11"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: Text-to-Speech — Tacotron2, VITS &</tspan>
      <tspan x="60" dy="42">Modern TTS</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Text-to-Speech & Voice Technologies</text>
...
Text-to-Speech — Tacotron2, VITS & Modern TTS is an important topic in the field of modern AI.
