...
description: >-
  Experimental tracking deep dive: MLflow setup, logging
  params/metrics/artifacts. W&B integrated. Hyperparameter sweeps. Model
  comparison. Best practices for reproducibility.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 1
section_title: 'Part 1: MLOps Foundations'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Experiment Tracking — MLflow &</tspan>
      <tspan x="60" dy="42">Weights & Biases</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: MLOps Foundations</text>
...
Have you ever:
- After training the model **forgot which hyperparameters** gives the best results?
- **Compare 20 experiments** by naming files `model_v1_lr001_final_FINAL_v2.pt`?
- Colleagues ask "What data is this model trained with?" — and you **don't remember**?

**Experiment Tracking** solves all of the above problems.

> 🎯 **Goal:** Track everything related to ML experiment: params, metrics, artifacts, code version.

---

## 1. Why is Experiment Tracking needed?
...
## 5. MLflow vs W&B — Comparison

| Features | MLflow | W&B |
|--------|--------|-----|
| **Pricing** | Free & Open Source | Free (individual), Paid (team) |
| **Self-hosted** | ✅ Easy | ⚠️ Yes, but complicated |
| **UI** | ⭐⭐⭐ OK | ⭐⭐⭐⭐⭐ Very beautiful |
| **Collaboration** | ⭐⭐⭐ | ⭐⭐⭐⭐⭐ Reports, Comments |
| **Model Registry** | ✅ Built-in | ✅ Artifacts |
| **Sweeps** | ❌ Need Optuna | ✅ Built-in |
| **Autologging** | ✅ Many frameworks | ✅ Many frameworks |
...
| Concepts | Remember |
|--------|--------|
| **Experiment Tracking** | Track params, metrics, artifacts, code for each run |
| **MLflow** | Open-source, self-hosted, model registry |
| **W&B** | Cloud-based, beautiful UI, built-in sweeps |
| **Autologging** | Self-tracking without code |
| **Sweeps** | Automated hyperparameter search |
| **Reproducibility** | Log git hash + data hash + environment |

## Exercises

1. **MLflow Setup:** Install MLflow, train 3 different models (RF, XGBoost, LightGBM), log all to MLflow. Compare on UI.
2. **W&B Integration:** Create W&B account, log training curves for PyTorch model. Share report link.
3. **Sweep:** Run hyperparameter sweep (50 trials) for 1 model. Find best parameters.
4. **Reproducibility:** Reproduce the best run from exercise 1 using the logged information.

> **Next article:** Data Versioning & Feature Store — DVC, LakeFS, Feast.
