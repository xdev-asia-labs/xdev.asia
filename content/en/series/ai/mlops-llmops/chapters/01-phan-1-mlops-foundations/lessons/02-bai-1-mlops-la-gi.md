...
description: >-
  ...
  technical debt in ML, team structure, tools ecosystem overview.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 1: What is MLOps? — ML Lifecycle &</tspan>
...
## 1. ML Lifecycle — ML Project life cycle
...
### Each step has its own problems:

| Phase | Common problems |
|-------|-------------------|
| **Data** | Data changes, schema drift, quality issues |
| **Training** | Not reproducible, lost track experiments |
| **Evaluation** | Offline metrics ≠ online performance |
| **Deployment** | "Runs on my computer" but fails on the server |
| **Monitoring** | Model decay, don't know when to retrain |
...
| **Reproducibility** | Easy | Very difficult (random seeds, GPU, ...) |
...
### Tool selected according to team size:

| Team Size | Recommendation |
|-----------|---------------|
| **1-3 people** | MLflow + DVC + Docker |
| **3-10 people** | + Airflow + Feast + Evidently |
| **10+ people** | Full platform: Kubeflow / Vertex AI / SageMaker |
...
| **Tech Debt** | ML code is only ~5%, 95% is infrastructure |
| **Tools** | MLflow, DVC, Feast, Kubeflow, Evidently |

## Exercises

1. **Evaluate your team:** What maturity level is your team at? List gaps.
2. **Project Setup:** Create project structure according to the above template. Init git + dvc.
3. **Research Tools:** Compare 2 experiment tracking tools: MLflow vs Weights & Biases. Choose 1 for the team.

> **Next article:** Experiment Tracking — MLflow & Weights & Biases.
