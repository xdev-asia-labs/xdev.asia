...
description: >-
  DVC (Data Version Control) setup & workflow. Data pipelines. LakeFS for data
  lake versioning. Feature Store: Feast setup, feature engineering pipelines,
  online/offline serving. Data quality validation.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Data Versioning & Feature Store</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: MLOps Foundations</text>
...
You version your code using Git. The model you track with MLflow. But what about **Data?**

Data is the most important part of ML — but it's often not versioned. Result: "The old model is better, but the old data has been overwritten..."

> 🎯 **This article:** DVC for data versioning + Feast for feature store.

---

## 1. Why is Data Versioning needed?
...
### 4.1 Why do we need a Feature Store?
...
| Concepts | Remember |
|--------|--------|
| **DVC** | Git for data, version + pipeline + reproduction |
| **dvc.yaml** | Define reproducible ML pipeline |
| **Data Validation** | Great Expectations / Pandera — validate before training |
| **Feature Store** | Feast — single source of truth for features |
| **Offline Store** | Historical features for training |
| **Online Store** | Real-time features for serving |
| **Training-Serving Skew** | Feature Store resolves |

## Exercises

1. **DVC Setup:** Init DVC for ML project. Track 1 dataset, push to remote. Rollback version.
2. **Pipeline:** Create a DVC pipeline with 3 stages: prepare → train → evaluate. Use `dvc repro`.
3. **Data Validation:** Write Pandera schema for dataset. Test with data in wrong format.
4. **Feast:** Setup Feast local, define 5 features, materialize, get online features.

> **Next article:** Model Registry, Versioning & Packaging.
