...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: CI/CD for ML — Testing & Validation</tspan>
...
CI/CD for software is popular. But CI/CD for ML is **very different**: in addition to testing code, you need to test **data**, test **model**, and validate **performance** before deploying.

> 🎯 **Goal:** Build automated pipeline: code change → test → train → validate → deploy.
...
| Concepts | Remember |
|--------|--------|
| **ML CI** | Test code + data + model, not just code |
...
| **Canary Deploy** | Deploy each part, monitor, promote/rollback |

## Exercises

1. **Unit Tests:** Write tests for feature engineering pipeline (≥5 test cases).
2. **Data Tests:** Write a data validation suite using Pandera.
3. **GitHub Actions:** Create a CI workflow that runs tests when pushing code.
4. **Model Gates:** Implement validation gates: accuracy ≥ 0.85, latency < 50ms, model size < 500MB.

> **Next article:** Infrastructure — Docker, Kubernetes & Cloud ML.
