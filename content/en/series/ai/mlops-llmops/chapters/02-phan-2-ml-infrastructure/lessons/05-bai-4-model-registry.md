...
description: >-
  MLflow Model Registry: stage transitions, model versioning. Model packaging:
  MLflow Models format, BentoML, Docker. Model serving patterns. A/B testing &
  canary deployments. Model governance.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 3
section_title: 'Part 2: ML Infrastructure'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 4: Model Registry, Versioning &</tspan>
      <tspan x="60" dy="42">Packaging</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 2: ML Infrastructure</text>
...
Model training is complete → save `model.pt` → copy to server → pray it runs. Sound familiar?

**Model Registry** solves model lifecycle management issues: versioning, staging, approval, rollback.

> 🎯 **Goal:** Manage models from experiment → staging → production in a systematic way.

---

## 1. What is the Model Registry?
...
| **BentoML** | Framework for packaging + serving |
| **Online Serving** | REST API, low latency |
| **Batch Inference** | Large datasets, scheduled |
| **A/B Testing** | Compare models in production |
| **Governance** | Approval workflow before promotion |

## Exercises

1. **Registry:** Train 3 model variants, register all, promote best → Production.
2. **Custom Model:** Create MLflow PythonModel with preprocessing built-in.
3. **Docker:** Package model into Docker container, serve with FastAPI.
4. **A/B Test:** Implement A/B testing between 2 model versions, log predictions.

> **Next article:** CI/CD for ML — Testing & Validation Pipelines.
