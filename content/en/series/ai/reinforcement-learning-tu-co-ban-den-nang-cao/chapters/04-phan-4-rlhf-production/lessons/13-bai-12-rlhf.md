...
slug: bai-12-rlhf
description: >-
  RLHF pipeline details: SFT → Reward Model → PPO fine-tuning. InstructGPT
  paper. Reward modeling. Constitutional AI. Implementation with TRL library.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🧠 AI & ML — Lesson 11</text>
...
KL penalty keeps model near SFT model → avoid reward hacking.
