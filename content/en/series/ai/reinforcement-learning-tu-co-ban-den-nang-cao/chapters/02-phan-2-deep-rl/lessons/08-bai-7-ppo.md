...
slug: bai-7-ppo
description: >-
  Trust region methods. PPO-Clip objective. Generalized Advantage Estimation
  (GAE). Full PPO implementation. Compare PPO vs TRPO vs A3C.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: PPO — Proximal Policy Optimization</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Reinforcement Learning: From Basics to Advanced</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 2: Deep Reinforcement Learning — Neural Networks meet RL</text>
...
|--------|--------|
| PPO-Clip | Limit policy changes by clipping |
| GAE | Balanced bias-variance advantage estimation |
| Entropy bonus | Encourage exploration |
| Multiple epochs | Reuse collected data many times |
