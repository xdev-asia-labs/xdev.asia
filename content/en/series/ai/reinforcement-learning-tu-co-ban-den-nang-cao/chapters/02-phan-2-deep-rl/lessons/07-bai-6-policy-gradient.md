...
description: >-
  Policy gradient theorem. REINFORCE algorithm. Baseline & variance reduction.
  Actor-Critic. A2C. Hands-on CartPole, LunarLander.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 6: Policy Gradient — REINFORCE &</tspan>
...
**Policy Gradient** methods directly optimize policy π(a|s;θ) — instead of learning value function and then deriving policy. Advantages: handle continuous actions, stochastic policies, and convergence guarantees.
...
**Intuition**: Increasing the probability of actions leads to high return, decreasing the probability of actions leads to low return.
...
Use baseline b(s) to reduce variance without changing the expected gradient:
