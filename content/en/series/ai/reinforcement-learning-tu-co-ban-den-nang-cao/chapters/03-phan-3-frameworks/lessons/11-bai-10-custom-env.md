...
description: >-
  Design Gymnasium environment for specific problems. Reward shaping.
  State/action space design. Environment wrappers. Hands-on Snake Game AI.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Custom Environment Design — Construction</tspan>
      <tspan x="60" dy="42">Build Game AI</tspan>
  </text>
...
Build a custom Gymnasium environment for your own problem — from design state/action spaces to reward shaping and training agents.
...
|-----------|--------|
| Sparse vs Dense | Dense rewards faster learning but risky reward hacking |
...
| Rewards | Dense shaping + sparse bonus |
