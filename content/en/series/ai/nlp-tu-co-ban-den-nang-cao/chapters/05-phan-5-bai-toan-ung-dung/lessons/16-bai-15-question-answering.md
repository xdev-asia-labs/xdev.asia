...
description: >-
  QA types: extractive, abstractive, open-domain. SQuAD dataset and format.
  Fine-tune BERT for extractive QA. Retrieval-Augmented QA. Cross-encoder vs
  bi-encoder for retrieval. Hands-on builds QA system for Vietnamese.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Question Answering — Question System</tspan>
      <tspan x="60" dy="42">Answer Smart</tspan>
  </text>
...
**Question Answering (QA)** — automatic question and answer system — is one of the NLP applications with the highest practical value: customer support automation, internal knowledge base, educational tools.
...
|-------|-------------|-------|
| **Extractive** | Extract text from context | SQuAD, "Apple CEO is Tim Cook" |
| **Abstractive** | Generate new answer | T5, GPT generate response |
| **Open-domain** | Search for context then answer | Wikipedia search + QA |
| **Closed-domain** | Answer within the document | FAQ chatbot |

---

## 2. Extractive QA with BERT
...
BERT predicts the **start position** and **end position** of the answer in context.
...
| Approach | Model | Advantages | Limitations |
|----------|-------|---------|---------|
| Extractive | BERT + QA head | Accurate, fast | Only extract, not generate |
| Abstractive | T5, GPT | Flexible, natural | Can hallucinate |
...
**Lesson 16: Text Summarization & Machine Translation** — Text summarization and machine translation: the two most important generation problems.
