...
description: >-
  From one-hot to dense vectors. Word2Vec: CBOW vs Skip-gram, negative sampling.
  GloVe: co-occurrence matrix factorization. FastText: subword embeddings.
  Visualize with t-SNE/UMAP. Pre-trained embeddings for Vietnamese. Hands-on
  with Gensim.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Word Embeddings — Word2Vec, GloVe,</tspan>
