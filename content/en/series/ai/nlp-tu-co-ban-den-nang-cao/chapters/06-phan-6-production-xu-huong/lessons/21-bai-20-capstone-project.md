...
description: >-
  Summary project: building a complete NLP platform — text classification + NER
  + QA for a specific domain (medical, legal, or e-commerce). Pipeline: data →
  training → evaluation → serving → monitoring. Best practices checklist and
  career roadmap.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🧠 AI & ML — Lesson 19</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 20: Capstone Project — Building NLP</tspan>
...
This is a summary lesson — you will build an end-to-end **NLP Platform** integrating all the knowledge from the previous 19 lessons. Choose a domain (medical, legal, or e-commerce) and build a complete pipeline.
...
Building **Vietnamese NLP Platform** for domain **E-commerce** with 3 features:

1. **Sentiment Analysis**: Classify product reviews (positive/neutral/negative)
2. **NER**: Extract entities (products, brands, attributes)
3. **QA**: Q&A from product descriptions
...
After 20 lessons, you will have mastered:

| Part | Knowledge |
|-----|----------|
| Platform | Preprocessing, Tokenization |
| Performing | BoW, TF-IDF, Word2Vec, Sentence Embeddings |
| Deep Learning | RNN, LSTM, Attention, Transformer |
| Pre-trained | BERT, GPT, Hugging Face ecosystem |
| Application | Classification, NER, QA, Summarization, Translation |
| Production | Vietnamese NLP, MLOps, LLM trends, Capstone |

> 🎓 **Congratulations on completing the NLP series from Basic to Advanced!**
