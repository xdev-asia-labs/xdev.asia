...
description: >-
  Transformers library deep-dive: pipeline, AutoModel, AutoTokenizer. Model Hub:
  find and use pre-trained models. Datasets library. Trainer API for fast
  fine-tuning. PEFT/LoRA for efficient tuning. Accelerate for multi-GPU. Spaces
  for demo.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Hugging Face Ecosystem — Practice</tspan>
      <tspan x="60" dy="42">Modern NLP</tspan>
  </text>
