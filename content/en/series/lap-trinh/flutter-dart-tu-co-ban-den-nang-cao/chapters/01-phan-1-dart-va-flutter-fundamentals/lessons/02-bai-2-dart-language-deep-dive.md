...
title: 'Lesson 2: Dart Language Deep Dive'
slug: bai-2-dart-language-deep-dive
description: >-
  Variables, types, null safety, late keyword. Functions, closures, extensions.
  Classes, mixins, abstract classes. Collections (List, Set, Map), pattern
  matching, records. Async/await, Futures, Streams.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 Programming — Lesson 2</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Dart Language Deep Dive</tspan>
  </text>
...
<p>Next article: <strong>Widget Tree & Basic Widgets</strong>.</p>
