...
title: 'Lesson 17: Clean Architecture for Flutter'
slug: bai-17-clean-architecture-cho-flutter
description: >-
  Clean Architecture layers: Domain, Data, Presentation. Use Cases,
  Repositories, Entities. Dependency injection with get_it/injectable.
  Feature-first vs Layer-first folder structure.
duration_minutes: 150
is_free: true
video_url: null
sort_order: 17
section_title: 'Part 5: Architecture & Patterns'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 Programming — Lesson 17</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Clean Architecture for Flutter</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Architecture & Patterns</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-structure"><strong>1. Clean Architecture</strong></h2>
...
<h2 id="4-di"><strong>4. Dependency Injection with get_it</strong></h2>
...
<p>Next article: <strong>Code Generation & Freezing</strong>.</p>
