...
title: 'Lesson 9: HTTP & REST API Integration'
slug: bai-9-http-va-rest-api-integration
description: >-
  Dio HTTP client, interceptors, retry. JSON serialization with
  json_serializable/freezed. Repository pattern, error handling. Pagination,
  infinite scroll.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: HTTP & REST API Integration</tspan>
  </text>
...
<h2 id="4-pagination"><strong>4. Infinite Scroll with Riverpod</strong></h2>
...
<p>Next article: <strong>Local Storage & Offline First</strong>.</p>
