...
title: 'Lesson 6: State Management with Riverpod'
slug: bai-6-state-management-voi-riverpod
description: >-
  Provider vs Riverpod vs Bloc. Riverpod 2.0: Provider, StateProvider,
  StateNotifierProvider, FutureProvider, StreamProvider. Auto-dispose, family
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 6: State Management with Riverpod</tspan>
  </text>
...
<p>Next article: <strong>Bloc Pattern & Cubit</strong>.</p>
