...
title: 'Lesson 21: CI/CD & App Signing'
slug: bai-21-cicd-va-app-signing
description: >-
  Android keystore & app signing. iOS certificates & provisioning profiles.
  GitHub Actions for Flutter. Fastlane automation. Codemagic, App Center.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 Programming — Lesson 21</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 21: CI/CD & App Signing</tspan>
  </text>
...
<p>Next article: <strong>Publish to App Store & Google Play</strong>.</p>
