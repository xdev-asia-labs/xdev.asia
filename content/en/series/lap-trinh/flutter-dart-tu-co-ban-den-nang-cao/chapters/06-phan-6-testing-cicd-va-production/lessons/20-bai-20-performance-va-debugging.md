...
title: 'Lesson 20: Performance & Debugging'
slug: bai-20-performance-va-debugging
description: >-
  DevTools: Timeline, Memory, Network. Widget optimization rebuild. const
  constructors, RepaintBoundary. Image caching, lazy loading. Isolates for heavy
  computation. Tree shaking, deferred loading.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 Programming — Lesson 20</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 20: Performance & Debugging</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Testing, CI/CD & Production</text>
...
<tbody>
<tr><td>Widget Inspector</td><td>View widget tree, properties</td></tr>
...
<h2 id="2-rebuild"><strong>2. Optimize Widget Rebuild</strong></h2>
...
<h2 id="3-isolates"><strong>3. Isolates for Heavy Computation</strong></h2>
...
<p>Next article: <strong>CI/CD & App Signing</strong>.</p>
