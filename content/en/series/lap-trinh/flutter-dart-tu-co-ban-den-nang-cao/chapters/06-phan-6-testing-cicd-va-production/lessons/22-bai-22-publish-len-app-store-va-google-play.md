...
title: 'Lesson 22: Publish to App Store & Google Play'
slug: bai-22-publish-len-app-store-va-google-play
description: >-
  Google Play Console: listing, screenshots, release tracks. App Store Connect:
  metadata, TestFlight. App review guidelines. Versioning strategy, staged
  rollout. Post-launch monitoring.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 Programming — Lesson 22</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 22: Publish to App Store & Google</tspan>
...
<h2 id="1-pre-publish"><strong>1. Prepare before Publish</strong></h2>
...
<tbody>
<tr><td>App icon</td><td>Adaptive icons of all sizes</td><td>1024x1024 + sizes</td></tr>
...
<p>Congratulations on completing the series <strong>Flutter & Dart: From Basics to Advanced</strong>! 🎉</p>
