...
title: 'Lesson 15: Platform Channels & Native Integration'
slug: bai-15-platform-channels-va-native-integration
description: >-
  MethodChannel, EventChannel. Call native code from Flutter (iOS/Android).
  Pigeon code generation. FFI for C/C++ libraries. Plugin development.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Platform Channels & Native</tspan>
...
<h2 id="2-event-channel"><strong>2. EventChannel — Streams from Native</strong></h2>
...
<p>Next article: <strong>Push Notifications & Background Tasks</strong>.</p>
