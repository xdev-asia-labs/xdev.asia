...
title: 'Lesson 14: Custom Painting & Advanced Widgets'
slug: bai-14-custom-painting-va-advanced-widgets
description: >-
  CustomPainter, Canvas API, Path operations. Slivers: SliverAppBar, SliverList,
  SliverGrid. CustomScrollView, NestedScrollView. Draggable, DragTarget,
  ReorderableListView.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 Programming — Lesson 14</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 14: Custom Painting & Advanced Widgets</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Advanced UI & Features</text>
...
<p>Next article: <strong>Platform Channels & Native Integration</strong>.</p>
