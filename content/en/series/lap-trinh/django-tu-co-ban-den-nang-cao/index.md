...
description: >-
  Comprehensive Django course from basic to advanced, helping you master the
  most powerful full-stack Python framework. Includes Django ORM, Django REST
  Framework, Class-Based Views, Authentication, Celery, Channels (WebSockets),
  Testing, Docker and Production deployment. Updated to Django 5.2+ and Python
  3.12+ with the latest 2026 best practices.
...
sections:
  - id: section-01
    title: 'Part 1: Django Fundamentals'
    description: 'Install Django, MVT pattern, models, views, templates, URL routing'
    sort_order: 1
    lessons:
      - id: 019d8b40-c101-7001-b004-django00000101
        title: 'Lesson 1: Introducing Django - The Web Framework for Perfectionists'
        slug: bai-1-gioi-thieu-django
        description: >-
          What is Django, the "batteries included" philosophy? Compare Django vs
          FastAPI vs Flask vs Laravel. MVT architecture, Django ecosystem.
          Install and create your first project and app.
        duration_minutes: 60
        is_free: true
        sort_order: 1
        video_url: null
      ...
      - id: 019d8b40-c103-7001-b004-django00000103
        title: 'Lesson 3: Views, URLs & Templates'
        slug: bai-3-views-urls-va-templates
        description: >-
          Function-Based Views, URL routing, URL namespaces. Django Template
          Language, template inheritance, custom template tags/filters. Static
          files, media files.
        duration_minutes: 90
        is_free: true
        sort_order: 3
      ...
      - id: 019d8b40-c104-7001-b004-django00000104
        ...
        description: >-
          ...
          DeleteView). Django Forms, ModelForms, formsets. CSRF protection, form
    ...
    lessons:
      ...
      - id: 019d8b40-c202-7001-b004-django00000202
        ...
        description: >-
          ...
          Pagination (PageNumber, LimitOffset, Cursor). Filtering with
      ...
      - id: 019d8b40-c203-7001-b004-django00000203
        title: 'Lesson 7: Advanced Serializers & Validation'
        ...
        description: >-
          ...
          Optimizing N+1 queries with select_related/prefetch_related.
        duration_minutes: 120
        is_free: true
        sort_order: 7
        video_url: null
      - id: 019d8b40-c204-7001-b004-django00000204
        title: 'Lesson 8: Versioning, Throttling & API Documentation'
        slug: bai-8-versioning-throttling-va-api-docs
        description: >-
          API versioning strategies. Throttling (AnonRate, UserRate,
          ScopedRate). OpenAPI/Swagger with drf-spectacular. API testing with
          DRF test client.
        duration_minutes: 90
        is_free: true
        sort_order: 8
  ...
  - id: section-03
    ...
    lessons:
      - id: 019d8b40-c301-7001-b004-django00000301
        title: 'Lesson 9: Authentication - Session, Token & JWT'
        slug: bai-9-authentication-session-token-va-jwt
        description: >-
          Django auth system, custom User model. Session auth, Token auth, JWT
          with djangorestframework-simplejwt. Token refresh, blacklisting.
      ...
      - id: 019d8b40-c302-7001-b004-django00000302
        ...
        description: >-
          ...
          Object-level permissions, django-guardian. Django Groups &
          Permissions, RBAC pattern. django-rules.
        duration_minutes: 120
        is_free: true
        sort_order: 10
        video_url: null
      - id: 019d8b40-c303-7001-b004-django00000303
        title: 'Lesson 11: Social Auth & OAuth2'
        slug: bai-11-social-auth-va-oauth2
        description: >-
          django-allauth for social authentication. Google, GitHub, Facebook
          login. OAuth2 provider with django-oauth-toolkit. Account linking,
          email verification.
        duration_minutes: 120
        is_free: true
        sort_order: 11
      ...
      - id: 019d8b40-c304-7001-b004-django00000304
        ...
        description: >-
          CSRF, XSS, SQL injection protection. CORS with django-cors-headers.
          Rate limiting, security middleware. Content Security Policy,
          django-csp. OWASP Top 10 for Django.
        duration_minutes: 90
        is_free: true
        sort_order: 12
        video_url: null
  - id: section-04
    ...
    lessons:
      - id: 019d8b40-c401-7001-b004-django00000401
        title: 'Lesson 13: Django Admin Customization'
        slug: bai-13-django-admin-customization
        description: >-
          ModelAdmin customization, list_display, list_filter, search_fields.
          Inline models, custom admin actions, admin widgets. django-unfold for
          modern admin UI.
        duration_minutes: 90
        is_free: true
        sort_order: 13
      ...
      - id: 019d8b40-c402-7001-b004-django00000402
        title: 'Lesson 14: Django Channels & WebSockets'
      ...
      - id: 019d8b40-c403-7001-b004-django00000403
        title: 'Lesson 15: Celery, Signals & Caching'
        slug: bai-15-celery-signals-va-caching
        description: >-
          Celery with Redis/RabbitMQ, periodic tasks (Celery Beat). Django
          Signals, custom signals. Django cache framework, Redis caching, cache
          patterns. django-cachalot.
        duration_minutes: 150
        is_free: true
        sort_order: 15
        video_url: null
      - id: 019d8b40-c404-7001-b004-django00000404
        title: 'Lesson 16: File Storage, Email & Notifications'
        slug: bai-16-file-storage-email-va-notifications
        description: >-
          Django storage backends, S3 with django-storages. Image processing
          with Pillow. Email sending, templates. Push notifications,
        ...
        video_url: null
  - id: section-05
    title: 'Part 5: Testing, Deployment & Production'
    description: 'Testing, Docker, CI/CD, monitoring, performance optimization'
    sort_order: 5
    lessons:
      - id: 019d8b40-c501-7001-b004-django00000501
        title: 'Lesson 17: Testing in Django'
        slug: bai-17-testing-trong-django
        description: >-
          Django TestCase, pytest-django. Factory Boy, bakery model. API testing
          with DRF test client. Coverage report, testing strategies. Mocking,
          fixtures, transaction tests.
        duration_minutes: 150
        is_free: true
        sort_order: 17
        video_url: null
      - id: 019d8b40-c502-7001-b004-django00000502
        title: 'Lesson 18: Performance Optimization'
      ...
      - id: 019d8b40-c503-7001-b004-django00000503
        title: 'Lesson 19: Docker & CI/CD for Django'
        slug: bai-19-docker-va-cicd-cho-django
        description: >-
          Dockerfile multi-stage build for Django. Docker Compose (Django +
...
The course **Django: From Basics to Advanced** is designed to help you master Django — the most powerful "batteries included" Python framework for web development, from MVT patterns to REST API production-ready.
...
- Basic understanding of HTTP, HTML and SQL
- Computer with Python 3.12+ and Docker installed
