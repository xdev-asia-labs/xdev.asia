...
description: >-
  What is Django, the "batteries included" philosophy? Compare Django vs FastAPI
  vs Flask vs Laravel. MVT architecture, Django ecosystem. Install and create
  your first project and app.
duration_minutes: 60
is_free: true
video_url: null
sort_order: 1
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 1: Introducing Django - The Web</tspan>
      <tspan x="60" dy="42">Framework for Perfectionists</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="244" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Django: From Basics to Advanced</text>

  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: Django Fundamentals</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-django-la-gi"><strong>1. What is Django?</strong></h2>

<p>Django is a Python web framework "batteries included" — providing an ORM, admin panel, authentication, form processing, template engine and many other modules right from the start.</p>

<table>
<thead><tr><th>Features</th><th>Django</th><th>FastAPI</th><th>Flask</th><th>Laravel</th></tr></thead>
<tbody>
<tr><td>Language</td><td>Python</td><td>Python</td><td>Python</td><td>PHP</td></tr>
<tr><td>Type</td><td>Full-stack</td><td>API-only</td><td>Microphone</td><td>Full-stack</td></tr>
<tr><td>ORM</td><td>Built-in</td><td>SQLAlchemy</td><td>SQLAlchemy</td><td>Eloquent</td></tr>
<tr><td>Admin</td><td>Built-in</td><td>No</td><td>No</td><td>Third party</td></tr>
<tr><td>Async</td><td>Django 5.x</td><td>Native</td><td>Limited</td><td>No</td></tr>
<tr><td>Use cases</td><td>Full-stack, CMS</td><td>APIs, microservices</td><td>Simple apps</td><td>Full-stack</td></tr>
</tbody>
</table>
...
<tr><td>View</td><td>Business logic — process requests, return responses</td></tr>
<tr><td>Template</td><td>Presentation — HTML rendering</td></tr>
</tbody>
</table>

<h2 id="3-cai-dat"><strong>3. Install & Create Project</strong></h2>
...
<h2 id="4-cau-truc"><strong>4. Project structure</strong></h2>
...
<h2 id="5-settings"><strong>5. Basic settings</strong></h2>
...
<p>Next article: <strong>Models & Django ORM</strong> — fields, relationships, managers.</p>
