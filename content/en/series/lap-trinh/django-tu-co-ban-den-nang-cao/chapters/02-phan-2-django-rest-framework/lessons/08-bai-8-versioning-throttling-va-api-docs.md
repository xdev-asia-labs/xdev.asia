...
title: 'Lesson 8: Versioning, Throttling & API Docs'
slug: bai-8-versioning-throttling-va-api-docs
description: >-
  API versioning strategies (URL, header, namespace). Rate limiting with
  throttling. Swagger/OpenAPI docs with drf-spectacular. API best practices,
  CORS configuration.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 Programming — Lesson 8</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Versioning, Throttling & API Docs</tspan>
  </text>
...
<h2 id="3-api-docs"><strong>3. API Docs with drf-spectacular</strong></h2>
...
<p>Next article: <strong>Authentication — Session, Token & JWT</strong>.</p>
