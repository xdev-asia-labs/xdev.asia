...
description: >-
  Django TestCase, pytest-django. Unit test models, views, serializers. API
  testing with APIClient. Factory Boy, fixtures, mocking, coverage report.
duration_minutes: 150
is_free: true
video_url: null
sort_order: 17
section_title: 'Part 5: Testing, Deployment & Production'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Testing in Django</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Testing, Deployment & Production</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-test-setup"><strong>1. Test Setup with pytest-django</strong></h2>
...
<p>Next article: <strong>Performance Optimization</strong>.</p>
