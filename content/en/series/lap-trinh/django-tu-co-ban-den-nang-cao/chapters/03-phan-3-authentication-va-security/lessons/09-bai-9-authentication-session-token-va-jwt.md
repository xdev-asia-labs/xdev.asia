...
description: >-
  Django session auth, DRF Token Authentication. JWT with
  djangorestframework-simplejwt. Token refresh, blacklist, custom claims.
  Multi-auth backend.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">💻 Programming — Lesson 9</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Authentication — Session, Token &</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Authentication & Security</text>
...
<h2 id="3-jwt"><strong>3. JWT vs SimpleJWT</strong></h2>
...
<p>Next article: <strong>Permissions & Authorization</strong>.</p>
