...
description: >-
  Social authentication with django-allauth (Google, GitHub, Facebook). OAuth2
  Provider with django-oauth-toolkit. SSO integration, account linking, custom
  social adapters.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: Social Auth & OAuth2</tspan>
  </text>
...
<h2 id="5-drf-social"><strong>5. Social Auth in DRF</strong></h2>
