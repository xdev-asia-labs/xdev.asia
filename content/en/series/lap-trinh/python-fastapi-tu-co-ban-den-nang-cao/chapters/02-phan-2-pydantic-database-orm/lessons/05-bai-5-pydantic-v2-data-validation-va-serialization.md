...
description: >-
  Pydantic BaseModel, Field validators, model_validator, computed fields. Custom
  types, JSON Schema generation, Settings management with pydantic-settings.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 Programming — Lesson 5</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Pydantic V2 - Data Validation &</tspan>
      <tspan x="60" dy="42">Serialization</tspan>
  </text>
...
<h2 id="1-pydantic-v2-overview"><strong>1. Pydantic V2 - Overview</strong></h2>

<p>Pydantic V2 is the fastest data validation library for Python, rewritten to the core in Rust (pydantic-core). FastAPI uses Pydantic for everything: request validation, response serialization, settings management.</p>

<h3 id="v1-vs-v2"><strong>Key changes from V1 to V2:</strong></h3>

<ul>
<li>Core written in Rust → 5-50x faster</li>
<li><code>model_validate()</code> instead <code>parse_obj()</code></li>
<li><code>model_dump()</code> instead <code>.dict()</code></li>
<li><code>model_dump_json()</code> instead <code>.json()</code></li>
<li><code>model_config</code> instead <code>classConfig</code></li>
<li><code>@field_validator</code> instead <code>@validator</code></li>
<li><code>@model_validator</code> instead <code>@root_validator</code></li>
</ul>

<h2 id="2-basemodel"><strong>2. Basic BaseModel</strong></h2>
...
<p>Pydantic V2 is the heart of FastAPI, providing:</p>

<ul>
<li><strong>BaseModel</strong>: Data validation with type hints</li>
<li><strong>Field Validators</strong>: Custom validation logic for each field</li>
<li><strong>Model Validators</strong>: Cross-field validation</li>
<li><strong>Computed Fields</strong>: Derived values automatically</li>
...
<li><strong>Settings</strong>: Configuration management from env vars</li>
</ul>

<p>The next article will show you how to connect the Database with SQLAlchemy 2.0 async.</p>
