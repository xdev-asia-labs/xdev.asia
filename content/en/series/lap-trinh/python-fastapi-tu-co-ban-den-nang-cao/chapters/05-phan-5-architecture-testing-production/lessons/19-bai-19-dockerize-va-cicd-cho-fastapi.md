...
description: >-
  Docker multi-stage build for FastAPI. Docker Compose for development and
  production. GitHub Actions CI/CD pipeline. Automated testing, linting and
  deployment workflow.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: Dockerize & CI/CD for FastAPI</tspan>
  </text>
...
<h2 id="4-makefile"><strong>4. Makefile for Developer Experience</strong></h2>
...
<ul>
<li><strong>Docker Multi-stage</strong>: Light build, production-ready (non-root, healthcheck)</li>
...
<li><strong>Pre-commit</strong>: Enforce code quality before committing</li>
</ul>
