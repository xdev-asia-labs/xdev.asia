...
description: >-
  Role-Based Access Control, Permission-based authorization in FastAPI. Custom
  dependencies for authorization, decorator patterns. Multi-tenant authorization
  strategies.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Authorization - RBAC & Permissions</tspan>
  </text>
...
<p>RBAC is the most popular permission model, in which permissions are assigned to roles, and users are assigned roles. FastAPI does not have RBAC built-in but is very simple to deploy with dependency injection.</p>

<h2 id="2-role-models"><strong>2. Database Models for RBAC</strong></h2>
...
<h2 id="4-su-dung-rbac"><strong>4. Use RBAC in Routes</strong></h2>
...
<p>In this article, we have built a complete authorization system:</p>

<ul>
<li><strong>RBAC Models</strong>: Users → Roles → Permissions (many-to-many)</li>
<li><strong>RoleChecker</strong>: Dependency checks roles</li>
<li><strong>PermissionChecker</strong>: Dependency checks permissions</li>
<li><strong>Resource Ownership</strong>: Only owner or admin can edit/delete</li>
<li><strong>Seeding</strong>: Script seed roles and permissions</li>
</ul>

<p>The next article will focus on Security Best Practices.</p>
