...
description: >-
  OAuth2 Authorization Code flow, Social login with Google, GitHub, Facebook.
  Authlib integration, Account linking, OpenID Connect. Multi-provider
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">💻 Programming — Lesson 12</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Social Login & OAuth2 Providers</tspan>
  </text>
...
<p>Social login uses OAuth2 Authorization Code flow - the most secure flow for web applications:</p>
...
<h2 id="6-starlette-session"><strong>6. Session Middleware (for OAuth state)</strong></h2>
...
<p>In this article, Social Login has been implemented:</p>

<ul>
<li><strong>OAuth2 Authorization Code Flow</strong>: Flow is safe for web apps</li>
<li><strong>Google Login</strong>: OpenID Connect with Google</li>
<li><strong>GitHub Login</strong>: OAuth2 with GitHub API</li>
<li><strong>Account Linking</strong>: Link social account with existing user</li>
<li><strong>Auto Registration</strong>: Automatically create an account when social login for the first time</li>
</ul>

<p>The next article will go into Middleware, Events and Lifespan management.</p>
