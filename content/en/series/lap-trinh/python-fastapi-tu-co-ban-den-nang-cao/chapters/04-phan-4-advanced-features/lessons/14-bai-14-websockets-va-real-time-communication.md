...
description: >-
  WebSocket endpoints in FastAPI, Connection manager, Broadcasting, Rooms
  pattern. Real-time chat, notifications. Server-Sent Events (SSE) and long
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 Programming — Lesson 14</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 14: WebSockets & Real-time</tspan>
...
<h2 id="1-websocket-basics"><strong>1. WebSocket Basics in FastAPI</strong></h2>
...
<table>
<thead>
<tr><th>Features</th><th>WebSockets</th><th>SSE</th><th>Long Polling</th></tr>
</thead>
<tbody>
...
<p>In this article, we have implemented:</p>

<ul>
<li><strong>WebSocket endpoints</strong>: Bi-directional real-time communication</li>
<li><strong>Connection Manager</strong>: Manage connections, rooms, users</li>
<li><strong>Chat Room</strong>: Real-time chat with rooms pattern</li>
<li><strong>Notifications</strong>: Push notifications via WebSocket</li>
<li><strong>SSE</strong>: Server-Sent Events for one-way streaming</li>
</ul>

<p>The next article will learn about Background Tasks and Celery.</p>
