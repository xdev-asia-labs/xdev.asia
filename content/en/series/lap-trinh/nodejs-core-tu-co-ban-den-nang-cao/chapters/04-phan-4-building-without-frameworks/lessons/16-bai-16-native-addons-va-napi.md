...
description: >-
  N-API (Node-API), napi-rs (Rust bindings). node-gyp, prebuild. C/C++ addons,
  performance-critical native code. When to use native addons vs Worker Threads
  vs WASM.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 Programming — Lesson 16</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Native Addons & N-API</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Building Without Frameworks</text>
...
<p>Node-API is a stable ABI (Application Binary Interface) that allows writing native addons in C/C++ or Rust without rebuilding when upgrading Node.js version.</p>

<table>
<thead><tr><th>Approach</th><th>Language</th><th>Build tools</th><th>When to use</th></tr></thead>
<tbody>
<tr><td>node-addon-api</td><td>C++</td><td>node-gyp</td><td>C/C++ libraries are available</td></tr>
<tr><td>napi-rs</td><td>Rust</td><td>cargo.cargo</td><td>Rust projects, performance</td></tr>
<tr><td>WASM</td><td>Any → WASM</td><td>wasm-pack</td><td>Portable, sandbox</td></tr>
<tr><td>Worker Threads</td><td>JavaScript</td><td>None</td><td>CPU tasks are simple</td></tr>
</tbody>
</table>
...
<h2 id="3-node-gyp"><strong>3. C++ Addon with node-addon-api</strong></h2>
...
<h2 id="5-benchmark"><strong>5. When to use Native Addons?</strong></h2>
...
<p>Next article: <strong>Testing Node.js Applications</strong> — node:test, Vitest, Supertest.</p>
