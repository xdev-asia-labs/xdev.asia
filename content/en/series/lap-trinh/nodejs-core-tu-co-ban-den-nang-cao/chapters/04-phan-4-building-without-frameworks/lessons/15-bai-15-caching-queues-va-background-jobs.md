...
description: >-
  Redis client (ioredis), caching patterns. BullMQ job queues, priority queues,
  rate limiting. Cron jobs with node-cron. In-memory caching (LRU cache).
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Caching, Queues & Background Jobs</tspan>
  </text>
...
<p>Next article: <strong>Native Addons & N-API</strong> — napi-rs, node-gyp, Rust bindings.</p>
