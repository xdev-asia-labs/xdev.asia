...
description: >-
  Build mini framework: Router, middleware pipeline, request parsing, response
  helpers. Compare with Express/Fastify internals. Content negotiation, CORS.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Building HTTP Framework from Scratch</tspan>
  </text>
...
<h2 id="4-usage"><strong>4. Use Frameworks</strong></h2>
...
<p>Next article: <strong>Database Drivers & Connection Pooling</strong> — pg, mysql2, better-sqlite3.</p>
