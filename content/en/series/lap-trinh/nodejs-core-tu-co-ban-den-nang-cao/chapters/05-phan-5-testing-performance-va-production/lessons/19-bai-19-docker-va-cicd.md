...
description: >-
  Docker multi-stage build for Node.js. Alpine vs slim vs distroless. Docker
  Compose, health checks. GitHub Actions CI/CD pipeline. pnpm in Docker,
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 Programming — Lesson 19</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: Docker & CI/CD</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Testing, Performance & Production</text>
...
<table>
<thead><tr><th>Image</th><th>Size</th><th>Use cases</th></tr></thead>
<tbody>
...
<tr><td>node:22-alpine</td><td>~130MB</td><td>Production (smallest)</td></tr>
<tr><td>gcr.io/distroless/nodejs22</td><td>~50MB</td><td>Security-hardened production</td></tr>
</tbody>
</table>

<p>Next article: <strong>Production Monitoring & Scaling</strong> — Pino, OpenTelemetry, Prometheus.</p>
