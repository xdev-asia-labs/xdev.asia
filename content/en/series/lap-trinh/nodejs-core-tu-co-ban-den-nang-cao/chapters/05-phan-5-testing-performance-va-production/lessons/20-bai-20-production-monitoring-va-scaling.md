...
description: >-
  Pino structured logging, OpenTelemetry tracing. Prometheus metrics, Grafana
  dashboards. PM2 ecosystem. Graceful shutdown, health checks. Horizontal
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 Programming — Lesson 20</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 20: Production Monitoring & Scaling</tspan>
  </text>
...
<tbody>
<tr><td>Logging</td><td>Pino structure, request IDs, log levels</td></tr>
...
<p>🎉 Complete the series <strong>Node.js Core: From Basics to Advanced</strong>!</p>
