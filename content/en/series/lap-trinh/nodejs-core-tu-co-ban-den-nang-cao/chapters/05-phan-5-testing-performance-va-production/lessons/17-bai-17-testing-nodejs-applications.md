...
description: >-
  Node.js built-in test runner (node:test). Vitest for unit/integration tests.
  Supertest for HTTP testing. Nock for HTTP mocking. Testcontainers, code
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Testing Node.js Applications</tspan>
  </text>
...
<p>Next article: <strong>Performance Profiling & Optimization</strong> — V8 profiler, flamegraphs, Clinic.js.</p>
