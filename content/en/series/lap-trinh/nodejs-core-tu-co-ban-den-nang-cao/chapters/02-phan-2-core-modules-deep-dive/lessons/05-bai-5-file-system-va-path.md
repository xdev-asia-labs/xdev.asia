...
description: >-
  ...
  chokidar). Path manipulation, __dirname, import.meta.url. Temporary files,
  atomic writes. Glob patterns.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 5
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: File System & Path</tspan>
  </text>
...
<p>Next article: <strong>Streams & Buffers</strong> — Readable, Writable, Transform, backpressure.</p>
