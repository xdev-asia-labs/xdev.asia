...
description: >-
  crypto module: hashing, HMAC, encryption (AES), key derivation (scrypt,
  argon2). Digital signatures. os module, process signals, environment
  variables. child_process, execute/spawn.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Crypto, OS & Process</tspan>
  </text>
...
<h2 id="4-process"><strong>4. Processes & Signals</strong></h2>
...
<p>Next article: <strong>Worker Threads & CPU-intensive Tasks</strong> — thread pool, SharedArrayBuffer.</p>
