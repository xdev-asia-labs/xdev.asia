...
description: >-
  Cluster module, fork(), round-robin. PM2 process manager, graceful shutdown.
  Sticky sessions, shared state challenges. Zero-downtime deployment, rolling
  restarts.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">💻 Programming — Lesson 10</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Cluster Module & Load Balancing</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Concurrency & Networking</text>
...
<p>Next article: <strong>TCP, UDP & WebSockets</strong> — net, dgram, ws.</p>
