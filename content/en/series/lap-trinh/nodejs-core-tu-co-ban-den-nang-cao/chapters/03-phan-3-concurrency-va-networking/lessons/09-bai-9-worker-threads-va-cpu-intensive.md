...
description: >-
  Worker Threads, SharedArrayBuffer, Atomics. MessageChannel, transferable
  objects. Thread pool patterns, Piscina. CPU-intensive task offloading, image
  processing.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 9
section_title: 'Part 3: Concurrency & Networking'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Worker Threads & CPU-intensive</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Concurrency & Networking</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-worker-threads"><strong>1. Basic Worker Threads</strong></h2>
...
<h2 id="4-piscina"><strong>4. Thread Pool with Piscina</strong></h2>
...
<p>Next article: <strong>Cluster Module & Load Balancing</strong> — fork, PM2, graceful shutdown.</p>
