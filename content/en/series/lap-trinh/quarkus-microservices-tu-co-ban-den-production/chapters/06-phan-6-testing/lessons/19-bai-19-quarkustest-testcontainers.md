...
title: 'Lesson 19: @QuarkusTest & Testcontainers'
slug: bai-19-quarkustest-testcontainers
description: >-
  Unit testing, integration testing with @QuarkusTest, Dev Services
  automatically provides PostgreSQL/Kafka/Keycloak containers, REST-assured,
  @InjectMock, @QuarkusTestResource.
duration_minutes: 100
is_free: false
video_url: null
sort_order: 18
section_title: 'Part 6: Testing'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">💻 Programming — Lesson 18</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: @QuarkusTest & Testcontainers</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Testing</text>
...
The Quarkus testing ecosystem includes: **@QuarkusTest** for integration testing (full CDI container), **Dev Services** that automatically provides databases/message brokers, **REST-assured** for HTTP testing, and **@InjectMock** for mocking. This article guides testing strategies for microservices.
...
1. Write Unit Tests for domain models: `Product`, `Order`, `Money`, `OrderStatus`
2. Write Integration Tests for `ProductResource` CRUD endpoints
3. Use `@InjectMock` mock Product Service when testing Order Service
4. Test validation errors return the correct Problem Details format
5. Test security: `@TestSecurity` for authenticated/forbidden scenarios
6. Create `@TestTransaction` tests for the Repository layer

## Summary

- **Unit Tests** for domain logic (entities, value objects) — no need for containers
- **`@QuarkusTest`** for integration tests — full CDI container + Dev Services
...
- **`@TestTransaction`** — auto-rollback database changes after each test
- Dev Services automatically provision PostgreSQL, Kafka, Redis, Keycloak containers

Next article: Contract Testing — ensuring API compatibility between services.
