...
title: 'Lesson 7: Building a complete Product Service'
slug: bai-7-xay-dung-product-service-hoan-chinh
description: >-
  Build end-to-end Product Service: Entity, Repository, Service layer, REST API,
  DTO mapping, search, and data import.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: Building a complete Product Service</tspan>
  </text>
...
This article builds a complete **Product Service** — the first microservice in the E-Commerce system. Apply knowledge from previous articles: Panache, Validation, Exception Handling, DDD, Flyway into a production-ready codebase.
...
1. Create a Product Service project with the above structure
2. Full implementation of CRUD + search + pagination
3. Add endpoints `GET /api/v1/products/top-viewed` Returns top 10 products
4. Write Flyway migrations (schema + seed data)
5. Test the entire API via Swagger UI in `http://localhost:8081/q/swagger-ui`
6. More `CategoryResource` with CRUD for categories

## Summary

- **Layered Architecture**: Entity → Repository → Service → Resource
- **DTO Mapping** with static factory method `from()` (no need for MapStruct for small projects)
- **PagedResult** record helps standardize paging responses
- **Domain Methods** holds business logic in the entity (DDD)
- **Flyway** manages schema + seed data

Next article: Order Service & Payment Service — process orders and payments.
