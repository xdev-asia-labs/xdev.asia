...
title: 'Lesson 7: Styling & UI Components'
slug: bai-7-styling-va-ui-components
description: >-
  Tailwind CSS integration, CSS Modules. Component libraries (shadcn/ui, Radix
  UI). Animation with Framer Motion. Responsive design, theming (dark mode).
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: Styling & UI Components</tspan>
  </text>
...
<p>Next article: <strong>Next.js & App Router</strong> — file-based routing, layouts, templates, and project structure.</p>
