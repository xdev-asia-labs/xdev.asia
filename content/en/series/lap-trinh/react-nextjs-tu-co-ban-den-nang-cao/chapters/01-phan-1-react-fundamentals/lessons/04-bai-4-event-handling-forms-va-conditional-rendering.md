...
title: 'Lesson 4: Event Handling, Forms & Conditional Rendering'
slug: bai-4-event-handling-forms-va-conditional-rendering
description: >-
  Event handling, synthetic events. Controlled/uncontrolled components, form
  libraries (React Hook Form, Zod validation). Lists, keys, conditional
  rendering patterns.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 4: Event Handling, Forms & Conditional</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: React Fundamentals</text>
...
<p>Next article: <strong>Context API & State Management</strong> — Zustand, TanStack Query, and state management strategies.</p>
