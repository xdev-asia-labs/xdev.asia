...
title: 'Lesson 2: Components, Props & TypeScript'
slug: bai-2-components-props-va-typescript
description: >-
  Functional components, props, children. TypeScript with React, typing props,
  events, refs. Component composition, render props pattern. React.FC vs
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Components, Props & TypeScript</tspan>
  </text>
...
<h2 id="4-typescript-patterns"><strong>4. TypeScript Patterns for React</strong></h2>
...
<p>Next article: <strong>Hooks Deep Dive</strong> — useState, useEffect, useRef, useMemo, useCallback, and custom hooks.</p>
