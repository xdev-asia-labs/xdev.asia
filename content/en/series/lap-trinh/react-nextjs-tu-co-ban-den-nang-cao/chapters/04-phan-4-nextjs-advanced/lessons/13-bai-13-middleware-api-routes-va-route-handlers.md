...
title: 'Lesson 13: Middleware, API Routes & Route Handlers'
slug: bai-13-middleware-api-routes-va-route-handlers
description: >-
  Next.js Middleware deep dive. Route Handlers (GET, POST, PUT, DELETE).
  Request/Response helpers. Rate limiting, CORS. Streaming responses, webhooks.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Middleware, API Routes & Routes</tspan>
      <tspan x="60" dy="42">Handlers</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Next.js Advanced</text>
...
<p>Next article: <strong>Database Integration & Prisma</strong> — ORM, migrations, relations, queries.</p>
