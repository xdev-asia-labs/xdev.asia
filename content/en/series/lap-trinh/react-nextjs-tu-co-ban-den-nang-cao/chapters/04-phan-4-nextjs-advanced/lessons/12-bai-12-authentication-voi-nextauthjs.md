...
title: 'Lesson 12: Authentication with NextAuth.js'
slug: bai-12-authentication-voi-nextauthjs
description: >-
  NextAuth.js (Auth.js) setup. OAuth providers (Google, GitHub). Credentials
  provider, JWT vs Session. Middleware protection, role-based access control.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 Programming — Lesson 12</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Authentication with NextAuth.js</tspan>
  </text>
...
<h2 id="4-server-component"><strong>4. Use in Server Component</strong></h2>
...
<h2 id="5-client-component"><strong>5. Use in Client Component</strong></h2>
...
<h2 id="7-login-form"><strong>7. Login Form with Server Action</strong></h2>
...
<p>Next article: <strong>Middleware, API Routes & Route Handlers</strong> — advanced request/response handling.</p>
