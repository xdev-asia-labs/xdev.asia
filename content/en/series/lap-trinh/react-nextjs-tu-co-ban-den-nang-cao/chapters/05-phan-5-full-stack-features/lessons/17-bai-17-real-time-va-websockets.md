...
title: 'Lesson 17: Real-time & WebSockets'
slug: bai-17-real-time-va-websockets
description: >-
  Server-Sent Events (SSE). WebSockets with Socket.io. Real-time notifications,
  chat. Pusher, Ably integrated. Optimistic UI patterns.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">💻 Programming — Lesson 17</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Real-time & WebSockets</tspan>
  </text>
...
<h2 id="2-socket-io"><strong>2. WebSockets with Socket.io</strong></h2>
...
<p>Next article: <strong>Email, Payment & Third-party</strong> — Resend, Stripe, OAuth.</p>
