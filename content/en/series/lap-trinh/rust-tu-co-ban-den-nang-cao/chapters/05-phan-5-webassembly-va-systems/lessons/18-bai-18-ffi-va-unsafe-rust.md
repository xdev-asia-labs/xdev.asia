...
description: >-
  ...
  calling C from Rust. Building C-compatible libraries. PyO3 for Python
  bindings. Safety variables.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 18: FFI & Unsafe Rust</tspan>
  </text>
...
<h2 id="2-ffi-c"><strong>2. FFI — Call C from Rust</strong></h2>
...
<p>Next article: <strong>Testing & Benchmarking</strong>.</p>
