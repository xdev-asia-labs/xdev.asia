...
description: >-
  Immutability by default, shadowing. Scalar types, compound types (tuple,
  array). String vs &str. if/else, matches, loops. Pattern matching deep dive.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 2
...
<p>Next article: <strong>Ownership, Borrowing & Lifetimes</strong>.</p>
