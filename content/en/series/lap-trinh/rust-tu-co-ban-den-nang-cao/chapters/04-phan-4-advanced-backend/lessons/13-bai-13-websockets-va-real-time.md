...
description: >-
  tokio-tungstenite, axum WebSocket support. Connection manager, broadcasting,
  rooms pattern. Server-Sent Events. Real-time chat application.
...
<h2 id="2-chat"><strong>2. Chat Room with Broadcasting</strong></h2>
...
<p>Next article: <strong>gRPC with Tonic</strong>.</p>
