...
description: >-
  Redis caching with deadpool-redis. Command-line tools with clap. Procedural
  macros, derive macros. Serde custom serialization. Configuration management.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 Programming — Lesson 16</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Caching, CLI Tools & Macros</tspan>
  </text>
...
<h2 id="2-clap"><strong>2. CLI Tools with Clap</strong></h2>
...
<p>Next article: <strong>WebAssembly with Rust</strong>.</p>
