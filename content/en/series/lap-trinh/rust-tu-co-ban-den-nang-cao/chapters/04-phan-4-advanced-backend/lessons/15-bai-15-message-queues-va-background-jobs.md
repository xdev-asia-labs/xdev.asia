...
description: >-
  RabbitMQ with lapin, Kafka with rdkafka. NATS messaging. Background job
  processing. Event-driven architecture patterns. Redis pub/sub.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 15
section_title: 'Part 4: Advanced Backend'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 Programming — Lesson 15</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Message Queues & Background Jobs</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Advanced Backend</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-rabbitmq"><strong>1. RabbitMQ with Lapin</strong></h2>
...
<h2 id="2-kafka"><strong>2. Kafka vs rdkafka</strong></h2>
...
<p>Next article: <strong>Caching, CLI Tools & Macros</strong>.</p>
