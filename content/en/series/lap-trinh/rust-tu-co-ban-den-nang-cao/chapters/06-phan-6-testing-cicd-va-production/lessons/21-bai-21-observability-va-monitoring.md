...
description: >-
  tracing crate, structured logging. OpenTelemetry integration, Prometheus
  metrics. Grafana dashboards. Health checks, graceful shutdown. tokio-console
  for async debugging.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 21: Observability & Monitoring</tspan>
  </text>
...
<h2 id="1-tracing"><strong>1. Structured Logging with tracing</strong></h2>
...
<p>Next article: <strong>Production Deployment & Performance Tuning</strong>.</p>
