...
description: >-
  The Laravel course is comprehensive from basic to advanced, helping you master
  the world's most popular PHP framework. Includes Eloquent ORM, Blade
  Templates, Laravel API (Sanctum/Passport), Queues, Events, Broadcasting,
  Livewire, Testing, Docker and Production deployment. Updated to Laravel 12+
  and PHP 8.4+ with the latest 2026 best practices.
...
sections:
  - id: section-01
    title: 'Part 1: Laravel Fundamentals'
    description: 'Laravel setup, routing, controllers, Blade, Eloquent ORM'
    sort_order: 1
    lessons:
      - id: 019d8b40-i101-7001-b010-laravel000101
        title: 'Lesson 1: Introducing Laravel - The most elegant PHP framework'
        slug: bai-1-gioi-thieu-laravel
        description: >-
          What is Laravel, "elegant syntax" philosophy. Compare Laravel vs
          Symfony vs Django vs Spring. PHP 8.4 essentials (readonly, enums,
          fibers, named arguments). Laravel Sail, Herd setup.
        duration_minutes: 60
        is_free: true
        sort_order: 1
        video_url: null
      - id: 019d8b40-i102-7001-b010-laravel000102
        title: 'Lesson 2: Routing, Controllers & Middleware'
      ...
      - id: 019d8b40-i103-7001-b010-laravel000103
        ...
        description: >-
          ...
          directives. Asset bundling (Vite). Tailwind CSS integration. Anonymous
      ...
      - id: 019d8b40-i104-7001-b010-laravel000104
        ...
        description: >-
          ...
          hasMany, belongsTo, belongsToMany, morphMany). Eager loading, query
  ...
  - id: section-02
    ...
    lessons:
      ...
      - id: 019d8b40-i202-7001-b010-laravel000202
        title: 'Lesson 6: Validation & Form Requests'
      ...
      - id: 019d8b40-i203-7001-b010-laravel000203
        title: 'Lesson 7: API Resources & Response'
        slug: bai-7-api-resources-va-response
        description: >-
          API Resource classes, Resource Collections. Conditional attributes,
          relationships. Pagination, wrapping. JSON responses, custom response
          macros. API versioning.
      ...
      - id: 019d8b40-i204-7001-b010-laravel000204
        ...
        video_url: null
  - id: section-03
    title: 'Part 3: Authentication & Authorization'
    description: 'Sanctum, Passport, Gates, Policies, Social Login'
    sort_order: 3
    lessons:
      - id: 019d8b40-i301-7001-b010-laravel000301
        title: 'Lesson 9: Authentication - Sanctum & Fortify'
        slug: bai-9-authentication-sanctum-va-fortify
        description: >-
          Laravel Sanctum (SPA auth, API tokens). Fortify (registration, login,
          email verification, 2FA). Password hashing, remember me. Custom
          guards, multi-auth.
        duration_minutes: 150
        is_free: true
        sort_order: 9
      ...
      - id: 019d8b40-i302-7001-b010-laravel000302
        ...
        description: >-
          ...
          Resource authorization, policy auto-discovery. Blade @can directives.
      ...
      - id: 019d8b40-i303-7001-b010-laravel000303
        ...
        description: >-
          ...
          login). Account linking, custom providers. JWT vs Passport tokens. API
          scopes.
        duration_minutes: 120
        is_free: true
        sort_order: 11
      ...
      - id: 019d8b40-i304-7001-b010-laravel000304
        title: 'Lesson 12: Security Best Practices'
        slug: bai-12-security-best-practices
        description: >-
          CSRF protection, XSS prevention. SQL injection, mass assignment
          protection. Rate limiting, encryption. CORS configuration. HTTPS
          enforcement, security headers. OWASP for Laravel.
        duration_minutes: 90
        is_free: true
        sort_order: 12
        video_url: null
  - id: section-04
    ...
    lessons:
      - id: 019d8b40-i401-7001-b010-laravel000401
        title: 'Lesson 13: Queues & Jobs'
        slug: bai-13-queues-va-jobs
        description: >-
          Queue drivers (Redis, SQS, Database). Job classes, dispatching,
          chaining. Job batching, rate limiting. Failed jobs, retry. Laravel
          Horizon monitoring. Queue priorities.
        duration_minutes: 150
        is_free: true
        sort_order: 13
        video_url: null
      - id: 019d8b40-i402-7001-b010-laravel000402
        title: 'Lesson 14: Events, Listeners & Broadcasting'
        slug: bai-14-events-listeners-va-broadcasting
        description: >-
          Event system, event subscribers. Broadcasting with Pusher/Laravel
          Reverb. Private/presence channels. Real-time notifications, WebSocket
          integration. Laravel Echo.
        duration_minutes: 150
        is_free: true
        sort_order: 14
        video_url: null
      - id: 019d8b40-i403-7001-b010-laravel000403
        title: 'Lesson 15: Notifications, Mail & Scheduler'
        slug: bai-15-notifications-mail-va-scheduler
        description: >-
          Notification channels (mail, database, Slack, SMS). Markdown mail,
          Mailables. Task scheduling, custom Artisan commands. laravel-data for
          DTOs. Service container deep dive.
        duration_minutes: 120
        is_free: true
        sort_order: 15
        video_url: null
      - id: 019d8b40-i404-7001-b010-laravel000404
        title: 'Lesson 16: Caching, Sessions & Performance'
        slug: bai-16-caching-sessions-va-performance
        description: >-
          Cache drivers (Redis, Memcached, files). Cache tags, atomic locks.
          Session management. N+1 query prevention, query monitoring. Laravel
          Debugbar, Telescope. Octane (Swoole/FrankenPHP).
        duration_minutes: 120
        is_free: true
        sort_order: 16
        video_url: null
  - id: section-05
    title: 'Part 5: Modern Full-Stack'
    description: 'Livewire, Inertia.js, Filament Admin, API Platform'
    sort_order: 5
    lessons:
      - id: 019d8b40-i501-7001-b010-laravel000501
        title: 'Lesson 17: Livewire - Full-Stack Components'
        slug: bai-17-livewire-full-stack-components
        description: >-
          Livewire 3, wire:model, wire:click. Component lifecycle, reactive
          properties. File uploads, pagination. Lazy loading, polling. Alpine.js
          integration. SPA-like experience.
        duration_minutes: 150
        is_free: true
        sort_order: 17
        video_url: null
      - id: 019d8b40-i502-7001-b010-laravel000502
        title: 'Lesson 18: Inertia.js & Vue/React Integration'
        slug: bai-18-inertiajs-va-vue-react
        description: >-
          Inertia.js monolith architecture. Laravel + Vue/React SPA. Shared
          data, form helpers, file uploads. Server-side rendering. Inertia vs
          Livewire vs traditional SPA.
        duration_minutes: 120
        is_free: true
        sort_order: 18
        video_url: null
  - id: section-06
    title: 'Part 6: Testing, Docker & Production'
    ...
    lessons:
      - id: 019d8b40-i601-7001-b010-laravel000601
        ...
        description: >-
          PHPUnit, Pest testing framework. Feature tests, unit tests. Database
          testing, factories. HTTP testing, mocking. Browser testing (Laravel
          Dusk). Code coverage.
        duration_minutes: 150
        is_free: true
        sort_order: 19
      ...
      - id: 019d8b40-i602-7001-b010-laravel000602
        title: 'Lesson 20: Clean Architecture & Packages'
      ...
      - id: 019d8b40-i603-7001-b010-laravel000603
        ...
        description: >-
          Dockerfile for Laravel (PHP-FPM + Nginx). Laravel Sail, Docker
      ...
      - id: 019d8b40-i604-7001-b010-laravel000604
        ...
        description: >-
          ...
          monitoring. Sentry error tracking, structured logging. Prometheus
          metrics, health checks. Scaling strategies (Octane, load balancer,
          queue workers).
        duration_minutes: 150
        is_free: true
        sort_order: 22
...
The course **Laravel: From Basics to Advanced** helps you master Laravel — the most popular PHP framework with a powerful "batteries included" ecosystem, from Eloquent ORM to real-time broadcasting and production deployment.
...
- Basic PHP 8.x knowledge (classes, namespaces, traits)
- Basic understanding of HTTP, HTML, SQL
- Composer, PHP 8.4+ and Docker
