...
description: >-
  CSRF protection, XSS prevention. SQL injection, mass assignment protection.
  Rate limiting, encryption. CORS configuration. HTTPS enforcement, security
  headers. OWASP for Laravel.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 12
...
<p>Next article: <strong>Queues & Jobs</strong>.</p>
