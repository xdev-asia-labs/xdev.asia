...
description: >-
  What is Laravel, "elegant syntax" philosophy. Compare Laravel vs Symfony vs
  Django vs Spring. PHP 8.4 essentials (readonly, enums, fibers, named
  arguments). Laravel Sail, Herd setup.
duration_minutes: 60
is_free: true
video_url: null
sort_order: 1
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 Programming — Lesson 1</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 1: Introducing Laravel — PHP framework</tspan>
      <tspan x="60" dy="42">The most elegant</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="244" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Laravel: From Basics to Advanced</text>

  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: Laravel Fundamentals</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-laravel-la-gi"><strong>1. What is Laravel?</strong></h2>

<p>Laravel is the most popular PHP framework, philosophically <strong>"elegant syntax"</strong> — code is clean, easy to read, developer experience comes first. Laravel provides a complete ecosystem: ORM (Eloquent), queue, cache, auth, testing, deployment.</p>

<table>
<thead><tr><th>Framework</th><th>Language</th><th>ORM</th><th>Advantages</th></tr></thead>
<tbody>
<tr><td>Laravel</td><td>PHP</td><td>Eloquent</td><td>Big ecosystem, great DX</td></tr>
<tr><td>Symfony</td><td>PHP</td><td>Doctrine</td><td>Enterprise, flexible</td></tr>
...
<h2 id="3-setup"><strong>3. Install Laravel</strong></h2>
...
<h2 id="4-structure"><strong>4. Folder structure</strong></h2>
...
<p>Next article: <strong>Routing, Controllers & Middleware</strong>.</p>
