...
description: >-
  Validation rules, custom validation. Form Request classes, authorization.
  Error messages, localization. File validation, conditional validation. Custom
  validation rules.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 6: Validation & Form Requests</tspan>
  </text>
...
<h2 id="1-validation"><strong>1. Basic validation</strong></h2>
...
<p>Next article: <strong>API Resources & Response</strong>.</p>
