...
description: >-
  Notification channels (mail, database, Slack, SMS). Markdown mail, Mailables.
  Task scheduling, custom Artisan commands. laravel-data for DTOs. Service
  container deep dive.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Notifications, Mail & Scheduler</tspan>
  </text>
...
<p>Next article: <strong>Caching, Sessions & Performance</strong>.</p>
