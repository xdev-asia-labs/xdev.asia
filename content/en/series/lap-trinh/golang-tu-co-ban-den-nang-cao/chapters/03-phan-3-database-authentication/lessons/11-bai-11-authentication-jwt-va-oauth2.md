...
description: >-
  JWT with golang-jwt, bcrypt password hashing. Access token, refresh token,
  token rotation. OAuth2 flows, social login with Google/GitHub. Session
  management.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: Authentication - JWT & OAuth2</tspan>
  </text>
...
<h2 id="1-password-hashing"><strong>1. Password Hashing with bcrypt</strong></h2>
...
<h2 id="2-jwt-authentication"><strong>2. JWT Authentication</strong></h2>
...
<h3 id="2-2-token-service"><strong>2.2. Service Tokens</strong></h3>
...
<h2 id="4-auth-middleware"><strong>4. Auth Middleware</strong></h2>
...
<h2 id="5-auth-handlers"><strong>5. Auth Handlers</strong></h2>
...
<h2 id="6-security-best-practices"><strong>6. Security Best Practices</strong></h2>

<ul>
<li><strong>Passwords</strong>: bcrypt (cost ≥ 10), NO md5/sha256 alone</li>
<li><strong>JWT</strong>: Short-lived access tokens (15 min), long-lived refresh tokens (7 days)</li>
<li><strong>Token rotation</strong>: Issue new token pair when refreshing</li>
<li><strong>Secrets</strong>: Use env vars, NO hardcode in the code</li>
<li><strong>HTTPS</strong>: Always use HTTPS in production</li>
<li><strong>Rate limiting</strong>: Limit login attempts (brute force protection)</li>
<li><strong>Error messages</strong>: Generic "Invalid credentials", does not reveal email exists</li>
</ul>

<p>Next article: <strong>Authorization, Security & Middleware</strong> — RBAC, Casbin, and advanced security.</p>
