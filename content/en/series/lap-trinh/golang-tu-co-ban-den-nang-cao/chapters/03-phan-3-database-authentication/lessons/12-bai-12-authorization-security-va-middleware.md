...
description: >-
  RBAC with Casbin, permission models. CORS configuration, rate limiting,
  security headers. Input validation, SQL injection prevention, XSS protection.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 Programming — Lesson 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Authorization, Security &</tspan>
      <tspan x="60" dy="42">Middleware</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Database & Authentication</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-rbac-voi-casbin"><strong>1. Role-Based Access Control (RBAC) with Casbin</strong></h2>
...
<li><strong>act. act</strong>: action (HTTP method)</li>
</ul>
...
<h2 id="7-middleware-chain"><strong>7. Complete Middleware Chain</strong></h2>
...
<table>
<thead><tr><th>Layer</th><th>Purpose</th><th>Tools</th></tr></thead>
<tbody>
<tr><td>Authentication</td><td>User authentication</td><td>JWT + bcrypt</td></tr>
<tr><td>Authorization</td><td>Decentralization</td><td>RBAC Casbin</td></tr>
<tr><td>Rate Limiting</td><td>Anti-DDoS/brute force</td><td>golang.org/x/time/rate</td></tr>
<tr><td>Input Validation</td><td>Validate & sanitize input</td><td>go-playground/validator</td></tr>
<tr><td>SQL Prevention</td><td>Prevent SQL injection</td><td>GORM parameterized queries</td></tr>
...
<p>Next article: <strong>WebSockets & Real-time Communication</strong> — gorilla/websocket, chat rooms, and broadcast patterns.</p>
