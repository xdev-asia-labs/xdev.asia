...
description: >-
  ...
  Dependency Injection with Wire/Fx. Clean Architecture project structure.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 10
section_title: 'Part 3: Database & Authentication'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 Programming — Lesson 10</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Migrations & Repository Pattern</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Database & Authentication</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-database-migrations"><strong>1. Database Migrations</strong></h2>

<p>GORM AutoMigrate is convenient for development but <strong>Not suitable for production</strong> because it does not support rollback, does not track versions, and does not manage secure schema changes. Use specialized migration tools.</p>

<h3 id="1-1-golang-migrate"><strong>1.1. golang-migrate</strong></h3>
...
<h3 id="1-2-migrate-in-code"><strong>1.2. Run migrations in code</strong></h3>
...
<h3 id="1-3-makefile"><strong>1.3. Makefile for migrations</strong></h3>
...
<h2 id="2-repository-pattern"><strong>2. Repository Pattern</strong></h2>

<p>The Repository pattern separates data access logic from business logic, making code easy to test and maintain.</p>

<h3 id="2-1-interface"><strong>2.1. Repository Interface</strong></h3>
...
<h3 id="2-2-gorm-implementation"><strong>2.2. GORM Implementation</strong></h3>
...
<h2 id="3-service-layer"><strong>3. Service Layer</strong></h2>
...
<h2 id="4-dependency-injection"><strong>4. Dependency Injection</strong></h2>

<h3 id="4-1-manual-di"><strong>4.1. Manual DI (Constructor Injection)</strong></h3>
...
<h3 id="4-2-wire"><strong>4.2. Google Wire (Code Generation DI)</strong></h3>
...
<h2 id="5-clean-architecture"><strong>5. Clean Architecture</strong></h2>
...
<ul>
<li><strong>Migrations</strong>: golang-migrate for version-controlled schema changes</li>
<li><strong>Repository pattern</strong>: Interface + implementation, separate data access</li>
<li><strong>Service layer</strong>: Business logic, validation, orchestration</li>
<li><strong>Dependency Injection</strong>: Manual (small), Wire/Fx (large)</li>
<li><strong>Clean Architecture</strong>: Handler → Service → Repository → Model</li>
</ul>

<p>Next article: <strong>Authentication - JWT & OAuth2</strong> — secure API with JWT tokens.</p>
