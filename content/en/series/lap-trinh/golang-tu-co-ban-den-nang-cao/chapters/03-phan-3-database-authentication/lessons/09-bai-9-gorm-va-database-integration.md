...
description: >-
  GORM v2 ORM, models, associations (HasOne, HasMany, BelongsTo, Many2Many).
  CRUD operations, scopes, hooks. Connection pool tuning. Compare GORM vs sqlx
  vs sqlc vs Ent.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: GORM & Database Integration</tspan>
  </text>
...
<table>
<thead>
<tr><th>Library</th><th>Type</th><th>Advantages</th><th>Disadvantages</th></tr>
</thead>
<tbody>
...
<tr><td><strong>sqlc</strong></td><td>Code generator</td><td>Type-safe, compile-time check</td><td>SQL-first, complicated setup</td></tr>
<tr><td><strong>Ent</strong></td><td>Graph ORM</td><td>Schema-first, code generation</td><td>Learning curve, opinionated</td></tr>
<tr><td><strong>Bun</strong></td><td>SQL-first ORM</td><td>Fast, struct mapping, migrations</td><td>Less popular</td></tr>
</tbody>
</table>

<p>This course focuses on <strong>GORM v2</strong> — Most popular ORM for Go, suitable for most projects.</p>

<h2 id="2-setup"><strong>2. Setup GORM with PostgreSQL</strong></h2>
...
<li><strong>Models</strong>: Struct tags for column config, soft delete with gorm.DeletedAt</li>
<li><strong>CRUD</strong>: Create, Find, Update, Delete with chainable query builder</li>
...
<p>Next article: <strong>Migrations & Repository Pattern</strong> — database migrations and clean architecture.</p>
