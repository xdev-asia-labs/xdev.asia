...
description: >-
  ...
  constants, iota. If/else, switch, for loops, range. Type assertions and type
  switches.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Variables, Types & Control Flow</tspan>
  </text>
...
<h2 id="1-variables"><strong>1. Declare variables in Go</strong></h2>

<p>Go has many ways to declare variables, each suitable for a different context:</p>

<h3 id="1-1-var-keyword"><strong>1.1. Use <code>var</code></strong></h3>
...
<p><strong>Rules of use</strong>: Use <code>:=</code> in function (short). Use <code>var</code> at package level or when zero value is needed.</p>

<h3 id="1-3-constants"><strong>1.3. Constants et <code>iota</code></strong></h3>
...
<tr><td><code>int32</code> / <code>runes</code></td><td>4 bytes</td><td>-2^31 → 2^31-1</td><td>0</td></tr>
...
<tr><td><code>uint8</code> / <code>bytes</code></td><td>1 byte</td><td>0 → 255</td><td>0</td></tr>
...
<h3 id="3-2-slice"><strong>3.2. Slice (Dynamic array) - Most important!</strong></h3>
...
<p>Every variable in Go is initialized with zero value if no value is assigned:</p>
...
<tr><td><code>string.string</code></td><td><code>""</code> (empty string)</td></tr>
<tr><td><code>pointer, slice, map, func, interface, channel</code></td><td><code>nil</code></td></tr>
<tr><td><code>array. array</code></td><td>Array of zero values</td></tr>
<tr><td><code>struct</code></td><td>Structure with zero-value fields</td></tr>
</tbody>
</table>
...
<p>Go has a simple but complete type system. Important points to remember:</p>

<ul>
<li><strong>Use <code>:=</code></strong> for local variables, <code>var</code> for package level or zero value</li>
<li><strong>Slice</strong> Used more than Array, always used <code>append. append</code> to add elements</li>
<li><strong>Map</strong> right <code>make</code> before write (nil map → panic)</li>
<li><strong>Pointer</strong> Use when you need to modify the value or avoid large copies</li>
<li><strong>Zero values</strong> This is an important feature that helps make code safer</li>
<li><strong>For</strong> is the only loop, used <code>range. range</code> to iterate</li>
<li><strong>Type conversion</strong> always explicit, no implicit conversion</li>
</ul>

<p>Next article: <strong>Functions, Interfaces & Error Handling</strong> — three pillars of Go programming.</p>
