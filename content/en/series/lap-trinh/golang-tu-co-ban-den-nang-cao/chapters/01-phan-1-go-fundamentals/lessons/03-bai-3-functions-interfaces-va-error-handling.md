...
description: >-
  Functions, multiple return values, variadic functions. Interfaces, embedding,
  composition over inheritance. Error handling patterns, custom errors,
  errors.Is/As, panic/recover.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">💻 Programming — Lesson 3</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Functions, Interfaces & Errors</tspan>
...
<h2 id="1-functions"><strong>1. Functions in Go</strong></h2>

<p>Functions are the basic building block in Go. Go functions have many unique features compared to other languages.</p>
...
<p>Interfaces in Go are <strong>implicit.implicit</strong> — type only needs to implement methods, no need to declare "implements". This is a big difference compared to Java/C#.</p>

<h3 id="2-1-basic-interface"><strong>2.1. Interface definition</strong></h3>
...
<h3 id="2-2-common-interfaces"><strong>2.2. Common Interfaces in Go</strong></h3>
...
<p>Go has no exceptions (try-catch). Error handling used <strong>explicit return values</strong> — this is an intentional design choice.</p>
...
<h3 id="3-5-error-patterns"><strong>3.5. Error Handling Patterns are commonly used</strong></h3>
...
<h2 id="4-struct-embedding"><strong>4. Structure Embedding (Composition)</strong></h2>
...
<li><strong>Composition</strong>: Structure embedding instead of inheritance</li>
<li><strong>Panic/Recover</strong>: Only for unrecoverable errors, not for business logic</li>
</ul>

<p>Next article: <strong>Generics, Packages & Modules</strong> — type parameters system and code management in Go.</p>
