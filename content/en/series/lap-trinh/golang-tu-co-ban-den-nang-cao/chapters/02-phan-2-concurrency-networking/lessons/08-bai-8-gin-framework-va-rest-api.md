...
description: >-
  Gin framework setup, routing, middleware. Request binding, validation with
  go-playground/validator. Response handling, error management. Swagger docs
  with swaggo. Compare Gin vs Fiber vs Echo vs Chi.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 Programming — Lesson 8</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Gin Framework & REST API</tspan>
  </text>
...
<h2 id="1-gioi-thieu-gin"><strong>1. Introducing Gin Framework</strong></h2>

<p>Gin is the most popular HTTP web framework for Go. Gin stands out for its high performance (using httprouter), intuitive API, and rich middleware ecosystem.</p>

<h3 id="1-1-so-sanh"><strong>1.1. Compare Gin vs other Frameworks</strong></h3>

<table>
<thead>
<tr><th>Criteria</th><th>Gin</th><th>Echo</th><th>Fiber</th><th>Chi</th></tr>
</thead>
<tbody>
<tr><td>Performance</td><td>Very high</td><td>Very high</td><td>Highest (fasthttp)</td><td>High</td></tr>
...
<tr><td>Middleware</td><td>Many</td><td>Many</td><td>Many</td><td>Chi compatible</td></tr>
...
<p><strong>When to choose Gin?</strong> Most popular, lots of resources, good balance between features and performance. Suitable for most projects.</p>
...
<h2 id="7-project-structure"><strong>7. Project Structure for Gin API</strong></h2>
...
<ul>
<li><strong>Gin</strong>: Most popular framework, high performance, rich middleware</li>
<li><strong>Routing</strong>: Groups, path params, query params, wildcards</li>
<li><strong>Binding</strong>: ShouldBindJSON, ShouldBindQuery with validator tags</li>
...
<p>Next part: <strong>GORM & Database Integration</strong> — connect Go to PostgreSQL and process the data layer.</p>
