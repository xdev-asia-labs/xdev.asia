...
description: >-
  gorilla/websocket, connection lifecycle. Chat rooms, broadcast patterns.
  Real-time notifications, heartbeat & reconnection. Scaling WebSockets.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">💻 Programming — Lesson 13</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: WebSockets & Real-time</tspan>
  </text>
...
<h2 id="1-websocket-fundamentals"><strong>1. WebSocket Fundamentals</strong></h2>

<p>WebSocket provides a full-duplex connection between client and server over a single TCP connection. Unlike HTTP request/response, WebSocket allows the server to proactively push data to the client.</p>

<table>
<thead><tr><th>Features</th><th>HTTP</th><th>WebSockets</th></tr></thead>
<tbody>
<tr><td>Connection. Connection</td><td>Short-lived</td><td>Persistent</td></tr>
<tr><td>Direction</td><td>Client → Server</td><td>Bi-directional</td></tr>
<tr><td>Protocol</td><td>HTTP/1.1, HTTP/2</td><td>ws://, wss://</td></tr>
<tr><td>Overhead</td><td>Headers per request</td><td>Minimal frame header</td></tr>
<tr><td>Use cases</td><td>REST API</td><td>Chat, notifications, live data</td></tr>
</tbody>
</table>

<h2 id="2-gorilla-websocket-setup"><strong>2. gorilla/websocket Setup</strong></h2>

<pre><code class="language-bash">go get github.com/gorilla/websocket
</code></pre>

<h3 id="2-1-basic-echo-server"><strong>2.1. Basic Echo Server</strong></h3>
...
<h2 id="3-chat-room-pattern"><strong>3. Chat Room — Hub Pattern</strong></h2>

<h3 id="3-1-hub"><strong>3.1. Hub (connection management)</strong></h3>
...
<h3 id="3-2-client"><strong>3.2. Client</strong></h3>
...
<h3 id="3-3-handler"><strong>3.3. WebSocket Handler with Gin</strong></h3>
...
<h2 id="4-heartbeat-reconnection"><strong>4. Heartbeat & Reconnection</strong></h2>
...
<h2 id="5-scaling-websockets"><strong>5. Scaling WebSockets with Redis Pub/Sub</strong></h2>
...
<p>Next article: <strong>gRPC & Protocol Buffers</strong> — high-performance RPC communication.</p>
