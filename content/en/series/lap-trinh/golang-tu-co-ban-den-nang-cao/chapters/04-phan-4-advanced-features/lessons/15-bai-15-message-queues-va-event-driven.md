...
description: >-
  RabbitMQ with Go, exchanges & queues. Kafka producer/consumer. Event-driven
  architecture patterns. Saga pattern, outbox pattern. Dead letter queues &
  retry strategies.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 Programming — Lesson 15</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Message Queues & Event-Driven</tspan>
  </text>
...
<h2 id="1-message-queue-overview"><strong>1. Message Queue Overview</strong></h2>

<table>
<thead><tr><th>Features</th><th>RabbitMQ</th><th>Kafka</th><th>NATS</th></tr></thead>
<tbody>
<tr><td>Model</td><td>Message Broker</td><td>Event Log</td><td>Pub/Sub</td></tr>
<tr><td>Ordering</td><td>Per queue</td><td>Per partition</td><td>No guarantee</td></tr>
<tr><td>Persistence</td><td>Optional</td><td>Always (retention)</td><td>Optional (JetStream)</td></tr>
<tr><td>Throughput</td><td>~50K msg/s</td><td>~1M msg/s</td><td>~10M msg/s</td></tr>
<tr><td>Use cases</td><td>Task queues, RPC</td><td>Event streaming</td><td>Microservices, IoT</td></tr>
<tr><td>Complexity</td><td>Medium</td><td>High</td><td>Low</td></tr>
</tbody>
</table>

<h2 id="2-rabbitmq-voi-go"><strong>2. RabbitMQ with Go</strong></h2>

<h3 id="2-1-setup"><strong>2.1. Setup</strong></h3>

<pre><code class="language-bash">go get github.com/rabbitmq/amqp091-go
</code></pre>

<h3 id="2-2-connection-manager"><strong>2.2. Connection Manager</strong></h3>
...
<h3 id="2-3-publisher"><strong>2.3. Publisher</strong></h3>
...
<h3 id="2-4-consumer"><strong>2.4. Consumer</strong></h3>
...
<h2 id="3-kafka"><strong>3. Kafka with Go</strong></h2>
...
<h2 id="4-event-driven-patterns"><strong>4. Event-Driven Patterns</strong></h2>

<h3 id="4-1-event-bus"><strong>4.1. Domain Events</strong></h3>
...
<h3 id="4-2-outbox-pattern"><strong>4.2. Outbox Pattern (Transactional Outbox)</strong></h3>
...
<h2 id="5-retry-strategies"><strong>5. Retry Strategies</strong></h2>
...
<p>Next article: <strong>Caching, File Upload & Performance</strong> — Redis caching, file upload, and optimization.</p>
