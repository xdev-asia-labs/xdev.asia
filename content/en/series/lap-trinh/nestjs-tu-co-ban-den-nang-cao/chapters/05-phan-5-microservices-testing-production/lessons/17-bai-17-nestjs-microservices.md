...
description: >-
  Microservices Architecture with NestJS. TCP, Redis, RabbitMQ, gRPC transports.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 Programming — Lesson 17</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: NestJS Microservices</tspan>
  </text>
...
<h2 id="1-overview"><strong>1. Microservices in NestJS</strong></h2>

<p>NestJS supports many transport layers for microservices:</p>

<ul>
<li><strong>TCP</strong>: Built-in, simple, used for internal services</li>
<li><strong>Redis</strong>: Pub/Sub pattern</li>
<li><strong>RabbitMQ (AMQP)</strong>: Powerful message queue</li>
...
<li><strong>TCP</strong>: Simple, internal services</li>
...
<li><strong>Hybrid</strong>: HTTP + Microservice in the same app</li>
</ul>

<p>The next article will explore <strong>Testing in NestJS</strong>.</p>
