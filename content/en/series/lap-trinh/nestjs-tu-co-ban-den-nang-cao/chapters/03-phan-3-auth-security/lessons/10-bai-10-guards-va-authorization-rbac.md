...
description: >-
  Guards in NestJS, AuthGuard, RolesGuard. Role-Based Access Control (RBAC),
  Permission-based authorization. Custom decorators @Roles(), @Public(). CASL
  integration.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Guards and Authorization - RBAC</tspan>
  </text>
...
<h2 id="1-guards-la-gi"><strong>1. What are Guards?</strong></h2>

<p>Guards decide whether the request is allowed to continue or not. They run <strong>after middleware, before interceptors and pipes</strong>. Main use cases: <strong>Authorization</strong> — check if the user has permission to access the resource.</p>
...
<h3 id="su-dung"><strong>Use</strong></h3>
...
<ul>
<li><strong>Guards</strong>: Decide whether the request will continue (canActivate)</li>
<li><strong>RBAC</strong>: Role-based qua @Roles() + RolesGuard</li>
<li><strong>Permissions</strong>: Fine-grained with permission strings</li>
<li><strong>Owner Guard</strong>: Resource ownership checking</li>
<li><strong>CASL</strong>: Attribute-based access control for complex logic</li>
<li><strong>Composite Decorators</strong>: @Auth() aggregates multiple guards</li>
</ul>

<p>The next article will explore <strong>Security Best Practices</strong> in NestJS.</p>
