...
description: >-
  Implement Authentication with @nestjs/passport, Local strategy, JWT strategy.
  Access token, Refresh token, Token rotation. Bcrypt password hashing.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Authentication with Passport and JWT</tspan>
  </text>
...
<h2 id="2-user-entity"><strong>2. User Entity with Password</strong></h2>
...
<h2 id="7-protect-routes"><strong>7. Protect Routes</strong></h2>
...
<li><strong>Access Tokens</strong>: Short term (15m), sent in Authorization header</li>
<li><strong>Refresh Tokens</strong>: Long term (7d), save hashed in DB</li>
<li><strong>Token Rotation</strong>: Each refresh creates a new pair of tokens</li>
<li><strong>Global Guard + @Public()</strong>: Pattern protects all default routes</li>
</ul>

<p>The next article will explore <strong>Guards and Authorization — RBAC</strong>.</p>
