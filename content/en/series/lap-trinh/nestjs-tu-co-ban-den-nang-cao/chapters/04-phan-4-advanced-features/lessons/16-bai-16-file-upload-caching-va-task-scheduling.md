...
description: >-
  File upload with Multer, S3 storage. Cache with Redis. Task scheduling with
  @nestjs/schedule. Queue with Bull.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">💻 Programming — Lesson 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: File Upload, Caching and Tasks</tspan>
      <tspan x="60" dy="42">Scheduling</tspan>
  </text>
...
<h2 id="1-file-upload"><strong>1. File Upload with Multer</strong></h2>
...
<h2 id="2-caching"><strong>2. Caching with Redis</strong></h2>
...
<h2 id="4-queue"><strong>4. Queue with Bull</strong></h2>
...
<ul>
<li><strong>File Upload</strong>: Multer for local, S3 for production, validate file type + size</li>
<li><strong>Caching</strong>: Redis-backed cache, cache invalidation, custom decorators</li>
<li><strong>Scheduling</strong>: Cron jobs, intervals, timeouts for background tasks</li>
<li><strong>Queue</strong>: Bull + Redis for async job processing (email, image, report)</li>
</ul>

<p>The next article will explore <strong>NestJS Microservices</strong>.</p>
