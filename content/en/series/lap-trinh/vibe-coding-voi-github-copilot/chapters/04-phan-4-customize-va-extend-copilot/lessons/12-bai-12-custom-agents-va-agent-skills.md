...
title: 'Lesson 12: Custom Agents & Agent Skills — Create specialized AI'
slug: bai-12-custom-agents-va-agent-skills
description: >-
  Create custom agent (.agent.md): roles, tools, instructions. YAML frontmatter.
  Agent Skills (SKILL.md): reusable domain knowledge. For example: Code Reviewer
  agent, Documentation Writer agent, Test Generator agent. Share agents within
  the team via .github/agents/.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 12
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Custom Agents & Agent Skills — Create</tspan>
...
<h2 id="1-custom-agents-la-gi"><strong>1. What are Custom Agents?</strong></h2>

<p>Custom Agents allow you to create <strong>Specialized AI personas</strong> for specific tasks. Each agent has:</p>

<ul>
<li><strong>Role</strong>: specific role (reviewer, tester, documenter)</li>
<li><strong>Tools</strong>: list of tools allowed to use</li>
<li><strong>Instructions</strong>: detailed instructions for behavior</li>
<li><strong>Model</strong>: can specify specific model (optional)</li>
</ul>

<h2 id="2-tao-custom-agent"><strong>2. Create Custom Agent</strong></h2>

<h3>2.1. File structure</h3>
<p>Custom agents are files <code>.agent.md</code> put in <code>.github/agents/</code>:</p>
...
<h3>2.2. .agent.md file structure</h3>
...
<p>Agent Skills is <strong>domain knowledge modules</strong> can be reused by multiple agents. Each skill is a file <code>SKILL.md</code>.</p>
...
<h2 id="5-su-dung-custom-agents"><strong>5. Use Custom Agents</strong></h2>

<ol>
<li>Open Chat view (<code>Ctrl+Cmd+I</code>)</li>
<li>Click agent dropdown (default "Agent")</li>
<li>Select the custom agent you created (Reviewer, TestWriter, etc.)</li>
<li>Prompt as usual — agent will follow role and instructions</li>
</ol>
...
<td>Ask user questions</td>
<td>Low</td>
</tr>
</tbody>
</table>

<p><strong>Security tips:</strong> Review-only agents (Reviewer) should <strong>no</strong> <code>editFile</code> and <code>runInTerminal</code>.</p>

<h2 id="7-chia-se-agents-trong-team"><strong>7. Share Agents in Team</strong></h2>

<p>Commit all <code>.github/agents/</code> go to the repository → every member has the same agents. This is a way to standardize AI workflow for the team.</p>
...
<td>AI persona with role + tools + instructions</td>
</tr>
<tr>
...
<p>The next song will be a cover <strong>MCP Servers</strong> — connect Copilot to Figma, databases, APIs and any external tools.</p>
