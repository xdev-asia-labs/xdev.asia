...
title: 'Lesson 10: Advanced Prompt Patterns — Slash Commands, Participants & Variables'
slug: bai-10-prompt-patterns-nang-cao
description: >-
  Slash commands (/init, /fix, /tests, /doc, /explain). Chat participants
  (@workspace, @terminal, @vscode). Context variables (#file, #selection,
  #codebase). Combining patterns. Prompt templates for common use cases.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">💻 Programming — Lesson 10</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Advanced Prompt Patterns — Slash</tspan>
...
<p>Slash commands are <strong>shortcuts</strong> for common tasks. Type <code>/</code> in chat to see the list:</p>
...
<td>Create custom instructions for the project</td>
<td><code>/init</code> (analyze codebase and create copilot-instructions.md)</td>
</tr>
<tr>
<td><code>/fix</code></td>
<td>Fix current code or error</td>
...
<h3>1.1. /init — Setup AI for project</h3>
<p>The most important Slash command! Run <code>/init</code> When starting to use Copilot for a project:</p>
...
<h3>1.3. /tests — Generate tests automatically</h3>
...
<p>Chat participants (starting with <code>@</code>) are "experts" for specific domains:</p>
...
<td>Understand the entire codebase</td>
<td>Ask about project structure, find related code</td>
</tr>
<tr>
<td><code>@terminal</code></td>
<td>Terminal commands</td>
<td>Command explanation, fix terminal errors</td>
</tr>
<tr>
<td><code>@vscode</code></td>
<td>VS Code features</td>
<td>Ask about settings, shortcuts, extensions</td>
</tr>
</tbody>
</table>
...
<h2 id="3-combining-patterns"><strong>3. Combining Patterns — Real power</strong></h2>

<p>Combine slash commands, participants, and context variables for powerful prompts:</p>
...
<h2 id="4-prompt-library-ca-nhan"><strong>4. Build a personal Prompt Library</strong></h2>

<p>Create a collection of commonly used prompt templates:</p>

<h3>4.1. Save prompt files in project</h3>
<p>Create folders <code>.github/prompts/</code> with files <code>.prompt.md</code>:</p>
...
<h3>4.2. Use prompt files</h3>
<p>In Chat, reference prompt file:</p>
...
<td>Reusable templates for recurring tasks</td>
</tr>
</tbody>
</table>

<p>Combine it all, you have one <strong>prompt toolkit</strong> complete for effective Vibe Coding. From Part 4, we will customize and extend Copilot's capabilities with <strong>Custom Instructions, Custom Agents, and MCP Servers</strong>.</p>
