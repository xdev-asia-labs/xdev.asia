...
description: >-
  ...
  Spring Cache abstraction with Caffeine and Redis. Cache eviction strategies.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Transaction Management & Caching</tspan>
  </text>
...
| REQUIRES_NEW | Always create new TX, suspend old TX |
| NESTED | Nested TX, rollback does not affect parent TX |
| SUPPORTS | Use TX if available, do not create new |
| NOT_SUPPORTED | Run outside TX, suspend TX if available |
| MANDATORY | Must have TX, throw exception otherwise |
| NEVER | There must be no TX, throw exception if there is |
