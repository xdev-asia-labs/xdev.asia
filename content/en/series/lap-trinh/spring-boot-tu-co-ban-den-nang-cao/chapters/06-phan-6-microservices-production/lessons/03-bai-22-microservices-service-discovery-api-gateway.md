...
title: 'Lesson 22: Microservices — Service Discovery & API Gateway'
slug: bai-22-microservices-service-discovery-api-gateway
description: >-
  Microservices Architecture with Spring Boot. Service Discovery with
  Consul/Eureka. Spring Cloud Gateway. Circuit Breaker with Resilience4j. Config
  Server.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 Programming — Lesson 21</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 22: Microservices — Service Discovery</tspan>
...
Microservices architecture divides the application into small, independent services. Spring Cloud provides full tools: Service Discovery, API Gateway, Circuit Breaker, Config Server to build production-ready microservices systems.
...
- Microservices architecture: each service is independent, has its own database, communicates via REST/gRPC
- Service Discovery (Consul): automatically register/discover services, load balancing with @LoadBalanced
- API Gateway: single entry point, routing, filtering, circuit breaker integration
- Resilience4j Circuit Breaker: protects service from cascading failures with fallback

## Exercises

1. Build 3 microservices (Order, Product, User) with Consul service discovery. Test load balancing when scaling the service
2. Setup Spring Cloud Gateway: routing to 3 services, global logging filter, rate limiting
3. Implement Circuit Breaker for Order → Product communication: test fallback when Product service is down
