...
title: 'Lesson 23: Message Queue — Kafka & RabbitMQ'
slug: bai-23-kafka-rabbitmq-event-driven
description: >-
  Event-Driven Architecture with Message Queues. Apache Kafka — producer,
  consumer, topics. RabbitMQ — exchanges, queues, bindings. Saga pattern for
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 23: Message Queue — Kafka & RabbitMQ</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Microservices & Production</text>
