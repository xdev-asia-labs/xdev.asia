...
description: >-
  Dockerfile multi-stage build. Spring Boot Buildpacks (Cloud Native
  Buildpacks). Docker Compose for development. GraalVM Native Image. Container
  best practices.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">💻 Programming — Lesson 20</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 21: Docker & Containerization for</tspan>
...
Containerization is the first step to bring Spring Boot applications to production. This article guides from basic Dockerfile to multi-stage builds, Cloud Native Buildpacks, GraalVM Native Image, and Docker Compose for local development.
...
Spring Boot creates layered JARs, allowing Docker to cache effectively:
...
Spring Boot supports buildpacks — create Docker images without Dockerfile:
...
| Peak throughput | Highest | ~10-20% lower |
...
Spring Boot automatically starts Docker Compose when running the app and configure connection properties.

---

## 5. Container Best Practices

### 5.1 JVM tuning for Containers
...
- Multi-stage Dockerfile: separate build and runtime stages, significantly reducing image size
- Cloud Native Buildpacks: create Docker images without Dockerfile, `./gradlew bootBuildImage`
- GraalVM Native Image: startup 50-200ms, memory 50-100MB — ideal for serverless
- Docker Compose + Spring Boot Docker Compose Support: automatically start dependencies when developing

## Exercises

1. Write multi-stage Dockerfile for Spring Boot app with layered extraction. Compare image size with single-stage
2. Create full docker-compose.yml: app + PostgreSQL + Redis. Configure healthcheck and depends_on
3. Build GraalVM Native Image, measure startup time and memory usage, compare with JVM mode
