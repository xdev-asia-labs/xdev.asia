...
description: >-
  JUnit Jupiter 6 in Spring Boot 4. Mockito — mock, stub, verify. Test service
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 Programming — Lesson 16</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Unit Testing with JUnit 5 & Mockito</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Spring Boot 4: From Basics to Advanced</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Testing & Code Quality</text>
...
Testing is a mandatory skill for every professional developer. Spring Boot 4 uses JUnit Jupiter 6 and integrates Mockito and AssertJ to write unit tests easily and reliably.
...
- **Integration Tests**: Test multiple components together, real DB
- **E2E Tests**: Test full flow from HTTP request → response

---

## 2. JUnit Jupiter 6 Basics

### 2.1 Main Annotations
...
### 3.2 Stubbing — Define behavior for mocks
...
### 3.3 Verify — Check mock was called correctly
...
- Unit testing follows the Given-When-Then pattern, using @Mock and @InjectMocks to isolate dependencies
- JUnit Jupiter 6: @ParameterizedTest, @DisplayName, assertions API
- Mockito: when().thenReturn() for stubbing, verify() checks interactions, ArgumentCaptor captures parameters
- AssertJ: fluent assertions for collections, exceptions, soft assertions

## Exercises

1. Write unit tests for ProductService: test CRUD operations, mock repository, verify enough scenarios (found, not found, validation error)
2. Write parameterized test for price calculator: many input/output combinations
3. Test OrderService.createOrder(): verify order saved, event published, stock decreased. Test rollback when product not found
