...
title: 'Lesson 9: Spring Security Fundamentals — Authentication & Authorization'
slug: bai-9-spring-security-fundamentals
description: >-
  SecurityFilterChain, HttpSecurity configuration. UserDetailsService,
  PasswordEncoder, login form, HTTP Basic. Role-based access control (RBAC) with
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Spring Security Fundamentals —</tspan>
      <tspan x="60" dy="42">Authentication & Authorization</tspan>
  </text>
