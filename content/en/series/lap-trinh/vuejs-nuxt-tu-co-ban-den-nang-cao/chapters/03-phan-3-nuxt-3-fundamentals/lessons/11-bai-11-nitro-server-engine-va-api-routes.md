...
title: 'Lesson 11: Nitro Server Engine & API Routes'
slug: bai-11-nitro-server-engine-va-api-routes
description: >-
  Nitro server engine, server routes, event handlers. Server middleware, server
  plugins. Server storage, KV storage. Database integration (Drizzle ORM).
  Server utilities.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">💻 Programming — Lesson 11</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: Nitro Server Engine & API Routes</tspan>
  </text>
...
<h2 id="4-drizzle"><strong>4. Database with Drizzle ORM</strong></h2>
...
<p>Next article: <strong>Middleware, Plugins & Modules</strong> — route middleware, Nuxt modules ecosystem.</p>
