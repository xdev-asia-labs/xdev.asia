...
title: 'Lesson 10: Data Fetching & SSR'
slug: bai-10-data-fetching-va-ssr
description: >-
  useFetch, useAsyncData, $fetch. SSR vs CSR vs SSG vs ISR. Hydration, payload
  optimization. useLazyFetch, refresh/execute. Error handling, loading states.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 Programming — Lesson 10</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Data Fetching & SSR</tspan>
  </text>
...
<table>
<thead><tr><th>Mode</th><th>Description</th><th>Config</th></tr></thead>
<tbody>
...
<p>Next article: <strong>Nitro Server Engine & API Routes</strong> — server routes, middleware, database.</p>
