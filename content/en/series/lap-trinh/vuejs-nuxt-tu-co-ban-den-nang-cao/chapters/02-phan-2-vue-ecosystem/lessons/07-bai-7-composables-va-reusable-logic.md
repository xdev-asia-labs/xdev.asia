...
title: 'Lesson 7: Composables & Reusable Logic'
slug: bai-7-composables-va-reusable-logic
description: >-
  Custom composables, VueUse library. useAsyncState, useFetch, useLocalStorage.
  Composable patterns, shared state. Dependency injection with composables.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: Composables & Reusable Logic</tspan>
  </text>
...
<h2 id="1-composable"><strong>1. What is Composable?</strong></h2>

<p>Composable is a function that uses the Composition API to encapsulate and reuse stateful logic. Convention: give names starting with <code>use</code>.</p>
...
<h2 id="2-usage"><strong>2. Use Composable</strong></h2>
...
<h2 id="3-common"><strong>3. Common Composables</strong></h2>
...
<p>Next article: <strong>Forms, Validation & Styling</strong> — VeeValidate, Tailwind CSS, component libraries.</p>
