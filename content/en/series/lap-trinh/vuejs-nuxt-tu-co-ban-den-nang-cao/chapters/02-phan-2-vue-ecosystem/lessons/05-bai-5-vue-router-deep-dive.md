...
title: 'Lesson 5: Vue Router Deep Dive'
slug: bai-5-vue-router-deep-dive
description: >-
  Vue Router 4, route definitions, dynamic routes. Navigation guards
  (beforeEach, beforeRouteEnter). Lazy loading, nested routes. Scroll behavior,
  route meta, route transitions.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Vue Router Deep Dive</tspan>
  </text>
...
<p>Next article: <strong>State Management with Pinia</strong> — stores, getters, actions, plugins.</p>
