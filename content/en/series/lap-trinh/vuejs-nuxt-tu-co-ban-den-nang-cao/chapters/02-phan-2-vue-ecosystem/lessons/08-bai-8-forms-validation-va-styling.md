...
title: 'Lesson 8: Forms, Validation & Styling'
slug: bai-8-forms-validation-va-styling
description: >-
  Form handling, v-model modifiers. VeeValidate, Zod schema validation. Tailwind
  CSS, UnoCSS. Component libraries (PrimeVue, Vuetify, Naive UI). CSS Scoped,
  CSS Modules.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Forms, Validation & Styling</tspan>
  </text>
...
<tr><td>Naive UI</td><td>Custom themes</td><td>90+</td><td>Tree-shakeable</td></tr>
...
<p>Next article: <strong>Nuxt 3 & File-based Routing</strong> — get started with the Nuxt 3 framework.</p>
