...
title: 'Lesson 16: Real-time, WebSockets & i18n'
slug: bai-16-real-time-websockets-va-i18n
description: >-
  WebSocket integration, Socket.IO. Server-Sent Events, polling. @nuxtjs/i18n,
  locale routing, message formatting. @nuxt/content for CMS. PWA support.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Real-time, WebSockets & i18n</tspan>
  </text>
...
<h2 id="2-websocket"><strong>2. WebSocket with Nitro</strong></h2>
...
<p>Next article: <strong>Animations & Transitions</strong> — Vue Transition, GSAP, page transitions.</p>
