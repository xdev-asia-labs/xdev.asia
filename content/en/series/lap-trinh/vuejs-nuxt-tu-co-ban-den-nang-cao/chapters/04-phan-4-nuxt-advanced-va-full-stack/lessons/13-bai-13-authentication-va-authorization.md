...
title: 'Lesson 13: Authentication & Authorization'
slug: bai-13-authentication-va-authorization
description: >-
  nuxt-auth-utils, sidebase/nuxt-auth. JWT, OAuth2 (Google, GitHub). Session
  management, cookie-based auth. Protected routes, RBAC. Lucia Auth integrated.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 Programming — Lesson 13</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Authentication & Authorization</tspan>
  </text>
...
<p>Next article: <strong>Database & ORM in Nuxt</strong> — Drizzle ORM, migrations, CRUD.</p>
