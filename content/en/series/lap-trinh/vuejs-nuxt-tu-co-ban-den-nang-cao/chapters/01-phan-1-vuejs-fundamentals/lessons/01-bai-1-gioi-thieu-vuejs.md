...
title: 'Lesson 1: Introducing Vue.js - The Progressive Framework'
slug: bai-1-gioi-thieu-vuejs
description: >-
  What is Vue.js, the "progressive framework" philosophy. Compare Vue vs React
  vs Angular vs Svelte. Vue DevTools, Vite setup. Single File Components,
  template syntax.
duration_minutes: 60
is_free: true
video_url: null
sort_order: 1
section_title: 'Part 1: Vue.js Fundamentals'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 1: Introducing Vue.js - The Progressive</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: Vue.js Fundamentals</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-vuejs-la-gi"><strong>1. What is Vue.js?</strong></h2>

<p>Vue.js is one <strong>progressive framework</strong> for building user interfaces. "Progressive" means you can start simple and then expand gradually — from a small library to a full-stack framework with Nuxt.</p>

<table>
<thead><tr><th>Features</th><th>Vue</th><th>React</th><th>Angular</th><th>Svelte</th></tr></thead>
<tbody>
<tr><td>Type</td><td>Progressive</td><td>Library</td><td>Full Framework</td><td>Compiler</td></tr>
...
<tr><td>Learning curve</td><td>Easy</td><td>Average</td><td>Difficult</td><td>Easy</td></tr>
</tbody>
</table>

<h2 id="2-setup"><strong>2. Setup with Vite</strong></h2>
...
<p>Install <strong>Vue DevTools</strong> extension on Chrome/Firefox for debugging:</p>

<ul>
<li>See component tree and state</li>
...
<h2 id="6-project-structure"><strong>6. Project structure</strong></h2>
...
<p>Next article: <strong>Reactivity System & Composition API</strong> — ref, reactive, computed, watch.</p>
