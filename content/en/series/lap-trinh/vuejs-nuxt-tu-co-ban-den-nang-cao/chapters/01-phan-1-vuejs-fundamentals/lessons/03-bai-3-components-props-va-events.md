...
title: 'Lesson 3: Components, Props & Events'
slug: bai-3-components-props-va-events
description: >-
  Component registration, props validation. v-model, custom events, emit. Slots
  (default, named, scoped). Provide/inject, component lifecycle hooks.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 Programming — Lesson 3</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Components, Props & Events</tspan>
  </text>
...
<p>Next article: <strong>Directives, Rendering & Template Refs</strong> — custom directives, render functions, Teleport.</p>
