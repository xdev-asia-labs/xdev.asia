...
description: >-
  VyOS firewall architecture (nftables), input/output/forward chains, accept/drop/reject rules, address/network/port groups, state policy, and troubleshooting.
...
<h2>Hands-on Lab: Firewall hoàn chỉnh cho Home Router</h2>
