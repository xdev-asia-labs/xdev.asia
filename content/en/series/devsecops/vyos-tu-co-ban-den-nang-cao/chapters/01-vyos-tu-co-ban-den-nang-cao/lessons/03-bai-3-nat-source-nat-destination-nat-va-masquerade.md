...
description: >-
  Detailed guide to NAT on VyOS: Source NAT, masquerade for LAN, Destination NAT (port forwarding), 1:1 NAT, NPTv6, rule ordering, and troubleshooting.
...
<h2>Hands-on Lab: NAT hoàn chỉnh</h2>
