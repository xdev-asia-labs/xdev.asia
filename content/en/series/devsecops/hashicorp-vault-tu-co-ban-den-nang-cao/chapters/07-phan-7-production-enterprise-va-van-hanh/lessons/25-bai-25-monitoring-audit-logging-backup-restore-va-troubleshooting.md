...
<text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🔒 DevSecOps — Lesson 25</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
<tspan x="60" dy="0">Lesson 25: Monitoring, Audit Logging,</tspan>
<tspan x="60" dy="42">Backup/Restore and Troubleshooting</tspan>
  </text>
...
<h2 id="1-monitoring-voi-prometheus-grafana"><strong>1. Monitoring with Prometheus + Grafana</strong></h2>
...
<h3 id="key-metrics"><strong>Key Metrics to Monitor</strong></h3>
...
<tbody>
<tr><td><code>vault.core.handle_request.count</code></td><td>Total requests</td><td>Trend analysis</td></tr>
...
<h3 id="enable-audit"><strong>Configure Audit Devices</strong></h3>
...
<h2 id="3-backup-restore"><strong>3. Backup and Restore</strong></h2>
...
<tbody>
<tr><td>Vault sealed after restart</td><td>No auto-unseal</td><td>KMS/HSM configuration sealed</td></tr>
<tr><td>503 Service Unavailable</td><td>Node is standby / DR secondary</td><td>Route requests to active node</td></tr>
<tr><td>Lease count increases continuously</td><td>Client does not revoke leases</td><td>Tidy leases, check TTL</td></tr>
<tr><td>Token store is too large</td><td>Orphan tokens are not revoke</td><td>Token tidy, reduce TTL</td></tr>
<tr><td>Raft leader flapping</td><td>Network instability</td><td>Increased heartbeat timeout</td></tr>
...
<ul>
<li><p><strong>Monitoring</strong> — Prometheus metrics + Grafana dashboards + alerting is required</p></li>
<li><p><strong>Audit</strong> — Always enable ≥ 2 audit devices, analyze logs regularly</p></li>
<li><p><strong>Backup</strong> — Automatic Raft snapshots, offsite save, periodic test restore</p></li>
<li><p><strong>Troubleshooting</strong> — Know debug commands, common issues and how to handle them</p></li>
<li><p><strong>Upgrade</strong> — Rolling upgrade for HA cluster, always backup first</p></li>
</ul>

<p>At this point, you have completed the entire <strong>HashiCorp Vault series from Basic to Advanced</strong>. From setup, secrets engines, auth methods, policies, agents, Kubernetes, CI/CD, to production HA, Enterprise, monitoring and operations.</p>
