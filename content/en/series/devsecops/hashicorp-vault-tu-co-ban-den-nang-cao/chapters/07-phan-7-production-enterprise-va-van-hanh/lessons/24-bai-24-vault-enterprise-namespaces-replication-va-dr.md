...
<text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🔒 DevSecOps — Lesson 24</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
<tspan x="60" dy="0">Lesson 24: Vault Enterprise — Namespaces,</tspan>
<tspan x="60" dy="42">Replication and DR</tspan>
  </text>
...
<p><strong>Vault Enterprise</strong> adds enterprise-grade features for large organizations. These are features NOT included in the OSS version.</p>

<table>
<thead>
<tr><th>Feature</th><th>Description</th><th>Tier</th></tr>
</thead>
<tbody>
...
<p>Namespaces creates <strong>isolated Vault instances</strong> within the same cluster. Each namespace has its own auth methods, secrets engines, policies, tokens.</p>
...
<h3 id="quan-ly-namespaces"><strong>Manage Namespaces</strong></h3>
...
<p>Performance Replication allows placing <strong>read replicas</strong> in multiple regions, reducing read operations latency.</p>
...
<h3 id="setup-perf-replication"><strong>Performance Replication Settings</strong></h3>
...
<p>DR Replication creates a <strong>hot standby cluster</strong> ready to promote when the primary cluster fails.</p>

<h3 id="setup-dr"><strong>Set DR</strong></h3>
...
<p>Control Groups require <strong>multi-person approval</strong> before an operation is executed — multi-person approval.</p>
...
<ul>
<li><p><strong>Namespaces</strong> — Multi-tenancy, each team/env manages its own Vault</p></li>
<li><p><strong>Performance Replication</strong> — Cross-region reads, reduced latency</p></li>
...
<li><p><strong>Sentinel</strong> — Policy-as-code, more complex logic than ACL</p></li>
</ul>
