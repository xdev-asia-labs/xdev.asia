...
<text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">🔒 DevSecOps — Lesson 22</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
<tspan x="60" dy="0">Lesson 22: Vault with Terraform, Ansible and</tspan>
...
<p><strong>Terraform Vault Provider</strong> enables Vault as Code configuration management — secrets engines, auth methods, policies, entities, groups, all version-controlled in Git.</p>

<h3 id="cau-hinh-provider"><strong>Provider Configuration</strong></h3>
...
<h3 id="quan-ly-secrets-engines"><strong>Managing Secrets Engines</strong></h3>
...
<h3 id="quan-ly-auth-methods"><strong>Manage Auth Methods</strong></h3>
...
<h3 id="quan-ly-policies"><strong>Policies Management</strong></h3>
...
<h3 id="doc-secrets-tu-vault"><strong>Read secrets from Vault in Terraform</strong></h3>
...
<h2 id="2-ansible-vault-integration"><strong>2. Ansible with Vault</strong></h2>
...
<ul>
<li><p><strong>Terraform Vault Provider</strong> — Vault configuration as code, manage all Vault setup</p></li>
<li><p><strong>Ansible</strong> — lookup plugin and collection for operational workflows</p></li>
...
<li><p><strong>External Secrets Operator</strong> — Kubernetes-native sync from Vault</p></li>
</ul>

<p>The final section will go into Production & Enterprise — HA, Integrated Storage, Replication, Namespaces, Monitoring and Troubleshooting.</p>
