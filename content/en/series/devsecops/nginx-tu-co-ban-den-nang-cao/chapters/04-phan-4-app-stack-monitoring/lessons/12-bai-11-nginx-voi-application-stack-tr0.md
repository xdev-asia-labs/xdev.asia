...
title: 'Lesson 11: Nginx with Application Stack'
slug: bai-11-nginx-voi-application-stack-tr0
description: >-
  A lesson on integrating Nginx with Application Stack — PHP-FPM configuration for WordPress/Laravel, Nginx + Node.js with PM2, Python applications (uWSGI/Gunicorn), Ruby on Rails with Puma, Docker containers, WebSocket proxying, and gRPC.
duration_minutes: 185
is_free: true
video_url: null
sort_order: 11
section_title: "Part 4: Application Stack & Monitoring"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Application Stack &amp; Monitoring</text>
...
[Install]
WantedBy=multi-user.target
</code></pre><hr><h2 id="4-ruby-on-rails-v%E1%BB%9Bi-puma"><strong>4. Ruby on Rails with Puma</strong></h2><h3 id="41-puma-configuration"><strong>4.1. Puma Configuration</strong></h3><p><strong>Puma config file:</strong></p><pre><code class="language-ruby"># config/puma.rb
...
</code></pre><hr><h2 id="t%E1%BB%95ng-k%E1%BA%BFt"><strong>Summary</strong></h2><p>In this lesson, you learned:</p><ul><li>✅ PHP-FPM configuration cho WordPress/Laravel</li><li>✅ Nginx + Node.js với PM2</li><li>✅ Python applications với Gunicorn/uWSGI</li><li>✅ Ruby on Rails with Puma</li><li>✅ Docker container integration</li><li>✅ WebSocket proxying</li><li>✅ gRPC proxying</li><li>✅ Multi-application production setup</li></ul><p><strong>Key takeaways:</strong></p><ul><li>Use appropriate process managers (PHP-FPM, PM2, Gunicorn, Puma)</li><li>Configure proper timeouts và buffering</li><li>Enable keepalive connections</li><li>Use Unix sockets khi possible (faster than TCP)</li><li>Implement health checks</li><li>Monitor application performance</li></ul><p><strong>Next lesson:</strong> Monitoring và Logging - access logs analysis, error tracking, Prometheus integration, ELK stack, real-time monitoring, alerting và dashboard creation để maintain healthy production environments.</p>
