...
title: 'LESSON 25: SECURITY BEST PRACTICES KUBERNETES 2026'
slug: bai-25-security-best-practices-kubernetes-2026
description: SecurityContext (non-root, read-only filesystem, drop capabilities), supply chain security with Cosign/Sigstore, SBOM, secrets encryption at rest, network isolation best practices.
duration_minutes: 90
is_free: false
video_url: null
sort_order: 25
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🔒 DevSecOps — Lesson 25</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 25: SECURITY BEST PRACTICES KUBERNETES</tspan>
...
<h2>🎯 Lesson objectives</h2><p>Master security best practices for Kubernetes 2026: SecurityContext hardening, supply chain security with Cosign, SBOM generation, and secure secrets management.</p>

<h2>1. SecurityContext — Container Hardening</h2>
<p>SecurityContext defines the security settings for the Pod or container. Apply defense-in-depth:</p>
...
<p><strong>readOnlyRootFilesystem</strong>: if the app needs to write files, use <code>emptyDir</code> volume:</p>
...
<p>Verify that container images are built and signed by a trusted source.</p>

<h3>2.1 Sign Image with Cosign</h3>
...
<p>SBOM lists all packages and dependencies in the container image, helping to track vulnerabilities.</p>
...
<p>Instead of storing secrets in Kubernetes etcd, use the External Secrets Operator to sync from:</p>
<ul>
...
spec:
  ...
  - to:
    ...
    - protocol: UDP
      port: 53
</code></pre><h2>7. Audit Logging</h2>
...
<h2>Summary — Security Checklist 2026</h2>
<ul>
  <li>✅ SecurityContext: non-root, readOnlyRootFilesystem, dropAll caps, seccomp RuntimeDefault</li>
  <li>✅ Pod Security Admission: Restricted mode for production namespaces</li>
  <li>✅ Sign images with Cosign, enforce with Policy Controller</li>
  <li>✅ Generate SBOM, scan with Grype</li>
  <li>✅ Secrets encryption at rest or External Secrets Operator</li>
  <li>✅ Network Policies: default-deny</li>
  <li>✅ RBAC: least privilege ServiceAccounts</li>
  <li>✅ Audit logging for Secrets and critical resources__HTMLTAG_135___
  <li>✅ Specific image tags (do not use :latest), pulled from private registry</li>
</ul>