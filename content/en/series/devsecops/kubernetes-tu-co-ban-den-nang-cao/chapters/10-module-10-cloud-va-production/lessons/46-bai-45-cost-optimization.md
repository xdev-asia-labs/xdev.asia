...
title: 'LECTURE 45: COST OPTIMIZATION ON KUBERNETES'
slug: bai-45-cost-optimization-kubernetes
description: 'Cost optimization Kubernetes 2026: Spot/Preemptible nodes, Karpenter consolidation, right-sizing with VPA, Kubecost, namespace budgets, idle resource cleanup, multi-tenant cost allocation.'
duration_minutes: 75
is_free: false
video_url: null
sort_order: 45
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🔒 DevSecOps — Lesson 45</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 45: COST OPTIMIZATION ON KUBERNETES</tspan>
  </text>
...
<h2>🎯 Lesson Objective</h2><p>Understand and apply Kubernetes cost optimization strategies in the cloud: Spot instances, right-sizing, node consolidation, and cost visibility tools.</p>

<h2>1. Why are K8s often more expensive than expected?</h2>
<ul>
  <li><strong>Over-provisioning</strong>: requests/limits set too high compared to actual usage</li>
  <li><strong>Idle nodes</strong>: nodes are not used effectively (utilization &lt; 30%)</li>
  <li><strong>Kube-system overhead</strong>: daemonsets (Cilium, logging agents) taking up resources</li>
  <li><strong>Unused PVs__HTMLTAG_86___: PersistentVolumes of deleted environments still billed</li>
  <li><strong>Load balancers</strong>: each LoadBalancer Service = 1 cloud LB ($18-30/month)</li>
  <li><strong>Data transfer</strong>: cross-AZ traffic between pods costs money</li>
</ul>
...
<h2>4. Right-sizing with VPA and Goldilocks</h2>
...
<h2>6. Reduce Load Balancer Costs</h2>
...
<ul>
  <li>Spot instances: 50-80% savings for fault-tolerant workloads__HTMLTAG_117___
  <li>Karpenter consolidation: automatically consolidate pods, delete idle nodes__HTMLTAG_119___
  <li>Goldilocks + VPA: right-size resources based on actual usage</li>
  <li>Kubecost: visibility into cost per team/namespace/deployment</li>
  <li>1 Gateway replaces many LoadBalancers: significant savings__HTMLTAG_125___
  <li>Topology Aware Routing: reduce cross-AZ traffic costs__HTMLTAG_127___
</ul>