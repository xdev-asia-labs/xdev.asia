...
title: 'LESSON 31: DEBUGGING AND TROUBLESHOOTING KUBERNETES'
slug: bai-31-debugging-va-troubleshooting-kubernetes
description: 'Debugging Kubernetes: kubectl debug, ephemeral containers, kubectl events, kubectl top. Troubleshoot Pod failures, node issues, network problems with Cilium Hubble. Common issues and detailed solutions.'
duration_minutes: 80
is_free: false
video_url: null
sort_order: 31
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🔒 DevSecOps — Lesson 31</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 31: DEBUGGING AND TROUBLESHOOTING</tspan>
...
<h2>🎯 Lesson objectives</h2><p>Master Debugging Kubernetes skills: from Pod failures, Node issues to network problems. Use kubectl debug, ephemeral containers, and Cilium Hubble to diagnose.</p>
...
<h3>2.1 Pod Stuck in Pending</h3>
...
<h2>5. kubectl Events — Source of important information</h2>
...
<ul>
  <li>kubectl debug: ephemeral containers for distroless images, debug node</li>
  <li>CrashLoopBackOff: see <code>kubectl logs --previous</code></li>
  <li>Pending: see Events in <code>kubectl describe pod</code></li>
  <li>Network issues: check endpoints, use Hubble to view dropped packets</li>
  <li>Performance: kubectl top, check CPU throttling in cgroup stats</li>
  <li>Events: <code>kubectl get events --sort-by='.lastTimestamp'</code> is the most important tool</li>
</ul>