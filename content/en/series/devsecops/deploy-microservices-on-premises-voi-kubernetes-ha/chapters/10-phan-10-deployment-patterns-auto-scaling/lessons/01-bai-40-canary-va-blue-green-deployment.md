...
title: 'LESSON 40: CANARY & BLUE-GREEN DEPLOYMENT'
slug: bai-40-canary-va-blue-green-deployment
description: 'Detailed deployment strategies: Canary with Istio/Argo Rollouts, Blue-Green deployment, traffic shifting, automated rollback, and progressive delivery.'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🔒 DevSecOps — Lesson 40</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 40: CANARY &amp; BLUE-GREEN DEPLOYMENT</tspan>
  </text>
...
<ul>
<li>✅ Compare deployment strategies (Rolling, Blue-Green, Canary)</li>
<li>✅ Argo Rollouts for progressive delivery</li>
<li>✅ Canary deployment with traffic shifting</li>
<li>✅ Blue-Green with instant cutover__HTMLTAG_75___
<li>✅ Analysis templates and automated rollback</li>
</ul>

<hr>

<h2 id="phan-1-strategies">PART 1: DEPLOYMENT STRATEGIES</h2>
...
<table>
<thead>
<tr><th>Strategy</th><th>Downtime_</th><th>_Rollback</th><th>Risk</th><th>Resource Cost</th></tr>
</thead>
<tbody>
...
<tr><td>Canary_</td><td>Zero</td><td>Fast_</td><td>Very Low</td><td>Low (+10%)</td></tr>
</tbody>
</table>
<!--kg-card-end: html-->
...
<h2 id="phan-2-argo-rollouts">PART 2: ARGO ROLLOUTS__HTMLTAG_140___
...
<h2 id="phan-3-analysis">PART 3: ANALYSIS TEMPLATES</h2>
...
<h2 id="phan-4-blue-green">PART 4: BLUE-GREEN DEPLOYMENT__HTMLTAG_146___
...
<hr><h2 id="phan-5-operations">PART 5: ROLLOUT OPERATIONS</h2>
...
<h2 id="bai-tap">🎯 EXERCISES__HTMLTAG_181___
...
<h3 id="bt2">Exercise 2: Blue-Green + Smoke Test</h3>
<ul>
<li>Setup Blue-Green Rollout</li>
<li>Create smoke test Job as pre-promotion analysis</li>
<li>Inject error → verify auto-rollback__HTMLTAG_200___
</ul>

<hr>

<h2 id="bai-tiep-theo">📚 NEXT POST</h2>
<p>In <strong>Lesson 41: Horizontal & Vertical Pod Autoscaling</strong>, we will implement auto-scaling for workloads.</p>