...
title: 'LESSON 28: GITOPS WITH ARGOCD — ARCHITECTURE AND INSTALLATION'
slug: bai-28-gitops-voi-argocd-kien-truc-va-cai-dat
description: Understand GitOps principles, ArgoCD architecture, install ArgoCD HA, configure Git repositories, RBAC, SSO, and compare ArgoCD vs FluxCD.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🔒 DevSecOps — Lesson 28</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 28: GITOPS WITH ARGOCD — ARCHITECTURE AND</tspan>
      <tspan x="60" dy="42">SETUP</tspan>
  </text>
...
<ul>
<li>✅ Understand GitOps principles and workflow</li>
<li>✅ ArgoCD architecture: components, sync flow</li>
<li>✅ Install ArgoCD HA on Kubernetes__HTMLTAG_75___
<li>✅ Configure Git repositories and SSH keys</li>
<li>✅ RBAC and SSO integration</li>
<li>✅ Compare ArgoCD vs FluxCD</li>
</ul>

<hr>

<h2 id="phan-1-gitops">PART 1: GITOPS PRINCIPLES</h2>
...
> 4. **Self-healing**: Drift detection + auto-correction<!--kg-card-begin: html-->
<table>
<thead>
...
<tr><td>Multi-cluster</td><td>Native (single pane)_</td><td>Per-cluster agents_</td></tr>
...
<tr><td>RBAC</td><td>Built-in, per-project</td><td>K8s RBAC_</td></tr>
<tr><td>SSO</td><td>OIDC, SAML, LDAP</td><td>Via K8s auth_</td></tr>
<tr><td>Best For</td><td>Central platform teams_</td><td>Distributed teams_</td></tr>
</tbody>
</table>
<!--kg-card-end: html-->
...
<h2 id="phan-2-architecture">PART 2: ARGOCD ARCHITECTURE</h2>
...
<h2 id="phan-3-install">PART 3: INSTALL ARGOCD HA</h2>
...
<h2 id="phan-4-app">PART 4: CREATE ARGOCD APPLICATION</h2>
...
<h2 id="phan-5-applicationset">PART 5: APPLICATIONSET (MULTI-APP GENERATION)</h2>
...
<h2 id="phan-6-notifications">PART 6: NOTIFICATIONS</h2>
...
<ol>
<li><strong>GitOps</strong>: Git is the single source of truth for infrastructure</li>
<li><strong>ArgoCD</strong>: Declarative CD, auto-sync, drift detection, rich UI</li>
<li><strong>HA install</strong>: 2+ replicas for controller, server, repo-server</li>
...
<h2 id="bai-tap">🎯 EXERCISE</h2><h3 id="bt1">Exercise 1: ArgoCD Setup</h3>
<ul>
...
<h3 id="bt2">Exercise 2: ApplicationSet</h3>
<ul>
...
<p>In <strong>Lesson 29: Helm Charts for Microservices — Templates, Values, Dependencies</strong>, we will build reusable Helm charts for the entire microservices stack.</p>