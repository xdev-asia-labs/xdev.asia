...
title: 'LESSON 12: INSTALLING ROOK-CEPH OPERATOR AND CEPHCLUSTER'
slug: bai-12-cai-dat-rook-ceph-operator-va-cephcluster
description: Deploy Rook Operator using Helm, create CephCluster CRD on 3 worker nodes, verify MON/MGR/OSD pods, Ceph Dashboard, and troubleshoot common Ceph issues.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🔒 DevSecOps — Lesson 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 12: INSTALL ROOK-CEPH OPERATOR AND</tspan>
...
<ul>
<li>✅ Deploy Rook Operator with Helm</li>
<li>✅ Create CephCluster CRD with 3 nodes</li>
<li>✅ Verify MON, MGR, OSD pods working</li>
<li>✅ Access Ceph Dashboard</li>
<li>✅ Troubleshoot common Ceph deployment issues</li>
</ul>

<hr>

<h2 id="phan-1-prerequisites">PART 1: PREREQUISITES</h2>

<h3 id="11-verify-disks">1.1. Verify disks on worker nodes</h3>
...
<h3 id="12-lvm2-package">1.2. Install LVM2 (required by Ceph)</h3>
...
<h2 id="phan-2-install-rook-operator">PART 2: INSTALL ROOK OPERATOR</h2>
...
<h2 id="phan-3-create-cephcluster">PART 3: CREATE CEPHCLUSTER</h2>
...
<h2 id="phan-4-ceph-dashboard">PART 4: CEPH DASHBOARD</h2>
...
<h2 id="phan-5-troubleshooting">PART 5: TROUBLESHOOTING</h2>
...
<ol>
<li><strong>Rook Operator</strong> manages the entire Ceph lifecycle on K8s</li>
<li><strong>CephCluster CRD</strong> cluster definition: nodes, devices, replicas, resources</li>
<li><strong>Disks must be clean</strong> (no partition, no filesystem) for Rook OSD prepare to succeed</li>
<li><strong>3 MON + 2 MGR + 3 OSD</strong> is the minimum for HA production</li>
<li><strong>Toolbox pod</strong> for direct ceph CLI access</li>
<li><strong>Dashboard</strong> web UI for monitoring and management</li>
</ol>
...
<h3 id="bt1">Exercise 1: Deploy Ceph cluster</h3>
<ul>
<li>Verify disks on worker nodes__HTMLTAG_152___
<li>Install Rook Operator with Helm</li>
<li>Create CephCluster, wait for HEALTH_OK</li>
</ul>

<h3 id="bt2">Exercise 2: Explore Ceph</h3>
<ul>
<li>Deploy toolbox, run ceph status, ceph osd tree, ceph df</li>
<li>Access Dashboard, explore UI</li>
</ul>

<hr>

<h2 id="bai-tiep-theo">📚 NEXT POST</h2>
<p>In <strong>Lesson 13: CephBlockPool, StorageClass and PVC</strong>, we will create block storage pool and provisioning PersistentVolumes.</p>