...
title: 'LESSON 18: POSTGRESQL BACKUP, PITR AND DISASTER RECOVERY'
slug: bai-18-postgresql-backup-pitr-va-disaster-recovery
description: Automated backup with Barman/S3, ScheduledBackup CRD, Point-in-Time Recovery (PITR), restore cluster from backup, and disaster recovery procedures.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 18: POSTGRESQL BACKUP, PITR AND</tspan>
...
<ul>
<li>✅ Configure backup destination (S3/Ceph Object Store)</li>
<li>✅ Setup ScheduledBackup CRD for automated backups</li>
<li>✅ Practice Point-in-Time Recovery (PITR)</li>
<li>✅ Restore cluster from backup</li>
<li>✅ Disaster recovery procedures</li>
</ul>

<hr>

<h2 id="phan-1-backup-architecture">PART 1: BACKUP ARCHITECTURE</h2>
...
<h2 id="phan-2-setup-backup-s3">PART 2: SETUP BACKUP DESTINATION__HTMLTAG_86___

<h3 id="21-ceph-rgw-s3">2.1. Use Ceph RGW (S3-compatible)</h3>
...
<h3 id="22-update-cluster-backup-config">2.2. Update Cluster with Backup Config</h3>
...
<h2 id="phan-3-scheduled-backup">PART 3: SCHEDULED BACKUP</h2>
...
<h2 id="phan-4-pitr">PART 4: POINT-IN-TIME RECOVERY (PITR)</h2>
...
<h3 id="42-restore-pitr">4.2. Restore with PITR</h3>
...
<h2 id="phan-5-dr-procedures">PART 5: DISASTER RECOVERY PROCEDURES</h2>

<h3 id="51-full-cluster-restore">5.1. Full Cluster Restore (no PITR)</h3>
...
<li><strong>PITR</strong>: Restore to any point in retention period</li>
<li><strong>Recovery = Create new cluster</strong> from backup, then switchover</li>
<li><strong>retentionPolicy: 30d</strong>: Keep backup 30 days</li>
<li><strong>Test restore periodically</strong>: Verify monthly backup integrity</li>
</ol>
...
<h3 id="bt1">Exercise 1: Backup Lab</h3>
<ul>
<li>Configure backup destination (S3/MinIO)</li>
<li>Setup ScheduledBackup, verify backup created successfully</li>
</ul>

<h3 id="bt2">Exercise 2: PITR Lab</h3>
<ul>
<li>Insert data, note timestamp</li>
<li>Delete data (simulate accident)</li>
<li>Restore to timestamp before delete</li>
<li>Verify data recovered__HTMLTAG_158___
</ul>

<hr>

<h2 id="bai-tiep-theo">📚 NEXT POST</h2>
<p>In <strong>Lesson 19: PostgreSQL Failover Testing and Switchover</strong>, we will test failover scenarios and planned switchover.</p>