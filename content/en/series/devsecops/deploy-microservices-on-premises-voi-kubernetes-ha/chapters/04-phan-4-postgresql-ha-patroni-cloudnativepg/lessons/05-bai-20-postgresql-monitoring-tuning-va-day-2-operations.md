...
title: 'LESSON 20: POSTGRESQL MONITORING, TUNING AND DAY-2 OPERATIONS'
slug: bai-20-postgresql-monitoring-tuning-va-day-2-operations
description: Setup pg_stat_statements, Prometheus metrics, Grafana dashboards, vacuum tuning, connection pooling optimization, and Day-2 operations for PostgreSQL HA on Kubernetes.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 20: POSTGRESQL MONITORING, TUNING AND</tspan>
...
<ul>
<li>✅ Setup pg_stat_statements for query analysis</li>
<li>✅ Deploy Prometheus monitoring for PostgreSQL</li>
<li>✅ Build Grafana dashboards for PG metrics</li>
<li>✅ Vacuum tuning and autovacuum configuration</li>
<li>✅ Connection pooling optimization with PgBouncer</li>
<li>✅ Day-2 operations: scaling, minor upgrade, major upgrade</li>
</ul>

<hr>

<h2 id="phan-1-pg-stat-statements">PART 1: pg_stat_statements — QUERY ANALYSIS</h2>

<h3 id="11-enable">1.1. Enable pg_stat_statements</h3>
...
<h2 id="phan-2-prometheus">PART 2: PROMETHEUS MONITORING</h2>
...
<h3 id="22-podmonitor">2.2. PodMonitor for Prometheus</h3>
...
<h2 id="phan-3-grafana">PART 3: GRAFANA DASHBOARDS</h2>
...
<h2 id="phan-4-vacuum-tuning">PART 4: VACUUM TUNING</h2>
...
<h3 id="42-manual-vacuum">4.2. Manual VACUUM for large tables</h3>
...
<h2 id="phan-5-pgbouncer-tuning">PART 5: PGBOUNCER TUNING</h2>
...
<h2 id="phan-6-day2">PART 6: DAY-2 OPERATIONS</h2>
...
</code></pre><h3 id="63-major-upgrade">6.3. Major Version Upgrade (e.g., 16 → 17)</h3>
...
<ol>
<li><strong>pg_stat_statements</strong>: Essential for query performance analysis</li>
<li><strong>Prometheus + Grafana</strong>: Real-time monitoring, alerting on lag/connections</li>
<li><strong>Vacuum tuning</strong>: Reduce scale_factor for large tables (5% instead of 20%)</li>
<li><strong>PgBouncer</strong>: transaction pooling, tune default_pool_size according to workload</li>
...
<h3 id="bt1">Exercise 1: Performance Baseline</h3>
<ul>
<li>Enable pg_stat_statements</li>
<li>Run pgbench workload</li>
<li>Identify top 5 slow queries__HTMLTAG_163___
<li>Setup Grafana dashboard</li>
</ul>

<h3 id="bt2">Exercise 2: Vacuum Lab</h3>
<ul>
<li>Create table, INSERT 1M rows, DELETE 500K</li>
<li>Observe dead tuples, trigger VACUUM__HTMLTAG_173___
<li>Compare autovacuum vs manual VACUUM timing__HTMLTAG_175___
</ul>

<hr>

<h2 id="bai-tiep-theo">📚 NEXT POST</h2>
<p>In <strong>Lesson 21: RabbitMQ HA Cluster on Kubernetes</strong>, we will deploy HA message queue for microservices communication.</p>