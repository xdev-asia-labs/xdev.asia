...
title: 'LESSON 36: RBAC & POD SECURITY STANDARDS'
slug: bai-36-rbac-va-pod-security-standards
description: Detailed Kubernetes RBAC, Pod Security Standards (PSS), ServiceAccount best practices, least-privilege access, audit logging, and security hardening for the cluster.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">🔒 DevSecOps — Lesson 36</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 36: RBAC &amp; POD SECURITY STANDARDS</tspan>
  </text>
...
<li>✅ ServiceAccount best practices__HTMLTAG_73___
...
<h2 id="phan-1-rbac">PART 1: KUBERNETES RBAC</h2>
...
<h2 id="phan-2-serviceaccount">PART 2: SERVICEACCOUNT BEST PRACTICES__HTMLTAG_84___
...
<h2 id="phan-3-pss">PART 3: POD SECURITY STANDARDS</h2>
...
<tr><td>Baseline_</td><td>Prevent known escalation</td><td>Default for most workloads_</td></tr>
<tr><td>Restricted</td><td>Hardened, all best practices</td><td>Sensitive workloads_</td></tr>
</tbody>
</table>
<!--kg-card-end: html-->
...
<h2 id="phan-4-audit">PART 4: AUDIT LOGGING</h2>
...
<h2 id="phan-5-hardening">PART 5: SECURITY HARDENING CHECKLIST</h2><!--kg-card-begin: html-->
<table>
<thead>
...
<tr><td>10_</td><td>Secrets in Vault (not plain K8s secrets)</td><td>☐</td></tr>
</tbody>
</table>
<!--kg-card-end: html-->
...
<li><strong>SecurityContext</strong>: runAsNonRoot, dropAll capabilities, readOnlyRootFilesystem</li>
</ol>
...
<h3 id="bt1">Exercise 1: RBAC Setup__HTMLTAG_259___
<ul>
<li>Create developer/ops Roles with different permissions</li>
<li>Test access with kubectl --as=developer</li>
<li>Enable audit logging, verify secret access is logged__HTMLTAG_266___
</ul>

<h3 id="bt2">Exercise 2: Pod Security</h3>
<ul>
...
<p>In <strong>Lesson 37: Kyverno Policy Engine</strong>, we will implement policy-as-code for the cluster.</p>