...
title: 'LESSON 22: APACHE KAFKA CLUSTER WITH STRIMZI OPERATOR'
slug: bai-22-apache-kafka-cluster-voi-strimzi-operator
description: Deploy Apache Kafka HA cluster on Kubernetes using Strimzi Operator, KRaft mode (no Zookeeper), topic management, consumer groups, Schema Registry, and monitoring.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🔒 DevSecOps — Lesson 22</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 22: APACHE KAFKA CLUSTER WITH STRIMZI</tspan>
      <tspan x="60" dy="42">OPERATOR</tspan>
  </text>
...
<ul>
<li>✅ Understand Kafka architecture: brokers, topics, partitions, consumer groups</li>
<li>✅ Deploy Kafka 3-node cluster with Strimzi (KRaft mode)</li>
<li>✅ Configuring topics, replication, retention</li>
<li>✅ Deploy Schema Registry for schema evolution</li>
<li>✅ Monitor Kafka cluster with JMX metrics + Prometheus</li>
<li>✅ Best practices: partitioning strategy, consumer lag, exactly-once</li>
</ul>

<hr>

<h2 id="phan-1-kien-truc">PART 1: APACHE KAFKA ARCHITECTURE</h2>
...
<tr><td>Ordering_</td><td>Per partition</td><td>Per queue (FIFO)</td></tr>
...
<tr><td>Protocol_</td><td>Kafka Binary Protocol_</td><td>AMQP 0.9.1</td></tr>
</tbody>
</table>
<!--kg-card-end: html-->
...
<h2 id="phan-2-install-strimzi">PART 2: INSTALL STRIMZI OPERATOR</h2>
...
<h2 id="phan-3-deploy-kafka">PART 3: DEPLOY KAFKA CLUSTER (KRaft Mode)</h2>
...
<h2 id="phan-4-topics">PART 4: TOPIC MANAGEMENT</h2>
...
<h2 id="phan-5-users">PART 5: KAFKA USERS & ACL</h2>
...
<h2 id="phan-6-produce-consume">PART 6: PRODUCE & CONSUME TEST</h2>
...
<h2 id="phan-7-schema-registry">PART 7: SCHEMA REGISTRY</h2>
...
<h2 id="phan-8-monitoring">PART 8: MONITORING KAFKA</h2>
...
<li><strong>Partition strategy</strong>: Key-based partitioning for ordering, partition increases for throughput</li>
...
<hr><h2 id="bai-tap">🎯 EXERCISE</h2>

<h3 id="bt1">Exercise 1: Kafka HA Lab</h3>
<ul>
...
<li>Verify no data loss, consumers catch up__HTMLTAG_227___
</ul>

<h3 id="bt2">Exercise 2: Performance Benchmark</h3>
<ul>
...
<p>In <strong>Lesson 23: Redis HA — Sentinel and Cluster Mode</strong>, we will deploy Redis for caching and real-time data.</p>