...
title: 'LESSON 21: RABBITMQ HA CLUSTER ON KUBERNETES'
slug: bai-21-rabbitmq-ha-cluster-tren-kubernetes
description: Deploy RabbitMQ HA cluster on Kubernetes using the RabbitMQ Cluster Operator, quorum queues, TLS, monitoring, and best practices for microservices messaging.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🔒 DevSecOps — Lesson 21</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">LESSON 21: RABBITMQ HA CLUSTER ON</tspan>
...
<ul>
<li>✅ Understand RabbitMQ cluster architecture and messaging patterns</li>
<li>✅ Deploy RabbitMQ 3-node cluster using Cluster Operator</li>
<li>✅ Configure quorum queues for HA</li>
<li>✅ Setup TLS encryption and authentication</li>
<li>✅ Monitor RabbitMQ cluster with Prometheus</li>
...
> Classic Queue: Only on 1 node (mirrored = deprecated)<!--kg-card-begin: html-->
<table>
<thead>
<tr><th>Feature</th><th>Classic Queue</th><th>Quorum Queue</th><th>Stream</th></tr>
</thead>
<tbody>
<tr><td>Replication</td><td>None (mirrored deprecated)</td><td>Raft-based (majority)_</td><td>_Append-only log</td></tr>
...
<tr><td>Ordering_</td><td>FIFO</td><td>FIFO</td><td>FIFO per partition</td></tr>
</tbody>
</table>
<!--kg-card-end: html-->
...
<h2 id="phan-2-install-operator">PART 2: INSTALL RABBITMQ CLUSTER OPERATOR</h2>
...
<h3 id="22-namespace">2.2. Create Namespace for Messaging</h3>
...
<h2 id="phan-3-deploy-cluster">PART 3: DEPLOY RABBITMQ HA CLUSTER</h2>
...
<h2 id="phan-4-quorum-queues">PART 4: QUORUM QUEUES AND POLICY</h2>

<h3 id="41-create-queues">4.1. Create Quorum Queues</h3>
...
<h2 id="phan-5-tls">PART 5: TLS ENCRYPTION</h2>
...
<h2 id="phan-6-monitoring">PART 6: MONITORING</h2>
...
<h2 id="phan-7-app-integration">PART 7: APPLICATION INTEGRATION</h2>
...
<ol>
<li><strong>Quorum queues</strong>: Raft-based replication, always used for production</li>
...
<h2 id="bai-tap">🎯 EXERCISE</h2><h3 id="bt1">Exercise 1: RabbitMQ HA Lab</h3>
<ul>
...
<h3 id="bt2">Exercise 2: Monitoring Setup__HTMLTAG_229___
<ul>
...
<p>In <strong>Lesson 22: Apache Kafka Cluster with Strimzi Operator</strong>, we will deploy Kafka for high-throughput event streaming.</p>