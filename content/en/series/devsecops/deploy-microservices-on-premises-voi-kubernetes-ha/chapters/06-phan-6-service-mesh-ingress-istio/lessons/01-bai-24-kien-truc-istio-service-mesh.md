...
title: 'LESSON 24: ISTIO SERVICE MESH ARCHITECTURE'
slug: bai-24-kien-truc-istio-service-mesh
description: 'Understand the Istio service mesh architecture: data plane (Envoy sidecar), control plane (istiod), traffic management, security (mTLS), observability, and compare with Linkerd.'
duration_minutes: 150
is_free: true
video_url: null
featured_image: uploads/2026/04/k8s-ha-bai24-istio-service-mesh.png
sort_order: 24
section_title: 'Part 6: Service Mesh & Ingress with Istio'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🔒 DevSecOps — Lesson 24</text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Service Mesh &amp; Ingress with Istio</text>
...
<h3 id="11-why-mesh">1.1. When do you need Service Mesh?</h3>
<ul>
...
<tbody>
<tr><td>istiod</td><td>Control Plane</td><td>Single binary: Pilot + Citadel + Galley_</td></tr>
<tr><td>Envoy</td><td>Sidecar Proxy</td><td>L4/L7 proxy, injected into every pod_</td></tr>
<tr><td>Pilot</td><td>Traffic Management</td><td>Converts routing rules → Envoy xDS config</td></tr>
<tr><td>Citadel_</td><td>Security</td><td>Certificate authority, mTLS cert rotation_</td></tr>
<tr><td>Galley_</td><td>Configuration</td><td>Validates & distributes Istio config</td></tr>
</tbody>
</table>
<!--kg-card-end: html-->
...
<tr><td>Features_</td><td>Most complete</td><td>Essential features_</td><td>Growing_</td></tr>
...
</code></pre><h3 id="32-install-profile">3.2. Install Istio (Production Profile)</h3>
...
<h2 id="phan-4-mtls">PART 4: mTLS (MUTUAL TLS)</h2>
...
<h2 id="phan-5-sidecar-injection">PART 5: SIDECAR INJECTION</h2>
...
<h2 id="phan-6-addons">PART 6: OBSERVABILITY ADD-ONS</h2>
...
<h3 id="bt1">Exercise 1: Install Istio__HTMLTAG_306___
<ul>
<li>Install Istio with production profile</li>
<li>Enable sidecar injection on default namespace__HTMLTAG_311___
<li>Deploy sample Bookinfo app</li>
<li>Verify mTLS between services</li>
</ul>

<h3 id="bt2">Exercise 2: Kiali & Jaeger</h3>
<ul>
<li>Install Kiali, explore service graph</li>
<li>Generate traffic, view traces in Jaeger__HTMLTAG_323___
...
<p>In <strong>Lesson 25: Istio Traffic Management — VirtualService, DestinationRule</strong>, we will configure traffic routing, canary deployment, and circuit breaking.</p>