---
id: 019d8a21-c513-70c5-d001-e1f2a3b4c513
title: 'Lesson 13: Anti-Money Laundering (AML) & KYC Pipeline'
slug: bai-13-anti-money-laundering-aml-kyc-pipeline
description: >-
  KYC pipeline design: identity verification, document validation. AML
  screening: sanctions lists, PEP screening. Suspicious Activity Reports.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8710" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8710)"/>

  <!-- Decorations -->
  <g>
    <circle cx="625" cy="145" r="28" fill="#fb923c" opacity="0.1"/>
    <circle cx="650" cy="270" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="675" cy="135" r="18" fill="#fb923c" opacity="0.1"/>
    <circle cx="700" cy="260" r="13" fill="#fb923c" opacity="0.05"/>
    <circle cx="725" cy="125" r="8" fill="#fb923c" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Anti-Money Laundering (AML) & KYC</tspan>
      <tspan x="60" dy="42">Pipelines</tspan>
  </text>
...
![Lesson 13: Anti-Money Laundering (AML) & KYC Pipeline](/storage/uploads/2026/03/fintech-bai-13-diagram.png)

## Introduction

KYC pipeline design: identity verification, document validation. AML screening: sanctions lists, PEP screening. Suspicious Activity Reports.

---

## 1. Design KYC pipeline: identity verification, document validation

### 1.1 Basic concepts

KYC pipeline design: identity verification, document validation is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. AML screening: sanctions lists, PEP screening
...
In this lesson, we learned about Anti-Money Laundering (AML) & KYC Pipeline. Key takeaways:
