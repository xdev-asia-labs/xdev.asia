...
description: >-
  Security testing for healthcare systems: vulnerability scanning (OWASP ZAP,
  Nuclei), SAST/DAST/IAST integration in CI/CD, dependency scanning (Snyk,
  Dependabot), PostgreSQL security audit, Keycloak security assessment, API
  security testing, compliance scanning, and creating Security Assessment Report
...
| Challenge | Details |
|----------|--------|
| **Regulatory Compliance** | HIPAA §164, ISO 27799, Decree 13/2023, Risk Assessment |
...
- §164.306(e) — Risk Analysis updated

### 1.3. Classification of Security Testing

| Test Type | Description | Tools | When to run |
|:---|:---|:---|:---|
| **SAST** | Static Application Security Testing — source code analysis | SonarQube, Semgrep, SpotBugs | Each commit/PR |
| **DAST** | Dynamic Application Security Testing — test running app | OWASP ZAP, Nuclei, Burp Suite | Each release |
| **IAST** | Interactive — agent in runtime | Contrast Security | When running integration tests |
| **SCA** | Software Composition Analysis — dependency check | Snyk, Dependabot, Trivy | Each commit + scheduled |
| **Pentest** | Manual penetration testing | Manual + tools | Quarterly/Annual |
| **Config Audit** | Infrastructure configuration review | CIS-CAT, Lynis, kube-bench | Monthly |

---

## 2. Static Application Security Testing (SAST) for Quarkus

### 2.1. SonarQube Configuration for Healthcare Java
...
### 2.2. Semgrep Rules for Healthcare
...
### 2.3. SpotBugs Security Plugin for Quarkus
...
### 3.1. OWASP ZAP for Healthcare APIs
...
### 3.3. Nuclei Templates for Healthcare
...
### 4.1. Dependency Scanning for Quarkus Healthcare
...
## 9. Integrated CI/CD Security Pipeline
...
### 10.1. Pentest report structure for Healthcare
...
### Checklist Security Testing for Healthcare
...
|:---|---:|
| [Lesson 22: Containers & Kubernetes Security for Healthcare Workloads](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-22-container-kubernetes-security-healthcare) | [Lesson 24: Capstone — Building Secure Healthcare Microservices Platform](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-24-capstone-xay-dung-secure-healthcare-platform) |
<!-- SERIES-NAV:END -->
