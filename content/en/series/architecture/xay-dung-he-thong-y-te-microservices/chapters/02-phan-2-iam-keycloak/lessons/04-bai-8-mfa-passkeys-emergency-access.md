...
description: >-
  Deploy Multi-Factor Authentication suitable for medical environments:
  TOTP/HOTP for doctors, WebAuthn/Passkeys for workstations, proximity badge
  authentication, conditional MFA (skip MFA in the internal network), Emergency
  Access (break-the-glass) procedure with audit trail, and Session Management
  for shared workstations in hospitals.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Architecture — Lesson 8</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: MFA, Passkeys & Emergency Access</tspan>
      <tspan x="60" dy="42">for Medical Staff</tspan>
  </text>
...
Hospitals have a special operating environment compared to regular businesses:

| Challenge | Description | Solution |
|-----------|-------|-----------|
| **Shared workstations** | Multiple doctors/nurses share a computer | Fast switching, tap-and-go |
| **Response time** | First aid needs access in seconds | Conditional MFA, proximity badge |
| **Medical gloves** | Cannot use fingerprint | WebAuthn security key, PIN |
| **Multiple logins/day** | Doctors log in 30-50 times/day | SSO + short MFA memory |
| **Limited personal equipment** | Not everyone has a smartphone | Hardware token options |
...
## 2. Keycloak Authentication Flow for Healthcare
...
## 3. WebAuthn / Passkeys for Healthcare
...
### 3.2. Supported Authenticators for Hospitals
...
## 4. Session Management for Shared Workstations
...
### 6.1. Account Recovery flow for Healthcare
...
- Analyze specific **MFA challenges** in the hospital environment
- Design an appropriate **MFA strategy** for each type of medical staff
- Configure **Conditional Authentication Flow** in Keycloak (skip MFA on internal network)
- Deploy **WebAuthn/Passkeys** for clinical workstations
- Build **Fast Session Switching** for shared workstations
- Implement **Proximity Badge Authentication** SPI
- Design **Recovery Procedures** for healthcare

## Exercises

1. Configure Keycloak authentication flow with conditional MFA (internal vs external network)
2. Register WebAuthn security key and test login passkey
3. Implement auto-logoff after 10 minutes of idle time for clinical workstations
4. Write documentation for Emergency Access procedure
...
|:---|---:|
| [Lesson 7: SMART on FHIR - OAuth2/OIDC for Healthcare APIs](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-7-smart-on-fhir-oauth2-oidc-healthcare-apis) | [Lesson 9: PostgreSQL Security Hardening - Comprehensive Security Configuration](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-9-postgresql-security-hardening-toan-dien) |
<!-- SERIES-NAV:END -->
