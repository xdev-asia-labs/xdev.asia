...
description: >-
  Deploy Role-Based Access Control (RBAC) and Attribute-Based Access Control
  (ABAC) for healthcare: design role hierarchy (Department Doctor, Treating
  Doctor, Chief Nurse, Nurse, Technician, Admin, Patient), department-based
  access, Keycloak Authorization Services with policies and permissions, and
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Architecture — Lesson 6</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 6: RBAC & ABAC Decentralization — Doctors, Nurses</tspan>
      <tspan x="60" dy="42">nurse, patient</tspan>
  </text>
...
**Advantages**: Simple, easy to manage, easy to audit
**Limitations**: Cannot handle complex rules (for example: only internal medicine doctors can see internal medicine patients)

### 1.2. Attribute-Based Access Control (ABAC)

ABAC makes decisions based on **attributes** of user, resource, action, and environment:
...
**Advantages**: Flexible, fine-grained, context-aware
**Limitations**: More complicated, difficult to debug, needs a lot of metadata

### 1.3. Combine RBAC + ABAC for Health

| Layers | Name | Mechanism | Example |
|-------|-----|--------|--------|
...
## 3. Implementation in Quarkus

### 3.1. RBAC with @RolesAllowed
...
### 3.2. ABAC with Custom SecurityIdentityAugmentor
...
### 5.1. Permission Matrix for Healthcare

| Resources | Doctor | Nurse | Lab Tech | Pharmacist | Patient | Admin |
|----------|--------|-------|----------|-------------|--------|-------|
...
- Compare **RBAC vs ABAC** and the strategy combining 4 layers for healthcare
- Configure **Keycloak Authorization Services** (Resources, Policies, Permissions)
- Implement **RBAC** in Quarkus with `@RolesAllowed`
- Implement **ABAC** with custom `SecurityIdentityAugmentor` and authorization interceptor
- Design **Break-the-Glass** emergency access procedure

## Exercises

1. Implement full ABAC for Lab Result access: only doctors in the same department can view it
2. Create a Break-the-Glass workflow with audit trails and notifications
3. Write integration test for permission matrix (doctor vs nurse vs patient access)
...
|:---|---:|
| [Lesson 5: Designing Keycloak Realm for Medical standards - Multi-tenancy for Hospitals](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-5-thiet-ke-keycloak-realm-chuan-y-te) | [Lesson 7: SMART on FHIR - OAuth2/OIDC for Healthcare APIs](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-7-smart-on-fhir-oauth2-oidc-healthcare-apis) |
<!-- SERIES-NAV:END -->
