...
description: >-
  Deploy Quarkus Security for healthcare microservices: quarkus-oidc extension
  with Keycloak, JWT token propagation between services, SecurityIdentity and
  custom augmentor, @RolesAllowed/@PermissionsAllowed annotations, programmatic
  security checks, and multi-tenant OIDC configuration for multi-hospital
  deployment.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Quarkus Security — OIDC, JWT</tspan>
...
| Extension | Artifact | Purpose |
|-----------|----------|----------|
| quarkus-oidc | `io.quarkus:quarkus-oidc` | OIDC authentication (Keycloak) |
| quarkus-oidc-token-propagation | `io.quarkus:quarkus-oidc-token-propagation-reactive` | JWT forwarding between services |
...
|:---|---:|
| [Lesson 12: Audit Logging & Change Data Capture with pgAudit](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-12-audit-logging-cdc-pgaudit) | [Lesson 14: API Gateway Security - Rate Limiting, Input Validation & WAF](/series/bao-mat-du-lieu-y-te-cho-microservices/bai-14-api-gateway-rate-limiting-waf) |
<!-- SERIES-NAV:END -->
