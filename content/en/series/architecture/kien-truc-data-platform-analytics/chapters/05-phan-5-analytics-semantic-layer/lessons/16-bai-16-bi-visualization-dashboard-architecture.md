...
description: >-
  BI platform architecture: Metabase, Superset, Looker. Embedded analytics.
  Dashboard performance optimization. Self-service analytics.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 16
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-126" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-126)"/>

  <!-- Decorations -->
  <g>
    <circle cx="986" cy="228" r="14" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="872" cy="34" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="758" cy="100" r="20" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="644" cy="166" r="8" fill="#2dd4bf" opacity="0.07"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: BI & Visualization - Dashboard</tspan>
...
![Lesson 16: BI & Visualization - Dashboard Architecture](/storage/uploads/2026/03/dp-bai-16-diagram.png)
...
## 1. BI platform architecture: Metabase, Superset, Looker

### 1.1 Basic concepts

BI platform architecture: Metabase, Superset, Looker is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about BI & Visualization - Dashboard Architecture. Key takeaways:
