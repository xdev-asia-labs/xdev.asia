...
description: >-
  Semantic layer: single source of truth for metrics. Cube.js, MetricFlow (dbt).
  Metric definitions, dimensions, measures. Headless BI.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Semantic Layer - Metrics Store &</tspan>
...
![Lesson 15: Semantic Layer - Store Metrics & Business Logic](/storage/uploads/2026/03/dp-bai-15-diagram.png)
...
Semantic layer: single source of truth for metrics is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Semantic Layer - Store Metrics & Business Logic. Key takeaways:
