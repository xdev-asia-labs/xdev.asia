...
description: >-
  Data platform for ML: training data preparation, labeling pipelines. Model
  training data versioning (DVC). A/B testing data. Experimental tracking.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 19
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: ML Pipeline Integration - Training</tspan>
...
![Lesson 19: ML Pipeline Integration - Training & Serving Data](/storage/uploads/2026/03/dp-bai-19-diagram.png)
