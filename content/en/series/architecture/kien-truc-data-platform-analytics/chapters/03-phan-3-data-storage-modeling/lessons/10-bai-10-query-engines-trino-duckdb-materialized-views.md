...
description: >-
  Federated query with Trino/Presto. DuckDB for embedded analytics. Materialized
  views and incremental computation. Query optimization.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 10
section_title: 'Part 3: Data Storage & Modeling'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1203" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1203)"/>

  <!-- Decorations -->
  <g>
    <circle cx="835" cy="275" r="8" fill="#fb923c" opacity="0.1"/>
    <circle cx="1070" cy="270" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="805" cy="265" r="8" fill="#fb923c" opacity="0.1"/>
    <circle cx="1040" cy="260" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="775" cy="255" r="8" fill="#fb923c" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Query Engines - Trino, DuckDB &</tspan>
      <tspan x="60" dy="42">Materialized Views</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Data Storage & Modeling</text>
...
Federated query with Trino/Presto. DuckDB for embedded analytics. Materialized views and incremental computation. Query optimization.

---

## 1. Federated query with Trino/Presto

### 1.1 Basic concepts

Federated query with Trino/Presto is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 3. Materialized views and incremental computation
...
In this lesson, we learned about Query Engines - Trino, DuckDB & Materialized Views. Key takeaways:
