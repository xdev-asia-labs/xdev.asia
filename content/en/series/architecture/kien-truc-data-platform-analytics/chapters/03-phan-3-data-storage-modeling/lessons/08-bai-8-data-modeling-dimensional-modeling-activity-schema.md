...
description: >-
  Star schema, snowflake schema. Kimball vs Inmon. Activity schema. Slowly
  changing dimensions (SCD). Wide table vs normalized. Modeling for analytics.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Architecture — Lesson 8</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Data Modeling - Dimensional</tspan>
      <tspan x="60" dy="42">Modeling & Activity Schema</tspan>
  </text>
...
![Lesson 8: Data Modeling - Dimensional Modeling & Activity Schema](/storage/uploads/2026/03/dp-bai-8-diagram.png)
...
Star schema, snowflake schema is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Data Modeling - Dimensional Modeling & Activity Schema. Key takeaways:
