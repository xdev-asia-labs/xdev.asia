...
title: 'Lesson 9: Storage Layer - Object Storage, Columnar Formats & Partitioning'
slug: bai-9-storage-layer-object-storage-columnar-formats-partitioning
description: >-
  Object storage (S3/MinIO). Columnar formats: Parquet, ORC, Avro. Partitioning
  strategies. Compaction. Z-ordering. Storage tiering and lifecycle policies.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 9
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Storage Layer - Object Storage,</tspan>
      <tspan x="60" dy="42">Columnar Formats & Partitioning</tspan>
  </text>
...
![Lesson 9: Storage Layer - Object Storage, Columnar Formats & Partitioning](/storage/uploads/2026/03/dp-bai-9-diagram.png)

## Introduction

Object storage (S3/MinIO). Columnar formats: Parquet, ORC, Avro. Partitioning strategies. Compaction. Z-ordering. Storage tiering and lifecycle policies.
...
Object storage (S3/MinIO) is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Storage Layer - Object Storage, Columnar Formats & Partitioning. Key takeaways:
