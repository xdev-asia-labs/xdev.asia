...
description: >-
  Data catalog: DataHub, OpenMetadata, Amundsen. Metadata management. Data
  lineage tracking. Data discovery and search. Business glossary.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 12
section_title: 'Part 4: Data Quality & Governance'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1501" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1501)"/>

  <!-- Decorations -->
  <g>
    <circle cx="914" cy="212" r="22" fill="#f472b6" opacity="0.07"/>
    <circle cx="728" cy="186" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="1042" cy="160" r="36" fill="#f472b6" opacity="0.11"/>
    <circle cx="856" cy="134" r="28" fill="#f472b6" opacity="0.13"/>
    <circle cx="670" cy="108" r="20" fill="#f472b6" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Data Catalog & Discovery -</tspan>
      <tspan x="60" dy="42">Metadata Management</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Data Quality & Governance</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 12: Data Catalog & Discovery - Metadata Management](/storage/uploads/2026/03/dp-bai-12-diagram.png)

## Introduction

Data catalog: DataHub, OpenMetadata, Amundsen. Metadata management. Data lineage tracking. Data discovery and search. Business glossary.

---

## 1. Data catalog: DataHub, OpenMetadata, Amundsen

### 1.1 Basic concepts

Data catalog: DataHub, OpenMetadata, Amundsen are among the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Data Catalog & Discovery - Metadata Management. Key takeaways:
