...
description: >-
  CDC concepts and use cases. Debezium: capture changes from PostgreSQL, MySQL.
  CDC → Kafka → Lakehouse pipeline. Event Sourcing patterns. Outbox pattern.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8604" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8604)"/>

  <!-- Decorations -->
  <g>
    <circle cx="719" cy="187" r="32" fill="#818cf8" opacity="0.12000000000000001"/>
    <circle cx="838" cy="66" r="29" fill="#818cf8" opacity="0.09"/>
    <circle cx="957" cy="205" r="26" fill="#818cf8" opacity="0.060000000000000005"/>
    <circle cx="1076" cy="84" r="23" fill="#818cf8" opacity="0.13"/>
    <circle cx="695" cy="223" r="20" fill="#818cf8" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 6: Change Data Capture (CDC) -</tspan>
      <tspan x="60" dy="42">Debezium & Event Sourcing</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 2: Data Ingestion & Pipeline</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 6: Change Data Capture (CDC) - Debezium & Event Sourcing](/storage/uploads/2026/03/dp-bai-6-diagram.png)

## Introduction

CDC concepts and use cases. Debezium: capture changes from PostgreSQL, MySQL. CDC → Kafka → Lakehouse pipeline. Event Sourcing patterns. Outbox pattern.

---

## 1. CDC concepts and use cases

### 1.1 Basic concepts

CDC concepts and use cases are among the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Debezium: capture changes from PostgreSQL, MySQL
...
## 3. CDC → Kafka → Lakehouse pipeline
...
In this lesson, we learned about Change Data Capture (CDC) - Debezium & Event Sourcing. Key takeaways:
