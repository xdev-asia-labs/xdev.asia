...
description: >-
  ETL vs ELT patterns. Apache Airflow: DAGs, operators, scheduling. dbt (data
  build tool): models, tests, documentation. Data transformation best practices.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 4: Batch Processing - ETL/ELT with</tspan>
...
![Lesson 4: Batch Processing - ETL/ELT with Airflow & dbt](/storage/uploads/2026/03/dp-bai-4-diagram.png)
...
ETL vs ELT patterns is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Batch Processing - ETL/ELT with Airflow & dbt. Key takeaways:
