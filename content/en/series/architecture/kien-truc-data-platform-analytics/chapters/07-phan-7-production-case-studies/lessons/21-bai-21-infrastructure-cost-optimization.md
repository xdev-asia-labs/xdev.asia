...
description: >-
  Data platform infrastructure: Kubernetes, Spark on K8s. Cost optimization:
  spot instances, auto-scaling, storage tiering. FinOps for data teams.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6271" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6271)"/>

  <!-- Decorations -->
  <g>
    <circle cx="926" cy="148" r="34" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="752" cy="274" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="1078" cy="140" r="30" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="904" cy="266" r="28" fill="#2dd4bf" opacity="0.07"/>
    <circle cx="730" cy="132" r="26" fill="#2dd4bf" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 21: Infrastructure & Cost Optimization</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 7: Production & Case Studies</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 21: Infrastructure & Cost Optimization](/storage/uploads/2026/03/dp-bai-21-diagram.png)

## Introduction

Data platform infrastructure: Kubernetes, Spark on K8s. Cost optimization: spot instances, auto-scaling, storage tiering. FinOps for data teams.

---

## 1. Data platform infrastructure: Kubernetes, Spark on K8s

### 1.1 Basic concepts

Data platform infrastructure: Kubernetes, Spark on K8s is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Cost optimization: spot instances, auto-scaling, storage tiering
...
In this lesson, we learned about Infrastructure & Cost Optimization. Key takeaways:
