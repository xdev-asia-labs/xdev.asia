...
description: >-
  DataOps practices: CI/CD for data pipelines, testing, monitoring. Self-serve
  data platform. Developer experience. Platform team topology.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 23
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <!-- Decorations -->
  <g>
    <circle cx="723" cy="279" r="16" fill="#c084fc" opacity="0.14"/>
    <circle cx="846" cy="102" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="969" cy="185" r="24" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="1092" cy="268" r="13" fill="#c084fc" opacity="0.11"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 23: DataOps & Platform Engineering</tspan>
  </text>
...
![Lesson 23: DataOps & Platform Engineering](/storage/uploads/2026/03/dp-bai-23-diagram.png)

## Introduction

DataOps practices: CI/CD for data pipelines, testing, monitoring. Self-serve data platform. Developer experience. Platform team topology.

---

## 1. DataOps practices: CI/CD for data pipelines, testing, monitoring

### 1.1 Basic concepts

DataOps practices: CI/CD for data pipelines, testing, monitoring is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about DataOps & Platform Engineering. Key takeaways:
