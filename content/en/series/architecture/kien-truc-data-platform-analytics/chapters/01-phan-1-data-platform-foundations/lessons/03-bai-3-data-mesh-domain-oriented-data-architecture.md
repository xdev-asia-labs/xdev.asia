...
description: >-
  ...
  platform, federated governance. Implementation patterns. Data contracts.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-3942" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-3942)"/>

  <!-- Decorations -->
  <g>
    <circle cx="652" cy="66" r="20" fill="#f87171" opacity="0.11"/>
    <circle cx="704" cy="78" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="756" cy="90" r="32" fill="#f87171" opacity="0.13"/>
    <circle cx="808" cy="102" r="8" fill="#f87171" opacity="0.09"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Architecture — Lesson 3</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Data Mesh - Domain-Oriented Data</tspan>
...
![Lesson 3: Data Mesh - Domain-Oriented Data Architecture](/storage/uploads/2026/03/dp-bai-3-diagram.png)

## Introduction

Data Mesh principles: domain ownership, data as product, self-serving platform, federated governance. Implementation patterns. Data contracts.

---

## 1. Data Mesh principles: domain ownership, data as product, self-serving platform, federated governance

### 1.1 Basic concepts

Data Mesh principles: domain ownership, data as product, self-serving platform, federated governance are one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Data Mesh - Domain-Oriented Data Architecture. Key takeaways:
