...
description: >-
  API catalog: discovery, documentation, versioning. OpenAPI/AsyncAPI/GraphQL
  specs. API governance. Automated API docs generation. API health monitoring.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 6
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6368" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6368)"/>

  <!-- Decorations -->
  <g>
    <circle cx="758" cy="84" r="36" fill="#fbbf24" opacity="0.09"/>
    <circle cx="916" cy="102" r="20" fill="#fbbf24" opacity="0.13"/>
    <circle cx="1074" cy="120" r="34" fill="#fbbf24" opacity="0.07"/>
    <circle cx="732" cy="138" r="18" fill="#fbbf24" opacity="0.11"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 6: API Portal & Documentation</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 2: Developer Portal</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 6: API Portal & Documentation](/storage/uploads/2026/03/pe-bai-6-diagram.png)
...
## 1. API catalog: discovery, documentation, versioning

### 1.1 Basic concepts

API catalog: discovery, documentation, versioning is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. OpenAPI/AsyncAPI/GraphQL specs
...
In this lesson, we learned about API Portal & Documentation. Key takeaways:
