...
description: >-
  Service catalog: register, discover, manage services. Software templates
  (scaffolder): golden paths for new services. Template customization. API
  documentation.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-763" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-763)"/>

  <!-- Decorations -->
  <g>
    <circle cx="742" cy="76" r="10" fill="#f87171" opacity="0.11"/>
    <circle cx="884" cy="178" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="1026" cy="280" r="12" fill="#f87171" opacity="0.13"/>
    <circle cx="668" cy="122" r="28" fill="#f87171" opacity="0.09"/>
    ...
    <polygon points="942.8467875173176,100.5 942.8467875173176,131.5 916,147 889.1532124826824,131.5 889.1532124826824,100.50000000000001 916,85" fill="none" stroke="#f87171" stroke-width="1" opacity="0.12"/>
  </g>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Architecture — Lesson 5</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Service Catalog & Software</tspan>
      <tspan x="60" dy="42">Templates</tspan>
  </text>
...
![Lesson 5: Service Catalog & Software Templates](/storage/uploads/2026/03/pe-bai-5-diagram.png)

## Introduction

Service catalog: register, discover, manage services. Software templates (scaffolder): golden paths for new services. Template customization. API documentation.

---

## 1. Service catalog: register, discover, manage services

### 1.1 Basic concepts

Service catalog: register, discover, manage services is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Software templates (scaffolder): golden paths for new services
...
In this lesson, we learned about Service Catalog & Software Templates. Key takeaways:
