...
description: >-
  Cloud cost management: cost allocation per team/service. FinOps practices.
  Budget alerts. Resource right-sizing. Spot instance management.
  Showback/chargeback.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-3585" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-3585)"/>

  <!-- Decorations -->
  <g>
    <circle cx="740" cy="270" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="880" cy="90" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1020" cy="170" r="8" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 18: Cost Management & FinOps Platform</tspan>
  </text>
...
![Lesson 18: Cost Management & FinOps Platform](/storage/uploads/2026/03/pe-bai-18-diagram.png)
...
## 1. Cloud cost management: cost allocation per team/service

### 1.1 Basic concepts

Cloud cost management: cost allocation per team/service is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Cost Management & FinOps Platform. Key takeaways:
