...
description: >-
  ...
  compliance checks. Vulnerability management platform. Secret management
  (Vault).
duration_minutes: 120
is_free: true
video_url: null
sort_order: 16
section_title: 'Part 5: Security & Compliance Platform'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4878" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4878)"/>

  <!-- Decorations -->
  <g>
    <circle cx="907" cy="91" r="20" fill="#a78bfa" opacity="0.060000000000000005"/>
    <circle cx="714" cy="198" r="11" fill="#a78bfa" opacity="0.07"/>
    <circle cx="1021" cy="45" r="32" fill="#a78bfa" opacity="0.08"/>
    <circle cx="828" cy="152" r="23" fill="#a78bfa" opacity="0.09"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Architecture — Lesson 16</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Security Platform - Policy as Code</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Security & Compliance Platform</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 16: Security Platform - Policy as Code](/storage/uploads/2026/03/pe-bai-16-diagram.png)
...
## 1. Security platform: OPA/Gatekeeper, Kyverno

### 1.1 Basic concepts

Security platform: OPA/Gatekeeper, Kyverno is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Security Platform - Policy as Code. Key takeaways:
