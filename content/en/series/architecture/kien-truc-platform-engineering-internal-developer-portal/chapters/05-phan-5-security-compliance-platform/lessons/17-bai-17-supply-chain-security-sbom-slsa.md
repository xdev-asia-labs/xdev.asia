...
description: >-
  Software supply chain security. SBOM (Software Bill of Materials). SLSA
  framework. Dependency scanning. Signed builds. Provenance verification.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 17
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6634" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6634)"/>

  <!-- Decorations -->
  <g>
    <circle cx="804" cy="82" r="22" fill="#f472b6" opacity="0.07"/>
    <circle cx="1008" cy="186" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="712" cy="30" r="36" fill="#f472b6" opacity="0.11"/>
    <circle cx="916" cy="134" r="28" fill="#f472b6" opacity="0.13"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Supply Chain Security - SBOM &</tspan>
      <tspan x="60" dy="42">SLSA</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Security & Compliance Platform</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 17: Supply Chain Security - SBOM & SLSA](/storage/uploads/2026/03/pe-bai-17-diagram.png)
...
Software supply chain security is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Supply Chain Security - SBOM & SLSA. Key takeaways:
