...
description: >-
  Container registry (Harbor). Image scanning & signing (Cosign). Base image
  management. Multi-arch builds. Image promotion pipeline. SBOM generation.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 14
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 14: Containers & Image Management</tspan>
  </text>
...
![Lesson 14: Containers & Image Management](/storage/uploads/2026/03/pe-bai-14-diagram.png)
...
Container registry (Harbor) is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Container & Image Management. Key takeaways:
