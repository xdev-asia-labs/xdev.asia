...
description: >-
  GitOps: ArgoCD, Flux. Deployment strategies: blue-green, canary, progressive.
  Rollback automation. Environmental promotion. Drift detection.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 13
section_title: 'Part 4: CI/CD Platform'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1033" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1033)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1034" cy="232" r="22" fill="#f472b6" opacity="0.07"/>
    <circle cx="968" cy="126" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="902" cy="280" r="36" fill="#f472b6" opacity="0.11"/>
    <circle cx="836" cy="174" r="28" fill="#f472b6" opacity="0.13"/>
    <circle cx="770" cy="68" r="20" fill="#f472b6" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ Architecture — Lesson 13</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: GitOps & Deployment Automation</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Architecture Platform Engineering & Internal Developer Portal</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: CI/CD Platform</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 13: GitOps & Deployment Automation](/storage/uploads/2026/03/pe-bai-13-diagram.png)

## Introduction

GitOps: ArgoCD, Flux. Deployment strategies: blue-green, canary, progressive. Rollback automation. Environmental promotion. Drift detection.
...
GitOps: ArgoCD, Flux is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Deployment strategies: blue-green, canary, progressive
...
In this lesson, we learned about GitOps & Deployment Automation. Key takeaways:
