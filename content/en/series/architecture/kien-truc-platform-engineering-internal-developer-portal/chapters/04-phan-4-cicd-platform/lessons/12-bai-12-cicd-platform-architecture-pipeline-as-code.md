...
description: >-
  CI/CD platform: shared pipelines, reusable workflows. GitHub Actions, GitLab
  CI, Tekton. Pipeline templates. Build caching. Artifact management.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Architecture — Lesson 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: CI/CD Platform Architecture -</tspan>
      <tspan x="60" dy="42">Pipeline as Code</tspan>
  </text>
...
![Lesson 12: CI/CD Platform Architecture - Pipeline as Code](/storage/uploads/2026/03/pe-bai-12-diagram.png)
...
## 1. CI/CD platform: shared pipelines, reusable workflows

### 1.1 Basic concepts

CI/CD platform: shared pipelines, reusable workflows is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. GitHub Actions, GitLab CI, Tekton
...
In this lesson, we learned about CI/CD Platform Architecture - Pipeline as Code. Key takeaways:
