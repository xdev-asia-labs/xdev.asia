...
description: >-
  Unified observability: OpenTelemetry, Prometheus, Grafana, Loki, Tempo.
  Self-service dashboards. Alert routing. On-call management integration.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4829" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4829)"/>

  <!-- Decorations -->
  <g>
    <circle cx="858" cy="204" r="36" fill="#fbbf24" opacity="0.09"/>
    <circle cx="616" cy="262" r="20" fill="#fbbf24" opacity="0.13"/>
    <circle cx="874" cy="60" r="34" fill="#fbbf24" opacity="0.07"/>
    <circle cx="632" cy="118" r="18" fill="#fbbf24" opacity="0.11"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ Architecture — Lesson 19</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: Observability Platform - Metrics,</tspan>
      <tspan x="60" dy="42">Logs & Traces</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Observability Platform</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 19: Observability Platform - Metrics, Logs & Traces](/storage/uploads/2026/03/pe-bai-19-diagram.png)
...
Unified observability: OpenTelemetry, Prometheus, Grafana, Loki, Tempo are among the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Observability Platform - Metrics, Logs & Traces. Key takeaways:
