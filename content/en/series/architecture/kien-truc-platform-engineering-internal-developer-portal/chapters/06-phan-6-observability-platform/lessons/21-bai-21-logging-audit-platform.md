...
description: >-
  Centralized logging: ELK/EFK, Loki. Log aggregation at scale. Audit logging
  platform. Log-based alerting. Compliance logging requirements.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 21
section_title: 'Part 6: Observability Platform'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2997" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2997)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1090" cy="160" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1080" cy="30" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1070" cy="160" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1060" cy="30" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1050" cy="160" r="8" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 21: Logging & Audit Platform</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Observability Platform</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 21: Logging & Audit Platform](/storage/uploads/2026/03/pe-bai-21-diagram.png)
...
## 1. Centralized logging: ELK/EFK, Loki

### 1.1 Basic concepts

Centralized logging: ELK/EFK, Loki is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Logging & Audit Platform. Key takeaways:
