...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-7687" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-7687)"/>

  <!-- Decorations -->
  <g>
    <circle cx="820" cy="190" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1040" cy="70" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="760" cy="210" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="980" cy="90" r="28" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Developer Experience (DX) -</tspan>
      <tspan x="60" dy="42">Measuring & Improving</tspan>
  </text>
...
![Lesson 2: Developer Experience (DX) - Measuring & Improving](/storage/uploads/2026/03/pe-bai-2-diagram.png)
...
## 1. Developer Experience: cognitive load, flow state, feedback loops

### 1.1 Basic concepts

Developer Experience: cognitive load, flow state, feedback loops is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. DORA metrics, SPACE framework
...
In this lesson, we learned about Developer Experience (DX) - Measuring & Improving. Key takeaways:
