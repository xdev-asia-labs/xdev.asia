...
description: >-
  IDP architecture layers: UI Portal, API, orchestration, integration. Platform
  capabilities map. Build vs buy decisions. Platform maturity model.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 3
section_title: 'Part 1: Platform Engineering Foundations'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-3146" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-3146)"/>

  <!-- Decorations -->
  <g>
    <circle cx="882" cy="236" r="30" fill="#f87171" opacity="0.11"/>
    <circle cx="664" cy="218" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="946" cy="200" r="22" fill="#f87171" opacity="0.13"/>
    <circle cx="728" cy="182" r="18" fill="#f87171" opacity="0.09"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      ...
      <tspan x="60" dy="42">Layers & Components</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: Platform Engineering Foundations</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 3: Platform Architecture Overview - Layers & Components](/storage/uploads/2026/03/pe-bai-3-diagram.png)
...
IDP architecture layers: UI Portal, API, orchestration, integration are one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Platform Architecture Overview - Layers & Components. Key takeaways:
