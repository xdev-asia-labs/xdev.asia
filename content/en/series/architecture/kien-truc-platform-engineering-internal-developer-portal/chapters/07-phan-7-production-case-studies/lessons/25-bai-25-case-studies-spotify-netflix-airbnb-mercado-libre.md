...
description: >-
  Actual platform engineering analysis: Spotify (Backstage origin), Netflix
  (full cycle dev), Airbnb (service mesh), Mercado Libre (platform at scale).
  Lessons learned.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 25: Case Studies - Spotify, Netflix,</tspan>
...
![Lesson 25: Case Studies - Spotify, Netflix, Airbnb & Mercado Libre](/storage/uploads/2026/03/pe-bai-25-diagram.png)

## Introduction

Actual platform engineering analysis: Spotify (Backstage origin), Netflix (full cycle dev), Airbnb (service mesh), Mercado Libre (platform at scale). Lessons learned.

---

## 1. Analysis of actual platform engineering: Spotify (Backstage origin), Netflix (full cycle dev), Airbnb (service mesh), Mercado Libre (platform at scale)

### 1.1 Basic concepts

Practical platform engineering analysis: Spotify (Backstage origin), Netflix (full cycle dev), Airbnb (service mesh), Mercado Libre (platform at scale) are one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Case Studies - Spotify, Netflix, Airbnb & Mercado Libre. Key takeaways:
