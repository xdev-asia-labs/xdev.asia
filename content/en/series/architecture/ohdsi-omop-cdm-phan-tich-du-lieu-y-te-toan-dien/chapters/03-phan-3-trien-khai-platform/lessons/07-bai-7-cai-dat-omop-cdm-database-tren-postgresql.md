...
description: >-
  Create OMOP CDM schema on PostgreSQL, import DDL scripts, load Standardized
  Vocabularies from Athena, create indexes and constraints, configure
  performance tuning for OMOP queries, and script automation for the setup
  process.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ Architecture — Lesson 7</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: Install OMOP CDM Database above</tspan>
...
![Lesson 7: OMOP CDM Database on PostgreSQL](/storage/uploads/2026/03/ohdsi-bai-7-postgresql-cdm-setup.png)

## Introduction

OMOP CDM database is a platform for storing all standardized medical data. PostgreSQL is the most popular choice in the OHDSI community thanks to its free, high performance, and good support from OHDSI tools.
...
### 2.3 List of tables after creation
...
### 4.2 Indexes (important for performance)
...
### 5.1 Configuration for OHDSI workload
...
| Step | Description |
|-------|-------|
| 1 | Install PostgreSQL, create database + schemas (cdm, results, temp) |
| 2 | Run OMOP CDM DDL scripts → create ~37 tables |
| 3 | Download vocabularies from Athena → load into vocabulary tables |
| 4 | Create indexes (vocabulary + clinical data) |
| 5 | Tuning PostgreSQL for OHDSI workload |
| 6 | Verify: query try concepts |

**Next article**: WebAPI — Installation, Configuration & REST API
