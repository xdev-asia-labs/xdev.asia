...
description: >-
  Docker Compose for OHDSI stack (PostgreSQL, WebAPI, ATLAS), Kubernetes Helm
  charts, backup/restore CDM, monitoring with Prometheus/Grafana, performance
  tuning PostgreSQL.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Deploying OHDSI Stack on Docker</tspan>
...
![Lesson 16: Deploying OHDSI Stack on Docker & Kubernetes](/storage/uploads/2026/03/ohdsi-bai-16-docker-kubernetes.png)

## Introduction

This article guides you through deploying **the entire OHDSI stack** (PostgreSQL + WebAPI + ATLAS + ACHILLES) for production environments, including Docker Compose for single-node and Kubernetes Helm for clusters.
...
| ATLAS | Containers + config-local.js | Deployment + ConfigMap |
...
| Backups | cron + pg_dump | CronJob |
| Monitoring | postgres-exporter + Grafana | ServiceMonitor |

**Next article**: Network Studies & Best Practices — Multicenter study
