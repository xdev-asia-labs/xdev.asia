...
title: 'Lesson 17: Network Studies & Best Practices — Multicenter Studies'
slug: bai-17-network-studies-best-practices-nghien-cuu-da-trung-tam
description: >-
  Network study workflow, distributed research model, study packages, data
  governance & privacy, OHDSI community, best practices for implementing OHDSI
  in Vietnam.
duration_minutes: 100
is_free: true
video_url: null
sort_order: 17
section_title: 'Part 6: Production & Network Studies'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2882" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2882)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1070" cy="40" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1040" cy="130" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1010" cy="220" r="28" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Network Studies & Best Practices —</tspan>
      <tspan x="60" dy="42">Multicenter Study</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Production & Network Studies</text>
...
The real power of OHDSI lies in its **multicenter studies (network studies)** — the same research question is answered simultaneously across dozens of databases from multiple countries, **without sharing patient data**.
...
### 4.1 Summary of multi-site results
...
## 6. Best Practices for implementing OHDSI in Vietnam
