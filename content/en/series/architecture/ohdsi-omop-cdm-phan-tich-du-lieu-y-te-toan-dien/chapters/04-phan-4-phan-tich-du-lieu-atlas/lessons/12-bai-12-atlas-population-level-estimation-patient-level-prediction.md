...
title: 'Lesson 12: ATLAS — Population-Level Estimation & Patient-Level Prediction'
slug: bai-12-atlas-population-level-estimation-patient-level-prediction
description: >-
  Population-Level Effect Estimation (propensity score matching, negative
  control outcomes), Patient-Level Prediction (LASSO, gradient boosting,
  ROC/AUC), generate R study packages from ATLAS and evaluate the results.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: ATLAS — Population-Level</tspan>
...
![Lesson 12: Population-Level Estimation & Patient-Level Prediction](/storage/uploads/2026/03/ohdsi-bai-12-estimation-prediction.png)

## Introduction

This article focuses on two of ATLAS's most advanced analysis features:
- **Population-Level Effect Estimation (PLE)**: Estimates drug effectiveness/side effects at the population level
- **Patient-Level Prediction (PLP)**: Predict the probability of an outcome occurring for each patient
...
| Features | Input | Output | Application |
|-----------|-------|-------|----------|
| Estimation | Target vs Comparator → Outcome | Hazard Ratio + CI | Compare drug effectiveness/safety |
| Predictions | Target → Outcome (time window) | Risk score per patient | Predicting personal risk |
| PS Matching | Covariates | Balanced cohorts | Reduce confounding |
| Negative Controls | Known null effects | Empirical calibration | Detecting systematic bias |

**Next article**: ACHILLES — Data Characterization & Source Profiling
