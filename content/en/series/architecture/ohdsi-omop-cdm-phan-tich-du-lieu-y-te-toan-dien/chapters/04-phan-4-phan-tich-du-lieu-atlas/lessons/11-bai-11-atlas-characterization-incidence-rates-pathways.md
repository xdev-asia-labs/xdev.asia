...
description: >-
  ...
  Incidence Rate analysis (time-at-risk, target/outcome cohort), Treatment
  Pathways visualization, export results and share via OHDSI network.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Architecture — Lesson 11</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: ATLAS — Characterization,</tspan>
      <tspan x="60" dy="42">Incidence Rates & Pathways</tspan>
  </text>
...
![Lesson 11: Characterization, Incidence Rates & Pathways](/storage/uploads/2026/03/ohdsi-bai-11-characterization-ir-pathways.png)

## Introduction

Once Cohort Definitions have been created, the next step is **cohort analysis** — characterizing (Characterization), calculating incidence rates (Incidence Rates), and analyzing treatment pathways (Pathways).
...
Characterization answers the question: **"What does my patient's Cohort look like?"**
...
### 1.2 Create Characterization in ATLAS
...
### 3.2 Configure Pathway Analysis
...
|----------|-----------------|
| Characterization | What does a cohort look like? (demographics, comorbidities, drugs) |
| Incidence Rate | How many new cases [outcome] in [target] over time? |
| Pathways | In what order are patients treated? |
| SMD | In what characteristics do the two cohorts differ? |

**Next article**: ATLAS — Population-Level Estimation & Patient-Level Prediction
