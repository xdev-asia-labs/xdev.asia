...
description: >-
  Use Athena to look up Standard Concepts, understand Vocabulary hierarchy
  (ICD-10, SNOMED CT, RxNorm, LOINC, ATC), concept relationships, how to load
  and import vocabularies into OMOP CDM database, mapping between source
  concepts and standard concepts.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 3
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Athena — Search & Management</tspan>
      <tspan x="60" dy="42">Standardized Vocabularies</tspan>
  </text>
...
![Lesson 3: Athena — Standardized Vocabularies](/storage/uploads/2026/03/ohdsi-bai-3-athena-vocabularies.png)

## Introduction

**Athena** (https://athena.ohdsi.org) is a portal to look up and download Standardized Vocabularies — an international standard vocabulary set for the entire OHDSI ecosystem. All concepts in OMOP CDM come from here.

This article explains how to look up concepts, understand common vocabulary, concept relationships, and the process of loading/importing vocabularies into the database.
...
| Vocabulary | Domain | Description | Standard? |
|-----------|--------|-------|----------|
| **SNOMED CT** | Condition, Procedure, Observation | International Medical Terminology | ✅ Standard |
| **RxNorm** | Drugs | Medicine (US market) | ✅ Standard |
| **RxNorm Extension** | Drugs | International medicine (outside US) | ✅ Standard |
| **LOINC** | Measurement | Testing and measurement | ✅ Standard |
| **ICD-10-CM** | Conditions | Diagnosis (popular in Vietnam) | ❌ Source |
| **ICD-9-CM** | Conditions | Diagnostic (legacy) | ❌ Source |
| **ATC** | Drugs | Drug classification (WHO) | ❌ Classification |
| **CPT4** | Procedure | Tips (USA) | ✅ Standard |
| **HCPCS** | Procedure, Device | Medical Services (USA) | ✅ Standard |
| **UCUM** | Unit | Unit of measurement | ✅ Standard |
| **Gender** | Gender | Gender | ✅ Standard |
| **Race** | Race | Race | ✅ Standard |

### 2.2 SNOMED CT — Most important Vocabulary
...
### 3.1 Important Relationship Types
...
## 4. Download and Import Vocabularies
...
## 5. SOURCE_TO_CONCEPT_MAP — Custom Mapping

When the source data has its own code (not standard vocabulary):
...
| Concept | Explanation |
|-----------|-----------|
| Athena | Web portal to look up and download Standardized Vocabularies |
| Standard Concept | Standard concepts used in analysis (SNOMED, ​​RxNorm, LOINC) |
| Source Concept | Concept from original vocabulary (ICD-10, internal code) |
| Maps to | Relationship mapping source → standard concept |
| Concept Ancestors | Hierarchy table for finding children/grandchildren of concept |
| SNOMED CT | Standard Vocabulary for Condition & Procedure |
| RxNorm | Standard Vocabulary for Drug |
| LOINC | Standard Vocabulary for Measurement |

**Next post**: WhiteRabbit & Rabbit-in-a-Hat — Source Data Survey & ETL Design
