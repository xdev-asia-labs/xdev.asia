...
description: >-
  HashiCorp Vault, dynamic secrets, Kubernetes Secrets + Sealed Secrets, CSI
  Secret Store Driver, container image scanning (Trivy), Pod Security Standards,
  runtime security (Falco), supply chain security (Sigstore/Cosign).
duration_minutes: 90
is_free: true
video_url: null
sort_order: 25
...
![Lesson 25: Secrets Management & Container Security](/storage/uploads/2026/03/cn-bai-25-diagram.png)
