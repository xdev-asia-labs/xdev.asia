...
description: >-
  CI/CD architecture for multi-service, pipeline per service, build → test →
  scan → deploy flow, container image build & push, automated testing strategy
  (unit, integration, contract, E2E), monorepo vs polyrepo CI/CD.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 21: CI/CD Pipeline for Microservices</tspan>
  </text>
...
![Lesson 21: CI/CD Pipeline for Microservices](/storage/uploads/2026/03/cn-bai-21-diagram.png)
