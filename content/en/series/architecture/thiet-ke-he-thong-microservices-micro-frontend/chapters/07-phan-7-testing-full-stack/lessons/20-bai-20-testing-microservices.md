...
title: 'Lesson 20: Testing Microservices — Unit, Integration & E2E'
slug: bai-20-testing-microservices-unit-integration-e2e
description: >-
  Testing Pyramid for Microservices. Unit testing with mocks/stubs. Integration
  testing with Testcontainers. E2E test strategies. Service virtualization.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 20: Testing Microservices — Unit,</tspan>
...
Testing microservices is more difficult than monolith because of distributed dependencies. This article builds a comprehensive testing strategy: from isolated unit testing to E2E testing across services.
...
Test business logic **isolated** from database, network, external services:
...
Test service with **real database & dependencies**:
...
|----------|-------|
| **Test Pyramid** | 70% units, 20% integration, 10% E2E |
| **Testcontainers** | Real DB instead of mocks for integration tests |
| **Parallel tests** | Each test has its own DB container |
...
- **Integration tests**: Testcontainers for real DB testing
- **Component tests**: whole service, mocked external deps
- **E2E tests**: critical business flows only (5-10 scenarios)
- **Contract tests**: verify API contracts (see Lesson 22)

---

**Next article:** [Lesson 21: Testing Micro Frontend — Component, Visual & Integration](/series/thiet-ke-he-thong-microservices-micro-frontend/bai-21-testing-micro-frontend-component-visual-integration)
