...
description: >-
  Time-series data patterns. TimescaleDB: hypertables, continuous aggregates.
  InfluxDB: Flux query language. QuestDB: SQL for time-series. Comparison and
  selection.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: Time-Series Database -</tspan>
...
![Lesson 11: Time-Series Database - TimescaleDB, InfluxDB & QuestDB](/storage/uploads/2026/03/iot-bai-11-diagram.png)

## Introduction

Time-series data patterns. TimescaleDB: hypertables, continuous aggregates. InfluxDB: Flux query language. QuestDB: SQL for time-series. Comparison and selection.
...
Time-series data patterns are one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Time-Series Database - TimescaleDB, InfluxDB & QuestDB. Key takeaways:
