...
description: >-
  Smart building architecture: BACnet, KNX integration. HVAC optimization.
  Occupancy detection. Energy monitoring and optimization. Building Management
  System (BMS).
duration_minutes: 90
is_free: true
video_url: null
sort_order: 18
section_title: 'Part 6: Industry Applications'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5176" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5176)"/>

  <!-- Decorations -->
  <g>
    <circle cx="730" cy="60" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="860" cy="70" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="990" cy="80" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="620" cy="90" r="28" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 18: Smart Building & Energy Management</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Real-time Architecture & IoT Platform</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Industry Applications</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 18: Smart Building & Energy Management](/storage/uploads/2026/03/iot-bai-18-diagram.png)

## Introduction

Smart building architecture: BACnet, KNX integration. HVAC optimization. Occupancy detection. Energy monitoring and optimization. Building Management System (BMS).

---

## 1. Smart building architecture: BACnet, KNX integration

### 1.1 Basic concepts

Smart building architecture: BACnet, KNX integration is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Smart Building & Energy Management. Key takeaways:
