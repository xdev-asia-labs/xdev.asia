...
description: >-
  Deploying IoT platform on K8s. EMQX operator. TimescaleDB on K8s. Edge K3s
  clusters. GitOps for IoT infrastructure. Multi-cluster management.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 22: IoT Platform on Kubernetes</tspan>
  </text>
...
![Lesson 22: IoT Platform on Kubernetes](/storage/uploads/2026/03/iot-bai-22-diagram.png)

## Introduction

Deploying IoT platform on K8s. EMQX operator. TimescaleDB on K8s. Edge K3s clusters. GitOps for IoT infrastructure. Multi-cluster management.
...
Deploying IoT platform on K8s is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about IoT Platform on Kubernetes. Key takeaways:
