...
description: >-
  IoT Platform architecture design: cloud-edge hybrid. Message broker (EMQX,
  HiveMQ). Rule engine. Device registry. Data pipeline architecture.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 3
section_title: 'Part 1: IoT Foundations'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1730" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1730)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1017" cy="161" r="30" fill="#a78bfa" opacity="0.060000000000000005"/>
    <circle cx="934" cy="118" r="11" fill="#a78bfa" opacity="0.07"/>
    <circle cx="851" cy="75" r="22" fill="#a78bfa" opacity="0.08"/>
    <circle cx="768" cy="32" r="33" fill="#a78bfa" opacity="0.09"/>
    <circle cx="685" cy="249" r="14" fill="#a78bfa" opacity="0.1"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Architecture — Lesson 3</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Platform Architecture Overview -</tspan>
      <tspan x="60" dy="42">Cloud-Edge Hybrid</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: IoT Foundations</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 3: Platform Architecture Overview - Cloud-Edge Hybrid](/storage/uploads/2026/03/iot-bai-3-diagram.png)

## Introduction

IoT Platform architecture design: cloud-edge hybrid. Message broker (EMQX, HiveMQ). Rule engine. Device registry. Data pipeline architecture.

---

## 1. IoT Platform architecture design: cloud-edge hybrid

### 1.1 Basic concepts

IoT Platform architecture design: cloud-edge hybrid is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Platform Architecture Overview - Cloud-Edge Hybrid. Key takeaways:
