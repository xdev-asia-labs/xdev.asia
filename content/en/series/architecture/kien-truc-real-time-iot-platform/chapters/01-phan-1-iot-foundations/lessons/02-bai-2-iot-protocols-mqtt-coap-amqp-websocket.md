...
description: >-
  ...
  constrained devices. AMQP for enterprises. WebSocket for real-time web.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5446" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5446)"/>

  <!-- Decorations -->
  <g>
    <circle cx="803" cy="159" r="16" fill="#c084fc" opacity="0.14"/>
    <circle cx="1006" cy="202" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="709" cy="245" r="24" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="912" cy="288" r="13" fill="#c084fc" opacity="0.11"/>
    <circle cx="615" cy="71" r="32" fill="#c084fc" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: IoT Protocols - MQTT, CoAP, AMQP &</tspan>
...
![Lesson 2: IoT Protocols - MQTT, CoAP, AMQP & WebSocket](/storage/uploads/2026/03/iot-bai-2-diagram.png)

## Introduction

MQTT deep-dive: QoS levels, retained messages, will messages. CoAP for constrained devices. AMQP for enterprises. WebSocket for real-time web. Protocol selection guide.

---

## 1. MQTT deep-dive: QoS levels, retained messages, will messages

### 1.1 Basic concepts

MQTT deep-dive: QoS levels, retained messages, will messages is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. CoAP for constrained devices
...
In this lesson, we learned about IoT Protocols - MQTT, CoAP, AMQP & WebSocket. Key takeaways:
