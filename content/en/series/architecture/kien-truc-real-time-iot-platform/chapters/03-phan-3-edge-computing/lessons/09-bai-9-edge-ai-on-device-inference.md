...
description: >-
  Edge AI: TensorRT, ONNX Runtime, TFLite. Model optimization: quantization,
  pruning. On-device inference vs cloud inference trade-offs. Vision at the
  edge.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5562" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5562)"/>

  <!-- Decorations -->
  <g>
    <circle cx="852" cy="206" r="20" fill="#f87171" opacity="0.11"/>
    <circle cx="604" cy="178" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="856" cy="150" r="32" fill="#f87171" opacity="0.13"/>
    <circle cx="608" cy="122" r="8" fill="#f87171" opacity="0.09"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Edge AI & On-device Inference</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Edge Computing</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 9: Edge AI & On-device Inference](/storage/uploads/2026/03/iot-bai-9-diagram.png)
...
## 1. Edge AI: TensorRT, ONNX Runtime, TFLite

### 1.1 Basic concepts

Edge AI: TensorRT, ONNX Runtime, TFLite are some of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 3. On-device inference vs cloud inference trade-offs
...
In this lesson, we learned about Edge AI & On-device Inference. Key takeaways:
