...
description: >-
  Edge computing: why and when. Edge deployment models. Edge runtime (K3s,
  KubeEdge). Edge AI inference. Data filtering and aggregation at edge.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1864" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1864)"/>

  <!-- Decorations -->
  <g>
    <circle cx="962" cy="256" r="10" fill="#f87171" opacity="0.11"/>
    <circle cx="824" cy="158" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="686" cy="60" r="12" fill="#f87171" opacity="0.13"/>
    <circle cx="1048" cy="222" r="28" fill="#f87171" opacity="0.09"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Edge Computing Architecture -</tspan>
      <tspan x="60" dy="42">Processing at the Edge</tspan>
  </text>
...
![Lesson 8: Edge Computing Architecture - Processing at the Edge](/storage/uploads/2026/03/iot-bai-8-diagram.png)

## Introduction

Edge computing: why and when. Edge deployment models. Edge runtime (K3s, KubeEdge). Edge AI inference. Data filtering and aggregation at edge.

---

## 1. Edge computing: why and when

### 1.1 Basic concepts

Edge computing: why and when is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Edge Computing Architecture - Processing at the Edge. Key takeaways:
