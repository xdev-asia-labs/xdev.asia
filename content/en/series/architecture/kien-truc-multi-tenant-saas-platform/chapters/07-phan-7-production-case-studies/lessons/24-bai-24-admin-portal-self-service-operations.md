...
description: >-
  Super admin portal: tenant management, usage monitoring. Tenant admin portal:
  user management, settings, billing. Self-service troubleshooting.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 24
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-9335" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-9335)"/>

  <!-- Decorations -->
  <g>
    <circle cx="850" cy="240" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="600" cy="50" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="850" cy="120" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="600" cy="190" r="18" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Architecture — Lesson 24</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 24: Admin Portal & Self-service</tspan>
      <tspan x="60" dy="42">Operations</tspan>
  </text>
...
![Lesson 24: Admin Portal & Self-service Operations](/storage/uploads/2026/03/saas-bai-24-diagram.png)
...
## 1. Super admin portal: tenant management, usage monitoring

### 1.1 Basic concepts

Super admin portal: tenant management, usage monitoring is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Tenant admin portal: user management, settings, billing
...
In this lesson, we learned about Admin Portal & Self-service Operations. Key takeaways:
