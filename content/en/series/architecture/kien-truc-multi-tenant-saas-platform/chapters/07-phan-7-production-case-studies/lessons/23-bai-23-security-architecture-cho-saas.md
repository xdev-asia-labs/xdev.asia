...
description: >-
  ...
  Vulnerability management. Penetration testing. SOC 2, ISO 27001 compliance.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ Architecture — Lesson 23</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 23: Security Architecture for SaaS</tspan>
  </text>
...
![Lesson 23: Security Architecture for SaaS](/storage/uploads/2026/03/saas-bai-23-diagram.png)
...
## 1. SaaS security: tenant data encryption, key management per tenant

### 1.1 Basic concepts

SaaS security: tenant data encryption, key management per tenant is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Security Architecture for SaaS. Key takeaways:
