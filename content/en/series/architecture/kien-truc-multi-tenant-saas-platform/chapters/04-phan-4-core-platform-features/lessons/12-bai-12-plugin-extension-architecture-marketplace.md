...
description: >-
  ...
  Marketplace plugin. Third-party integrations. Webhook system. OAuth app
  platform.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 12
section_title: 'Part 4: Core Platform Features'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4523" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4523)"/>

  <!-- Decorations -->
  <g>
    <circle cx="968" cy="114" r="36" fill="#fbbf24" opacity="0.09"/>
    <circle cx="836" cy="142" r="20" fill="#fbbf24" opacity="0.13"/>
    <circle cx="704" cy="170" r="34" fill="#fbbf24" opacity="0.07"/>
    <circle cx="1072" cy="198" r="18" fill="#fbbf24" opacity="0.11"/>
    <circle cx="940" cy="226" r="32" fill="#fbbf24" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ Architecture — Lesson 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Plugin & Extension Architecture -</tspan>
      <tspan x="60" dy="42">Marketplace</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Core Platform Features</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 12: Plugin & Extension Architecture - Marketplace](/storage/uploads/2026/03/saas-bai-12-diagram.png)

## Introduction

Design plugin system: extension points, hooks, sandboxed execution. Marketplace plugin. Third-party integrations. Webhook system. OAuth app platform.

---

## 1. Design plugin system: extension points, hooks, sandboxed execution

### 1.1 Basic concepts

Plugin system design: extension points, hooks, sandboxed execution is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Plugin & Extension Architecture - Marketplace. Key takeaways:
