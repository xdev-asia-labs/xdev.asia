...
description: >-
  White-label architecture: custom domains, logos, colors, email templates. CSS
  theming engine. Reseller/partner program support. Custom login pages.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 13
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Architecture — Lesson 13</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: White-labeling & Custom Branding</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Core Platform Features</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 13: White-labeling & Custom Branding](/storage/uploads/2026/03/saas-bai-13-diagram.png)

## Introduction

White-label architecture: custom domains, logos, colors, email templates. CSS theming engine. Reseller/partner program support. Custom login pages.

---

## 1. White-label architecture: custom domains, logos, colors, email templates

### 1.1 Basic concepts

White-label architecture: custom domains, logos, colors, email templates is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 3. Reseller/partner program support
...
In this lesson, we learned about White-labeling & Custom Branding. Key takeaways:
