...
title: 'Lesson 1: Overview of SaaS - Business Models, Metrics & Architecture Patterns'
slug: bai-1-tong-quan-saas-business-models-metrics-architecture
description: >-
  SaaS business models (B2B, B2C, PLG, Sales-led). Key metrics: MRR, ARR, Churn,
  LTV, CAC. SaaS architecture patterns and evolution from on-premise to
  cloud-native.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2224" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2224)"/>

  <!-- Decorations -->
  <g>
    <circle cx="674" cy="72" r="22" fill="#f472b6" opacity="0.07"/>
    <circle cx="748" cy="86" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="822" cy="100" r="36" fill="#f472b6" opacity="0.11"/>
    <circle cx="896" cy="114" r="28" fill="#f472b6" opacity="0.13"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ Architecture — Lesson 1</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 1: Overview of SaaS - Business Models,</tspan>
      <tspan x="60" dy="42">Metrics & Architectural Patterns</tspan>
  </text>
...
![Lesson 1: Overview of SaaS - Business Models, Metrics & Architecture Patterns](/storage/uploads/2026/03/saas-bai-1-diagram.png)

## Introduction

SaaS business models (B2B, B2C, PLG, Sales-led). Key metrics: MRR, ARR, Churn, LTV, CAC. SaaS architecture patterns and evolution from on-premise to cloud-native.

---

## 1. SaaS business models (B2B, B2C, PLG, Sales-led)

### 1.1 Basic concepts

SaaS business models (B2B, B2C, PLG, Sales-led) are one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Key metrics: MRR, ARR, Churn, LTV, CAC
...
## 3. SaaS architecture patterns and Evolution from on-premise to cloud-native.
...
In this lesson, we learned about SaaS Overview - Business Models, Metrics & Architecture Patterns. Key takeaways:
