...
description: >-
  Immutable audit logs per tenant. Activity feed. Data retention policies. GDPR
  compliance: data deletion, export. SOC 2 requirements.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 18
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 18: Audit Logging & Compliance</tspan>
  </text>
...
![Lesson 18: Audit Logging & Compliance](/storage/uploads/2026/03/saas-bai-18-diagram.png)
...
## 1. Immutable audit logs per tenant

### 1.1 Basic concepts

Immutable audit logs per tenant is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 4. GDPR compliance: data deletion, export
...
In this lesson, we learned about Audit Logging & Compliance. Key takeaways:
