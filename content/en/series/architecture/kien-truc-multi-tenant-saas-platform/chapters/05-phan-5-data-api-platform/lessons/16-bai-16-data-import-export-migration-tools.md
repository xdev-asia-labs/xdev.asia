...
description: >-
  Bulk data import with streaming. Export formats (CSV, JSON, Parquet). Data
  migration from competitor platforms. ETL pipelines for tenant data.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 16
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6874" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6874)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1079" cy="227" r="22" fill="#818cf8" opacity="0.12000000000000001"/>
    <circle cx="1058" cy="206" r="29" fill="#818cf8" opacity="0.09"/>
    <circle cx="1037" cy="185" r="36" fill="#818cf8" opacity="0.060000000000000005"/>
    <circle cx="1016" cy="164" r="13" fill="#818cf8" opacity="0.13"/>
    <circle cx="995" cy="143" r="20" fill="#818cf8" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Data Import/Export & Migration</tspan>
      <tspan x="60" dy="42">Tools</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Data & API Platform</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 16: Data Import/Export & Migration Tools](/storage/uploads/2026/03/saas-bai-16-diagram.png)

## Introduction

Bulk data import with streaming. Export formats (CSV, JSON, Parquet). Data migration from competitor platforms. ETL pipelines for tenant data.

---

## 1. Bulk data import with streaming

### 1.1 Basic concepts

Bulk data import with streaming is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 3. Data migration from competitor platforms
...
## 4. ETL pipelines for tenant data.
...
In this lesson, we learned about Data Import/Export & Migration Tools. Key takeaways:
