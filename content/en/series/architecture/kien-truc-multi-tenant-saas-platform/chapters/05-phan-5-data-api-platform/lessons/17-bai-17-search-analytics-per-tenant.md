...
description: >-
  Full-text search for multi-tenant (Elasticsearch/Meilisearch). Tenant data
  isolation in search index. In-app analytics dashboard. Data exports.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 17
section_title: 'Part 5: Data & API Platform'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5408" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5408)"/>

  <!-- Decorations -->
  <g>
    <circle cx="722" cy="156" r="30" fill="#f87171" opacity="0.11"/>
    <circle cx="844" cy="198" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="966" cy="240" r="22" fill="#f87171" opacity="0.13"/>
    <circle cx="1088" cy="282" r="18" fill="#f87171" opacity="0.09"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: Search & Analytics Per Tenant</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">Multi-tenant SaaS Platform architecture</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Data & API Platform</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 17: Search & Analytics Per Tenant](/storage/uploads/2026/03/saas-bai-17-diagram.png)

## Introduction

Full-text search for multi-tenant (Elasticsearch/Meilisearch). Tenant data isolation in search index. In-app analytics dashboard. Data exports.

---

## 1. Full-text search for multi-tenant (Elasticsearch/Meilisearch)

### 1.1 Basic concepts

Full-text search for multi-tenant (Elasticsearch/Meilisearch) is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Tenant data isolation in search index
...
In this lesson, we learned about Search & Analytics Per Tenant. Key takeaways:
