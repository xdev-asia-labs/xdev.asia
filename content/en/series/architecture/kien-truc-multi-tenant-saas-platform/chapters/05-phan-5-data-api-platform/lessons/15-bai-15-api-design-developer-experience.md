...
description: >-
  API-first SaaS: REST/GraphQL API design. API versioning strategy. Developer
  portal. SDK generation. Rate limiting per API key. Sandbox environment.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8335" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8335)"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ Architecture — Lesson 15</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: API Design & Developer Experience</tspan>
  </text>
...
![Lesson 15: API Design & Developer Experience](/storage/uploads/2026/03/saas-bai-15-diagram.png)
...
## 1. API-first SaaS: REST/GraphQL API design

### 1.1 Basic concepts

API-first SaaS: REST/GraphQL API design is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about API Design & Developer Experience. Key takeaways:
