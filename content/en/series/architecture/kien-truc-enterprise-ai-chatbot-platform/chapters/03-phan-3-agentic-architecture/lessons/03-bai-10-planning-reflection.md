...
title: >-
  Lesson 10: Planning & Reflection — ReAct, Self-Correction & Complex Task
  Decomposition
slug: bai-10-planning-reflection
description: >-
  ReAct pattern (Reasoning + Acting), plan-execute-review cycle, self-reflection
  loop, task decomposition, error recovery, hallucination detection, confidence
  scoring.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Architecture — Lesson 10</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Planning & Reflection — ReAct,</tspan>
      <tspan x="60" dy="42">Self-Correction & Complex Task</tspan>
      <tspan x="60" dy="42">Decomposition</tspan>
  </text>
...
<p>ReAct (Reason + Act) is the strongest pattern for agentic AI — LLM <strong>think before acting</strong>, and <strong>Feedback after receiving results</strong>. Different from naive function calling, ReAct creates trace of thought to help debug and improve the agent.</p>
...
<h2 id="tong-ket"><strong>Summary of Lesson 10</strong></h2>

<ul>
<li><strong>ReAct</strong>: Thought → Action → Observation loop — agent thinks before acting</li>
<li><strong>Plan-Execute-Review</strong>: Create plan → execute step-by-step → review results → replan if failed</li>
<li><strong>Self-Reflection</strong>: Agent self-assess quality, detect issues, improve response (max N attempts)</li>
...
<p><strong>Next article:</strong> Structured Data Querying — Text-to-SQL, knowledge graph querying, database agent, result formatting.</p>
