...
title: 'Lesson 9: Multi-Agent Orchestration — Supervisor, Routing & Handoff Protocol'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ Architecture — Lesson 9</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Multi-Agent Orchestration —</tspan>
      <tspan x="60" dy="42">Supervisor, Routing & Handoff Protocol</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Agentic Architecture</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-multi-agent-overview"><strong>1. Why Multi-Agent? — Single Agent Limits</strong></h2>

<p>A single agent with 50+ tools will have problems: <strong>tool confusion</strong> (choose the wrong tool), <strong>context overload</strong> (system prompt is too long), and <strong>poor specialization</strong>. Multi-agent is divided into specialized agents, each agent only handles one domain.</p>
...
<h2 id="tong-ket"><strong>Summary of Lesson 9</strong></h2>

<ul>
<li><strong>Multi-Agent</strong>: Divide the chatbot into specialist agents, each agent has its own tools + prompt</li>
<li><strong>Supervisor Pattern</strong>: LLM-based router decides which agent to handle, fallback to embedding similarity</li>
<li><strong>Handoff Protocol</strong>: Transfer context between agents via summary + system message</li>
<li><strong>Shared Memory</strong>: Redis-based shared context (customer info, collected data, agent notes)</li>
<li><strong>Topic Change Detection</strong>: Automatically detect when user changes topic → handoff agent</li>
</ul>

<p><strong>Next article:</strong> Planning & Reflection — ReAct pattern, self-reflection loop, plan-execute-review cycle for complex tasks.</p>
