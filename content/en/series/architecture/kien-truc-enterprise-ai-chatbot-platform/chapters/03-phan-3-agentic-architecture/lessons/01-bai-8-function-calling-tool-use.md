...
title: >-
  Lesson 8: Function Calling & Tool Use — Tool Registry, Safe Execution & Output
  Validation
slug: bai-8-function-calling-tool-use
description: >-
  Design tool registry, OpenAI/Anthropic function calling, safe execution
  sandbox, output validation, tool chaining, error handling, rate limiting per
  tool.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Function Calling & Tool Use — Tool</tspan>
...
<h2 id="1-function-calling-overview"><strong>1. Function Calling — Turn LLM into Action Engine</strong></h2>

<p>Function calling enables LLM <strong>call external tools/APIs</strong> instead of just generating text. This is the foundation of every agentic chatbot — from looking up orders, making appointments, to executing complex workflows.</p>
...
<h2 id="tong-ket"><strong>Summary of Lesson 8</strong></h2>

<ul>
<li><strong>Tool Registry</strong>: Manage tool definitions, permissions, rate limits, danger levels</li>
<li><strong>Safe Execution</strong>: Permission check → Rate limit → Input validation → Sanitize → Timeout → Audit log</li>
<li><strong>Tool Chaining</strong>: LLM automatically chains multiple tool calls, max depth = 5 to avoid infinite loops</li>
<li><strong>Confirmation</strong>: Dangerous actions (cancel, delete) require user confirmation before execution</li>
<li><strong>Output Validation</strong>: Use Zod schema to validate tool output before sending back to LLM</li>
</ul>

<p><strong>Next article:</strong> Multi-Agent Orchestration — agent routing, supervisor pattern, handoff protocol, shared memory between agents.</p>
