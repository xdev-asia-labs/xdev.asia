...
title: >-
  Lesson 13: Knowledge Base Management — Document Ingestion, Lifecycle & Access
  Control
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Knowledge Base Management —</tspan>
...
<p>RAG pipeline (Lesson 5) solves <strong>retrieval. retrieval</strong>. But enterprises need management <strong>lifecycle</strong> of knowledge — ingestion from multiple sources, versioning, access control, stale content detection, multi-tenant isolation.</p>
...
<h2 id="tong-ket"><strong>Summary of Lesson 13</strong></h2>
...
<li><strong>Incremental Sync</strong>: Only process changes, no need to fully re-index each time you sync</li>
</ul>

<p><strong>Next article:</strong> Multi-Tenant Architecture — tenant isolation, configuration per tenant, resource quotas, billing metering.</p>
