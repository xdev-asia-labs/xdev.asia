...
title: >-
  Lesson 15: Analytics & Observability — Conversation Analytics, LLM Metrics &
  Cost Tracking
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Architecture — Lesson 15</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Analytics & Observability —</tspan>
...
<h2 id="1-observability-stack"><strong>1. Observability Stack for AI Chatbot</strong></h2>
...
<h2 id="tong-ket"><strong>Summary of Lesson 15</strong></h2>
...
<li><strong>LLM Tracing</strong>: Langfuse traces per call with spans (RAG, guardrail, LLM) + cost scoring</li>
<li><strong>Cost Tracking</strong>: Per-model cost, daily reports, optimization recommendations</li>
<li><strong>Alerting</strong>: Automated alerts for error rate, latency spikes, cost overrun, quality drops</li>
</ul>

<p><strong>Next article:</strong> Multi-Channel Integration — Omnichannel gateway, Facebook Messenger, Zalo OA, Web Widget, LINE, Slack, Teams.
</p>
