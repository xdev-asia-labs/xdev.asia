...
title: 'Lesson 14: Multi-Tenant Architecture — Tenant Isolation, Quotas & Billing'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ Architecture — Lesson 14</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 14: Multi-Tenant Architecture — Tenant</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Enterprise Features & Safety</text>
...
<p>Enterprise chatbot platform serves hundreds of organizations — each tenant has its own data, configuration, branding, models, and quotas. Multi-tenancy is the deciding factor <strong>unit economics</strong> of platform.</p>
...
<h2 id="tong-ket"><strong>Summary of Lesson 14</strong></h2>
...
<p><strong>Next article:</strong> Analytics & Observability — conversation analytics, LLM metrics, dashboards, alerting, cost tracking.</p>
