...
title: >-
  Lesson 19: Personalization & Long-term Memory — User Profiling, Preference
...
description: >-
  ...
  memory architecture, memory consolidation, forgetting strategies,
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🏗️ Architecture — Lesson 19</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: Personalization & Long-term Memory</tspan>
      <tspan x="60" dy="42">— User Profiling, Preference Learning &</tspan>
      <tspan x="60" dy="42">Memory Consolidation</tspan>
  </text>
...
<p>People remember context through many conversations — chatbots also need that. Long-term memory helps chatbots <strong>Remember preferences, history, relationships</strong> of users across sessions.</p>
...
<h2 id="tong-ket"><strong>Summary of Lesson 19</strong></h2>
...
<p><strong>Next article:</strong> Domain-Specific AI — Healthcare, Finance, Legal chatbot compliance, domain knowledge fine-tuning.</p>
