...
title: 'Lesson 20: Domain-Specific AI — Healthcare, Finance & Legal Chatbot Compliance'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2230" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2230)"/>

  <!-- Decorations -->
  <g>
    <circle cx="810" cy="60" r="28" fill="#38bdf8" opacity="0.05"/>
    <circle cx="1020" cy="70" r="8" fill="#38bdf8" opacity="0.05"/>
    <circle cx="730" cy="80" r="18" fill="#38bdf8" opacity="0.05"/>
    <circle cx="940" cy="90" r="28" fill="#38bdf8" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Architecture — Lesson 20</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 20: Domain-Specific AI — Healthcare,</tspan>
      <tspan x="60" dy="42">Finance & Legal Chatbot Compliance</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Advanced AI Capabilities</text>
...
<p>General-purpose chatbots are not enough for industries to have <strong>strict compliance requirements</strong> — Healthcare (HIPAA), Finance (PCI-DSS, SOX), Legal (attorney-client privilege). Each domain needs specialized guardrails, knowledge, and response patterns.</p>
...
<h2 id="tong-ket"><strong>Summary of Lesson 20</strong></h2>
...
<li><strong>Domain Knowledge</strong>: Terminology mapping for better RAG, domain-specific response templates</li>
<li><strong>Compliance Audit</strong>: Immutable audit trail, tamper detection, periodic compliance reports</li>
</ul>

<p><strong>Next article:</strong> Multimodal AI — Image understanding, document OCR, chart/graph analysis, visual question answering.</p>
