...
title: >-
  Lesson 7: Mockup Engine & 3D Visualization — Product Mockup, Three.js
  Rendering & AR Try-on
slug: bai-7-mockup-engine-3d-visualization
description: >-
  Mockup generation pipeline, perspective transform, 3D rendering with
  Three.js/Blender, AR try-on (WebXR), product photography simulation, batch
  mockup generation, multi-angle preview system.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 7: Mockup Engine & 3D Visualization —</tspan>
...
<h2 id="3-3d-rendering"><strong>3. 3D Rendering with Three.js</strong></h2>
...
<tbody>
<tr><td>2D Perspective Transform</td><td>~100ms</td><td>Good</td><td>Real-time preview in editor</td></tr>
...
<ul>
<li><p><strong>2D Mockups</strong> — Perspective transform + displacement map + shadow overlay, ~100ms, used for real-time editor preview</p></li>
<li><p><strong>3D Mockups</strong> — Three.js + GLTF models + PBR materials, multi-angle camera presets, studio lighting</p></li>
<li><p><strong>AI Mockups</strong> — SDXL + ControlNet + IP-Adapter, photorealistic product shots for marketing</p></li>
<li><p><strong>AR Try-on</strong> — MediaPipe body tracking + WebGL overlay, real-time on browser</p></li>
<li><p><strong>Batch Processing</strong> — Parallel queue (PQueue), concurrent mockup for the entire catalog</p></li>
</ul>
