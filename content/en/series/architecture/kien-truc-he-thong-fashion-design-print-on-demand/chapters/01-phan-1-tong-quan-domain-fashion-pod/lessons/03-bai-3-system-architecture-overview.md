...
title: 'Lesson 3: System Architecture Overview — Microservices, Event-Driven & DDD'
slug: bai-3-system-architecture-overview
description: >-
  High-level system architecture, bounded contexts (Design, Catalog, Order,
  Production, Fulfillment, Analytics), event-driven architecture, CQRS,
  technology stack selection, C4 diagrams.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: System Architecture Overview —</tspan>
...
<p>Apply <strong>Domain-Driven Design</strong> to separate the POD system into clearly bounded contexts.</p>
...
<tr><td>Channel (Shopify/Etsy)</td><td>Catalogs, Orders</td><td>Anti-corruption Layer</td><td>External API → Internal model</td></tr>
</tbody>
</table>
...
<tr><td>Order → Production</td><td>Async (saga orchestrator)</td><td>seconds. seconds</td></tr>
...
<li><p><strong>Event-Driven</strong> — Kafka event bus, domain events for loose coupling</p></li>
<li><p><strong>CQRS</strong> — Separate read/write for performance (product catalog, search)</p></li>
<li><p><strong>Saga Pattern</strong> — Distributed transactions for order lifecycle</p></li>
