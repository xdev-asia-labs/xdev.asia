...
title: >-
  ...
  Design-Product Binding
slug: bai-8-product-catalog-sku-architecture
description: >-
  Product catalog architecture for POD, SKU management strategy, base product +
  design = sellable product, variant matrix (size × color × design),
  inventory-less model, product data model, multi-channel product sync.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Product Catalog & SKU Architecture</tspan>
      <tspan x="60" dy="42">— Variant Management & Design-Product</tspan>
      <tspan x="60" dy="42">Binding</tspan>
  </text>
...
<p>In POD, the product does not exist in inventory (inventory-less) — it is only produced when there is an order. The product model is <strong>Base Product × Design = Sellable Product</strong>.</p>
...
<tr><td>Availability</td><td>Always available (supplier authorized)</td><td>Out-of-stock possible</td></tr>
