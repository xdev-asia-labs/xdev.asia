...
title: >-
  Lesson 9: Multi-channel Sales — Shopify, Etsy, Amazon, TikTok Shop & API
  Integration
slug: bai-9-multi-channel-sales-integration
description: >-
  Multi-channel sales architecture for POD, integration with Shopify, Etsy,
  Amazon, TikTok Shop, WooCommerce, product listing sync, order routing,
  inventory sync, webhook handling, channel-specific requirements.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 9
section_title: 'Part 3: Product & E-Commerce Platform'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Architecture — Lesson 9</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Multi-channel Sales — Shopify,</tspan>
      <tspan x="60" dy="42">Etsy, Amazon, TikTok Shop & API</tspan>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Product & E-Commerce Platform</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-multi-channel-architecture"><strong>1. Multi-channel Architecture</strong></h2>
...
<h2 id="2-channel-connector"><strong>2. Channel Connector Interface</strong></h2>
...
<h2 id="3-product-sync"><strong>3. Product Listing Sync</strong></h2>
...
<h2 id="4-order-routing"><strong>4. Order Routing from Channels</strong></h2>
...
<h2 id="5-webhook-handling"><strong>5. Webhook Handling</strong></h2>
...
<h2 id="6-channel-comparison"><strong>6. Channel Comparison</strong></h2>

<table>
<thead>
<tr><th>Features</th><th>Shopify</th><th>Etsy</th><th>Amazon</th><th>TikTok Shop</th><th>WooCommerce</th></tr>
</thead>
<tbody>
<tr><td>API Type</td><td>GraphQL + REST</td><td>REST v3</td><td>SP-API</td><td>REST</td><td>REST v3</td></tr>
<tr><td>Auth</td><td>OAuth 2.0</td><td>OAuth 2.0</td><td>IAM + OAuth</td><td>OAuth 2.0</td><td>API Key</td></tr>
<tr><td>Max Images</td><td>250</td><td>10</td><td>9</td><td>9</td><td>Unlimited</td></tr>
<tr><td>Max Variants</td><td>100</td><td>Varies</td><td>Per category</td><td>Varies</td><td>Unlimited</td></tr>
<tr><td>Webhooks</td><td>Yes (HMAC)</td><td>Limited</td><td>SQS/SNS</td><td>Yes</td><td>Yes (JWT)</td></tr>
<tr><td>Commission</td><td>0%</td><td>6.5%</td><td>8-15%</td><td>5%</td><td>0%</td></tr>
<tr><td>Order Flow</td><td>Push (webhook)</td><td>Pull (poll)</td><td>Pull (SP-API)</td><td>Push</td><td>Push (webhook)</td></tr>
</tbody>
</table>
