...
title: >-
  Lesson 10: Pricing Engine & Revenue Model — Cost Calculation, Dynamic Pricing
  & Margin Optimization
slug: bai-10-pricing-engine-revenue-model
description: >-
  Pricing engine architecture for POD, cost breakdown (base cost + print +
  shipping + fees), dynamic pricing, margin calculator, multi-currency support,
  discount/coupon system, revenue split (designer + platform), AI-powered
  pricing.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ Architecture — Lesson 10</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Pricing Engine & Revenue Model —</tspan>
...
<table>
<thead>
<tr><th>Component</th><th>Key Features</th><th>Impact</th></tr>
</thead>
<tbody>
