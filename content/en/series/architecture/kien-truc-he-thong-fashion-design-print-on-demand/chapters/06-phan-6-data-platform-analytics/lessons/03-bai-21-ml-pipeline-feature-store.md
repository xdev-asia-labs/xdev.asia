...
title: 'Lesson 21: ML Pipeline & Feature Store — Training, Serving & A/B Testing'
slug: bai-21-ml-pipeline-feature-store
description: >-
  ML Platform for Fashion POD — feature store, training pipeline, model serving,
  A/B testing, model monitoring, drift detection, MLOps stack (MLflow, registry,
  experiment tracking).
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ Architecture — Lesson 21</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 21: ML Pipeline & Feature Store —</tspan>
...
<li><strong>Point-in-time correctness</strong>: avoid data leakage</li>
</ul>
...
<table>
<thead>
<tr><th>Pattern</th><th>When used</th></tr>
</thead>
<tbody>
<tr><td>Online inference</td><td>Recommendation, real-time personalization</td></tr>
<tr><td>Batch inference</td><td>Nightly ranking precompute, trend prediction</td></tr>
<tr><td>Streaming inference</td><td>Fraud/risk scoring by event</td></tr>
</tbody>
</table>
...
<ul>
<li>Primary metrics are clear before running the test</li>
...
<li>Experimental tracking (MLflow)</li>
<li>Reproducible training (code + data snapshot)</li>
<li>Rollback strategy when model degrades</li>
</ul>

<h2 id="8-tong-ket"><strong>8. Summary</strong></h2>

<ul>
<li><p><strong>Feature store</strong> is the center to synchronize training and serving</p></li>
<li><p><strong>Training pipeline</strong> Need quality criteria before promoting the model</p></li>
<li><p><strong>A/B testing</strong> is a safe production decision-making mechanism</p></li>
<li><p><strong>Drift monitoring</strong> Helps detect model deterioration early</p></li>
<li><p><strong>MLOps governance</strong> ensure ML can operate sustainably</p></li>
</ul>
