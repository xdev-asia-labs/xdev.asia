...
title: >-
  Lesson 19: Data Architecture & Event Streaming — Event Sourcing, Kafka, Data
  Lake & Real-time Processing
slug: bai-19-data-architecture-event-streaming
description: >-
  Data platform architecture for POD, event sourcing, Apache Kafka event
  streaming, CDC (Debezium), data lake (S3 + Iceberg), real-time processing
  (Flink), data governance, schema registry, data lineage.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Architecture — Lesson 19</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: Data Architecture & Events</tspan>
      <tspan x="60" dy="42">Streaming — Event Sourcing, Kafka, Data</tspan>
      <tspan x="60" dy="42">Lake & Real-time Processing</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Data Platform & Analytics</text>
...
<h2 id="4-cdc-debezium"><strong>4. CDC (Change Data Capture) with Debezium</strong></h2>
...
<tbody>
<tr><td>Event Streaming</td><td>Apache Kafka (3-node)</td><td>Reliable event backbone for all services</td></tr>
