...
title: >-
  Lesson 14: Supplier Network & Routing Engine — Multi-supplier, Quality Control
  & Fallback
slug: bai-14-supplier-network-routing-engine
description: >-
  Supplier network architecture, routing engine (geo-based, cost-based,
  quality-based), multi-supplier orchestration, quality control & scoring,
  fallback strategy, supplier onboarding, SLA monitoring, capacity planning.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Architecture — Lesson 14</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 14: Supplier Network & Routing Engine</tspan>
...
<tr><td>Fallback</td><td>Auto-reroute to ranking alternatives</td><td>Reroute time, success rate</td></tr>
