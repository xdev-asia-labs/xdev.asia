...
title: >-
  Lesson 17: AI Quality Control — Design Validation, Print-readiness Check &
  Defect Detection
slug: bai-17-ai-quality-control
description: >-
  AI quality control pipeline, design validation (DPI, color, resolution),
  automated print-readiness check, AI defect detection (CNN-based), IP/copyright
  screening (CLIP similarity), NSFW content filtering, automated design scoring.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 17: AI Quality Control — Design</tspan>
      <tspan x="60" dy="42">Validation, Print-readiness Check & Defect</tspan>
