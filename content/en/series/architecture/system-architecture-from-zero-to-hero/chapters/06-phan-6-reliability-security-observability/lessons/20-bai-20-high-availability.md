...
description: >-
  ...
  Active-Passive. Failover strategies. Health checks & heartbeats. Chaos
  Engineering principles. Graceful degradation. Designing for failure mindset.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ Architecture — Lesson 20</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 20: High Availability & Fault</tspan>
...
"Everything fails, all the time." — Werner Vogels, Amazon CTO. High Availability (HA) is not about preventing failures — it is about the system **continuing to operate** when failures occur.
...
### 1.2 Availability of complex systems
...
| Graceful deterioration | Neutral | ⬇️ Partial service | Medium |
...
1. **Availability Calculation:** System includes: LB (99.99%) → 3 App Servers (99.9% each, active-active) → DB Primary (99.95%) + DB Replica (99.95%, hot standby). Calculate overall availability.

2. **Failover Design:** PostgreSQL cluster: 1 Primary + 2 Replicas. Primary crashes. Write detailed failover procedure: detection, promotion, reconnection, verification.

3. **Chaos Plan:** Design 5 chaos experiments for the e-commerce system (API, Database, Redis, S3, Payment Gateway). For each experiment: action, hypothesis, expected behavior, rollback plan.
