...
title: 'Lesson 28: Case Study - Design of Ride-Sharing Platform'
slug: bai-28-case-study-thiet-ke-ride-sharing-platform
description: >-
  Grab/Uber design. Location tracking & geospatial indexing. Real-time driver
  matching. Surge pricing. ETA calculation. Trip lifecycle management.
  Geospatial databases (PostGIS, H3, Geohash).
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ Architecture — Lesson 28</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 28: Case Study - Ride-Sharing Design</tspan>
...
The ride-sharing platform combines many challenges: real-time location tracking, geospatial queries, dynamic matching, pricing algorithms, and high availability requirements. This is the gold standard for system design interviews.
...
| Components | Technology | Choice Reason |
|-----------|-----------|--------------|
| Location store | Redis + Geospatial | Fast R/W, built-in geo |
| Trip data | PostgreSQL | ACID, relational |
| Matching | Custom algorithms | Low latency, domain-specific |
| Real-time | WebSockets | Driver/Rider tracking |
...
1. **Matching Optimization:** Peak hour: 50K ride requests, 10K available drivers. Process 50K matching requests in < 5 seconds. Design batch matching algorithm.

2. **Location Accuracy:** GPS accuracy ±10m. Driver at intersection, 2 one-way streets. How to determine which path the driver is on (map matching)?

3. **Scheduled Rides:** "Book a ride for 7:00 tomorrow morning". Pre-booking system design: when to match driver? Guarantees for riders?
