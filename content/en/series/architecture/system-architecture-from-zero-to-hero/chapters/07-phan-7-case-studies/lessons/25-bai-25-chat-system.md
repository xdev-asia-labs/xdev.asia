...
title: 'Lesson 25: Case Study - Chat System Design'
slug: bai-25-case-study-thiet-ke-chat-system
description: >-
  Design real-time chat system (WhatsApp/Messenger). WebSocket for real-time.
  Message delivery guarantees. Online presence. Group chat. Media sharing.
  Message storage & sync. Push notifications.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ Architecture — Lesson 25</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 25: Case Study - Chat System Design</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 7: System Design Case Studies</text>
...
Chat system is the most complex system design lesson, covering: real-time delivery, persistent connections, message ordering, offline support, group chat, and media handling.
...
| Components | Technology | Why |
|-----------|-----------|-----|
| Real-time | WebSockets | Bidirectional, persistent |
...
1. **Typing Indicator:** Design "User A is typing..." feature. Frequency sending events? When to stop? What about group chat with 100 members?

2. **Message Search:** Add feature search messages. Which database for full-text search? Index strategy? Is it possible to search in E2E encrypted messages?

3. **Multi-device Sync:** User has 3 devices (phone, tablet, laptop). Design sync strategy: messages, read receipts, contacts.
