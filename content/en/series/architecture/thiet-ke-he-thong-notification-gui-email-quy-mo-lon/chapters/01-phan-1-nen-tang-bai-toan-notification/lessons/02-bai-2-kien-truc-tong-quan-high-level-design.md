...
description: >-
  ...
  Notification Service, Message Queue, Worker Pool, Email Provider. Data flow
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Overview architecture — High-Level</tspan>
...
In the previous lesson, you understood the problem of sending millions of emails. Now, we will **design the overall architecture** — the blue print for the entire system. This is the most important step in system design.
...
- **Routing**: Route to the correct service
...
## 4. Data Flow: From Trigger to Inbox
...
## 5. Idempotency — Send exactly once

### Problem

Worker crashes after sending email but before commit offset → Kafka re-deliver → email sent twice.
...
You now have the complete blue print:
- **6 main components** and responsibility of each component
- **Database schema** for notification system
- **Data flow** end-to-end from trigger to inbox
- **Idempotency** ensures sending exactly once

**Next article:** Deep dive into important Design Patterns for large-scale email systems.
