...
description: >-
  Email template system: MJML, Handlebars, React Email. Template versioning, A/B
  testing, dynamic content personalization, content pipeline, pre-rendering,
  caching.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 9: Template Engine & Content Pipeline</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Email Infrastructure & Delivery Engine</text>
...
When sending 10 million emails, each email may need **different** content — name, suggested product, unique discount code. Template Engine is the component responsible for rendering millions of emails **fast** and **personalized**.
...
|-----------|--------|--------|-----------|---------------|
| MJML | XML-like | HTML emails | ✅ Built-in | Easy |
| Handlebars | `{{var}}` | HTML/Text | Manual | Easy |
| React Email | JSX | HTML emails | ✅ Components | Medium |
...
10 million emails × 50ms render = **139 hours** render time 😱
...
- **MJML** is the best choice for responsive email templates
- **Content pipeline**: Template → Render → CSS Inline → Track → Send
- **Pre-rendering** or **fragment caching** reduces render time by 10x
- **A/B testing** helps optimize open rate and click rate
- Always comply with **CAN-SPAM** with one-click unsubscribe

**Next article:** Rate Limiting & Throttling — control email sending speed.
