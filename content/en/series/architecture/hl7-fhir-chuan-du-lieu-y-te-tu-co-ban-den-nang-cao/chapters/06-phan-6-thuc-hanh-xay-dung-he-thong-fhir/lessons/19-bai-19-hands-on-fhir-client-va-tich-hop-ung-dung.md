...
description: >-
  HAPI FHIR Client (Java), fhir.js (JavaScript), Python fhirclient, Fluent
  Client API, Generic Client, build patient management application with React +
  FHIR, mobile app integration, error handling and retry patterns.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 19: Hands-on — FHIR Client and Integration</tspan>
      <tspan x="60" dy="42">Application</tspan>
  </text>
...
<p>FHIR Client is a library that helps applications communicate with FHIR Server via RESTful API. Each language has its own library.</p>

<table>
<thead>
<tr><th>Language</th><th>Library</th><th>Characteristics</th></tr>
</thead>
<tbody>
<tr><td>Java</td><td>HAPI FHIR Client</td><td>Most complete, Generic + Fluent API</td></tr>
...
<h2 id="5-react-fhir-app"><strong>5. Build a Patient Management application with React</strong></h2>
...
<h2 id="6-error-handling"><strong>6. Error Handling and Retry Patterns</strong></h2>
...
<ul>
<li><p><strong>HAPI FHIR Client (Java)</strong> — Generic Client for flexibility, Fluent Client for type-safety</p></li>
<li><p><strong>fhirclient.js</strong> — SMART on FHIR launch, browser + Node.js</p></li>
<li><p><strong>Python fhirclient</strong> — Pydantic models, easy to integrate data pipeline</p></li>
<li><p><strong>React + FHIR</strong> — Patient management SPA connects directly to FHIR Server</p></li>
<li><p><strong>Error handling</strong> — OperationOutcome parsing, retry with exponential backoff</p></li>
</ul>
