...
description: >-
  Search parameter types (string, token, reference, date, number, quantity,
  uri), modifiers (:exact, :contains, :missing, :not), chaining, reverse
  chaining (_has), _include, _revinclude, _summary, _elements, _count, paging,
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Search Parameters and advanced search</tspan>
      <tspan x="60" dy="42">high</tspan>
  </text>
...
<tbody>
<tr><td>string.string</td><td>Search for text</td><td>Patient?name=Nguyen</td></tr>
<tr><td>token</td><td>Code/identifier</td><td>Patient?gender=male</td></tr>
<tr><td>reference. reference</td><td>Reference to another resource</td><td>Observation?subject=Patient/123</td></tr>
<tr><td>date. date</td><td>Date</td><td>Patient?birthdate=1990-05-15</td></tr>
<tr><td>number. number</td><td>No</td><td>RiskAssessment?probability=gt0.8</td></tr>
<tr><td>quantity. quantity</td><td>Number + unit</td><td>Observation?value-quantity=gt5.4|http://unitsofmeasure.org|mg</td></tr>
<tr><td>uri</td><td>URI</td><td>ValueSet?url=http://hl7.org/fhir/ValueSet/example</td></tr>
<tr><td>composite</td><td>Combine multiple params</td><td>Observation?code-value-quantity=...</td></tr>
<tr><td>special</td><td>Especially</td><td>Location?near=42.2|-71.0|10|km</td></tr>
</tbody>
</table>
...
<h2 id="6-chaining"><strong>6. Chaining — Search through references</strong></h2>
...
<h2 id="8-include-revinclude"><strong>8. _include and _revinclude</strong></h2>
...
<p>Client follows link <code>next. next</code> to get the next page. <strong>Do not create your own URL</strong> — always use the link from the server response.</p>

<h2 id="11-custom-search-parameter"><strong>11. Custom SearchParameters</strong></h2>
...
<li><p><strong>Chaining</strong> — Search through chain references (subject:Patient.name)</p></li>
<li><p><strong>_has</strong> — Reverse chaining, finding resources referenced by other resources</p></li>
<li><p><strong>_include / _revinclude</strong> — Drag referenced resources into the results</p></li>
<li><p><strong>_summary, _elements, _sort, _count</strong> — Control response</p></li>
</ul>
