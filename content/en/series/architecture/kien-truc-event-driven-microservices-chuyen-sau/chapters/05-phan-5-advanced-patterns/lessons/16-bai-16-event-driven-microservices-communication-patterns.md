...
description: >-
  ...
  event-carried state transfer. Hybrid sync+async patterns. API composition.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Event-Driven Microservices</tspan>
      <tspan x="60" dy="42">Communication Patterns</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Advanced Patterns</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 16: Event-Driven Microservices Communication Patterns](/storage/uploads/2026/03/edm-bai-16-diagram.png)
...
## 1. Communication patterns: request-reply over events, event notification, event-carried state transfer

### 1.1 Basic concepts

Communication patterns: request-reply over events, event notification, event-carried state transfer is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Event-Driven Microservices Communication Patterns. Key takeaways:
