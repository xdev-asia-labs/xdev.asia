...
description: >-
  Domain Events in DDD. Event Storming workshop. Event Modeling technique.
  Identifying events, commands, aggregates. Event naming conventions.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1916" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1916)"/>

  <!-- Decorations -->
  <g>
    <circle cx="829" cy="177" r="12" fill="#818cf8" opacity="0.12000000000000001"/>
    <circle cx="1058" cy="226" r="29" fill="#818cf8" opacity="0.09"/>
    <circle cx="787" cy="275" r="16" fill="#818cf8" opacity="0.060000000000000005"/>
    <circle cx="1016" cy="64" r="33" fill="#818cf8" opacity="0.13"/>
    <circle cx="745" cy="113" r="20" fill="#818cf8" opacity="0.1"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 2: Domain Events & Event Modeling</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">In-depth Event-Driven Microservices architecture</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: Event-Driven Foundations</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 2: Domain Events & Event Modeling](/storage/uploads/2026/03/edm-bai-2-diagram.png)

## Introduction

Domain Events in DDD. Event Storming workshop. Event Modeling technique. Identifying events, commands, aggregates. Event naming conventions.
...
Domain Events in DDD is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 4. Identifying events, commands, aggregates
...
In this lesson, we learned about Domain Events & Event Modeling. Key takeaways:
