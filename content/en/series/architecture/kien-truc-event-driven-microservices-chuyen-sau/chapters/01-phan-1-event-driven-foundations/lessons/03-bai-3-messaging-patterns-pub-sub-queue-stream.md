...
description: >-
  Messaging patterns: point-to-point, pub/sub, event streaming. Message brokers
  vs event streaming platforms. At-most-once, at-least-once, exactly-once
  delivery.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4685" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4685)"/>

  <!-- Decorations -->
  <g>
    <circle cx="671" cy="263" r="24" fill="#34d399" opacity="0.08"/>
    <circle cx="742" cy="254" r="17" fill="#34d399" opacity="0.11"/>
    <circle cx="813" cy="245" r="10" fill="#34d399" opacity="0.14"/>
    <circle cx="884" cy="236" r="33" fill="#34d399" opacity="0.07"/>
    <circle cx="955" cy="227" r="26" fill="#34d399" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Messaging Patterns - Pub/Sub, Queue</tspan>
...
![Lesson 3: Messaging Patterns - Pub/Sub, Queue & Stream](/storage/uploads/2026/03/edm-bai-3-diagram.png)
...
## 1. Messaging patterns: point-to-point, pub/sub, event streaming

### 1.1 Basic concepts

Messaging patterns: point-to-point, pub/sub, event streaming is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Message brokers vs event streaming platforms
...
## 3. At-most-once, at-least-once, exactly-once delivery.
...
In this lesson, we learned about Messaging Patterns - Pub/Sub, Queue & Stream. Key takeaways:
