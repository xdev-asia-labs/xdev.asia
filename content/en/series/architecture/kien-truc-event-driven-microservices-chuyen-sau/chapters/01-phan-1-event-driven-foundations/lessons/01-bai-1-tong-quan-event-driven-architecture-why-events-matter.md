...
description: >-
  Event-Driven Architecture (EDA) fundamentals. Events vs Commands vs Queries.
  Temporal coupling vs event decoupling. EDA benefits and trade-offs.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 1
section_title: 'Part 1: Event-Driven Foundations'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1317" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1317)"/>

  <!-- Decorations -->
  <g>
    <circle cx="966" cy="168" r="14" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="832" cy="214" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="698" cy="260" r="20" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="1064" cy="46" r="8" fill="#2dd4bf" opacity="0.07"/>
    <circle cx="930" cy="92" r="26" fill="#2dd4bf" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🏗️ Architecture — Lesson 1</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 1: Overview of Event-Driven Architecture</tspan>
      <tspan x="60" dy="42">- Why Events Matter</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 1: Event-Driven Foundations</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 1: Overview of Event-Driven Architecture - Why Events Matter](/storage/uploads/2026/03/edm-bai-1-diagram.png)

## Introduction

Event-Driven Architecture (EDA) fundamentals. Events vs Commands vs Queries. Temporal coupling vs event decoupling. EDA benefits and trade-offs.
...
Event-Driven Architecture (EDA) fundamentals are one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 3. Temporal coupling vs event decoupling
...
In this lesson, we learned about Event-Driven Architecture Overview - Why Events Matter. Key takeaways:
