...
description: >-
  Kafka Streams: KStream, KTable, windowing, joins. State stores. Interactive
  queries. ksqlDB: SQL over streams. Materialized views. Stream processing
  topologies.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🏗️ Architecture — Lesson 6</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 6: Kafka Streams & ksqlDB</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 2: Apache Kafka Deep Dive</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 6: Kafka Streams & ksqlDB](/storage/uploads/2026/03/edm-bai-6-diagram.png)
...
## 1. Kafka Streams: KStream, KTable, windowing, joins

### 1.1 Basic concepts

Kafka Streams: KStream, KTable, windowing, joins is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Kafka Streams & ksqlDB. Key takeaways:
