...
video_url: null
sort_order: 25
section_title: 'Part 7: Case Studies'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1832" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1832)"/>

  <!-- Decorations -->
  <g>
    <circle cx="968" cy="94" r="36" fill="#fbbf24" opacity="0.09"/>
    <circle cx="836" cy="202" r="20" fill="#fbbf24" opacity="0.13"/>
    <circle cx="704" cy="50" r="34" fill="#fbbf24" opacity="0.07"/>
    <circle cx="1072" cy="158" r="18" fill="#fbbf24" opacity="0.11"/>
    <circle cx="940" cy="266" r="32" fill="#fbbf24" opacity="0.05"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 25: Case Studies - Uber, Wix,</tspan>
      <tspan x="60" dy="42">Booking.com & LinkedIn</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 7: Case Studies</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 25: Case Studies - Uber, Wix, Booking.com & LinkedIn](/storage/uploads/2026/03/edm-bai-25-diagram.png)

## Introduction

Actual event-driven analysis: Uber (event sourcing ride matching), Wix (event-driven platform), Booking.com (Kafka at scale), LinkedIn (Kafka origin). Lessons learned.

---

## 1. Actual event-driven analysis: Uber (event sourcing ride matching), Wix (event-driven platform), Booking.com (Kafka at scale), LinkedIn (Kafka origin)

### 1.1 Basic concepts

Actual event-driven analysis: Uber (event sourcing ride matching), Wix (event-driven platform), Booking.com (Kafka at scale), LinkedIn (Kafka origin) is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Case Studies - Uber, Wix, Booking.com & LinkedIn. Key takeaways:
