...
description: >-
  ...
  transactions. Saga execution coordinator. Error handling. Saga state machine.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 12
section_title: 'Part 4: Distributed Patterns'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6103" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6103)"/>

  <!-- Decorations -->
  <g>
    <circle cx="703" cy="119" r="16" fill="#c084fc" opacity="0.14"/>
    <circle cx="806" cy="62" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="909" cy="265" r="24" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="1012" cy="208" r="13" fill="#c084fc" opacity="0.11"/>
    <circle cx="615" cy="151" r="32" fill="#c084fc" opacity="0.1"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ Architecture — Lesson 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 12: Saga Pattern - Managing</tspan>
      <tspan x="60" dy="42">Distributed Transactions</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 4: Distributed Patterns</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 12: Saga Pattern - Managing Distributed Transactions](/storage/uploads/2026/03/edm-bai-12-diagram.png)
...
## 1. Saga pattern deep-dive: choreography vs orchestration

### 1.1 Basic concepts

The deep-dive pattern saga: choreography vs orchestration is one of the most important topics in the field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about the Saga Pattern - Managing Distributed Transactions. Key takeaways:
