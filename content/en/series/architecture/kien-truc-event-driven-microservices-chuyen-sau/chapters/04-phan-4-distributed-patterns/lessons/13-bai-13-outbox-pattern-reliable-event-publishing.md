...
description: >-
  Transactional outbox pattern. Polling publisher vs CDC-based. Debezium outbox
  connector. Guaranteed event delivery. Ordering guarantees.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1048" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1048)"/>

  <!-- Decorations -->
  <g>
    <circle cx="868" cy="274" r="16" fill="#fbbf24" opacity="0.09"/>
    <circle cx="636" cy="182" r="20" fill="#fbbf24" opacity="0.13"/>
    <circle cx="904" cy="90" r="24" fill="#fbbf24" opacity="0.07"/>
    <circle cx="672" cy="258" r="28" fill="#fbbf24" opacity="0.11"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 13: Outbox Pattern & Reliable Event</tspan>
      <tspan x="60" dy="42">Publishing</tspan>
  </text>
...
![Lesson 13: Outbox Pattern & Reliable Event Publishing](/storage/uploads/2026/03/edm-bai-13-diagram.png)
...
Transactional outbox pattern is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Polling publisher vs CDC-based
...
In this lesson, we learned about Outbox Pattern & Reliable Event Publishing. Key takeaways:
