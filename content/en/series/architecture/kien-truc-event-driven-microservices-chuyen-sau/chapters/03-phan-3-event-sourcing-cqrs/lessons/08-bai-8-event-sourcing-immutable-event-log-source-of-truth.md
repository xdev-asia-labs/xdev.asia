...
description: >-
  Event Sourcing fundamentals: event store, event replay, snapshots. Aggregate
  reconstruction. Temporal queries. Audit trail naturally. Event versioning.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 8
section_title: 'Part 3: Event Sourcing & CQRS'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-482" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-482)"/>

  <!-- Decorations -->
  <g>
    <circle cx="862" cy="276" r="30" fill="#f87171" opacity="0.11"/>
    <circle cx="624" cy="98" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="886" cy="180" r="22" fill="#f87171" opacity="0.13"/>
    <circle cx="648" cy="262" r="18" fill="#f87171" opacity="0.09"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ Architecture — Lesson 8</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Event Sourcing - Immutable Event</tspan>
      <tspan x="60" dy="42">Log as Source of Truth</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Event Sourcing & CQRS</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 8: Event Sourcing - Immutable Event Log as Source of Truth](/storage/uploads/2026/03/edm-bai-8-diagram.png)

## Introduction

Event Sourcing fundamentals: event store, event replay, snapshots. Aggregate reconstruction. Temporal queries. Audit trail naturally. Event versioning.

---

## 1. Event Sourcing fundamentals: event store, event replay, snapshots

### 1.1 Basic concepts

Event Sourcing fundamentals: event store, event replay, snapshots are one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Event Sourcing - Immutable Event Log as Source of Truth. Key takeaways:
