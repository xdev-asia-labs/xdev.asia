...
description: >-
  Building read models from events. Projection patterns: inline, catch-up, live.
  Multi-model projections. Rebuilding projections. Handling projection failures.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 11
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4163" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4163)"/>

  <!-- Decorations -->
  <g>
    <circle cx="923" cy="99" r="36" fill="#c084fc" opacity="0.14"/>
    <circle cx="746" cy="122" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="1069" cy="145" r="34" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="892" cy="168" r="33" fill="#c084fc" opacity="0.11"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ Architecture — Lesson 11</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 11: Projections & Reading Model Patterns</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Event Sourcing & CQRS</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 11: Projections & Reading Model Patterns](/storage/uploads/2026/03/edm-bai-11-diagram.png)
...
## 1. Building read models from events

### 1.1 Basic concepts

Building read models from events is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Projection patterns: inline, catch-up, live
...
In this lesson, we learned about Projections & Read Model Patterns. Key takeaways:
