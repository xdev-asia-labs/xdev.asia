...
title: 'Lesson 20: Payment & Subscription for EdTech'
slug: bai-20-payment-subscription-cho-edtech
description: >-
  EdTech billing: course purchase, subscription, team licenses. Coupon/discount
  engine. Refund policy. Tax handling. Revenue recognition.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 20
section_title: 'Part 6: Analytics & Business'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-1639" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-1639)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1061" cy="53" r="34" fill="#34d399" opacity="0.08"/>
    <circle cx="1022" cy="234" r="17" fill="#34d399" opacity="0.11"/>
    <circle cx="983" cy="155" r="30" fill="#34d399" opacity="0.14"/>
    <circle cx="944" cy="76" r="13" fill="#34d399" opacity="0.07"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ Architecture — Lesson 20</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 20: Payment & Subscription for EdTech</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 6: Analytics & Business</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 20: Payment & Subscription for EdTech](/storage/uploads/2026/03/edtech-bai-20-diagram.png)
...
## 1. EdTech billing: course purchase, subscription, team licenses

### 1.1 Basic concepts

EdTech billing: course purchase, subscription, team licenses is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Payment & Subscription for EdTech. Key takeaways:
