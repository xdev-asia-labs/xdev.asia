...
title: 'Lesson 10: Gamification Engine - Points, Badges & Leaderboards'
slug: bai-10-gamification-engine-points-badges-leaderboards
description: >-
  Gamification architecture: XP system, achievement badges, streaks. Leaderboard
  (global, friends, class). Progress tracking. Spaced repetition integration.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 10
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6608" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6608)"/>

  <!-- Decorations -->
  <g>
    <circle cx="723" cy="99" r="36" fill="#c084fc" opacity="0.14"/>
    <circle cx="846" cy="122" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="969" cy="145" r="34" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="1092" cy="168" r="33" fill="#c084fc" opacity="0.11"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ Architecture — Lesson 10</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 10: Gamification Engine - Points,</tspan>
      <tspan x="60" dy="42">Badges & Leaderboards</tspan>
  </text>
...
![Lesson 10: Gamification Engine - Points, Badges & Leaderboards](/storage/uploads/2026/03/edtech-bai-10-diagram.png)
...
## 1. Gamification architecture: XP system, achievement badges, streaks

### 1.1 Basic concepts

Gamification architecture: XP system, achievement badges, streaks is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Leaderboard (global, friends, class)
...
In this lesson, we learned about Gamification Engine - Points, Badges & Leaderboards. Key takeaways:
