...
title: 'Lesson 8: Assessment Engine - Question Bank & Quiz System'
slug: bai-8-assessment-engine-question-bank-quiz-system
description: >-
  Question types: MCQ, coding, essay, matching. Question banking management.
  Quiz generation algorithms. Anti-cheating: proctoring, randomization, time
  limits.
duration_minutes: 120
is_free: true
video_url: null
sort_order: 8
section_title: 'Part 3: Assessment & Gamification'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2196" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2196)"/>

  <!-- Decorations -->
  <g>
    <circle cx="1003" cy="39" r="26" fill="#c084fc" opacity="0.14"/>
    <circle cx="906" cy="42" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="809" cy="45" r="14" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="712" cy="48" r="23" fill="#c084fc" opacity="0.11"/>
    <circle cx="615" cy="51" r="32" fill="#c084fc" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 8: Assessment Engine - Question Bank &</tspan>
      <tspan x="60" dy="42">Quiz System</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 3: Assessment & Gamification</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 8: Assessment Engine - Question Bank & Quiz System](/storage/uploads/2026/03/edtech-bai-8-diagram.png)

## Introduction

Question types: MCQ, coding, essay, matching. Question banking management. Quiz generation algorithms. Anti-cheating: proctoring, randomization, time limits.

---

## 1. Question types: MCQ, coding, essay, matching

### 1.1 Basic concepts

Question types: MCQ, coding, essay, matching are one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 4. Anti-cheating: proctoring, randomization, time limits.
...
In this lesson, we learned about Assessment Engine - Question Bank & Quiz System. Key takeaways:
