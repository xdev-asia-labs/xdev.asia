...
title: 'Lesson 15: Real-time Collaboration - Shared Workspace'
slug: bai-15-real-time-collaboration-shared-workspace
description: >-
  Real-time collaborative editing (CRDT/OT). Shared code editors. Collaborative
  whiteboard. Group projects. Peer programming sessions.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-7611" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-7611)"/>

  <!-- Decorations -->
  <g>
    <circle cx="964" cy="222" r="32" fill="#f472b6" opacity="0.07"/>
    <circle cx="828" cy="286" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="692" cy="90" r="26" fill="#f472b6" opacity="0.11"/>
    <circle cx="1056" cy="154" r="8" fill="#f472b6" opacity="0.13"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 15: Real-time Collaboration - Shared</tspan>
      <tspan x="60" dy="42">Workspace</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">Part 5: Collaboration & Community</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![Lesson 15: Real-time Collaboration - Shared Workspace](/storage/uploads/2026/03/edtech-bai-15-diagram.png)
...
## 1. Real-time collaborative editing (CRDT/OT)

### 1.1 Basic concepts

Real-time collaborative editing (CRDT/OT) is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Real-time Collaboration - Shared Workspace. Key takeaways:
