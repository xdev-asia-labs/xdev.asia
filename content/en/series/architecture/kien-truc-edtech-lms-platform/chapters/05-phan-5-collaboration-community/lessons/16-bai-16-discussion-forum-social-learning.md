...
title: 'Lesson 16: Discussion Forum & Social Learning'
slug: bai-16-discussion-forum-social-learning
description: >-
  Forum architecture: threads, replies, voting. Q&A system (Stack
  Overflow-style). Course-scoped discussions. Moderation tools. Notification
  system.
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2878" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2878)"/>

  <!-- Decorations -->
  <g>
    <circle cx="886" cy="248" r="34" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="672" cy="234" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="958" cy="220" r="30" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="744" cy="206" r="28" fill="#2dd4bf" opacity="0.07"/>
    <circle cx="1030" cy="192" r="26" fill="#2dd4bf" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🏗️ Architecture — Lesson 16</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 16: Discussion Forum & Social Learning</tspan>
  </text>
...
![Lesson 16: Discussion Forum & Social Learning](/storage/uploads/2026/03/edtech-bai-16-diagram.png)
...
## 1. Forum architecture: threads, replies, voting

### 1.1 Basic concepts

Forum architecture: threads, replies, voting is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Q&A system (Stack Overflow-style)
...
In this lesson, we learned about Discussion Forum & Social Learning. Key takeaways:
