...
title: 'Lesson 5: Content Authoring & Rich Media'
slug: bai-5-content-authoring-rich-media
description: >-
  Content authoring tools: rich text editor, drag-and-drop builder. Interactive
  content: H5P, embedded simulations. Content versioning. Multi-format support.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 5
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-2615" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-2615)"/>

  <!-- Decorations -->
  <g>
    <circle cx="996" cy="278" r="24" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="892" cy="274" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="788" cy="270" r="10" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="684" cy="266" r="18" fill="#2dd4bf" opacity="0.07"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 5: Content Authoring & Rich Media</tspan>
  </text>
...
![Lesson 5: Content Authoring & Rich Media](/storage/uploads/2026/03/edtech-bai-5-diagram.png)
...
## 1. Content authoring tools: rich text editor, drag-and-drop builder

### 1.1 Basic concepts

Content authoring tools: rich text editor, drag-and-drop builder is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. Interactive content: H5P, embedded simulations
...
In this lesson, we learned about Content Authoring & Rich Media. Key takeaways:
