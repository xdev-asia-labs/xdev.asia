...
title: 'Lesson 3: Learning Standards - SCORM, xAPI & LTI'
slug: bai-3-learning-standards-scorm-xapi-lti
description: >-
  SCORM 1.2/2004: course packaging, runtime communication. xAPI (Experience
  API): learning statements, LRS. LTI (Learning Tools Interoperability).
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4717" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4717)"/>

  <!-- Decorations -->
  <g>
    <circle cx="746" cy="228" r="34" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="892" cy="34" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="1038" cy="100" r="30" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="684" cy="166" r="28" fill="#2dd4bf" opacity="0.07"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">🏗️ Architecture — Lesson 3</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 3: Learning Standards - SCORM, xAPI &</tspan>
      <tspan x="60" dy="42">LTI</tspan>
  </text>
...
![Lesson 3: Learning Standards - SCORM, xAPI & LTI](/storage/uploads/2026/03/edtech-bai-3-diagram.png)
...
## 1. SCORM 1.2/2004: course packaging, runtime communication

### 1.1 Basic concepts

SCORM 1.2/2004: course packaging, runtime communication is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
## 2. xAPI (Experience API): learning statements, LRS
...
In this lesson, we learned about Learning Standards - SCORM, xAPI & LTI. Key takeaways:
