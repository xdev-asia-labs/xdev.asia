...
title: 'Lesson 23: Security & Privacy for EdTech'
slug: bai-23-security-privacy-cho-edtech
description: >-
  EdTech security: COPPA compliance (children data), FERPA. Content DRM.
  Anti-piracy. Student data privacy. Proctoring ethics.
duration_minutes: 90
is_free: true
video_url: null
sort_order: 23
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-4877" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-4877)"/>

  <!-- Decorations -->
  <g>
    <circle cx="733" cy="69" r="36" fill="#c084fc" opacity="0.14"/>
    <circle cx="866" cy="82" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="999" cy="95" r="34" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="632" cy="108" r="33" fill="#c084fc" opacity="0.11"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Lesson 23: Security & Privacy for EdTech</tspan>
  </text>
...
![Lesson 23: Security & Privacy for EdTech](/storage/uploads/2026/03/edtech-bai-23-diagram.png)
...
EdTech security: COPPA compliance (children data), FERPA is one of the most important topics in this field. Understanding the core concepts will help you design the right system from the beginning.
...
In this lesson, we learned about Security & Privacy for EdTech. Key takeaways:
