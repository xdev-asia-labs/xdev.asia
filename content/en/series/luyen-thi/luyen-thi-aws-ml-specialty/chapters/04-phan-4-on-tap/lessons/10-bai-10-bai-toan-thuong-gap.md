...
title: 'Lesson 10: Common ML Problem Patterns'
slug: bai-10-bai-toan-thuong-gap
description: >-
  Fraud detection, recommendation systems, NLP pipeline, time series forecasting,
  computer vision — identify the problem and choose the right AWS service/algorithm.
duration_minutes: 55
is_free: true
video_url: null
sort_order: 10
...
<h2 id="pattern-matching"><strong>1. Quick Problem Recognition</strong></h2>

<p>Most MLS-C01 questions are <strong>scenario-based</strong>: read the business problem description, choose the most appropriate AWS service or algorithm. This lesson provides a framework for quick recognition.</p>
...
<p>Fraud detection is a classic exam problem. Key challenge: <strong>extreme class imbalance</strong> (99.9% of transactions are legitimate).</p>
...
<blockquote>
<p><strong>Exam tip:</strong> When the question says "no fraud labels" or "detect unusual behavior" → <strong>Random Cut Forest</strong>. When there's labeled historical fraud data → Classification (XGBoost).</p>
</blockquote>
...
<p>The exam often asks: <em>"Real-time personalized recommendations for e-commerce"</em> → the answer is almost always <strong>Amazon Personalize</strong> (managed service).</p>
