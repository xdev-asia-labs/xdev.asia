...
title: 'Lesson 8: Amazon Bedrock Deep Dive'
...
<p><strong>Amazon Bedrock</strong> is a fully managed service that provides access to <strong>FMs from multiple providers</strong> through a single API, along with tools to customize, deploy, and secure AI applications.</p>

<h3 id="bedrock-key-features"><strong>1.1. Key Value Propositions</strong></h3>

<ul>
<li><strong>Choice</strong>: Access FMs from Amazon, Anthropic, Meta, Mistral, Cohere, Stability AI, AI21 Labs</li>
...
<p>Agents allow FMs to <strong>perform multi-step tasks</strong> by automatically planning, executing actions, and using tools.</p>
...
<p><strong>PartyRock</strong> is a <strong>free, no-code playground</strong> for Bedrock — allowing anyone to create GenAI apps without needing an AWS account or coding skills.</p>
...
<p>AI coding assistant for developers:</p>
