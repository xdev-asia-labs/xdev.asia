...
title: 'Lesson 6: RAG, Vector Databases & Bedrock Knowledge Bases'
slug: bai-6-rag-vector-databases-knowledge-bases
description: >-
  Retrieval-Augmented Generation (RAG) architecture.
  Vector databases, embeddings, chunking strategies.
  Amazon Bedrock Knowledge Bases. RAG vs Fine-tuning comparison.
duration_minutes: 60
is_free: true
video_url: null
sort_order: 2
...
<p><em>RAG Architecture — Indexing Phase and Query Phase with Amazon Bedrock Knowledge Bases</em></p>
</div>

<h2 id="rag-overview"><strong>1. What is RAG?</strong></h2>

<p><strong>Retrieval-Augmented Generation (RAG)</strong> is a technique that combines FMs with <strong>external knowledge sources</strong> to provide more accurate answers, reduce hallucination, and incorporate information the model doesn't know.</p>
...
<p>Before creating embeddings, documents must be <strong>split into smaller pieces (chunked)</strong> into appropriately sized segments.</p>
...
<p><strong>Bedrock Knowledge Bases</strong> is a <strong>fully managed RAG solution</strong>. AWS handles chunking, embedding, indexing, and retrieval — you only need to point to your data sources.</p>
...
<p><em>Explanation: Faithfulness measures whether the generated answer is grounded in the retrieved documents. Low faithfulness means the model is generating information beyond what the retrieved context supports (hallucination in the RAG context).</em></p>
