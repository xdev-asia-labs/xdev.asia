...
slug: luyen-thi-cka
description: >-
  A comprehensive study guide for the CKA (Certified Kubernetes Administrator) exam.
  Covers all 5 hands-on domains: Troubleshooting (30%), Cluster Architecture (25%),
...
- id: cka-section-01
  ...
  lessons:
  - id: cka-d1-l01
    title: "Lesson 1: Kubernetes Architecture & kubeadm Cluster Setup"
    slug: 01-kien-truc-cka-kubeadm
    description: >-
      Deep dive into control plane components. kubeadm init, join, config.
  ...
  - id: cka-d1-l02
    ...
    video_url: null
  - id: cka-d1-l03
    title: "Lesson 3: RBAC — Role-Based Access Control"
    slug: 03-rbac-cka
    description: >-
      Role vs ClusterRole. RoleBinding vs ClusterRoleBinding.
      ServiceAccounts and tokens. kubectl auth can-i.
...
- id: cka-section-05
  ...
  - id: cka-d5-l01
    ...
    description: >-
      ...
      Static pod manifest for etcd. Recovery procedures.
    ...
    video_url: null
  - id: cka-d5-l02
    title: "Lesson 10: Troubleshooting Nodes & Cluster"
