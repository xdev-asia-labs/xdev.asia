---
id: cka-d5-l11
title: 'Lesson 11: Troubleshooting Workloads'
slug: 11-troubleshooting-workloads
description: >-
  Debug Pods: CrashLoopBackOff, ImagePullBackOff, Pending. Troubleshoot
  Deployments and Services. Systematic kubectl debugging workflow.
duration_minutes: 55
is_free: true
video_url: null
sort_order: 11
...
<table>
<thead><tr><th>State</th><th>Cause</th><th>Debug</th></tr></thead>
<tbody>
<tr><td><strong>Pending</strong></td><td>Cannot be scheduled</td><td>describe pod → Events: Insufficient CPU/memory or No nodes match affinity</td></tr>
<tr><td><strong>ImagePullBackOff</strong></td><td>Image doesn't exist / registry auth</td><td>Check image name typo, imagePullSecrets</td></tr>
<tr><td><strong>CrashLoopBackOff</strong></td><td>App crashing repeatedly</td><td>kubectl logs --previous, check app exit code</td></tr>
<tr><td><strong>OOMKilled</strong></td><td>Exceeded memory limit</td><td>kubectl describe pod → Container Reason: OOMKilled</td></tr>
<tr><td><strong>CreateContainerError</strong></td><td>Volume mount, ConfigMap, Secret doesn't exist</td><td>describe pod Events</td></tr>
</tbody>
</table>

<blockquote><p><strong>Exam tip:</strong> The <code>kubectl describe pod</code> Events section is the most important place for debugging. CKA tasks often require you to fix a broken pod — usually a typo in the image name, wrong ConfigMap name, or port conflict.</p></blockquote>
...
<ul>
<li>A) The image exists on Docker Hub with the exact tag</li>
