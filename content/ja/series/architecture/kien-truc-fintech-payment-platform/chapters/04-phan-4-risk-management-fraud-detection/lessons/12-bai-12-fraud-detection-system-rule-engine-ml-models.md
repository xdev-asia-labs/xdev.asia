...
description: 不正検出システムのアーキテクチャ。動的ルールを備えたルールベースのエンジン。不正行為検出のための機械学習モデル。リアルタイムのスコアリング パイプライン。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: 不正検出システム - ルール</tspan>
      <tspan x="60" dy="42">エンジンおよびMLモデル</tspan>
  </text>
...
![レッスン 12: 不正検出システム - ルール エンジンと ML モデル](/storage/uploads/2026/03/fintech-bai-12-diagram.png)

## はじめに

不正検出システムのアーキテクチャ。動的ルールを備えたルールベースのエンジン。不正行為検出のための機械学習モデル。リアルタイムのスコアリング パイプライン。
...
不正検出システムのアーキテクチャは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、不正検出システム - ルール エンジンと ML モデルについて学びました。重要なポイント:
