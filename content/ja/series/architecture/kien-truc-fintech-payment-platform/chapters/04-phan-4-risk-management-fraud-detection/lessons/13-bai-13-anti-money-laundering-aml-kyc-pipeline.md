...
description: 'KYC パイプラインの設計: 本人確認、文書検証。 AML スクリーニング: 制裁リスト、PEP スクリーニング。不審行為の報告。'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: マネーロンダリング対策 (AML) と KYC</tspan>
...
![レッスン 13: マネーロンダリング対策 (AML) と KYC パイプライン](/storage/uploads/2026/03/fintech-bai-13-diagram.png)

## はじめに

KYC パイプラインの設計: 本人確認、文書検証。 AML スクリーニング: 制裁リスト、PEP スクリーニング。不審行為の報告。

---

## 1. KYC パイプラインの設計: 本人確認、文書検証

### 1.1 基本概念

KYC パイプラインの設計: 本人確認、文書検証は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 2. AML スクリーニング: 制裁リスト、PEP スクリーニング
...
このレッスンでは、マネーロンダリング対策 (AML) と KYC パイプラインについて学びました。重要なポイント:
