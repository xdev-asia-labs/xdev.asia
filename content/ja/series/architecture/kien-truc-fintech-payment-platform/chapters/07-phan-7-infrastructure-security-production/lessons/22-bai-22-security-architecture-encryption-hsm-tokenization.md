...
description: >-
  FinTech 向けのセキュリティ アーキテクチャ。エンドツーエンドの暗号化。ハードウェア セキュリティ モジュール (HSM)。 PAN
  データのトークン化。 PCI-DSS ネットワークセグメンテーション。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 22: セキュリティ アーキテクチャ -</tspan>
      <tspan x="60" dy="42">暗号化、HSM、トークン化</tspan>
  </text>
...
![レッスン 22: セキュリティ アーキテクチャ - 暗号化、HSM、トークン化](/storage/uploads/2026/03/fintech-bai-22-diagram.png)

## はじめに

FinTech 向けのセキュリティ アーキテクチャ。エンドツーエンドの暗号化。ハードウェア セキュリティ モジュール (HSM)。 PAN データのトークン化。 PCI-DSS ネットワークセグメンテーション。

---

## 1. FinTech のセキュリティ アーキテクチャ

### 1.1 基本概念

FinTech のセキュリティ アーキテクチャは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、セキュリティ アーキテクチャ - 暗号化、HSM、トークン化について学びました。重要なポイント:
