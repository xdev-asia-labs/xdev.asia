...
description: >-
  FinTech 向けのデータ パイプラインを設計します。 Kafka によるイベント ストリーミング。台帳レプリケーションのための変更データ
  キャプチャ。財務データのデータ レイク アーキテクチャ。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 19
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: 財務データ パイプライン - イベント</tspan>
      <tspan x="60" dy="42">ストリーミングとCDC</tspan>
  </text>
...
![レッスン 19: 財務データ パイプライン - イベント ストリーミングと CDC](/storage/uploads/2026/03/fintech-bai-19-diagram.png)

## はじめに

FinTech 向けのデータ パイプラインを設計します。 Kafka によるイベント ストリーミング。台帳レプリケーションのための変更データ キャプチャ。財務データのデータ レイク アーキテクチャ。

---

## 1. FinTech 向けのデータ パイプラインを設計する

### 1.1 基本概念

FinTech 向けのデータ パイプライン設計は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、財務データ パイプライン - イベント ストリーミングと CDC について学びました。重要なポイント:
