...
description: 'FinTechにおける二重会計の原則。台帳スキーマの設計: 勘定科目、仕訳入力、転記。不変の追加専用台帳。決済プラットフォーム用の勘定科目表の設計。'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 9: 複式簿記システム -</tspan>
      <tspan x="60" dy="42">会計エンジン</tspan>
  </text>
...
![レッスン 9: 複式簿記システム - 会計エンジン](/storage/uploads/2026/03/fintech-bai-9-diagram.png)

## はじめに

FinTechにおける二重会計の原則。台帳スキーマの設計: 勘定科目、仕訳入力、転記。不変の追加専用台帳。決済プラットフォーム用の勘定科目表の設計。

---

## 1. FinTechにおける二重会計の原則

### 1.1 基本概念

FinTech における二重会計の原則は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、複式簿記システム - 会計エンジンについて学びました。重要なポイント:
