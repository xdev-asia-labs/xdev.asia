...
description: 信用スコアリング エンジンを構築します。代替データソース。特徴エンジニアリング パイプライン。信用リスク評価のための ML モデル。 CICベトナムと統合。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 17
section_title: 'パート 5: 銀行および融資プラットフォーム'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ アーキテクチャ — レッスン 17</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 17: 信用スコアリング エンジン - データ</tspan>
      <tspan x="60" dy="42">パイプラインと機械学習</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 5: 銀行および融資プラットフォーム</text>
...
信用スコアリング エンジンを構築します。代替データソース。特徴エンジニアリング パイプライン。信用リスク評価のための ML モデル。 CICベトナムと統合。

---

## 1. 信用スコアリング エンジンを構築する

### 1.1 基本概念

信用スコアリング エンジンの構築は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、信用スコアリング エンジン - データ パイプラインと ML について学びました。重要なポイント:
