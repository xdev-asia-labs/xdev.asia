...
description: '利息計算エンジンの設計: 単利/複利、日数計算規則。償却スケジュール。前払い、違約金、猶予期間。'
duration_minutes: 90
is_free: true
video_url: null
sort_order: 18
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 18: 利息の計算と</tspan>
      <tspan x="60" dy="42">償却エンジン</tspan>
  </text>
...
![レッスン 18: 利息計算および償却エンジン](/storage/uploads/2026/03/fintech-bai-18-diagram.png)

## はじめに

利息計算エンジンの設計: 単利/複利、日数計算規則。償却スケジュール。前払い、違約金、猶予期間。

---

## 1. 利息計算エンジンの設計: 単利/複利、日数計算規則

### 1.1 基本概念

利息計算エンジンの設計: 単利/複利、日数計算規則は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、利息計算および償却エンジンについて学びました。重要なポイント:
