...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ アーキテクチャ — レッスン 24</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 24: 認証と認可 —</tspan>
...
![レッスン 24: 認証と認可 — OAuth2、JWT、OIDC](/storage/uploads/2026/03/cn-bai-24-diagram.png)
...
利点: ダウンストリーム サービスには JWT ライブラリが必要ありません
欠点: これらのヘッダーは、誰かが API ゲートウェイをバイパスすると簡単に偽造されてしまいます。
