...
title: 'レッスン 12: 注文管理システム — ステート マシン、Saga パターン、注文オーケストレーション'
slug: bai-12-order-management-system
description: >-
  POD 用の OMS アーキテクチャ、注文ステート マシン、分散トランザクション用の Saga パターン、分割注文
  (複数サプライヤー)、注文オーケストレーション、補償ロジック、注文イベント ソーシング、冪等性。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 12
section_title: 'パート 4: 注文の処理と履行'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ アーキテクチャ — レッスン 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: 注文管理システム — 状態</tspan>
      <tspan x="60" dy="42">マシン、サーガ パターンとオーダー</tspan>
  ...
  <!-- Section -->
  <text x="60" y="310" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: 注文の処理と履行</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-order-lifecycle"><strong>1. POD注文のライフサイクル</strong></h2>
...
<h2 id="2-state-machine"><strong>2. オーダーステートマシン</strong></h2>
...
<h2 id="3-saga-pattern"><strong>3. Saga パターン — オーダー オーケストレーション</strong></h2>
...
<h2 id="4-split-orders"><strong>4. 分割注文 (複数のサプライヤー)</strong></h2>
...
<h2 id="5-event-sourcing"><strong>5. 注文イベントのソーシング</strong></h2>
...
<table>
<thead>
<tr><th>パターン</th><th>目的</th><th>POD コンテキスト</th></tr>
</thead>
<tbody>
<tr><td>ステートマシン</td><td>有効な注文遷移を強制する</td><td>POD 生産フローに特有の 15 以上の状態</td></tr>
<tr><td>サーガパターン</td><td>分散トランザクション調整</td><td>支払い → ファイルの印刷 → サプライヤー → ロールバックで通知</td></tr>
<tr><td>分割注文</td><td>複数のサプライヤーのフルフィルメント</td><td>1 つの顧客注文 → N 個のサプライヤーのサブ注文</td></tr>
<tr><td>イベントソーシング</td><td>完全な監査証跡</td><td>イベント履歴から注文状態を再構築する</td></tr>
<tr><td>べき等性</td><td>重複した Webhook/再試行を処理する</td><td>操作ごとの冪等キー</td></tr>
</tbody>
</table>
