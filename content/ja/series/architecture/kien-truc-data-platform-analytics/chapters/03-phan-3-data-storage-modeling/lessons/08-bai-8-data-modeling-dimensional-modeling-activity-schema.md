...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ アーキテクチャ — レッスン 8</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: データ モデリング - 次元</tspan>
      <tspan x="60" dy="42">モデリングとアクティビティのスキーマ</tspan>
  </text>
...
![レッスン 8: データ モデリング - 次元モデリングとアクティビティ スキーマ](/storage/uploads/2026/03/dp-bai-8-diagram.png)

## はじめに

スター スキーマ、スノーフレーク スキーマ。キンボール対インモン。アクティビティスキーマ。ゆっくりと変化する寸法 (SCD)。ワイドテーブルと正規化。分析のためのモデリング。

---

## 1. スター スキーマ、スノーフレーク スキーマ

### 1.1 基本概念

スター スキーマ、スノーフレーク スキーマは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、データ モデリング - 次元モデリングとアクティビティ スキーマについて学びました。重要なポイント:
