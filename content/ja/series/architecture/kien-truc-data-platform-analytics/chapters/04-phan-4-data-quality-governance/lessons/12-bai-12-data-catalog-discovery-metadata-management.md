...
description: 'データ カタログ: DataHub、OpenMetadata、Amunsen。メタデータ管理。データリネージの追跡。データの発見と検索。ビジネス用語集。'
duration_minutes: 90
is_free: true
video_url: null
sort_order: 12
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: データカタログと検出 -</tspan>
      <tspan x="60" dy="42">メタデータ管理</tspan>
  </text>
...
![レッスン 12: データ カタログと検出 - メタデータ管理](/storage/uploads/2026/03/dp-bai-12-diagram.png)

## はじめに

データ カタログ: DataHub、OpenMetadata、Amunsen。メタデータ管理。データリネージの追跡。データの発見と検索。ビジネス用語集。

---

## 1. データカタログ: DataHub、OpenMetadata、Amunsen

### 1.1 基本概念

データ カタログ: DataHub、OpenMetadata、Amunsen は、この分野の最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、データ カタログと検出 - メタデータ管理について学びました。重要なポイント:
