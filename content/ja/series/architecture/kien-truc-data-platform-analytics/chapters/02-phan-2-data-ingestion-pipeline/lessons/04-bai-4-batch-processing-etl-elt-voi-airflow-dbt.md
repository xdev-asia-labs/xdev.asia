...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: バッチ処理 - ETL/ELT を使用する</tspan>
      <tspan x="60" dy="42">エアフローとdbt</tspan>
  </text>
...
ETL と ELT のパターン。 Apache Airflow: DAG、オペレーター、スケジューリング。 dbt (データ構築ツール): モデル、テスト、ドキュメント。データ変換のベスト プラクティス。
...
ETL と ELT のパターンは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 2. Apache Airflow: DAG、オペレーター、スケジューリング
...
このレッスンでは、バッチ処理 - Airflow と dbt を使用した ETL/ELT について学びました。重要なポイント:
