...
video_url: null
sort_order: 6
section_title: 'パート 2: データの取り込みとパイプライン'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 6: 変更データ キャプチャ (CDC) -</tspan>
      <tspan x="60" dy="42">Debezium とイベント ソーシング</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 2: データの取り込みとパイプライン</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 6: 変更データ キャプチャ (CDC) - Debezium とイベント ソーシング](/storage/uploads/2026/03/dp-bai-6-diagram.png)

## はじめに

CDC の概念と使用例。 Debezium: PostgreSQL、MySQL からの変更をキャプチャします。 CDC → Kafka → Lakehouse パイプライン。イベントソーシングパターン。送信ボックスのパターン。
...
CDC の概念と使用例は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 2. Debezium: PostgreSQL、MySQL からの変更のキャプチャ
...
このレッスンでは、Change Data Capture (CDC) - Debezium と Event Sourcing について学びました。重要なポイント:
