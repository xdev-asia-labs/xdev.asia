...
description: >-
  Spotify バックステージ: アーキテクチャ、プラグイン、カタログ。ソフトウェア カタログ: コンポーネント、API、リソース。 TechDocs
  の統合。カスタマイズとプラグインの開発。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: バックステージ - 内部開発者</tspan>
      <tspan x="60" dy="42">ポータル</tspan>
  </text>
...
![レッスン 4: バックステージ - 内部開発者ポータル](/storage/uploads/2026/03/pe-bai-4-diagram.png)

## はじめに

Spotify バックステージ: アーキテクチャ、プラグイン、カタログ。ソフトウェア カタログ: コンポーネント、API、リソース。 TechDocs の統合。カスタマイズとプラグインの開発。

---

## 1. Spotify バックステージ: アーキテクチャ、プラグイン、カタログ

### 1.1 基本概念

Spotify Backstage: アーキテクチャ、プラグイン、カタログは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 2. ソフトウェア カタログ: コンポーネント、API、リソース
...
このレッスンでは、Backstage - 内部開発者ポータルについて学習しました。重要なポイント:
