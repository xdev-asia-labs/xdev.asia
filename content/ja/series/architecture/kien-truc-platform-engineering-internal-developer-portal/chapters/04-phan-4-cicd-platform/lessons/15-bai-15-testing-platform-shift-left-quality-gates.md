...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 15: テスト プラットフォーム - シフト左と</tspan>
      <tspan x="60" dy="42">品質のゲート</tspan>
  </text>
...
![レッスン 15: テスト プラットフォーム - シフトレフトと品質ゲート](/storage/uploads/2026/03/pe-bai-15-diagram.png)

## はじめに

テスト インフラストラクチャ: テスト環境、テスト データ管理。品質ゲート: コード カバレッジ、セキュリティ スキャン、パフォーマンス テスト。不安定なテストの検出。

---

## 1. テストインフラストラクチャ: テスト環境、テストデータ管理

### 1.1 基本概念

テスト インフラストラクチャ: テスト環境、テスト データ管理は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 2. 品質ゲート: コード カバレッジ、セキュリティ スキャン、パフォーマンス テスト
...
このレッスンでは、テスト プラットフォーム - シフトレフトと品質ゲートについて学びました。重要なポイント:
