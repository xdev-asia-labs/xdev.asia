...
description: >-
  コンテナレジストリ（ハーバー）。画像のスキャンと署名 (Cosign)。基本イメージの管理。マルチアーチビルド。イメージプロモーションパイプライン。
  SBOM世代。
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 14: コンテナーとイメージ管理</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: CI/CD プラットフォーム</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 14: コンテナーとイメージ管理](/storage/uploads/2026/03/pe-bai-14-diagram.png)

## はじめに

コンテナレジストリ（ハーバー）。画像のスキャンと署名 (Cosign)。基本イメージの管理。マルチアーチビルド。イメージプロモーションパイプライン。 SBOM世代。
...
コンテナ レジストリ (ハーバー) は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、コンテナーとイメージの管理について学びました。重要なポイント:
