...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: GitOps とデプロイメントの自動化</tspan>
  </text>
...
![レッスン 13: GitOps とデプロイメントの自動化](/storage/uploads/2026/03/pe-bai-13-diagram.png)

## はじめに

GitOps: ArgoCD、Flux。導入戦略: ブルーグリーン、カナリア、プログレッシブ。ロールバックの自動化。環境推進。ドリフト検出。
...
GitOps: ArgoCD、Flux は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、GitOps とデプロイメントの自動化について学びました。重要なポイント:
