...
description: >-
  CI/CD プラットフォーム: 共有パイプライン、再利用可能なワークフロー。 GitHub アクション、GitLab CI、Tekton。パイプライン
  テンプレート。キャッシュを構築します。アーティファクト管理。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 12
section_title: 'パート 4: CI/CD プラットフォーム'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-5858" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-5858)"/>

  <!-- Decorations -->
  <g>
    <circle cx="702" cy="216" r="30" fill="#f87171" opacity="0.11"/>
    <circle cx="804" cy="278" r="26" fill="#f87171" opacity="0.07"/>
    <circle cx="906" cy="80" r="22" fill="#f87171" opacity="0.13"/>
    <circle cx="1008" cy="142" r="18" fill="#f87171" opacity="0.09"/>
    <circle cx="610" cy="204" r="14" fill="#f87171" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🏗️ アーキテクチャ — レッスン 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: CI/CD プラットフォームのアーキテクチャ -</tspan>
      <tspan x="60" dy="42">コードとしてのパイプライン</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="244" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">アーキテクチャ プラットフォーム エンジニアリングと社内開発者ポータル</text>

  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: CI/CD プラットフォーム</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 12: CI/CD プラットフォーム アーキテクチャ - コードとしてのパイプライン](/storage/uploads/2026/03/pe-bai-12-diagram.png)

## はじめに

CI/CD プラットフォーム: 共有パイプライン、再利用可能なワークフロー。 GitHub アクション、GitLab CI、Tekton。パイプライン テンプレート。キャッシュを構築します。アーティファクト管理。

---

## 1. CI/CD プラットフォーム: 共有パイプライン、再利用可能なワークフロー

### 1.1 基本概念

CI/CD プラットフォーム: 共有パイプライン、再利用可能なワークフローは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 2. GitHub アクション、GitLab CI、Tekton
...
このレッスンでは、CI/CD プラットフォーム アーキテクチャ - コードとしてのパイプラインについて学習しました。重要なポイント:
