...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      ...
      <tspan x="60" dy="42">レイヤーとコンポーネント</tspan>
  </text>
...
![レッスン 3: プラットフォーム アーキテクチャの概要 - レイヤーとコンポーネント](/storage/uploads/2026/03/pe-bai-3-diagram.png)

## はじめに

IDP アーキテクチャ レイヤー: UI ポータル、API、オーケストレーション、統合。プラットフォーム機能マップ。構築か購入かの決定。プラットフォーム成熟度モデル。

---

## 1. IDP アーキテクチャ層: UI ポータル、API、オーケストレーション、統合

### 1.1 基本概念

IDP アーキテクチャ レイヤー: UI ポータル、API、オーケストレーション、統合は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、プラットフォーム アーキテクチャの概要 - レイヤーとコンポーネントについて学習しました。重要なポイント:
