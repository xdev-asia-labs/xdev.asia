...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 2: 開発者エクスペリエンス (DX) -</tspan>
      <tspan x="60" dy="42">測定と改善</tspan>
  </text>
...
![レッスン 2: 開発者エクスペリエンス (DX) - 測定と改善](/storage/uploads/2026/03/pe-bai-2-diagram.png)

## はじめに

開発者エクスペリエンス: 認知負荷、フロー状態、フィードバック ループ。 DORA メトリクス、SPACE フレームワーク。開発者アンケート。オンボーディング時間。最初の展開までの時間。

---

## 1. 開発者のエクスペリエンス: 認知負荷、フロー状態、フィードバック ループ

### 1.1 基本概念

開発者エクスペリエンス: 認知負荷、フロー状態、フィードバック ループは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、開発者エクスペリエンス (DX) - 測定と改善について学びました。重要なポイント:
