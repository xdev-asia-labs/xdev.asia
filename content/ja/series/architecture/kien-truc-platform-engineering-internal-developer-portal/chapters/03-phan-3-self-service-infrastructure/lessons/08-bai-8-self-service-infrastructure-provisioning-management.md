...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: セルフサービス インフラストラクチャ -</tspan>
      <tspan x="60" dy="42">プロビジョニングと管理</tspan>
  </text>
...
![レッスン 8: セルフサービス インフラストラクチャ - プロビジョニングと管理](/storage/uploads/2026/03/pe-bai-8-diagram.png)

## はじめに

セルフサービス インフラストラクチャ: 要求 → 承認 → プロビジョニング → 管理。インフラストラクチャ抽象化レイヤー。リソースカタログ。リクエストごとのコストの可視化。

---

## 1. セルフサービスインフラストラクチャ: リクエスト→承認→プロビジョニング→管理

### 1.1 基本概念

セルフサービス インフラストラクチャ: 要求 → 承認 → プロビジョニング → 管理は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、セルフサービス インフラストラクチャ - プロビジョニングと管理について学びました。重要なポイント:
