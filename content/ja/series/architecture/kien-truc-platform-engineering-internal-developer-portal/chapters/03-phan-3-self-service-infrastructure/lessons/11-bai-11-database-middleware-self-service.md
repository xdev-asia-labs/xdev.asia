...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 11: データベースとミドルウェアのセルフサービス</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: セルフサービス インフラストラクチャ</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 11: データベースとミドルウェアのセルフサービス](/storage/uploads/2026/03/pe-bai-11-diagram.png)

## はじめに

データベース プロビジョニング: セルフサービスとしての PostgreSQL、Redis、Kafka。演算子のパターン。バックアップの自動化。スキーマの移行。接続管理。

---

## 1. データベース プロビジョニング: セルフサービスとしての PostgreSQL、Redis、Kafka

### 1.1 基本概念

データベース プロビジョニング: セルフサービスとしての PostgreSQL、Redis、Kafka は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、データベースとミドルウェアのセルフサービスについて学びました。重要なポイント:
