...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 9: コードとしてのインフラストラクチャ - Terraform、</tspan>
      <tspan x="60" dy="42">クロスプレーン＆プルミ</tspan>
  </text>
...
![レッスン 9: コードとしてのインフラストラクチャ - Terraform、Crossplane、Pulumi](/storage/uploads/2026/03/pe-bai-9-diagram.png)

## はじめに

IaC プラットフォーム: Terraform モジュール、Crossplane コンポジション、Pulumi プログラム。生の IaC に対するプラットフォームの抽象化。ガードレール付きのセルフサービス。状態管理。

---

## 1. IaC プラットフォーム: Terraform モジュール、Crossplane コンポジション、Pulumi プログラム

### 1.1 基本概念

IaC プラットフォーム: Terraform モジュール、Crossplane コンポジション、Pulumi プログラムは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、コードとしてのインフラストラクチャ - Terraform、Crossplane、Pulumi について学びました。重要なポイント:
