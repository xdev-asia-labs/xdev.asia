...
video_url: null
sort_order: 10
section_title: 'パート 3: セルフサービス インフラストラクチャ'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🏗️ アーキテクチャ — レッスン 10</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: 環境管理 - 開発、</tspan>
      <tspan x="60" dy="42">ステージング、プロダクション</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: セルフサービス インフラストラクチャ</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 10: 環境管理 - 開発、ステージング、実稼働](/storage/uploads/2026/03/pe-bai-10-diagram.png)

## はじめに

環境管理: 一時的な環境、プレビュー環境。環境の同等性。名前空間ベースの分離。開発/ステージングのコストの最適化。

---

## 1. 環境管理: 一時的な環境、プレビュー環境

### 1.1 基本概念

環境管理: 一時的な環境、プレビュー環境は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、環境管理 - 開発、ステージング、実稼働について学びました。重要なポイント:
