...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ アーキテクチャ — レッスン 13</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: ホワイトラベルとカスタムブランディング</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: コア プラットフォームの機能</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 13: ホワイトラベルとカスタムブランディング](/storage/uploads/2026/03/saas-bai-13-diagram.png)

## はじめに

ホワイトラベル アーキテクチャ: カスタム ドメイン、ロゴ、色、電子メール テンプレート。 CSSテーマエンジン。再販業者/パートナー プログラムのサポート。カスタムログインページ。

---

## 1. ホワイトラベル アーキテクチャ: カスタム ドメイン、ロゴ、色、電子メール テンプレート

### 1.1 基本概念

ホワイトラベル アーキテクチャ: カスタム ドメイン、ロゴ、色、電子メール テンプレートは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、ホワイトラベルとカスタムブランディングについて学びました。重要なポイント:
