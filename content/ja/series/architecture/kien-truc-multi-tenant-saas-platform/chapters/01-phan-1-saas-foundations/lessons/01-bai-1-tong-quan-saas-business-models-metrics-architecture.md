...
description: >-
  SaaS ビジネス モデル (B2B、B2C、PLG、販売主導)。主要な指標: MRR、ARR、チャーン、LTV、CAC。 SaaS アーキテクチャ
  パターンとオンプレミスからクラウドネイティブへの進化。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 1
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ アーキテクチャ — レッスン 1</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 1: SaaS の概要 - ビジネス モデル、</tspan>
      <tspan x="60" dy="42">メトリクスとアーキテクチャ パターン</tspan>
  </text>
...
![レッスン 1: SaaS の概要 - ビジネス モデル、メトリクス、アーキテクチャ パターン](/storage/uploads/2026/03/saas-bai-1-diagram.png)

## はじめに

SaaS ビジネス モデル (B2B、B2C、PLG、販売主導)。主要な指標: MRR、ARR、チャーン、LTV、CAC。 SaaS アーキテクチャ パターンとオンプレミスからクラウドネイティブへの進化。

---

## 1. SaaS ビジネスモデル (B2B、B2C、PLG、販売主導)

### 1.1 基本概念

SaaS ビジネス モデル (B2B、B2C、PLG、販売主導) は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 3. SaaS アーキテクチャ パターンとオンプレミスからクラウドネイティブへの進化。
...
このレッスンでは、SaaS の概要 - ビジネス モデル、メトリクス、アーキテクチャ パターンについて学びました。重要なポイント:
