...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 21: テナントを意識した CI/CD と</tspan>
      <tspan x="60" dy="42">インフラストラクチャの自動化</tspan>
  </text>
...
![レッスン 21: テナントを意識した CI/CD とインフラストラクチャの自動化](/storage/uploads/2026/03/saas-bai-21-diagram.png)

## はじめに

SaaS 向け CI/CD: ダウンタイムゼロの導入。 Canary はテナント グループごとにリリースします。テナント プロビジョニングのためのコードとしてのインフラストラクチャ。 GitOps ワークフロー。

---

## 1. SaaS 用 CI/CD: ダウンタイムゼロのデプロイメント

### 1.1 基本概念

SaaS の CI/CD: ゼロダウンタイムの導入は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 3. テナント プロビジョニングのためのコードとしてのインフラストラクチャ
...
このレッスンでは、テナント対応の CI/CD とインフラストラクチャの自動化について学びました。重要なポイント:
