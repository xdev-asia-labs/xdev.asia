...
video_url: null
sort_order: 9
section_title: 'パート 3: 請求およびサブスクリプション エンジン'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 9: 使用量測定および請求エンジン</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: 請求およびサブスクリプション エンジン</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 9: 使用量測定および請求エンジン](/storage/uploads/2026/03/saas-bai-9-diagram.png)

## はじめに

使用量ベースの課金: インフラストラクチャの計測、集約パイプライン。請求書の生成。アップグレード/ダウングレードの比例配分。税金の計算。ストライプ/パドルの統合。

---

## 1. 使用量ベースの課金: 計測インフラストラクチャ、集約パイプライン

### 1.1 基本概念

使用量ベースの課金: インフラストラクチャの計測、集約パイプラインは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、使用量測定と請求エンジンについて学びました。重要なポイント:
