...
description: 'スーパー管理者ポータル: テナント管理、使用状況の監視。テナント管理ポータル: ユーザー管理、設定、請求。セルフサービスのトラブルシューティング。'
duration_minutes: 90
is_free: true
video_url: null
sort_order: 24
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 24: 管理ポータルとセルフサービス</tspan>
      <tspan x="60" dy="42">運営</tspan>
  </text>
...
![レッスン 24: 管理ポータルとセルフサービス操作](/storage/uploads/2026/03/saas-bai-24-diagram.png)

## はじめに

スーパー管理者ポータル: テナント管理、使用状況の監視。テナント管理ポータル: ユーザー管理、設定、請求。セルフサービスのトラブルシューティング。

---

## 1. スーパー管理者ポータル: テナント管理、使用状況監視

### 1.1 基本概念

スーパー管理者ポータル: テナント管理、使用状況の監視は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、管理ポータルとセルフサービス操作について学びました。重要なポイント:
