...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🏗️ アーキテクチャ — レッスン 23</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 23: SaaS のセキュリティ アーキテクチャ</tspan>
  </text>
...
![レッスン 23: SaaS のセキュリティ アーキテクチャ](/storage/uploads/2026/03/saas-bai-23-diagram.png)

## はじめに

SaaS セキュリティ: テナント データの暗号化、テナントごとのキー管理。脆弱性管理。侵入テスト。 SOC 2、ISO 27001 準拠。

---

## 1. SaaS セキュリティ: テナント データの暗号化、テナントごとのキー管理

### 1.1 基本概念

SaaS セキュリティ: テナント データの暗号化、テナントごとのキー管理は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、SaaS のセキュリティ アーキテクチャについて学びました。重要なポイント:
