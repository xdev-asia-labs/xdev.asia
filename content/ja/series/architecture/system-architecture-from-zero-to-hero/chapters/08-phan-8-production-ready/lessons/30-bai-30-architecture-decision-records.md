...
description: >-
  アーキテクチャ決定記録 (ADR):
  形式、いつ作成するか、実際の例。本番準備チェックリスト。システム設計面接の包括的なフレームワーク。システムアーキテクトのキャリアパス。リソースと次のステップ。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 30
section_title: 'パート 8: 本番環境に対応したアーキテクチャ'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ アーキテクチャ — レッスン 30</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 30: アーキテクチャの決定記録と</tspan>
      <tspan x="60" dy="42">生産チェックリスト</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 8: 本番環境に対応したアーキテクチャ</text>
