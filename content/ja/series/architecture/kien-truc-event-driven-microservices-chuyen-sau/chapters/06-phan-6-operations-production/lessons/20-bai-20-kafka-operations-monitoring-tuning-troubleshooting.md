...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 20: Kafka の操作 - 監視、</tspan>
      <tspan x="60" dy="42">チューニングとトラブルシューティング</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 6: 運用と生産</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 20: Kafka の操作 - 監視、チューニング、トラブルシューティング](/storage/uploads/2026/03/edm-bai-20-diagram.png)

## はじめに

Kafka の操作: モニタリング (JMX、Prometheus)、パフォーマンスのチューニング。消費者のラグモニタリング。パーティションのリバランス。ブローカーのメンテナンス。一般的な問題のトラブルシューティング。

---

## 1. Kafka の操作: モニタリング (JMX、Prometheus)、パフォーマンスのチューニング

### 1.1 基本概念

Kafka 操作: モニタリング (JMX、Prometheus)、パフォーマンス チューニングは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、Kafka の操作 - 監視、チューニング、トラブルシューティングについて学びました。重要なポイント:
