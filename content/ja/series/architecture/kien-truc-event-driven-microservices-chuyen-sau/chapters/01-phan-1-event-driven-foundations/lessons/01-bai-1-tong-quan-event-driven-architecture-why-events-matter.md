...
description: イベント駆動型アーキテクチャ (EDA) の基礎。イベント、コマンド、クエリ。時間的カップリングとイベントのデカップリング。 EDA の利点とトレードオフ。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 1
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 1: イベント駆動型アーキテクチャの概要</tspan>
      <tspan x="60" dy="42">- イベントが重要な理由</tspan>
  </text>
...
イベント駆動型アーキテクチャ (EDA) の基礎。イベント、コマンド、クエリ。時間的カップリングとイベントのデカップリング。 EDA の利点とトレードオフ。

---

## 1. イベント駆動型アーキテクチャ (EDA) の基礎

### 1.1 基本概念

イベント駆動型アーキテクチャ (EDA) の基礎は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、イベント駆動型アーキテクチャの概要 - なぜイベントが重要なのかについて学習しました。重要なポイント:
