...
description: DDD のドメイン イベント。イベントストーミングワークショップ。イベントモデリング技術。イベント、コマンド、集約の識別。イベントの命名規則。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 2: ドメイン イベントとイベント モデリング</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: イベント駆動型の基盤</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 2: ドメイン イベントとイベント モデリング](/storage/uploads/2026/03/edm-bai-2-diagram.png)

## はじめに

DDD のドメイン イベント。イベントストーミングワークショップ。イベントモデリング技術。イベント、コマンド、集約の識別。イベントの命名規則。
...
DDD のドメイン イベントは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、ドメイン イベントとイベント モデリングについて学びました。重要なポイント:
