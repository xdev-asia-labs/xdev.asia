...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🏗️ アーキテクチャ — レッスン 12</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: Saga パターン - 管理</tspan>
      <tspan x="60" dy="42">分散トランザクション</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: 分散パターン</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 12: Saga パターン - 分散トランザクションの管理](/storage/uploads/2026/03/edm-bai-12-diagram.png)

## はじめに

サーガ パターンの詳細: 振り付けとオーケストレーション。補償取引。佐賀実行コーディネーター。エラー処理。サーガステートマシン。

---

## 1. サーガパターンの詳細: 振付とオーケストレーション

### 1.1 基本概念

パターンの詳細な話: コリオグラフィーとオーケストレーションは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、Saga パターン - 分散トランザクションの管理について学びました。重要なポイント:
