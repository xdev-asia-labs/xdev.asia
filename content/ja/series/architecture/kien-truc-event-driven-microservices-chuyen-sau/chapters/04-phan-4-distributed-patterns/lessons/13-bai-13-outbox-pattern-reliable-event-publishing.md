...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: 送信ボックスのパターンと信頼できるイベント</tspan>
      <tspan x="60" dy="42">出版</tspan>
  </text>
...
![レッスン 13: 送信ボックスのパターンと信頼性の高いイベント発行](/storage/uploads/2026/03/edm-bai-13-diagram.png)

## はじめに

トランザクション送信ボックスのパターン。ポーリングパブリッシャーと CDC ベース。 Debezium 送信ボックス コネクタ。イベントの配信を保証します。注文保証。

---

## 1. トランザクション送信ボックスのパターン

### 1.1 基本概念

トランザクション送信ボックスのパターンは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、送信ボックスのパターンと信頼性の高いイベント発行について学びました。重要なポイント:
