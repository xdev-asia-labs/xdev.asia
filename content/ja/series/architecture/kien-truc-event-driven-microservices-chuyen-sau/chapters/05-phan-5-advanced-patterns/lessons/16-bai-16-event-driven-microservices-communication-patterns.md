...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: イベント駆動型のマイクロサービス</tspan>
      <tspan x="60" dy="42">コミュニケーションパターン</tspan>
  </text>
...
![レッスン 16: イベント駆動型マイクロサービスの通信パターン](/storage/uploads/2026/03/edm-bai-16-diagram.png)

## はじめに

通信パターン: イベントを介した要求と応答、イベント通知、イベントを伴う状態転送。ハイブリッド同期 + 非同期パターン。 APIの構成。

---

## 1. 通信パターン: イベントを介した要求と応答、イベント通知、イベントを伴う状態転送

### 1.1 基本概念

通信パターン: イベントを介した要求と応答、イベント通知、イベントを伴う状態転送は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、イベント駆動型マイクロサービスの通信パターンについて学びました。重要なポイント:
