...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: プロセス マネージャーとワークフロー エンジン</tspan>
  </text>
...
![レッスン 19: プロセス マネージャーとワークフロー エンジン](/storage/uploads/2026/03/edm-bai-19-diagram.png)

## はじめに

プロセス マネージャー パターン: ステート マシンとして長時間実行されるビジネス プロセス。 Temporal.io ワークフロー エンジン。耐久性のある実行。補償。

---

## 1. プロセス マネージャー パターン: ステート マシンとして長時間実行されるビジネス プロセス

### 1.1 基本概念

プロセス マネージャー パターン: ステート マシンとしての長時間実行されるビジネス プロセスは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、プロセス マネージャーとワークフロー エンジンについて学びました。重要なポイント:
