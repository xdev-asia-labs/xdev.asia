...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: イベント ストアの実装 -</tspan>
      <tspan x="60" dy="42">PostgreSQL と EventStoreDB</tspan>
  </text>
...
![レッスン 10: イベント ストアの実装 - PostgreSQL と EventStoreDB](/storage/uploads/2026/03/edm-bai-10-diagram.png)

## はじめに

イベント ストアの実装: PostgreSQL ベース (アウトボックス)、EventStoreDB、Axon Server。イベント連載。サブスクリプションモデル。プロジェクションエンジン。

---

## 1. イベント ストアの実装: PostgreSQL ベース (アウトボックス)、EventStoreDB、Axon Server

### 1.1 基本概念

イベント ストアの実装: PostgreSQL ベース (アウトボックス)、EventStoreDB、Axon Server は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、イベント ストアの実装 - PostgreSQL と EventStoreDB について学びました。重要なポイント:
