...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: イベント ソーシング - 不変イベント</tspan>
      <tspan x="60" dy="42">信頼できる情報源としてのログ</tspan>
  </text>
...
![レッスン 8: イベント ソーシング - 真実の情報源としての不変イベント ログ](/storage/uploads/2026/03/edm-bai-8-diagram.png)

## はじめに

イベント ソーシングの基本: イベント ストア、イベント リプレイ、スナップショット。集合体の再構築。一時的なクエリ。自然に監査証跡を取得します。イベントのバージョン管理。

---

## 1. イベント ソーシングの基礎: イベント ストア、イベント リプレイ、スナップショット

### 1.1 基本概念

イベント ソーシングの基礎: イベント ストア、イベント リプレイ、スナップショットは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、イベント ソーシング - 真実のソースとしての不変イベント ログについて学習しました。重要なポイント:
