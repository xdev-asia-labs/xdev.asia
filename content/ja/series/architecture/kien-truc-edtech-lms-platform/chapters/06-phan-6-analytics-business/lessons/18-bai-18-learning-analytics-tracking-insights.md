...
title: 'レッスン 18: 分析の学習 - 追跡と洞察'
slug: bai-18-learning-analytics-tracking-insights
description: '学習分析: 完了率、エンゲージメント指標、評価パフォーマンス。危険にさらされている生徒の検出。インストラクターのダッシュボード。 xAPI 分析。'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🏗️ アーキテクチャ — レッスン 18</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 18: 分析の学習 - 追跡と</tspan>
      <tspan x="60" dy="42">洞察</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 6: 分析とビジネス</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 18: 分析の学習 - 追跡と洞察](/storage/uploads/2026/03/edtech-bai-18-diagram.png)

## はじめに

学習分析: 完了率、エンゲージメント指標、評価パフォーマンス。危険にさらされている生徒の検出。インストラクターのダッシュボード。 xAPI 分析。

---

## 1. 学習分析: 完了率、エンゲージメント指標、評価パフォーマンス

### 1.1 基本概念

学習分析: 完了率、エンゲージメント指標、評価パフォーマンスは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、Learning Analytics - Tracking & Insights について学習しました。重要なポイント:
