...
title: 'レッスン 6: ビデオ配信 - HLS、DASH、アダプティブ ストリーミング'
slug: bai-6-video-delivery-hls-dash-adaptive-streaming
description: >-
  ビデオ プラットフォーム アーキテクチャ: トランスコーディング パイプライン、アダプティブ ビットレート ストリーミング (HLS/DASH)。
  CDN配信。ビデオプレーヤーの統合。 DRM 保護。字幕管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 6: ビデオ配信 - HLS、DASH、</tspan>
      <tspan x="60" dy="42">アダプティブ ストリーミング</tspan>
  </text>
...
![レッスン 6: ビデオ配信 - HLS、DASH、アダプティブ ストリーミング](/storage/uploads/2026/03/edtech-bai-6-diagram.png)

## はじめに

ビデオ プラットフォーム アーキテクチャ: トランスコーディング パイプライン、アダプティブ ビットレート ストリーミング (HLS/DASH)。 CDN配信。ビデオプレーヤーの統合。 DRM 保護。字幕管理。

---

## 1. ビデオ プラットフォーム アーキテクチャ: トランスコーディング パイプライン、アダプティブ ビットレート ストリーミング (HLS/DASH)

### 1.1 基本概念

ビデオ プラットフォーム アーキテクチャ: トランスコーディング パイプライン、アダプティブ ビットレート ストリーミング (HLS/DASH) は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、ビデオ配信 - HLS、DASH、アダプティブ ストリーミングについて学びました。重要なポイント:
