...
title: 'レッスン 5: コンテンツ オーサリングとリッチ メディア'
slug: bai-5-content-authoring-rich-media
description: >-
  コンテンツ オーサリング ツール: リッチ テキスト エディター、ドラッグ アンド ドロップ ビルダー。インタラクティブなコンテンツ:
  H5P、組み込みシミュレーション。コンテンツのバージョン管理。マルチフォーマットのサポート。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 5
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 5: コンテンツ オーサリングとリッチ メディア</tspan>
  </text>
...
![レッスン 5: コンテンツ オーサリングとリッチ メディア](/storage/uploads/2026/03/edtech-bai-5-diagram.png)

## はじめに

コンテンツ オーサリング ツール: リッチ テキスト エディター、ドラッグ アンド ドロップ ビルダー。インタラクティブなコンテンツ: H5P、組み込みシミュレーション。コンテンツのバージョン管理。マルチフォーマットのサポート。

---

## 1. コンテンツ オーサリング ツール: リッチ テキスト エディター、ドラッグ アンド ドロップ ビルダー

### 1.1 基本概念

コンテンツ オーサリング ツール: リッチ テキスト エディター、ドラッグ アンド ドロップ ビルダーは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 2. インタラクティブ コンテンツ: H5P、組み込みシミュレーション
...
このレッスンでは、コンテンツ オーサリングとリッチ メディアについて学びました。重要なポイント:
