...
title: 'レッスン 15: リアルタイム コラボレーション - 共有ワークスペース'
slug: bai-15-real-time-collaboration-shared-workspace
description: リアルタイム共同編集 (CRDT/OT)。共有コードエディタ。共同作業用のホワイトボード。グループプロジェクト。ピアプログラミングセッション。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 15: リアルタイム コラボレーション - 共有</tspan>
      <tspan x="60" dy="42">ワークスペース</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 5: コラボレーションとコミュニティ</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 15: リアルタイム コラボレーション - 共有ワークスペース](/storage/uploads/2026/03/edtech-bai-15-diagram.png)

## はじめに

リアルタイム共同編集 (CRDT/OT)。共有コードエディタ。共同作業用のホワイトボード。グループプロジェクト。ピアプログラミングセッション。

---

## 1. リアルタイム共同編集 (CRDT/OT)

### 1.1 基本概念

リアルタイム共同編集 (CRDT/OT) は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、リアルタイム コラボレーション - 共有ワークスペースについて学びました。重要なポイント:
