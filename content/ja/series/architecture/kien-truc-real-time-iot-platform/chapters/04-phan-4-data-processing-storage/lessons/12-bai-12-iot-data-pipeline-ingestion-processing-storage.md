...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: IoT データ パイプライン - 取り込み、</tspan>
      <tspan x="60" dy="42">処理と保管</tspan>
  </text>
...
![レッスン 12: IoT データ パイプライン - 取り込み、処理、ストレージ](/storage/uploads/2026/03/iot-bai-12-diagram.png)

## はじめに

IoT データ パイプライン アーキテクチャ。高スループットの取り込み (1 秒あたり数百万メッセージ)。ストリーム処理: フィルタリング、強化、集約。温・温・冷蔵保管。

---

## 1. IoT データ パイプライン アーキテクチャ

### 1.1 基本概念

IoT データ パイプライン アーキテクチャは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、IoT データ パイプライン - 取り込み、処理、ストレージについて学びました。重要なポイント:
