...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 21: スケーラビリティ - 何百万ものデータの処理</tspan>
      <tspan x="60" dy="42">デバイス</tspan>
  </text>
...
![レッスン 21: スケーラビリティ - 数百万のデバイスの処理](/storage/uploads/2026/03/iot-bai-21-diagram.png)

## はじめに

IoT プラットフォームの拡張: 大規模な接続管理、メッセージ ルーティング。 MQTT ブローカーのクラスタリング。パーティショニング戦略。自動スケーリングデバイス接続。

---

## 1. IoT プラットフォームの拡張: 接続管理、大規模なメッセージ ルーティング

### 1.1 基本概念

IoT プラットフォームの拡張: 接続管理、大規模なメッセージ ルーティングは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、スケーラビリティ - 数百万のデバイスの処理について学びました。重要なポイント:
