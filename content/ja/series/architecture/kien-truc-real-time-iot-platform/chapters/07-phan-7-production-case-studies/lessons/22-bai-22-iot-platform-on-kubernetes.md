...
description: >-
  K8s に IoT プラットフォームを導入します。 EMQX オペレーター。 K8 上の TimescaleDB。エッジ K3s クラスター。 IoT
  インフラストラクチャ向けの GitOps。マルチクラスター管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-6218" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-6218)"/>

  <!-- Decorations -->
  <g>
    <circle cx="793" cy="289" r="36" fill="#c084fc" opacity="0.14"/>
    <circle cx="986" cy="202" r="35" fill="#c084fc" opacity="0.13"/>
    <circle cx="679" cy="115" r="34" fill="#c084fc" opacity="0.12000000000000001"/>
    <circle cx="872" cy="288" r="33" fill="#c084fc" opacity="0.11"/>
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 22: Kubernetes 上の IoT プラットフォーム</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">リアルタイム アーキテクチャと IoT プラットフォーム</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 7: 制作とケーススタディ</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 22: Kubernetes 上の IoT プラットフォーム](/storage/uploads/2026/03/iot-bai-22-diagram.png)

## はじめに

K8s に IoT プラットフォームを導入します。 EMQX オペレーター。 K8 上の TimescaleDB。エッジ K3s クラスター。 IoT インフラストラクチャ向けの GitOps。マルチクラスター管理。

---

## 1. K8s への IoT プラットフォームの展開

### 1.1 基本概念

K8s への IoT プラットフォームの展開は、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、Kubernetes 上の IoT プラットフォームについて学びました。重要なポイント:
