...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">🏗️ アーキテクチャ — レッスン 3</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 3: プラットフォーム アーキテクチャの概要 -</tspan>
      <tspan x="60" dy="42">クラウドエッジハイブリッド</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: IoT の基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 3: プラットフォーム アーキテクチャの概要 - クラウド エッジ ハイブリッド](/storage/uploads/2026/03/iot-bai-3-diagram.png)

## はじめに

IoT プラットフォーム アーキテクチャ設計: クラウド エッジ ハイブリッド。メッセージ ブローカー (EMQX、HiveMQ)。ルールエンジン。デバイスレジストリ。データ パイプライン アーキテクチャ。

---

## 1. IoT プラットフォームのアーキテクチャ設計: クラウドとエッジのハイブリッド

### 1.1 基本概念

IoT プラットフォームのアーキテクチャ設計: クラウドとエッジのハイブリッドは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、プラットフォーム アーキテクチャの概要 - クラウド エッジ ハイブリッドについて学びました。重要なポイント:
