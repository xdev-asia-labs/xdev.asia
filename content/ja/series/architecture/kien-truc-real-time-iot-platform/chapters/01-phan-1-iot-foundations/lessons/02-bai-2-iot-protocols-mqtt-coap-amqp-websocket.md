...
description: >-
  MQTT の詳細: QoS レベル、保持されるメッセージ、意志メッセージ。制約のあるデバイスの CoAP。企業向けの AMQP。リアルタイム Web 用の
  WebSocket。プロトコル選択ガイド。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 2: IoT プロトコル - MQTT、CoAP、AMQP および</tspan>
      <tspan x="60" dy="42">Webソケット</tspan>
  </text>
...
![レッスン 2: IoT プロトコル - MQTT、CoAP、AMQP、WebSocket](/storage/uploads/2026/03/iot-bai-2-diagram.png)

## はじめに

MQTT の詳細: QoS レベル、保持されるメッセージ、意志メッセージ。制約のあるデバイスの CoAP。企業向けの AMQP。リアルタイム Web 用の WebSocket。プロトコル選択ガイド。

---

## 1. MQTT の詳細: QoS レベル、保持されるメッセージ、意志メッセージ

### 1.1 基本概念

MQTT の詳細: QoS レベル、保持されるメッセージ、メッセージは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、IoT プロトコル - MQTT、CoAP、AMQP、WebSocket について学びました。重要なポイント:
