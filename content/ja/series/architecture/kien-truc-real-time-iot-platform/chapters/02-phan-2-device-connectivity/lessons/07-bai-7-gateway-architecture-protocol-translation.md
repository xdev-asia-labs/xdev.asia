...
description: >-
  IoT ゲートウェイ: プロトコル変換、ローカル処理、ストア アンド フォワード。エッジゲートウェイとクラウドゲートウェイ。 Modbus/BACnet →
  MQTT 変換。ゲートウェイのクラスタリング。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 7
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-7273" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-7273)"/>

  <!-- Decorations -->
  <g>
    <circle cx="616" cy="258" r="34" fill="#2dd4bf" opacity="0.13"/>
    <circle cx="632" cy="74" r="32" fill="#2dd4bf" opacity="0.11"/>
    <circle cx="648" cy="150" r="30" fill="#2dd4bf" opacity="0.09"/>
    <circle cx="664" cy="226" r="28" fill="#2dd4bf" opacity="0.07"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 7: ゲートウェイのアーキテクチャとプロトコル</tspan>
...
![レッスン 7: ゲートウェイ アーキテクチャとプロトコル変換](/storage/uploads/2026/03/iot-bai-7-diagram.png)

## はじめに

IoT ゲートウェイ: プロトコル変換、ローカル処理、ストア アンド フォワード。エッジゲートウェイとクラウドゲートウェイ。 Modbus/BACnet → MQTT 変換。ゲートウェイのクラスタリング。

---

## 1. IoT ゲートウェイ: プロトコル変換、ローカル処理、ストア アンド フォワード

### 1.1 基本概念

IoT ゲートウェイ: プロトコル変換、ローカル処理、ストア アンド フォワードは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、ゲートウェイ アーキテクチャとプロトコル変換について学びました。重要なポイント:
