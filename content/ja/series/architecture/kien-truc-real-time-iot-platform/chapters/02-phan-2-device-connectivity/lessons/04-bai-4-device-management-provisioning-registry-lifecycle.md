...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: デバイス管理 - プロビジョニング、</tspan>
      <tspan x="60" dy="42">レジストリとライフサイクル</tspan>
  </text>
...
![レッスン 4: デバイス管理 - プロビジョニング、レジストリ、ライフサイクル](/storage/uploads/2026/03/iot-bai-4-diagram.png)

## はじめに

デバイス プロビジョニング: ゼロタッチ、証明書ベース。デバイスのレジストリとメタデータ。デバイスのライフサイクル: オンボード、アクティブ、メンテナンス、廃止。フリート管理。

---

## 1. デバイス プロビジョニング: ゼロタッチ、証明書ベース

### 1.1 基本概念

デバイス プロビジョニング: ゼロタッチ、証明書ベースは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
## 3. デバイスのライフサイクル: オンボード、アクティブ、メンテナンス、廃止
...
このレッスンでは、デバイス管理 - プロビジョニング、レジストリ、ライフサイクルについて学びました。重要なポイント:
