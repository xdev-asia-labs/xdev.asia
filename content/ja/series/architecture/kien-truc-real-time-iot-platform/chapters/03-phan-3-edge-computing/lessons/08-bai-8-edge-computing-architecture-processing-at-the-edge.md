...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: エッジ コンピューティング アーキテクチャ -</tspan>
      <tspan x="60" dy="42">エッジでの処理</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: エッジ コンピューティング</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

![レッスン 8: エッジ コンピューティング アーキテクチャ - エッジでの処理](/storage/uploads/2026/03/iot-bai-8-diagram.png)

## はじめに

エッジ コンピューティング: なぜ、いつなのか。エッジ展開モデル。エッジ ランタイム (K3s、KubeEdge)。エッジAI推論。エッジでのデータのフィルタリングと集約。

---

## 1. エッジ コンピューティング: なぜ、いつなのか

### 1.1 基本概念

エッジ コンピューティング: なぜ、いつなのかは、この分野で最も重要なトピックの 1 つです。中心となる概念を理解すると、最初から適切なシステムを設計するのに役立ちます。
...
このレッスンでは、エッジ コンピューティング アーキテクチャ - エッジでの処理について学びました。重要なポイント:
