...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">🏗️ アーキテクチャ — レッスン 10</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: ATLAS — コンセプト セットとコホート</tspan>
...
![レッスン 10: ATLAS — 概念セットとコホートの定義](/storage/uploads/2026/03/ohdsi-bai-10-concept-sets-cohorts.png)

## はじめに

**コホート定義** は、ATLAS のすべての分析の中心です。 「コホート」は、定義された期間にわたって特定の臨床基準を満たす患者の集合です。

コホートを作成する前に、**コンセプト セット** (再利用可能なコンセプトのセット) を構築する必要があります。
...
|コンセプト |説明 |
|----------|----------|
|コンセプトセット |再利用可能な概念のコレクション (子孫を含む/除外する) |
|コホートの定義 |患者グループの定義 (最初のイベント + 基準 + 終了) |
|最初のイベント |患者をコホートに加えるイベント (最初の発生) |
|包含基準 |追加のフィルタリング条件 (以前の経歴、年齢、以前のイベントなし...) |
|コホートの出口 |患者がコホートから脱落するのはいつですか |
|人員削減レポート |各基準の後に除外された患者の数を報告します。
|ウォッシュアウト期間 |インデックス日以前の「クリーンな」期間 |

**次の記事**: ATLAS — 特徴付け、発生率、経路
