...
description: >-
  ...
  テーブルへのデータのロード、エラー処理とデータ検証、増分 ETL 戦略、ETL フレームワークの推奨事項 (Python、SQL、Talend)。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 6: ETL パイプラインの構築 — データから</tspan>
      <tspan x="60" dy="42">ソースからOMOP CDMへ</tspan>
  </text>
...
![レッスン 6: ETL パイプライン — OMOP CDM へのソース](/storage/uploads/2026/03/ohdsi-bai-6-etl-pipeline.png)
...
|ステップ |活動内容 |出力 |
|------|----------|------|
|抜粋 |ソース DB からの SQL クエリ |生データ |
|変換 |コードマッピング、型変換、クリーニング | CDM 対応データ |
|ロード | OMOP CDM テーブルに挿入 (正しい FK 順序) | OMOP CDM が実装されました |
|検証 | ETL 後のチェック、カバレッジ分析 |品質レポート |
|時代の構築 | CONDITION_ERA、DRUG_ERA を導出 |派生テーブル |
