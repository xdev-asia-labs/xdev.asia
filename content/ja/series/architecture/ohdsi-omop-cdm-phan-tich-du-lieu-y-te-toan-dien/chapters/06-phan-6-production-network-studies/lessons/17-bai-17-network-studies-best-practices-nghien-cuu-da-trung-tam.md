...
description: >-
  ネットワーク調査ワークフロー、分散型調査モデル、調査パッケージ、データ ガバナンスとプライバシー、OHDSI コミュニティ、ベトナムでの OHDSI
  実装のベスト プラクティス。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 17: ネットワークの研究とベスト プラクティス —</tspan>
      <tspan x="60" dy="42">多施設研究</tspan>
  </text>
...
![レッスン 17: ネットワーク研究 — 多施設研究](/storage/uploads/2026/03/ohdsi-bai-17-network-studies.png)

## はじめに

OHDSI の真の力は、**多施設研究 (ネットワーク研究)** にあります。**患者データを共有することなく、**同じ研究課題が複数の国の数十のデータベースにわたって同時に回答されます。
