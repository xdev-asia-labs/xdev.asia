...
description: >-
  電子メール テンプレート システム: MJML、ハンドルバー、React Email。テンプレートのバージョン管理、A/B
  テスト、動的なコンテンツのパーソナライゼーション、コンテンツ パイプライン、プリレンダリング、キャッシュ。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 9: テンプレート エンジンとコンテンツ パイプライン</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: 電子メール インフラストラクチャと配信エンジン</text>
...
1,000 万通の電子メールを送信する場合、各電子メールには名前、提案された製品、固有の割引コードなど、**異なる** コンテンツが必要になる場合があります。テンプレート エンジンは、数百万の電子メールを **高速**かつ**パーソナライズ**してレンダリングするコンポーネントです。

---

## 1. 電子メール テンプレート テクノロジ

### 比較する

|テクノロジー |構文 |出力 |レスポンシブ |学習曲線 |
|----------|----------|----------|-----------|------|
| MJML | XML ライク | HTMLメール | ✅ 内蔵 |簡単 |
|ハンドルバー | `{{var}}` | HTML/テキスト |マニュアル |簡単 |
|電子メールに反応する | JSX | HTMLメール | ✅ コンポーネント |中 |
|液体 | `{{var}}` | HTML/テキスト |マニュアル |簡単 |
| EJS | `<%= var %>` | HTML/テキスト |マニュアル |簡単 |
...
1,000 万件のメール × 50 ミリ秒のレンダリング = **139 時間** のレンダリング時間 😱

### 解決策 1: バックグラウンドでの事前レンダリング
...
- **MJML** はレスポンシブ電子メール テンプレートに最適です
- **コンテンツ パイプライン**: テンプレート → レンダリング → CSS インライン → トラック → 送信
- **プリレンダリング**または**フラグメントキャッシュ**により、レンダリング時間が10倍に短縮されます
- **A/B テスト** は開封率とクリック率の最適化に役立ちます
- ワンクリックで配信停止を行うことで **CAN-SPAM** に常に準拠します

**次の記事:** レート制限とスロットリング — 電子メールの送信速度を制御します。
