...
description: >-
  NGINXとアプリケーションスタックの統合に関するレッスン——WordPress/Laravel向けPHP-FPM設定、Nginx + Node.js（PM2）、Pythonアプリケーション（uWSGI/Gunicorn）、PumaによるRuby on Rails、Dockerコンテナ、WebSocketプロキシ、gRPC。
duration_minutes: 185
is_free: true
video_url: null
sort_order: 11
section_title: "第4部：アプリケーションスタック＆監視"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8585" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8585)"/>

  <!-- Decorations -->
  <g>
    <circle cx="954" cy="132" r="12" fill="#f472b6" opacity="0.07"/>
    <circle cx="808" cy="166" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="662" cy="200" r="16" fill="#f472b6" opacity="0.11"/>
    <circle cx="1016" cy="234" r="18" fill="#f472b6" opacity="0.13"/>
    <circle cx="870" cy="268" r="20" fill="#f472b6" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🔒 DevSecOps — 第11課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 11: Nginx với Application Stack trong</tspan>
      <tspan x="60" dy="42">NGINX</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="244" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">NGINXの基礎から応用まで</text>

  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第4部：アプリケーションスタック＆監視</text>
...
[Install]
WantedBy=multi-user.target
</code></pre><hr><h2 id="4-ruby-on-rails-v%E1%BB%9Bi-puma"><strong>4. PumaによるRuby on Rails</strong></h2><h3 id="41-puma-configuration"><strong>4.1. Puma Configuration</strong></h3><p><strong>Puma config file:</strong></p><pre><code class="language-ruby"># config/puma.rb
...
</code></pre><hr><h2 id="t%E1%BB%95ng-k%E1%BA%BFt"><strong>まとめ</strong></h2><p>このレッスンで学んだこと：</p><ul><li>✅ PHP-FPM configuration cho WordPress/Laravel</li><li>✅ Nginx + Node.js với PM2</li><li>✅ Python applications với Gunicorn/uWSGI</li><li>✅ PumaによるRuby on Rails</li><li>✅ Docker container integration</li><li>✅ WebSocket proxying</li><li>✅ gRPC proxying</li><li>✅ Multi-application production setup</li></ul><p><strong>重要なポイント：</strong></p><ul><li>Use appropriate process managers (PHP-FPM, PM2, Gunicorn, Puma)</li><li>Configure proper timeouts và buffering</li><li>Enable keepalive connections</li><li>Use Unix sockets khi possible (faster than TCP)</li><li>Implement health checks</li><li>Monitor application performance</li></ul><p><strong>次のレッスン：</strong> Monitoring và Logging - access logs analysis, error tracking, Prometheus integration, ELK stack, real-time monitoring, alerting và dashboard creation để maintain healthy production environments.</p>
