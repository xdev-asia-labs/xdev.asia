...
description: >-
  ヘルスチェック（アクティブ/パッシブ）、セッション永続性、スティッキーセッション、フェイルオーバー戦略、仮想IPのためのKeepalived、アクティブ-アクティブおよびアクティブ-パッシブアーキテクチャ、データベースロードバランシング、地理的分散、災害復旧計画、HAセットアップのテスト。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-9968" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-9968)"/>

  <!-- Decorations -->
  <g>
    <circle cx="904" cy="42" r="12" fill="#f472b6" opacity="0.07"/>
    <circle cx="708" cy="46" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="1012" cy="50" r="16" fill="#f472b6" opacity="0.11"/>
    <circle cx="816" cy="54" r="18" fill="#f472b6" opacity="0.13"/>
    <circle cx="620" cy="58" r="20" fill="#f472b6" opacity="0.05"/>
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f472b6">🔒 DevSecOps — 第13課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 13: High Availability và Load</tspan>
      <tspan x="60" dy="42">Balancing Advanced trong NGINX</tspan>
  </text>
