...
description: >-
  Nginxによるマイクロサービスとサービスメッシュのレッスン——サービスディスカバリ、APIゲートウェイパターン、サービスごとのレート制限、サーキットブレーカー、リトライポリシー、分散トレーシング、サービスメッシュ統合（Consul、Istio）、サイドカーパターン、カナリアデプロイ、ブルーグリーンデプロイ。
duration_minutes: 245
is_free: true
video_url: null
sort_order: 14
section_title: "第5部：本番環境＆高度なトピック"
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🔒 DevSecOps — 第14課</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">Bài 14: マイクロサービスとサービスメッシュ</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">第5部：本番環境＆高度なトピック</text>
