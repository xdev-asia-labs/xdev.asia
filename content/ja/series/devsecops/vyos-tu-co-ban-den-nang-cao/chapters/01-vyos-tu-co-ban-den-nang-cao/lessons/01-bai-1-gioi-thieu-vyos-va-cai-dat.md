...
title: '第1課：VyOSの概要とインストール'
slug: bai-1-gioi-thieu-vyos-va-cai-dat
description: >-
  VyOSとは何か、Vyattaからの歴史、pfSense/OPNsense/MikroTikとの比較、システムアーキテクチャ、KVM・VirtualBox・Proxmox・ベアメタルへのインストールガイドを学びます。
...
<h2>開発の歴史: Từ Vyatta đến VyOS</h2>
...
<h2>ハンズオンラボ: VyOSのインストール trên VirtualBox</h2>
