...
title: '第2課：インターフェースと基本IP設定'
slug: bai-2-cau-hinh-interface-va-ip-co-ban
description: >-
  ethernetインターフェース、スタティックIP、DHCPクライアント、ユーザー管理、ホスト名、タイムゾーン、NTP、DNS、VyOSのバックアップ/リストア設定のガイドです。
...
<img src="/storage/uploads/2026/04/vyos-02-interface-ip.png" alt="インターフェース設定 và IP cơ bản" style="display:block;margin:24px auto 32px auto;max-width:700px;width:100%;border-radius:18px;box-shadow:0 4px 32px #0002" loading="lazy" />
...
<h2>ユーザー管理 và Authentication</h2>
...
<h2>ハンズオンラボ: Setup Router 2 Interfaces WAN + LAN</h2>
...
<ul>
  ...
  <li>ハンズオンラボ: Setup router 2 interfaces WAN + LAN hoàn chỉnh</li>
</ul>
