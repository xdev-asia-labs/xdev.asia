...
description: >-
  VyOSのゾーンベースファイアウォールを学びます：LAN/WAN/DMZ/GUESTゾーンの設計、ゾーン間ルール、インターフェースベースファイアウォールとの比較、3ゾーンのハンズオンラボ。
...
<h3>Bước 1: ファイアウォールルールセットの作成 (ipv4 name)</h3>
...
<h2>ハンズオンラボ: Zone-policy 3 Zones cho Home Network</h2>
...
<ul>
  ...
  <li>ハンズオンラボ: Xây dựng hệ thống 3 zones (WAN/LAN/DMZ) hoàn chỉnh</li>
</ul>
