...
description: >-
  VyOSでのDHCPサーバー、DNS転送、NTPの設定。実践例、ハンズオンラボ、知識のまとめを含みます。
...
<h3>3. NTPの設定 (Network Time Protocol)</h3>
...
<h3>5. ハンズオンラボ: Cấu hình DHCP, DNS, NTP</h3>
<ol>
