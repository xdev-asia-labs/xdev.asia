...
description: 時系列に対するトランスフォーマーの適応。パッチTST。 iトランスフォーマー。情報屋、オートフォーマー。チャンネル独立とチャンネルミキシング。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: 時系列のトランスフォーマー —</tspan>
...
時系列に対するトランスフォーマーの適応。パッチTST。 iトランスフォーマー。情報屋、オートフォーマー。チャンネル独立とチャンネルミキシング。
...
時系列のトランスフォーマー — PatchTST、iTransformer は、最新の AI の分野における重要なトピックです。
