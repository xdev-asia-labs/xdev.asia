...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-3728" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-3728)"/>

  <!-- Decorations -->
  <g>
    <circle cx="985" cy="245" r="18" fill="#fb923c" opacity="0.1"/>
    <circle cx="870" cy="230" r="23" fill="#fb923c" opacity="0.05"/>
    <circle cx="755" cy="215" r="28" fill="#fb923c" opacity="0.1"/>
    <circle cx="640" cy="200" r="33" fill="#fb923c" opacity="0.05"/>
    <circle cx="1025" cy="185" r="8" fill="#fb923c" opacity="0.1"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 1: 時系列の基礎 — EDA と</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: 時系列分析の基礎</text>
...
時系列コンポーネント: トレンド、季節性、残差。 STL分解。定常性テスト: ADF、KPSS。 ACF/PACFプロット。パンダの時系列。
...
時系列の基礎 — EDA と分解は、最新の AI の分野における重要なトピックです。
