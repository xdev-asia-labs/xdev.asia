...
title: 'レッスン 2: CLIP と視覚と言語の対照的な学習'
slug: bai-2-clip-contrastive-learning
description: CLIP アーキテクチャ。対照的な損失。ゼロショット分類。画像とテキストの検索。 OpenCLIP、SigLIP。 CLIPを微調整します。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 2: CLIP と対照的な視覚言語</tspan>
...
CLIP アーキテクチャ。対照的な損失。ゼロショット分類。画像とテキストの検索。 OpenCLIP、SigLIP。 CLIPを微調整します。
...
CLIP と対照的な視覚言語学習は、現代の AI 分野における重要なトピックです。
