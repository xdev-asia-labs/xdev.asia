...
title: 'レッスン 10: テキストから画像への生成と編集'
slug: bai-10-text-to-image
description: 安定した拡散マルチモーダルパイプライン。 Pix2Pixを指示します。テキストを使った画像編集。グランディングDINO+SAM。視覚的なグラウンディング。
duration_minutes: 150
is_free: true
video_url: null
sort_order: 9
section_title: 'パート 3: ドキュメント AI とビデオの理解'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: テキストから画像への生成と編集</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: ドキュメント AI とビデオの理解</text>
...
安定した拡散マルチモーダルパイプライン。 Pix2Pixを指示します。テキストを使った画像編集。グランディングDINO+SAM。視覚的なグラウンディング。
...
テキストから画像への生成と編集は、最新の AI 分野における重要なトピックです。
