...
title: 'レッスン 8: Document AI — OCR、レイアウト分析、抽出'
slug: bai-8-document-ai-ocr
description: '最新の OCR: PaddleOCR、EasyOCR。ドキュメントのレイアウト分析。テーブルの抽出。 LayoutLMファミリー。請求書/領収書の処理。'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: Document AI — OCR、レイアウト分析</tspan>
      <tspan x="60" dy="42">& 抽出</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: ドキュメント AI とビデオの理解</text>
...
最新の OCR: PaddleOCR、EasyOCR。ドキュメントのレイアウト分析。テーブルの抽出。 LayoutLMファミリー。請求書/領収書の処理。
...
ドキュメント AI — OCR、レイアウト分析、抽出は、最新の AI 分野における重要なトピックです。
