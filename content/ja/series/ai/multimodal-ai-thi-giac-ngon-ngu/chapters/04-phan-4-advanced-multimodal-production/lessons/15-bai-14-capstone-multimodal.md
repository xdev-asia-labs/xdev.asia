...
title: 'レッスン 14: Capstone — マルチモーダル アシスタント パイプライン'
slug: bai-14-capstone-multimodal
description: 'プロジェクトの概要: マルチモーダル AI アシスタントの構築 — 画像理解 + 文書抽出 + 会話。本番環境に対応したパイプライン。'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">🧠 AI と ML — レッスン 13</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 14: Capstone — マルチモーダル アシスタント</tspan>
...
### 説明
プロジェクトの概要: マルチモーダル AI アシスタントの構築 — 画像理解 + 文書抽出 + 会話。本番環境に対応したパイプライン。
