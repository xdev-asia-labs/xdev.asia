...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: グラフ ニューラル ネットワーク</tspan>
      <tspan x="60" dy="42">おすすめ</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: 高度な RecSys — ナレッジ グラフ、マルチタスク、GNN</text>
...
ユーザー項目の 2 部グラフ。ライトGCN。ピンセージ。推奨事項のメッセージ受け渡し。 PyGの実装。
...
レコメンデーションのためのグラフ ニューラル ネットワークは、最新の AI の分野における重要なトピックです。
