...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: 本番環境の RecSys アーキテクチャ</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: RecSys の運用 — 導入と拡張</text>
...
3 段階のパイプライン: 候補の生成 → スコアリング → 再ランキング。特集ストア。リアルタイムとバッチ。 100万規模のシステム設計。
...
プロダクション RecSys アーキテクチャは、最新の AI 分野における重要なトピックです。
