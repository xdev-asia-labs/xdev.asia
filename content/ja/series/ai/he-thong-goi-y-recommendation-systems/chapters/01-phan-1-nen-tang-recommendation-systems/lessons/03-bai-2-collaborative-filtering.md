...
video_url: null
sort_order: 1
section_title: 'パート 1: レコメンデーション システム プラットフォーム'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🧠 AI と ML — レッスン 1</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 2: 協調フィルタリング —</tspan>
      <tspan x="60" dy="42">ユーザーベースとアイテムベース</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: レコメンデーション システム プラットフォーム</text>
...
ユーザーベースの CF: 類似性メトリクス。アイテム系CF。近所のメソッド。コサイン類似度、ピアソン相関。コールドスタートの問題。
...
協調フィルタリング — ユーザーベースとアイテムベースは、最新の AI 分野における重要なトピックです。
