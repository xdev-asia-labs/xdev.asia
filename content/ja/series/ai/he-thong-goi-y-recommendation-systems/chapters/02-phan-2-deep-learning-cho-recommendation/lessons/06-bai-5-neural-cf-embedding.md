...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">🧠 AI と ML — レッスン 4</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 5: ニューラル協調フィルタリングと</tspan>
      <tspan x="60" dy="42">埋め込み</tspan>
  </text>
...
NCF アーキテクチャ。レイヤーの埋め込み。 GMF + MLP。ワイド＆ディープ。ディープFM。インタラクション学習機能を搭載。
...
ニューラル協調フィルタリングと埋め込みは、最新の AI の分野における重要なトピックです。
