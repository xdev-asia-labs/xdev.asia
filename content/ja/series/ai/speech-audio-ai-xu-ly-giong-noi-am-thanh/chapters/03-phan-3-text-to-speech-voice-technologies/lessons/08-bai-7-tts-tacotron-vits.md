...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 7: テキスト読み上げ — Tacotron2、VITS および</tspan>
      <tspan x="60" dy="42">モダンな TTS</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: テキスト読み上げおよび音声テクノロジ</text>
...
TTS パイプライン: テキスト → メル → 波形。 Tacotron2 アーキテクチャ。 VITS はエンドツーエンドです。ボコーダー: HiFi-GAN。コキ TTS、バーク。
...
Text-to-Speech — Tacotron2、VITS、最新の TTS は、最新の AI 分野における重要なトピックです。
