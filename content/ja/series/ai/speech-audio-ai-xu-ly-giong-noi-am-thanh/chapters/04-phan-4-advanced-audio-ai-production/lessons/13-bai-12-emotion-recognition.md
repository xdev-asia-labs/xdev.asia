...
description: '音声感情認識。パラ言語的な特徴。マルチモーダル: 音声 + テキスト。感情の場合は Wav2Vec2。データセット: IEMOCAP、RAVDESS。'
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">🧠 AI と ML — レッスン 11</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: 感情の認識と感情</tspan>
      <tspan x="60" dy="42">スピーチから</tspan>
  </text>
