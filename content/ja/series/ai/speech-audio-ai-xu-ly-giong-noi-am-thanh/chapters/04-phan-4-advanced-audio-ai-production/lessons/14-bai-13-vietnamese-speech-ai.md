...
description: >-
  ベトナム語の特徴：声調言語、発音記号。ベトナム語向けにウィスパーを微調整します。ベトナムのTTS。 VLSP データセット。 Viettel/FPT AI
  の比較。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: ベトナム語音声 AI — ASR および TTS</tspan>
      <tspan x="60" dy="42">ベトナム語</tspan>
  </text>
...
ベトナム語の特徴：声調言語、発音記号。ベトナム語向けにウィスパーを微調整します。ベトナムのTTS。 VLSP データセット。 Viettel/FPT AI の比較。
...
ベトナム語音声 AI — ASR および TTS ベトナム語は、現代の AI 分野において重要なトピックです。
