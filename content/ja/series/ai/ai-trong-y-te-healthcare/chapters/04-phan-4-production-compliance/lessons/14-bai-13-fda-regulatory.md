...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: FDA と AI の規制順守</tspan>
      <tspan x="60" dy="42">医療機器</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: 生産とコンプライアンス</text>
...
| SaMDクラス |患者のリスク | FDA パスウェイ |例 |
|----------|---------------|---------------|----------|
|クラス I |低い | 510(k) 免除または迅速化 |基本的な心拍数モニタリング |
|クラス II |平均 | 510(k) または De Novo | AI が糖尿病性網膜症を検出 |
|クラスⅢ |曹操 | PMA (市販前承認) | AIがインスリンポンプを制御 |
...
**510(k)** = 市場前通知。述語デバイスとの**実質的同等性**の証明が必要です。
