...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 11: 医療のためのフェデレーション ラーニング</tspan>
  </text>
...
1. FedAvg を最初から実装します (Fflower は使用しません)。異なるデータセット サイズ (1000、500、2000) で 3 つの病院をシミュレートします。グローバル モデルと最適な個別モデルを比較します。

2. Opacus による差分プライバシーを追加します。 ε = [0.1, 1.0, 10.0] で訓練します。プロット精度対ε曲線。

3. DP が必要な理由を示すために、勾配反転攻撃 (Zhu et al., 2019) を実装します。勾配から 1 つのトレーニング画像を再構築します。
