...
description: >-
  ...
  ノイズ除去拡散確率モデル。スコアベースのモデル。ノイズスケジュール。 DDPM をゼロから実践してみましょう。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: 拡散モデル — 数学と方向性</tspan>
      <tspan x="60" dy="42">感覚</tspan>
  </text>
...
**拡散モデル** は安定拡散、DALL-E 2/3、Midjourney の基盤であり、GAN よりも優れた画像生成品質を実現します。天才的なアイデア: **画像が完全にノイズになるまで徐々にノイズを追加し、その後、そのプロセスを逆にする方法を学びます**。
...
|方法 |ステップ |スピード |品質 |決定論的 |
|----------|----------|----------|----------|--------------|
| DDPM | 1000 |遅い |ベスト |いいえ |
| DDIM | 50 | 20 倍高速 |良い |はい |
| DPM++ | 20-30 | 35 倍高速 |すばらしい |はい |
|オイラー | 20-30 | 35 倍高速 |すばらしい |設定可能 |

---

## 6. スコアベースのモデル

$$\nabla_x \log p(x) \おおよそ s_\theta(x)$$
...
|コンセプト |説明 |
|----------|----------|
|前進プロセス |ガウス ノイズを段階的に追加する |
|逆のプロセス |ノイズ除去を段階的に学習する |
| DDPM |ノイズ除去拡散確率モデル |
| Uネット |ニューラル ネットワークによるノイズの予測 |
| DDIM |確定的サンプリング、少ないステップ |
|騒音スケジュール |線形とコサイン — 品質への影響 |
|スコアベース |対数密度の勾配を学ぶ |

> 📌 **次の記事:** 安定拡散の詳細 — 潜在拡散、UNet、CLIP コンディショニング。
