...
description: >-
  テキストから 3D へ: DreamFusion、Magic3D、Point-E。画像から 3D モデルへ。 3D ガウス スプラッティング。 AI
  アバター: 話す頭、全身。 NeRF の基本。ゲームと VR 用の 3D アセットの生成。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 14: 3D 生成とアバター AI</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 5: ビデオ生成とマルチモーダル</text>
