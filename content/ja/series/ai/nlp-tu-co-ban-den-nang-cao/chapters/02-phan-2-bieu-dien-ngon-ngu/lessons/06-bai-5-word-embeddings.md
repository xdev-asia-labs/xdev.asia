...
description: >-
  ワンホットベクトルから高密度ベクトルまで。 Word2Vec: CBOW とスキップグラム、ネガティブ サンプリング。 GloVe: 共起行列因数分解。
  FastText: サブワード埋め込み。 t-SNE/UMAPで可視化します。ベトナム語用に事前トレーニングされた埋め込み。 Gensim
  を実際に使ってみましょう。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 5: 単語の埋め込み — Word2Vec、GloVe、</tspan>
      <tspan x="60" dy="42">ファストテキスト</tspan>
  </text>
...
単語埋め込みは、各単語を **密なベクトル** (通常は 100 ～ 300 次元) で表現するため、同様の意味を持つ単語がベクトル空間内で **互いに近く**なります。これは NLP 史上最大の進歩の 1 つです。
...
GloVe はコーパス全体から **共起行列**を構築し、次のように因数分解します。
...
FastText は単語を **文字の n グラムの合計**として表します。OOV 単語を処理します。
