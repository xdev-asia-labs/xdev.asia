...
description: >-
  プロジェクトの概要: 完全な NLP プラットフォームの構築 — 特定のドメイン (医療、法律、または電子商取引) のテキスト分類 + NER +
  QA。パイプライン: データ → トレーニング → 評価 → サービス提供 → モニタリング。ベスト プラクティスのチェックリストとキャリア ロードマップ。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🧠 AI と ML — レッスン 19</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 20: Capstone プロジェクト — NLP の構築</tspan>
      <tspan x="60" dy="42">プラットフォームのエンドツーエンド</tspan>
  </text>
...
3 つの機能を備えたドメイン **E コマース**向けの **ベトナム NLP プラットフォーム** を構築:
