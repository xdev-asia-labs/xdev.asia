...
description: >-
  自律型 AI エージェントの構築: ツールの使用、OpenAI/Claude API による関数呼び出し、ReAct エージェント、マルチエージェント
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 18: AI エージェント — ツールの使用法、機能</tspan>
      <tspan x="60" dy="42">通話、エージェント ワークフロー</tspan>
  </text>
...
AI エージェントは、**アクション機能** (ツールの呼び出し、Web の検索、コードの実行、ファイルの読み取り、API の呼び出し) を備えた LLM です。エージェントは単に応答するだけでなく、**複数ステップのタスク**を自律的に実行できます。
