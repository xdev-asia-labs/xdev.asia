...
description: >-
  英語/ベトナム語のコマンド「ネオンを明るくする」、「デザインを上に移動する」、「色を紫に変更する」を受け取る AI エディターを構築します。画像編集用の
  InstructPix2Pix、Instruct-NeRF2NeRF。 LLM ルーティングの意図。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: AI 編集アシスタント — 編集</tspan>
      <tspan x="60" dy="42">自然言語でデザインする</tspan>
  </text>
...
デザインを作成した後、ユーザーは編集したいと考えています: *「ネオンを明るくする」*、*「デザインを上に移動する」*、*「色を紫に変更する」*。このプラットフォームでは、ユーザーに Photoshop の使用を強制するのではなく、**自然言語でのデザイン編集**が可能です。この記事では AI 編集アシスタントを構築します。
...
1. **インテント ルーティング** — LLM は編集コマンドを 4 つのカテゴリに分類します
2. **レイアウト エディタ** — プログラムによる移動/サイズ変更/回転/中央揃え
3. **スタイル エディター** — AI ベースのスタイル変更のための InstructPix2Pix
4. **カラーエディタ** — 色相シフト、明るさ、鮮やかさの調整
5. **品質検証** — 各編集後の自動チェック

次の記事: **AI タイポグラフィ** — T シャツのテキスト、フォント スタイル、自動配置を生成します。
