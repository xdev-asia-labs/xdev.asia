...
description: >-
  AI は、T シャツ用の引用文、ミーム テキスト、様式化されたタイポグラフィを生成します。フォント推奨エンジン。テキスト レンダリング パイプライン:
  フォントのスタイル転送、印刷領域への自動配置。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  <defs>
    <linearGradient id="bg-8783" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  <!-- Background -->
  <rect width="1200" height="340" rx="12" fill="url(#bg-8783)"/>

  <!-- Decorations -->
  <g>
    <circle cx="754" cy="132" r="12" fill="#f472b6" opacity="0.07"/>
    <circle cx="908" cy="166" r="14" fill="#f472b6" opacity="0.09"/>
    <circle cx="1062" cy="200" r="16" fill="#f472b6" opacity="0.11"/>
    <circle cx="716" cy="234" r="18" fill="#f472b6" opacity="0.13"/>
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 11: AI タイポグラフィ — テキストの生成</tspan>
      <tspan x="60" dy="42">フォントのスタイルと配置</tspan>
  </text>
...
タイポグラフィーは、引用文、ミームテキスト、ブランド名、様式化されたレタリングなど、T シャツのデザインにおける重要な要素です。 AI は画像を作成するだけでなく、適切なフォント スタイルで美しいテキストを生成し、シャツの適切な位置に配置する必要があります。

---

## 1. AI におけるタイポグラフィーの課題
...
1. **テキスト生成** — LLM は引用文、ミームテキスト、スローガンを作成します
2. **フォントの推奨** — デザインスタイルに応じたフォントの提案
3. **テキスト レンダリング** — Pillow/Cairo は高品質のテキストをレンダリングします
4. **効果** — ネオンの輝き、影、輪郭、グラデーション
5. **自動配置** — デザイン上の適切な空き領域を見つけます

次の記事は **パート 4: AI パーソナライゼーション** から始まります。AI システムは各ユーザーの美的好みを学習します。
