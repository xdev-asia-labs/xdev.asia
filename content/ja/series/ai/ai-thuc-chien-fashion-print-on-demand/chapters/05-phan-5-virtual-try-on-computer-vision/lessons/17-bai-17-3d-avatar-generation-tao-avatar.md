...
description: >-
  身体パラメータから 3D アバターを生成: SMPL/SMPL-X モデル、テクスチャ マッピング、身体形状モーフィング。ブラウザーレンダリングのための
  Three.js/WebGL との統合。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">🧠 AI と ML — レッスン 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 17: 3D アバターの生成 — アバターの作成</tspan>
      <tspan x="60" dy="42">バーチャル試着</tspan>
  </text>
...
この記事では、前の記事の SMPL パラメータから、ユーザーが仮想アイテムを試着できるように **3D アバターを作成します**。リアルなボディ メッシュには SMPL-X モデルを使用し、肌の外観にはテクスチャ マッピングを使用し、ブラウザ レンダリングのために Three.js にエクスポートします。
...
1. **SMPL-X** — パラメトリック ボディ モデル、10,475 頂点
2. **テクスチャ マッピング** — 肌色のテクスチャ
3. **ポーズのプリセット** — 立ったり、歩いたり、腰に手を当てたり
4. **GLB エクスポート** — Web 配信用のバイナリ glTF
5. **Three.js** — ブラウザーでのリアルタイム レンダリング

次の記事: **衣服のレンダリング** — 布地シミュレーションを使用してアバターにシャツをレンダリングします。
