...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: 行動学習 — 行動から学ぶ</tspan>
      <tspan x="60" dy="42">ja & 時間の経過に伴う好み</tspan>
  </text>
...
オンボーディングのスタイル プロファイルは、単なる初期スナップショットです。美的センスは時間の経過とともに変化します。この記事では、**行動学習** システムを構築します。これは、あらゆるユーザー インタラクションから継続的に学習して、より正確にパーソナライズする AI です。
...
1. **暗黙的なフィードバック** — 重み付けされたスコアを持つ 10 種類の信号
2. **イベント収集** — リアルタイムの動作イベント ストリーム
3. **エンベディング更新** — EMA は動作からユーザー スタイル ベクトルを更新します
4. **プロンプトパターン** — テーマ、キーワード、色の好みを学ぶ
5. **協調フィルタリング** — 同様の嗜好を持つユーザーからの提案

次の記事: **AI レコメンデーション システム** — すべてのシグナルを組み合わせて生成をパーソナライズします。
