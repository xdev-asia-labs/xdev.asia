...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 5: 画像参照分析 — CLIP、</tspan>
      <tspan x="60" dy="42">スタイルの転送とレイアウトの検出</tspan>
  </text>
...
ユーザーは、デザインをテキストで説明する方法を常に知っているわけではありません。多くの場合、彼らは参照画像 (アートワーク、ロゴ、ミーム、その他の T シャツの写真) を持っており、そこから**インスピレーション**された新しいデザインを AI に作成してもらいたいと考えています。この記事では、**画像参照分析** モジュールを構築します。
...
画像参照分析モジュールには以下が含まれます。

1. **CLIP スタイル分析** — ゼロショット分類スタイル、デザイン間の類似性を計算します
2. **カラー パレットの抽出** — K-means クラスタリング、CMYK 互換性チェック
3. **IP アダプター** — 制御可能な強度でスタイル参照を維持した新しいデザインを生成します
4. **レイアウト検出** — 適切な印刷領域を自動的に推奨します

次の記事: **マルチモーダル生成** — テキスト プロンプトと画像参照を組み合わせて、より強力なデザイン出力を実現します。
