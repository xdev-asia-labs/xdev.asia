...
description: >-
  実際の T シャツ データセットで SDXL/FLUX を微調整します。 Tシャツデザインに特化したLoRAトレーニング。ブランド固有のスタイルを提供する
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: テキストからデザインへ — 安定した微調整</tspan>
      <tspan x="60" dy="42">ファッションとしての普及</tspan>
  </text>
...
これは、プラットフォームの最も重要な AI モジュールである **Text-to-Design Engine** です。ユーザーはテキストで説明するだけで、AIが印刷可能なTシャツのデザインを作成します。この記事では、特にファッション ドメイン向けに LoRA を使用して SDXL を微調整する方法について説明します。
...
|側面 | SDXLベース |ファッションに合わせて微調整された SDXL |
|----------|-----------|---------------|
|出力 |一般的なアート写真 |すぐに制作可能な T シャツのデザイン |
|背景 |風景、テクスチャ | 写真透明/無地の背景 |
|スタイル |多くのスタイル |ストリートウェア、ミニマル、ゲーム向けに最適化... |
|印刷範囲 |わかりません |前/後/袖の配置を理解する |
|色 |一般的なRGB | CMYK印刷用に最適化 |

### Tシャツデザイン作成時のSDXL基本問題
...
レッスン 4 では、**Text-to-Design** パイプライン全体について説明します。

1. **データセットの準備** — ファッション データの収集、処理、自動キャプション
2. **LoRA の微調整** — T シャツのデザインに特化した SDXL LoRA のトレーニング
3. **評価** — CLIP スコア、美的スコア、印刷可能率
4. **推論パイプライン** — 自動強化プロンプト、生成、後処理
5. **バイリンガル サポート** — ベトナム語/英語のプロンプトを処理します
6. **バリエーション戦略** — 2 ～ 4 つの多様なデザイン バリエーションを作成する

次の記事: **画像参照分析** — CLIP と IP アダプターを使用して参照画像を分析します。
