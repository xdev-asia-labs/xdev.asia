...
title: 'レッスン 23: トレンドの検出とコンテンツの管理'
slug: bai-23-trending-detection-xu-huong-content-moderation
description: >-
  エンゲージメントメトリクスからデザイントレンドを検出: トレンドスコアアルゴリズム、季節検出。コンテンツモデレーション: NSFW
  検出、著作権チェック、ブランドセーフティ。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🧠 AI と ML — レッスン 22</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 23: トレンドの検出とコンテンツ</tspan>
      <tspan x="60" dy="42">節度</tspan>
  </text>
...
1. **トレンド スコア** — 加重イベント × 指数関数的減衰
2. **速度** — 加速度検出 (上昇/下降傾向)
3. **季節ブースト** — カレンダーベースのテーママッチング
4. **NSFW 検出** — 画像分類モデル
5. **テキスト スキャン** — OCR + ブロックされたパターン マッチング
6. **モデレーションワークフロー** — 自動承認 / キューレビュー / 拒否
