...
title: 'レッスン 22: AI 製品生成 — 自動タイトル、説明、モックアップ'
slug: bai-22-ai-product-generation-title-description-mockup
description: >-
  LLM はデザインタグから製品タイトルと説明を生成します。自動モックアップ レンダリング:
  実際の製品写真にデザインを重ね合わせます。マルチマーケットプレイス形式 (Etsy、Amazon、Shopify)。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">🧠 AI と ML — レッスン 21</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 22: AI プロダクトの生成 — タイトル、</tspan>
      <tspan x="60" dy="42">説明と自動モックアップ</tspan>
  </text>
...
販売者はデザインとタグを持っています。**商品リスト**: SEO に配慮したタイトル、魅力的な説明、プロ仕様のモックアップ画像が必要です。この記事では、コピーライティングに LLM を使用し、モックアップの生成に透視変換を使用します。
...
1. **LLM コピーライティング** — GPT-4o-mini はタイトル、説明、SEO タグを生成します
2. **マルチマーケットプレイス** — Etsy、Amazon、Shopify のフォーマット ルール
3. **モックアップ エンジン** — テンプレート写真への遠近感変換デザイン
4. **バッチ パイプライン** — 1 つのワークフローでタグ → コピー → モックアップ

次の記事: **トレンドの検出とコンテンツのモデレーション**。
