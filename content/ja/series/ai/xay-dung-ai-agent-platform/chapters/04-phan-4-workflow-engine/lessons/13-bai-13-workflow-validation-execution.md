...
title: 'レッスン 13: ワークフローの検証と実行'
slug: bai-13-workflow-validation-execution
description: >-
  DAG 検証: サイクル検出、孤立ノード。トポロジカルソートの実行。エラー処理、再試行、タイムアウト。実行履歴、ステップバイステップのデバッグ。
  EventBus を介したリアルタイムの進行状況。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: ワークフローの検証と実行</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: ワークフロー エンジン</text>
