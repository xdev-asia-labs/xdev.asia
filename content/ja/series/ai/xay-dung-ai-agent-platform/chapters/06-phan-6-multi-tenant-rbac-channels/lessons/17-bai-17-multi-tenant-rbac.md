...
title: 'レッスン 17: マルチテナント RBAC — テナントの分離と権限'
slug: bai-17-multi-tenant-rbac
description: >-
  マルチテナント アーキテクチャ: テナントの分離、データのパーティショニング。 RBAC システム: ロール、権限、ポリシー。 60 の詳細な権限、4
  つのシステム ロール。テナント設定、使用量割り当て、請求。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">🧠 AI と ML — レッスン 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 17: マルチテナント RBAC — テナント</tspan>
      <tspan x="60" dy="42">分離と権限</tspan>
  </text>
...
- **テナント分離** — 共有 DB `tenantId` フィルタリング
- **60 権限** — 機能ごとにグループ化された詳細な権限
