...
title: 'レッスン 16: プラグイン システムと MCP プロトコル'
slug: bai-16-plugin-mcp
description: >-
  プラグイン アーキテクチャ: ロード/アンロード、サンドボックス実行、マーケットプレイス。 MCP (モデル コンテキスト プロトコル):
  サーバーの実装、ツールの公開、リソース管理。サードパーティの統合。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: プラグイン システムと MCP プロトコル</tspan>
  </text>

  <!-- Series subtitle -->
  <text x="60" y="222" font-family="system-ui,-apple-system,sans-serif" font-size="15" fill="#94a3b8" opacity="0.8">AIエージェントプラットフォームをゼロから構築 — xClawとの実戦</text>

  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 5: スキル、ドメイン、プラグイン</text>
...
プラグイン システムにより、サードパーティがプラットフォームを拡張できます。 MCP (モデル コンテキスト プロトコル) は、AI ツールの相互運用性の新しい標準です。xClaw は、MCP サーバー (ツールを公開) と MCP クライアント (外部ツールを使用) の両方を実装します。
...
- **プラグイン システム** — ライフサイクル フック (ロード/アンロード)、ツール + スキル + ルートを提供します
- **MCP サーバー** — xClaw ツールを Claude Desktop、Cursor などに公開します。
- **MCP クライアント** — 外部 MCP ツールを xClaw にインポートします
- **双方向** — xClaw は MCP サーバーと MCP クライアントの両方です

**次の記事:** マルチテナント RBAC — きめ細かい権限を持つ分離されたテナント。
