...
title: 'レッスン 9: ジムと安定したベースライン 3 — 現実の RL フレームワーク'
slug: bai-9-gymnasium-stable-baselines3
description: >-
  体育館 API の詳細。ラッパー。 Stable-Baselines3 のトレーニング、評価、コールバック。ハイパーパラメータの調整。
  TensorBoard のロギング。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 9: 体育館と安定したベースライン 3 — Rs</tspan>
      <tspan x="60" dy="42">実戦フレームワーク</tspan>
  </text>
