...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 2: 変数、型、制御フロー</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: Go の基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-variables"><strong>1. Go で変数を宣言する</strong></h2>

<p>Go には変数を宣言するさまざまな方法があり、それぞれが異なるコンテキストに適しています。</p>

<h3 id="1-1-var-keyword"><strong>1.1.使用する <code>変数</code></strong></h3>
...
<h3 id="1-2-short-declaration"><strong>1.2.短い宣言 <code>:=</code></strong></h3>
...
<p><strong>利用規約</strong>: 使用する <code>:=</code> 関数内 (短い)。使用する <code>変数</code> パッケージ レベル、またはゼロ値が必要な場合。</p>

<h3 id="1-3-constants"><strong>1.3.定数など <code>イオタ</code></strong></h3>
...
<h2 id="2-primitive-types"><strong>2. プリミティブ型</strong></h2>

<h3 id="2-1-numeric"><strong>2.1.数値型</strong></h3>

<table>
<thead>
<tr><th>種類</th><th>サイズ</th><th>範囲</th><th>ゼロ値</th></tr>
</thead>
<tbody>
<tr><td><code>int8</code></td><td>1バイト</td><td>-128 → 127</td><td>0</td></tr>
<tr><td><code>int16</code></td><td>2バイト</td><td>-32768 → 32767</td><td>0</td></tr>
<tr><td><code>int32</code> / <code>ルーン文字</code></td><td>4バイト</td><td>-2^31 → 2^31-1</td><td>0</td></tr>
<tr><td><code>int64</code></td><td>8バイト</td><td>-2^63 → 2^63-1</td><td>0</td></tr>
<tr><td><code>整数</code></td><td>4または8バイト</td><td>プラットフォームに依存する</td><td>0</td></tr>
<tr><td><code>uint8</code> / <code>バイト</code></td><td>1バイト</td><td>0→255</td><td>0</td></tr>
<tr><td><code>uint16</code></td><td>2バイト</td><td>0 → 65535</td><td>0</td></tr>
<tr><td><code>uint32</code></td><td>4バイト</td><td>0 → 2^32-1</td><td>0</td></tr>
<tr><td><code>uint64</code></td><td>8バイト</td><td>0 → 2^64-1</td><td>0</td></tr>
<tr><td><code>float32</code></td><td>4バイト</td><td>IEEE-754</td><td>0.0</td></tr>
<tr><td><code>float64</code></td><td>8バイト</td><td>IEEE-754</td><td>0.0</td></tr>
<tr><td><code>コンプレックス64</code></td><td>8バイト</td><td>float32 + float32i</td><td>(0+0i)</td></tr>
<tr><td><code>コンプレックス128</code></td><td>16バイト</td><td>float64 + float64i</td><td>(0+0i)</td></tr>
</tbody>
</table>
...
<h3 id="2-2-string"><strong>2.2.文字列</strong></h3>
...
<h3 id="2-3-bool"><strong>2.3.ブール値</strong></h3>
...
<h2 id="3-composite-types"><strong>3. 複合型</strong></h2>

<h3 id="3-1-array"><strong>3.1.配列 (固定サイズ)</strong></h3>
...
<h3 id="3-2-slice"><strong>3.2.スライス (動的配列) - 最も重要です。</strong></h3>
...
<h3 id="3-3-map"><strong>3.3.マップ(キー-値)</strong></h3>
...
<h3 id="3-4-struct"><strong>3.4.構造体</strong></h3>
...
<h2 id="4-pointers"><strong>4. ポインタ</strong></h2>
...
<h2 id="5-zero-values"><strong>5. ゼロ値</strong></h2>

<p>値が割り当てられていない場合、Go のすべての変数はゼロ値で初期化されます。</p>

<table>
<thead>
<tr><th>種類</th><th>ゼロ値</th></tr>
</thead>
<tbody>
<tr><td><code>int、float64、...</code></td><td><code>0</code></td></tr>
<tr><td><code>ブール</code></td><td><code>偽</code></td></tr>
<tr><td><code>文字列.文字列</code></td><td><code>「」</code> (空の文字列)</td></tr>
<tr><td><code>ポインタ、スライス、マップ、関数、インターフェイス、チャネル</code></td><td><code>なし</code></td></tr>
<tr><td><code>配列。配列</code></td><td>ゼロ値の配列</td></tr>
<tr><td><code>構造体</code></td><td>ゼロ値フィールドを含む構造体</td></tr>
</tbody>
</table>
...
<h2 id="6-control-flow"><strong>6. 制御フロー</strong></h2>
...
<h3 id="6-2-switch"><strong>6.2.スイッチ</strong></h3>
...
<h3 id="6-3-for"><strong>6.3. For ループ</strong></h3>
...
<h2 id="7-type-system"><strong>7. 型アサーションと変換</strong></h2>
...
<p>Go にはシンプルですが完全な型システムがあります。覚えておくべき重要な点:</p>

<ul>
<li><strong>使用する <code>:=</code></strong> ローカル変数の場合、 <code>変数</code> パッケージレベルまたはゼロ値の場合</li>
<li><strong>スライス</strong> 配列よりも多く使用され、常に使用されます <code>追加します。追加する</code> 要素を追加するには</li>
<li><strong>地図</strong> そうだよ <code>作る</code> 書き込み前 (nil マップ → パニック)</li>
<li><strong>ポインタ</strong> 値を変更する必要がある場合、または大量のコピーを避ける必要がある場合に使用します。</li>
<li><strong>ゼロ値</strong> これはコードをより安全にするのに役立つ重要な機能です</li>
<li><strong>のために</strong> 使用される唯一のループです <code>範囲。範囲</code> 繰り返す</li>
<li><strong>型変換</strong> 常に明示的で、暗黙的な変換はありません</li>
</ul>

<p>次の記事: <strong>関数、インターフェース、エラー処理</strong> — Go プログラミングの 3 つの柱。</p>
