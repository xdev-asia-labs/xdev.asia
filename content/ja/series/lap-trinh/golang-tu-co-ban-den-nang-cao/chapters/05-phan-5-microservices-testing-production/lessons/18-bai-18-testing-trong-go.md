...
description: >-
  単体テスト、テーブル駆動テスト。証人を嘲笑、嘲笑。テストコンテナを使用した統合テスト。 HTTP
  ハンドラーのテスト。ベンチマークテスト、ファジング。テストカバレッジ、CI統合。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 プログラミング — レッスン 18</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 18: Go でのテスト</tspan>
  </text>
...
<h2 id="1-testing-basics"><strong>1. テストの基本</strong></h2>
...
<h2 id="2-table-driven-tests"><strong>2. テーブル駆動テスト</strong></h2>
...
<h2 id="3-testify"><strong>3. 証言する — 主張と嘲笑</strong></h2>
...
<h3 id="3-1-interface-mocking"><strong>3.1.インターフェースモッキング</strong></h3>
...
<h2 id="4-http-handler-testing"><strong>4. HTTP ハンドラーのテスト</strong></h2>
...
<h2 id="5-integration-tests"><strong>5. Testcontainer を使用した統合テスト</strong></h2>
...
<h2 id="6-fuzzing"><strong>6. ファズテスト</strong></h2>
...
<h2 id="7-test-commands"><strong>7. テストコマンド</strong></h2>
...
<p>次の記事: <strong>Docker、CI/CD、DevOps</strong> — コンテナ化、パイプライン、デプロイメントの自動化。</p>
