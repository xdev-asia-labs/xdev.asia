...
description: >-
  Go 用のマルチステージ Docker ビルド。開発用の Docker Compose。 GitHub アクション CI/CD パイプライン。
  GoReleaser、セマンティック バージョニング。ヘルスチェック、正常なシャットダウン。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#f87171">💻 プログラミング — レッスン 19</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: Docker、CI/CD、DevOps</tspan>
  </text>
...
<h2 id="1-dockerfile"><strong>1. 多段階の Dockerfile</strong></h2>
...
<h3 id="1-1-dockerfile-tips"><strong>1.1. Dockerfile のヒント</strong></h3>

<ul>
<li><strong>スクラッチ。スクラッチ</strong>: 最小のイメージ (~5 ～ 15MB)、バイナリのみが含まれます</li>
<li><strong>高山</strong>: シェルのデバッグが必要な場合 (~20-30MB)</li>
<li><strong>CGO_ENABLED=0</strong>: 静的バイナリ、libc は必要ありません</li>
<li><strong>-ldflags="-w -s"</strong>: デバッグ情報を削除し、バイナリ サイズを 30% 削減します。</li>
<li><strong>.dockerignore</strong>: ベンダー、.git、テストを除外します</li>
</ul>
...
<h2 id="3-graceful-shutdown"><strong>3. 正常なシャットダウン</strong></h2>
...
<h2 id="4-health-checks"><strong>4. ヘルスチェック</strong></h2>
...
<h2 id="5-github-actions"><strong>5. GitHub アクション CI/CD</strong></h2>
...
<h2 id="6-makefile"><strong>6. メイクファイル</strong></h2>
...
<p>次の記事: <strong>実稼働環境のデプロイメントと可観測性</strong> — 構造化されたロギング、メトリクス、モニタリング、および展開戦略。</p>
