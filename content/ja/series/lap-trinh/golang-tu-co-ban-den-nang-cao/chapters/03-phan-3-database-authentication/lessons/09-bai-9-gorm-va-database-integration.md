...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 9: GORM とデータベースの統合</tspan>
  </text>
...
<h2 id="1-go-orm-landscape"><strong>1. ORMランドスケープに行く</strong></h2>

<table>
<thead>
<tr><th>図書館</th><th>種類</th><th>利点</th><th>短所</th></tr>
</thead>
<tbody>
<tr><td><strong>ゴーム</strong></td><td>完全な ORM</td><td>機能が豊富で人気のある関連付け</td><td>頭上の反射、魔法</td></tr>
<tr><td><strong>SQLX</strong></td><td>SQLヘルパー</td><td>軽量、生の SQL、高速</td><td>移行なし、手動クエリなし</td></tr>
<tr><td><strong>SQL</strong></td><td>コードジェネレーター</td><td>タイプセーフ、コンパイル時チェック</td><td>SQL ファーストの複雑なセットアップ</td></tr>
<tr><td><strong>エント</strong></td><td>グラフORM</td><td>スキーマファーストのコード生成</td><td>学習曲線、独自の意見</td></tr>
<tr><td><strong>バン</strong></td><td>SQLファーストORM</td><td>高速な構造マッピング、移行</td><td>人気が低い</td></tr>
</tbody>
</table>

<p>このコースでは次のことに重点を置きます <strong>GORM v2</strong> — Go で最も人気のある ORM で、ほとんどのプロジェクトに適しています。</p>

<h2 id="2-setup"><strong>2.PostgreSQLでGORMをセットアップする</strong></h2>
...
<h2 id="3-models"><strong>3. モデルの定義</strong></h2>
...
<h2 id="4-crud"><strong>4. CRUD操作</strong></h2>

<h3 id="4-1-create"><strong>4.1.作成</strong></h3>
...
<h3 id="4-2-read"><strong>4.2.読み取り (クエリ)</strong></h3>
...
<h3 id="4-3-update"><strong>4.3.アップデート</strong></h3>
...
<h3 id="4-4-delete"><strong>4.4.削除</strong></h3>
...
<h2 id="5-advanced"><strong>5. 高度な GORM 機能</strong></h2>

<h3 id="5-1-scopes"><strong>5.1.スコープ (再利用可能なクエリ)</strong></h3>
...
<h3 id="5-2-hooks"><strong>5.2.フック (コールバック)</strong></h3>
...
<h3 id="5-3-transactions"><strong>5.3.取引</strong></h3>
...
<ul>
<li><strong>GORM v2</strong>: フル機能の ORM、アソシエーション、フック、スコープ</li>
<li><strong>モデル</strong>: 列構成の構造体タグ、gorm.DeletedAt による論理的な削除</li>
<li><strong>クラッド</strong>: チェーン可能なクエリ ビルダーによる作成、検索、更新、削除</li>
<li><strong>プリロード</strong>: 積極的な読み込みの関連付け、ネストされたプリロード、条件付きプリロード</li>
<li><strong>スコープ</strong>: 再利用可能なクエリ条件 (ページネーション、検索、フィルター)</li>
<li><strong>取引</strong>: 自動トランザクション、ネストされたセーブポイント</li>
<li><strong>接続プール</strong>: MaxOpenConns、MaxIdleConns、ConnMaxLifetime</li>
</ul>

<p>次の記事: <strong>移行とリポジトリのパターン</strong> — データベースの移行とクリーンなアーキテクチャ。</p>
