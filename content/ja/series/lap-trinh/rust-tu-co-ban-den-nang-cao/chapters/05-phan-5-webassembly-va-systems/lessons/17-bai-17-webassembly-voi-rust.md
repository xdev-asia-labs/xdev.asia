...
description: >-
  wasm-pack、wasm-bindgen。 Rust → WASM compilation. JavaScript interop, web-sys,
  js-sys. Performance-critical browser code. Leptos/Yew frontend frameworks.
duration_minutes: 150
is_free: true
video_url: null
sort_order: 17
section_title: 'パート 5: WebAssembly とシステム'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 プログラミング — レッスン 17</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 17: Rust を使用した WebAssembly</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 5: WebAssembly とシステム</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-setup"><strong>1. WASMのセットアップ</strong></h2>
...
<h2 id="2-js-interop"><strong>2. JavaScript の相互運用性</strong></h2>
...
<h2 id="3-web-sys"><strong>3. web-sys による DOM 操作</strong></h2>
...
<h2 id="4-leptos"><strong>4. Leptos フロントエンドフレームワーク</strong></h2>
...
<p>次の記事: <strong>FFI と危険な Rust</strong>。</p>
