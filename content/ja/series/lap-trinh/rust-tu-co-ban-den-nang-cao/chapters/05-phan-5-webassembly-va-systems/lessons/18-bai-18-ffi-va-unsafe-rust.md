...
description: >-
  安全でないブロック、生のポインター、変換。 FFI (Foreign Function Interface)、Rust から C を呼び出します。 C
  互換ライブラリの構築。 Python バインディング用の PyO3。安全変数。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 18: FFI と危険な Rust</tspan>
  </text>
...
<h2 id="1-unsafe"><strong>1. 危険な錆</strong></h2>
...
<h2 id="2-ffi-c"><strong>2. FFI — Rust から C を呼び出す</strong></h2>
...
<h2 id="3-pyo3"><strong>3. PyO3 — Python バインディング</strong></h2>
...
<h2 id="4-safety"><strong>4. 安全性の不変条件</strong></h2>
...
<p>次の記事: <strong>テストとベンチマーク</strong>。</p>
