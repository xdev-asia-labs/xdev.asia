...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 21: 可観測性と監視</tspan>
  </text>
...
<h2 id="1-tracing"><strong>1. トレースを伴う構造化ロギング</strong></h2>
...
<h2 id="2-metrics"><strong>2. プロメテウスのメトリクス</strong></h2>
...
<h2 id="3-health"><strong>3. ヘルスチェックと正常なシャットダウン</strong></h2>
...
<p>次の記事: <strong>実稼働環境の導入とパフォーマンスのチューニング</strong>。</p>
