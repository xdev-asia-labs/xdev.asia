...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 プログラミング — レッスン 14</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 14: Tonic を使用した gRPC</tspan>
  </text>
...
<h2 id="1-proto"><strong>1. プロトコルバッファ</strong></h2>
...
<h2 id="2-server"><strong>2. gRPC サーバー</strong></h2>
...
<h2 id="3-client"><strong>3. gRPC クライアント</strong></h2>
...
<p>次の記事: <strong>メッセージキューとバックグラウンドジョブ</strong>。</p>
