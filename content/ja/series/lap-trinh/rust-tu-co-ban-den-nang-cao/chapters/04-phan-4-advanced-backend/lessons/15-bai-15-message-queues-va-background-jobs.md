...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 15: メッセージ キューとバックグラウンド ジョブ</tspan>
  </text>
...
<h2 id="1-rabbitmq"><strong>1. ラパンを使用した RabbitMQ</strong></h2>
...
<h2 id="2-kafka"><strong>2. カフカ vs ルドカフカ</strong></h2>
...
<h2 id="4-background"><strong>4. バックグラウンドジョブのパターン</strong></h2>
...
<p>次の記事: <strong>キャッシュ、CLI ツール、マクロ</strong>。</p>
