...
description: >-
  構造体、impl ブロッ​​ク、メソッド。列挙型、Option<T>、Result<T, E>。 match を使用したパターン マッチング、if
  let、while let。解体。ビルダーパターン。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: 構造体、列挙型、パターン マッチング</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: Rust の基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-structs"><strong>1. 構造と方法</strong></h2>
...
<h2 id="2-enums"><strong>2.列挙型</strong></h2>
...
<h2 id="3-pattern"><strong>3. 高度なパターンマッチング</strong></h2>
...
<h2 id="4-builder"><strong>4. ビルダーパターン</strong></h2>
...
<p>次の記事: <strong>特性とジェネリック</strong>。</p>
