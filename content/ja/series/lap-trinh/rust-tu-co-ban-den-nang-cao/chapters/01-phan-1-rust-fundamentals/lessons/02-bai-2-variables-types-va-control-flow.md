...
description: デフォルトでの不変性、シャドウイング。スカラー型、複合型 (タプル、配列)。文字列と&str。 if/else、一致、ループ。パターンマッチングの詳細。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 2
...
<h2 id="1-variables"><strong>1. 変数と可変性</strong></h2>
...
<h2 id="2-types"><strong>2. 種類</strong></h2>
...
<h2 id="3-control"><strong>3. 制御フロー</strong></h2>
...
<h2 id="4-pattern-matching"><strong>4. パターンマッチングの詳細</strong></h2>
...
<p>次の記事: <strong>所有権、借入、存続期間</strong>。</p>
