...
description: >-
  特性の定義、デフォルトの実装。ジェネリックタイプ、トレイト境界。関連するタイプ、スーパー特性。 impl 特性、dyn 特性。マクロを派生します。共通の特性
  (表示、デバッグ、クローン、From/Into)。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 5: 特性とジェネリック</tspan>
  </text>
...
<h2 id="1-traits"><strong>1. 特徴</strong></h2>
...
<h2 id="2-generics"><strong>2. ジェネリックスとトレイトの境界</strong></h2>
...
<h2 id="3-associated"><strong>3. 関連するタイプとスーパートレイト</strong></h2>
...
<h2 id="4-dyn-trait"><strong>4. impl 特性と dyn 特性</strong></h2>
...
<p>次の記事: <strong>クロージャ、イテレータ、コレクション</strong>。</p>
