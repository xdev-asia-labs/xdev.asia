...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 7: エラー処理とモジュール</tspan>
  </text>
...
<h2 id="1-result-option"><strong>1. 結果とオプション</strong></h2>
...
<h2 id="2-propagation"><strong>2.？演算子とエラーの伝播</strong></h2>
...
<h2 id="3-custom-errors"><strong>3. thiserror などのカスタム エラー</strong></h2>
...
<h2 id="4-modules"><strong>4. モジュールシステム</strong></h2>
...
<p>次の記事: <strong>スマート ポインタと同時実行性</strong>。</p>
