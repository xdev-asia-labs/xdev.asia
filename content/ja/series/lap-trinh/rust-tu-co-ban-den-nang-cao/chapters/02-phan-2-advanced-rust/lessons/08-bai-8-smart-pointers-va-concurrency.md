...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 プログラミング — レッスン 8</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: スマート ポインタと同時実行性</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 2: 高度な Rust</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-smart-pointers"><strong>1. スマートポインター</strong></h2>
...
<h2 id="2-threads"><strong>2. スレッドとメッセージパッシング</strong></h2>
...
<h2 id="3-shared-state"><strong>3. 共有状態 — アーク + ミューテックス</strong></h2>
...
<h2 id="4-rayon"><strong>4. レーヨン — データ並列処理</strong></h2>
...
<table>
<thead><tr><th>種類</th><th>シングルスレッド</th><th>マルチスレッド</th></tr></thead>
<tbody>
<tr><td>所有権</td><td>ボックス<T></td><td>ボックス<T> + 送信</td></tr>
<tr><td>共有</td><td>Rc<T></td><td>アーク<T></td></tr>
<tr><td>内部の可変性</td><td>RefCell<T></td><td>ミューテックス<T> / RwLock<T></td></tr>
</tbody>
</table>

<p>次の記事: <strong>非同期RustとTokio</strong>。</p>
