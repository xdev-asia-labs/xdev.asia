...
description: >-
  SQLx 非同期、コンパイル時のクエリ チェック。移行、接続プーリング。 CRUD 操作、トランザクション。 Sea-ORM の代替品。リポジトリ
  パターン、クリーンなアーキテクチャ。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 プログラミング — レッスン 11</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 11: SQLx とデータベースの統合</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. SQLx のセットアップ</strong></h2>
...
<h2 id="2-crud"><strong>2. CRUD操作</strong></h2>
...
<h2 id="3-transactions"><strong>3. 取引</strong></h2>
...
<h2 id="4-connection"><strong>4. 接続プール</strong></h2>
