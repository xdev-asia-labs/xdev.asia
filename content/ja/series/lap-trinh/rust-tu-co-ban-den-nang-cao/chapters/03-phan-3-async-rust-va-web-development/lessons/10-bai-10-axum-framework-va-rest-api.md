...
description: >-
  Axum のセットアップ、ルーティング、ハンドラー、エクストラクター。状態管理、ミドルウェア（タワー）。シリアル化、JSON 応答。エラー処理、カスタム
  エラー。 Axum、Actix-web、Rocket を比較します。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: Axum フレームワークと REST API</tspan>
  </text>
...
<h2 id="1-setup"><strong>1.Axumのセットアップ</strong></h2>
...
<h2 id="2-handlers"><strong>2. ハンドラーとエクストラクター</strong></h2>
...
<h2 id="4-middleware"><strong>4. タワーを備えたミドルウェア</strong></h2>
...
<p>次の記事: <strong>SQLx とデータベースの統合</strong>。</p>
