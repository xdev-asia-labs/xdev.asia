...
description: >-
  ...
  JwtAuthenticationFilter、リフレッシュ トークン フロー。 Stateless session management for REST
  API.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">💻 プログラミング — レッスン 9</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: JWT 認証 — ステートレス</tspan>
      <tspan x="60" dy="42">REST APIのセキュリティ</tspan>
  </text>
...
1. JWT 認証フローの完全な実装: 登録、ログイン、リフレッシュ トークン、保護されたエンドポイントへのアクセス
2. JWT クレームにロールを追加し、USER エンドポイントと ADMIN エンドポイントを区別するための承認を構成します
3. ユーザーのログアウト時にトークンを取り消すためのトークン ブラックリスト (Redis またはメモリ内に保存) を実装します。
