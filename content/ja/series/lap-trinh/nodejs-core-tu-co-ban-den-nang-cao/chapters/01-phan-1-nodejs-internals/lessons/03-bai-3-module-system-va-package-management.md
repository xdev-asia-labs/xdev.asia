...
description: >-
  CommonJS と ES モジュール、モジュール解決アルゴリズム。 Package.json フィールドのエクスポート、条件付きエクスポート。
  npm、pnpm ワークスペース。 Node.js 組み込みテスト ランナー、権限モデル。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 3
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 プログラミング — レッスン 3</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 3: モジュール システムとパッケージ管理</tspan>
  </text>
...
<h2 id="1-cjs-vs-esm"><strong>1. CommonJS 対 ES モジュール</strong></h2>

<table>
<thead><tr><th>特長</th><th>共通JS (CJS)</th><th>ESモジュール(ESM)</th></tr></thead>
<tbody>
<tr><td>構文</td><td>require() / module.exports</td><td>インポート/エクスポート</td></tr>
<tr><td>読み込み中</td><td>同期</td><td>非同期</td></tr>
<tr><td>トップレベルの待機</td><td>いいえ</td><td>はい</td></tr>
<tr><td>__ディレクトリ名</td><td>はい</td><td>import.meta.dirname (ノード 21 以降)</td></tr>
<tr><td>JSONインポート</td><td>require('./data.json')</td><td>{ type: 'json' } を使用して './data.json' からデータをインポートします</td></tr>
<tr><td>木を揺らす</td><td>いいえ</td><td>はい (静的解析)</td></tr>
</tbody>
</table>
...
<h2 id="2-package-json"><strong>2. Package.json エクスポート フィールド</strong></h2>
...
<h2 id="3-pnpm"><strong>3.pnpmワークスペース</strong></h2>
...
<h2 id="4-permission-model"><strong>4. 権限モデル (Node.js 22+)</strong></h2>
...
<h2 id="5-built-in-test"><strong>5. 内蔵テストランナー</strong></h2>
...
<p>次の記事: <strong>TypeScript と最新の JavaScript</strong> — tsx、ts-node、タイプストリッピング。</p>
