...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 5: ファイル システムとパス</tspan>
  </text>
...
<h2 id="2-streams"><strong>2. ファイルストリーム</strong></h2>
...
<h2 id="3-path"><strong>3. パスモジュール</strong></h2>
...
<h2 id="4-file-watching"><strong>4. ファイル監視</strong></h2>
...
<h2 id="5-atomic-write"><strong>5. アトミック書き込み</strong></h2>
...
<h2 id="6-glob"><strong>6. グロブパターン (Node.js 22+)</strong></h2>
...
<p>次の記事: <strong>ストリームとバッファ</strong> — 読み取り可能、書き込み可能、変換、バックプレッシャー。</p>
