...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 7: HTTP/HTTPS と HTTP/2</tspan>
  </text>
...
<h2 id="1-http-server"><strong>1. 基本的なHTTPサーバー</strong></h2>
...
<h2 id="2-request-body"><strong>2. リクエスト本文の読み取り</strong></h2>
...
<h2 id="3-https"><strong>3.HTTPS/TLSサーバー</strong></h2>
...
<h2 id="4-http2"><strong>4.HTTP/2サーバー</strong></h2>
...
<h2 id="5-fetch"><strong>5.フェッチ（組み込み）</strong></h2>
...
<h2 id="6-keep-alive"><strong>6. 接続プーリング</strong></h2>
...
<p>次の記事: <strong>暗号、OS、プロセス</strong> — ハッシュ、暗号化、子プロセス。</p>
