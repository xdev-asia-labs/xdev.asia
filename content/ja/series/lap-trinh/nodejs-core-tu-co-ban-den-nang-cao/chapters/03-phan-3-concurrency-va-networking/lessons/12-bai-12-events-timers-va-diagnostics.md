...
description: >-
  ...
  AbortController/AbortSignal。診断チャネル、async_hooks。 Node.js インスペクター、ヒープ スナップショット。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: イベント、タイマー、診断</tspan>
  </text>
...
<h2 id="1-eventemitter"><strong>1. イベントエミッタパターン</strong></h2>
...
<h2 id="2-abort"><strong>2. AbortController と AbortSignal</strong></h2>
...
<h2 id="3-diagnostics"><strong>3. 診断チャネル</strong></h2>
...
<h2 id="4-memory-leak"><strong>4. メモリリークの検出</strong></h2>
...
<h2 id="5-inspector"><strong>5. Node.js インスペクター API</strong></h2>
...
<p>次の記事: <strong>HTTP フレームワークを最初から構築する</strong> — ルーター、ミドルウェア パイプライン。</p>
