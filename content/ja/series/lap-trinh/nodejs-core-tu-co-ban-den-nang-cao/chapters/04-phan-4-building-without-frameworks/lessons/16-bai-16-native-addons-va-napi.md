...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 プログラミング — レッスン 16</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: ネイティブ アドオンと N-API</tspan>
  </text>
...
<h2 id="1-napi"><strong>1. N-API（ノードAPI）</strong></h2>

<p>Node-API は安定した ABI (Application Binary Interface) であり、Node.js のバージョンをアップグレードするときにリビルドせずに C/C++ または Rust でネイティブ アドオンを作成できます。</p>

<table>
<thead><tr><th>アプローチ</th><th>言語</th><th>ビルドツール</th><th>いつ使用するか</th></tr></thead>
<tbody>
<tr><td>ノードアドオンAPI</td><td>C++</td><td>ノード-gyp</td><td>C/C++ライブラリが利用可能</td></tr>
<tr><td>ナパール</td><td>さび</td><td>貨物.貨物</td><td>Rust プロジェクト、パフォーマンス</td></tr>
<tr><td>WASM</td><td>任意 → WASM</td><td>wasmパック</td><td>ポータブル、サンドボックス</td></tr>
<tr><td>ワーカースレッド</td><td>JavaScript</td><td>なし</td><td>CPUのタスクはシンプルです</td></tr>
</tbody>
</table>
...
<h2 id="3-node-gyp"><strong>3.node-addon-api を使用した C++ アドオン</strong></h2>
...
<h2 id="4-prebuild"><strong>4. プリビルドと配布</strong></h2>
...
<h2 id="5-benchmark"><strong>5. ネイティブ アドオンをいつ使用するか?</strong></h2>
...
<p>次の記事: <strong>Node.js アプリケーションのテスト</strong> — ノード:テスト、ヴィテスト、スーパーテスト。</p>
