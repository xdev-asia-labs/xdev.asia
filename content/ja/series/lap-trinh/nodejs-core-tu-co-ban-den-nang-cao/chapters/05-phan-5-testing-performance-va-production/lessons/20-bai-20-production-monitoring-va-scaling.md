...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 プログラミング — レッスン 20</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 20: 本番環境の監視とスケーリング</tspan>
  </text>
...
<h2 id="1-pino"><strong>1. 構造化ロギング (Pino)</strong></h2>
...
<h2 id="2-otel"><strong>2.オープンテレメトリー</strong></h2>
...
<h2 id="5-graceful-shutdown"><strong>5. 正常なシャットダウン</strong></h2>
...
<h2 id="6-scaling"><strong>6. 制作チェックリスト</strong></h2>

<table>
<thead><tr><th>カテゴリ</th><th>チェックリスト</th></tr></thead>
<tbody>
<tr><td>ロギング</td><td>Pino 構造、リクエスト ID、ログ レベル</td></tr>
<tr><td>モニタリング</td><td>プロメテウス + グラファナ、OpenTelemetry</td></tr>
<tr><td>エラー追跡</td><td>セントリー、unhandledRejection ハンドラー</td></tr>
<tr><td>ヘルスチェック</td><td>/health エンドポイント、readiness プローブ</td></tr>
<tr><td>正常なシャットダウン</td><td>SIGTERM ハンドラー、接続ドレイン</td></tr>
<tr><td>セキュリティ</td><td>ヘルメット、CORS、レート制限、入力検証</td></tr>
<tr><td>パフォーマンス</td><td>クラスター/PM2、接続プーリング、キャッシュ</td></tr>
</tbody>
</table>

<p>🎉 シリーズを完了する <strong>Node.js コア: 基本から高度まで</strong>！</p>
