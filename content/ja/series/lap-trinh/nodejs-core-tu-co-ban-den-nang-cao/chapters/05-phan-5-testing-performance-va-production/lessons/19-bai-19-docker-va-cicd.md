...
description: >-
  Node.js 用の Docker マルチステージ ビルド。アルパイン vs スリム vs ディストロレス。 Docker Compose、ヘルスチェック。
  GitHub アクション CI/CD パイプライン。 Docker の pnpm、.dockerignore のベスト プラクティス。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 プログラミング — レッスン 19</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: Docker と CI/CD</tspan>
  </text>
...
<h2 id="3-compose"><strong>3.ドッカーコンポーズ</strong></h2>
...
<h2 id="5-base-images"><strong>5. ベース画像の比較</strong></h2>

<table>
<thead><tr><th>画像</th><th>サイズ</th><th>ユースケース</th></tr></thead>
<tbody>
<tr><td>ノード:22</td><td>～1GB</td><td>開発、ネイティブビルド</td></tr>
<tr><td>ノード:22-スリム</td><td>～200MB</td><td>実稼働環境 (ネイティブ DEP なし)</td></tr>
<tr><td>ノード:22-アルパイン</td><td>～130MB</td><td>生産量（最小）</td></tr>
<tr><td>gcr.io/distroless/nodejs22</td><td>~50MB</td><td>セキュリティが強化された生産</td></tr>
</tbody>
</table>

<p>次の記事: <strong>本番環境の監視とスケーリング</strong> — ピノ、OpenTelemetry、Prometheus。</p>
