...
title: 'レッスン 16: プッシュ通知とバックグラウンド タスク'
slug: bai-16-push-notifications-va-background-tasks
description: >-
  Firebase クラウド
  メッセージングのセットアップ。ローカル通知。バックグラウンドフェッチ、WorkManager。フォアグラウンドサービス。通知からのディープリンク。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 プログラミング — レッスン 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: プッシュ通知とバックグラウンド</tspan>
...
<h2 id="1-fcm"><strong>1. Firebaseクラウドメッセージング</strong></h2>
...
<h2 id="2-local"><strong>2. ローカル通知</strong></h2>
...
<h2 id="3-background"><strong>3. WorkManager を使用したバックグラウンド タスク</strong></h2>
...
<p>次の記事: <strong>Flutter のクリーンなアーキテクチャ</strong>。</p>
