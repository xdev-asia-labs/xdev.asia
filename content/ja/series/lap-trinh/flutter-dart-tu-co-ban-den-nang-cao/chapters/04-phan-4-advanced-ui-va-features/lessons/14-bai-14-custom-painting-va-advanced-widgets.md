...
title: 'レッスン 14: カスタム ペイントと高度なウィジェット'
slug: bai-14-custom-painting-va-advanced-widgets
description: >-
  CustomPainter、Canvas API、パスの操作。スライバー: SliverAppBar、SliverList、SliverGrid。
  CustomScrollView、NestedScrollView。ドラッグ可能、DragTarget、ReorderableListView。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 プログラミング — レッスン 14</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 14: カスタム ペイントと高度なウィジェット</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 4: 高度な UI と機能</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-custom-painter"><strong>1.カスタムペインター</strong></h2>
...
<h2 id="2-slivers"><strong>2. スライバーと CustomScrollView</strong></h2>
...
<h2 id="3-drag-drop"><strong>3. ドラッグ＆ドロップ</strong></h2>
...
<h2 id="4-render-objects"><strong>4. カスタム RenderObject</strong></h2>
...
<p>次の記事: <strong>プラットフォームチャネルとネイティブ統合</strong>。</p>
