...
title: 'レッスン 13: アニメーションとモーション'
slug: bai-13-animations-va-motion
description: >-
  暗黙的なアニメーション、AnimatedContainer、AnimatedOpacity。明示的なアニメーション、AnimationController、Tween、CurvedAnimation。ヒーローのトランジション、時差アニメーション、Rive/Lottie。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: アニメーションとモーション</tspan>
  </text>
...
<h2 id="1-implicit"><strong>1. 暗黙的なアニメーション</strong></h2>
...
<h2 id="2-explicit"><strong>2. 明示的なアニメーション</strong></h2>
...
<h2 id="3-hero"><strong>3. ヒーローとページの遷移</strong></h2>
...
<h2 id="4-lottie"><strong>4.ロッティアニメーション</strong></h2>
...
<p>次の記事: <strong>カスタムペイントと高度なウィジェット</strong>。</p>
