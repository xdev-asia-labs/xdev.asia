...
title: 'レッスン 10: ローカル ストレージとオフライン ファースト'
slug: bai-10-local-storage-va-offline-first
description: >-
  SharedPreferences、Hive、Isar データベース。 SQL のドリフト
  (湿原)。オフラインファーストのアーキテクチャ、同期戦略。キャッシュ管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: ローカル ストレージとオフライン ファースト</tspan>
  </text>
...
<h2 id="1-shared-preferences"><strong>1. 共有設定</strong></h2>
...
<h2 id="2-hive"><strong>2. Hive — NoSQL ローカル データベース</strong></h2>
...
<h2 id="3-drift"><strong>3. ドリフト — タイプセーフな SQL</strong></h2>
...
<h2 id="4-offline-first"><strong>4. オフラインファーストのアーキテクチャ</strong></h2>
...
<p>次の記事: <strong>Firebaseの統合</strong>。</p>
