...
title: 'レッスン 11: Firebase の統合'
slug: bai-11-firebase-integration
description: >-
  FlutterFire CLI を使用した Firebase のセットアップ。 Cloud Firestore CRUD、リアルタイム リスナー。
  Firebase 認証、クラウド ストレージ、クラウド メッセージング。アナリティクス、クラッシュリティクス。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 11: Firebase の統合</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. Firebaseのセットアップ</strong></h2>
...
<h2 id="2-firestore"><strong>2.クラウドファイアストア</strong></h2>
...
<h2 id="3-storage"><strong>3. クラウドストレージ</strong></h2>
...
<h2 id="4-crashlytics"><strong>4. クラッシュリティクスと分析</strong></h2>
