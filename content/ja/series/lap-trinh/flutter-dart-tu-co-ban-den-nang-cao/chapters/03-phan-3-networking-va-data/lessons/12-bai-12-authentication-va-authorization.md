...
description: >-
  Firebase 認証: メール/パスワード、Google サインイン、Apple サインイン。 JWT
  トークン管理。認証状態の永続化。役割ベースのアクセス制御。生体認証。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 12
section_title: 'パート 3: ネットワーキングとデータ'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: 認証と認可</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 3: ネットワーキングとデータ</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-firebase-auth"><strong>1. Firebase認証</strong></h2>
...
<h2 id="2-auth-state"><strong>2. Riverpod による認証状態</strong></h2>
...
<h2 id="3-jwt"><strong>3. JWTトークン管理</strong></h2>
...
<h2 id="4-biometric"><strong>4. 生体認証</strong></h2>
...
<p>次の記事: <strong>アニメーションとモーション</strong>。</p>
