...
title: 'レッスン 9: HTTP と REST API の統合'
slug: bai-9-http-va-rest-api-integration
description: >-
  Dio HTTP クライアント、インターセプター、再試行。 json_serializable/freez による JSON シリアル化。リポジトリ
  パターン、エラー処理。ページネーション、無限スクロール。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 9: HTTP と REST API の統合</tspan>
  </text>
...
<h2 id="1-dio"><strong>1.Dio HTTPクライアント</strong></h2>
...
<h2 id="2-models"><strong>2. JSON シリアル化</strong></h2>
...
<h2 id="3-repository"><strong>3. リポジトリパターン</strong></h2>
...
<h2 id="4-pagination"><strong>4. Riverpod による無限スクロール</strong></h2>
...
<p>次の記事: <strong>ローカルストレージとオフラインファースト</strong>。</p>
