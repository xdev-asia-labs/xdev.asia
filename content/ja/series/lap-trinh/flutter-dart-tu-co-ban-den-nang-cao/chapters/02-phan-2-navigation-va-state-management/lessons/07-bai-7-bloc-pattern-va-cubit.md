...
title: 'レッスン 7: ブロック パターンとキュービット'
slug: bai-7-bloc-pattern-va-cubit
description: >-
  ブロック パターン、イベント、状態。キュービット対ブロック。
  BlocProvider、BlocBuilder、BlocListener、BlocConsumer。
  MultiBlocProvider、ブロック間通信。水和ブロック。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 7: ブロック パターンとキュービット</tspan>
  </text>
...
<h2 id="1-cubit"><strong>1. Cubit — シンプルな状態管理</strong></h2>
...
<h2 id="2-bloc"><strong>2. ブロック — イベント駆動型</strong></h2>
...
<h2 id="4-hydrated"><strong>4. 水和ブロック — 状態を維持する</strong></h2>
...
<p>次の記事: <strong>フォーム、検証、テーマ設定</strong>。</p>
