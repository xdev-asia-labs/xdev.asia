...
title: 'レッスン 8: フォーム、検証、テーマ設定'
slug: bai-8-forms-validation-va-theming
description: >-
  フォーム ウィジェット、TextFormField、検証。
  flutter_form_builder、カスタムフォームフィールド。テーマデータ、カラースキーム、テキストテーマ。ダークモード、ダイナミックテーマ。カスタムフォント、資料3。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: フォーム、検証、テーマ設定</tspan>
  </text>
...
<h2 id="1-forms"><strong>1. フォームと検証</strong></h2>
...
<h2 id="2-form-builder"><strong>2.フラッターフォームビルダー</strong></h2>
...
<h2 id="3-theming"><strong>3. テーマデータとマテリアル 3</strong></h2>
...
<h2 id="4-dynamic-theme"><strong>4. 動的なテーマ</strong></h2>
...
<p>次の記事: <strong>HTTP と REST API の統合</strong>。</p>
