...
title: 'レッスン 21: CI/CD とアプリの署名'
slug: bai-21-cicd-va-app-signing
description: >-
  Android キーストアとアプリ署名。 iOS 証明書とプロビジョニング プロファイル。 Flutter の GitHub
  アクション。ファストレーンの自動化。コードマジック、アプリセンター。フレーバー/環境構成。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 プログラミング — レッスン 21</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 21: CI/CD とアプリの署名</tspan>
  </text>
...
<h2 id="1-android-signing"><strong>1. Android アプリの署名</strong></h2>
...
<h2 id="2-flavors"><strong>2. フレーバーを構築する</strong></h2>
...
<h2 id="4-fastlane"><strong>4. ファストレーンの自動化</strong></h2>
...
<p>次の記事: <strong>App Store と Google Play に公開する</strong>。</p>
