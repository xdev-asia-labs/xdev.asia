...
title: 'レッスン 22: App Store と Google Play に公開する'
slug: bai-22-publish-len-app-store-va-google-play
description: >-
  Google Play Console: リスト、スクリーンショット、リリース トラック。 App Store Connect:
  メタデータ、TestFlight。アプリのレビューガイドライン。バージョン管理戦略、段階的なロールアウト。打ち上げ後のモニタリング。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 プログラミング — レッスン 22</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 22: App Store と Google に公開する</tspan>
      <tspan x="60" dy="42">遊ぶ</tspan>
  </text>
...
<h2 id="1-pre-publish"><strong>1. 公開前の準備</strong></h2>
...
<table>
<thead><tr><th>チェックリスト</th><th>アンドロイド</th><th>iOS</th></tr></thead>
<tbody>
<tr><td>アプリアイコン</td><td>あらゆるサイズのアダプティブアイコン</td><td>1024x1024 + サイズ</td></tr>
<tr><td>スプラッシュスクリーン</td><td>flutter_native_splash</td><td>flutter_native_splash</td></tr>
<tr><td>権限</td><td>AndroidManifest.xml</td><td>情報plist</td></tr>
<tr><td>プロガード</td><td>proguard-rules.pro</td><td>該当なし</td></tr>
<tr><td>署名</td><td>キーストア + key.properties</td><td>証明書 + プロファイル</td></tr>
</tbody>
</table>

<h2 id="2-google-play"><strong>2.Google Playコンソール</strong></h2>
...
<h2 id="3-app-store"><strong>3. App Store コネクト</strong></h2>
...
<h2 id="4-versioning"><strong>4. バージョン管理と段階的ロールアウト</strong></h2>
...
<h2 id="5-monitoring"><strong>5. 打ち上げ後のモニタリング</strong></h2>
...
<p>シリーズ完結おめでとうございます <strong>フラッター＆ダーツ: 基本から上級まで</strong>！ 🎉</p>
