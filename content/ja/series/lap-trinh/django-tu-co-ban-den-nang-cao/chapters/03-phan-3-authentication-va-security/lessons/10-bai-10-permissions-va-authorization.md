...
description: >-
  DRF 権限
  (IsAuthenticated、IsAdminUser、カスタム)。オブジェクトレベルの権限、django-guardian。ロールベースのアクセス制御
  (RBAC)、Django グループ。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 プログラミング — レッスン 10</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: 権限と認可</tspan>
  </text>
...
<h2 id="1-drf-permissions"><strong>1. DRF 組み込み権限</strong></h2>
...
<h2 id="2-custom-permissions"><strong>2. カスタム権限</strong></h2>
...
<h2 id="3-django-groups"><strong>3. Django グループと権限</strong></h2>
...
<h2 id="4-object-level"><strong>4. オブジェクトレベルの権限</strong></h2>
...
<h2 id="5-rbac"><strong>5. 役割ベースのアクセス制御</strong></h2>
...
<p>次の記事: <strong>ソーシャル認証とOAuth2</strong>。</p>
