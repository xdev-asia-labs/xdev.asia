...
description: >-
  ViewSet (ModelViewSet、ReadOnlyModelViewSet、カスタム アクション)。 DefaultRouter, nested
  routers. django-filter を使用したページネーションのスタイル、フィルタリング、順序付け。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 プログラミング — レッスン 6</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 6: ビューセット、ルーター、ページネーション</tspan>
  </text>
...
<h2 id="1-viewsets"><strong>1. ビューセット</strong></h2>
...
<h2 id="2-router"><strong>2.ルーター</strong></h2>
...
<h2 id="3-pagination"><strong>3. ページネーション</strong></h2>
...
<h2 id="4-filtering"><strong>4. フィルタリングと順序付け</strong></h2>
...
<p>次の記事: <strong>高度なシリアライザーと検証</strong>。</p>
