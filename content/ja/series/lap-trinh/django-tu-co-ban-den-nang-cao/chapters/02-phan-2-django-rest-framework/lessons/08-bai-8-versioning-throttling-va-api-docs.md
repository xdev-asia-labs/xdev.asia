...
description: >-
  API のバージョン管理戦略 (URL、ヘッダー、名前空間)。スロットルによるレート制限。 drf-spectacular を使用した
  Swagger/OpenAPI ドキュメント。 API のベスト プラクティス、CORS 構成。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 8
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 プログラミング — レッスン 8</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: バージョニング、スロットリング、API ドキュメント</tspan>
  </text>
...
<h2 id="1-versioning"><strong>1. API のバージョン管理</strong></h2>
...
<h2 id="2-throttling"><strong>2. スロットリング (レート制限)</strong></h2>
...
<h2 id="3-api-docs"><strong>3. drf-spectacular を使用した API ドキュメント</strong></h2>
...
<p>次の記事: <strong>認証 - セッション、トークン、JWT</strong>。</p>
