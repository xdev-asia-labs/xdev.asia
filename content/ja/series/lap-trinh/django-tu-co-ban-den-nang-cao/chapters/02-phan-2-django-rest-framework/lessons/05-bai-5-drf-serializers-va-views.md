...
title: 'レッスン 5: DRF シリアライザーとビュー'
slug: bai-5-drf-serializers-va-views
description: >-
  DRF セットアップ、シリアライザー (シリアライザー、ModelSerializer、ネストされたシリアライザー)。
  APIView、GenericAPIView、ミックスイン。リクエスト/レスポンス オブジェクト、ステータス コード、コンテンツ ネゴシエーション。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 プログラミング — レッスン 5</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 5: DRF シリアライザーとビュー</tspan>
  </text>
...
<h2 id="1-setup"><strong>1.DRFをインストールする</strong></h2>
...
<h2 id="2-serializers"><strong>2. シリアライザー</strong></h2>
...
<h2 id="3-apiview"><strong>3. APIビュー</strong></h2>
...
<h2 id="4-genericapiview"><strong>4. GenericAPIView とミックスイン</strong></h2>
...
<h2 id="5-urls"><strong>5. URLの設定</strong></h2>
...
<p>次の記事: <strong>ビューセット、ルーター、ページネーション</strong> — 最適化された API ビュー。</p>
