...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 3: ビュー、URL、テンプレート</tspan>
  </text>
...
<h2 id="1-fbv"><strong>1. 機能ベースのビュー</strong></h2>
...
<h2 id="2-urls"><strong>2. URLルーティング</strong></h2>
...
<h2 id="3-templates"><strong>3. Django テンプレート言語</strong></h2>
...
<h2 id="4-custom-tags"><strong>4. カスタムテンプレートのタグとフィルター</strong></h2>
...
<h2 id="5-static-media"><strong>5. 静的ファイルとメディア ファイル</strong></h2>
...
<p>次の記事: <strong>クラスベースのビューとフォーム</strong> — ListView、CreateView、ModelForms。</p>
