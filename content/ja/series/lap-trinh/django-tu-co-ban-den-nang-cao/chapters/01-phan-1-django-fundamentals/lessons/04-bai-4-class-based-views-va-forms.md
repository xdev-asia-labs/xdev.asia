...
description: >-
  クラスベースのビュー (ListView、DetailView、CreateView、UpdateView、DeleteView)。 Django
  フォーム、ModelForms、フォームセット。 CSRF 保護、フォーム検証、ファイルのアップロード。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: クラスベースのビューとフォーム</tspan>
  </text>
...
<h2 id="1-cbv"><strong>1. クラスベースのビュー</strong></h2>
...
<h2 id="2-forms"><strong>2. ジャンゴフォーム</strong></h2>
...
<h2 id="3-form-view"><strong>3. ビュー内のフォーム</strong></h2>
...
<h2 id="4-formsets"><strong>4. フォームセット</strong></h2>
...
<h2 id="5-file-upload"><strong>5. ファイルのアップロード</strong></h2>
...
<p>次の記事: <strong>DRF シリアライザーとビュー</strong> — Django REST フレームワークのセットアップ。</p>
