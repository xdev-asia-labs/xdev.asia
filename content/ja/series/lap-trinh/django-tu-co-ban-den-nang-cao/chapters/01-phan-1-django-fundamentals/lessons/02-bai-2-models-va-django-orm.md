...
video_url: null
sort_order: 2
section_title: 'パート 1: Django の基礎'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 プログラミング — レッスン 2</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 2: モデルと Django ORM</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: Django の基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-model-fields"><strong>1. モデルフィールド</strong></h2>
...
<h2 id="3-queryset"><strong>3. クエリセット API</strong></h2>
...
<h2 id="4-managers"><strong>4. カスタムマネージャー</strong></h2>
...
<h2 id="5-migrations"><strong>5. 移行</strong></h2>
...
<p>次の記事: <strong>ビュー、URL、テンプレート</strong> — FBV、URL ルーティング、テンプレート言語。</p>
