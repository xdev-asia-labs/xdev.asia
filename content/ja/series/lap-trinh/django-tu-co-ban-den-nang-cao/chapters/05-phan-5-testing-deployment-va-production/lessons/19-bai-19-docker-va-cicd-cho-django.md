...
description: >-
  Django アプリケーションを Docker 化します。 Docker Compose (Django + PostgreSQL + Redis +
  Celery)。 GitHub アクション CI/CD パイプライン。複数段階のビルド、環境管理。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: Django の Docker と CI/CD</tspan>
  </text>
...
<h2 id="1-dockerfile"><strong>1. Dockerfile (多段階)</strong></h2>
...
<p>次の記事: <strong>実稼働環境の導入と監視</strong>。</p>
