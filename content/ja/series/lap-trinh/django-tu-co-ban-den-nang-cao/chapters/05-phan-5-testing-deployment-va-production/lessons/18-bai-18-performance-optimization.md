...
description: >-
  Django デバッグ ツールバー、クエリの最適化。 N+1
  クエリの問題、select_関連/プリフェッチ関連。データベースのインデックス作成、クエリプロファイリング。接続プーリング、リードレプリカ。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">💻 プログラミング — レッスン 18</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 18: パフォーマンスの最適化</tspan>
  </text>
...
<h2 id="1-debug-toolbar"><strong>1. Django デバッグツールバー</strong></h2>
...
<h2 id="2-query-optimization"><strong>2. クエリの最適化</strong></h2>
...
<h2 id="3-aggregation"><strong>3. 集計と注釈付け</strong></h2>
...
<h2 id="4-indexing"><strong>4. データベースのインデックス作成</strong></h2>
...
<h2 id="5-connection-pooling"><strong>5. 接続プーリングとリードレプリカ</strong></h2>
...
<p>次の記事: <strong>Django 用の Docker と CI/CD</strong>。</p>
