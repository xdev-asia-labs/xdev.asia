...
description: >-
  Django ファイル ストレージ (ローカル、django-storages を備えた S3)。電子メール バックエンド
  (SMTP、SES)。プッシュ通知、アプリ内通知、通知設定。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: ファイル ストレージ、電子メール、</tspan>
...
<h2 id="1-file-storage"><strong>1. ファイルストレージ</strong></h2>
...
<h2 id="2-custom-storage"><strong>2. カスタム ストレージ バックエンド</strong></h2>
...
<h2 id="3-email"><strong>3. 電子メールバックエンド</strong></h2>
...
<h2 id="4-notifications"><strong>4. アプリ内通知</strong></h2>
...
<p>次の記事: <strong>Django でのテスト</strong>。</p>
