...
title: 'レッスン 4: ディレクティブ、レンダリング、およびテンプレート参照'
slug: bai-4-directives-rendering-va-template-refs
description: >-
  v-if、v-for、v-show、v-bind、v-on。カスタムディレクティブ。テンプレート参照、nextTick。レンダリング関数、JSX。テレポート、サスペンス、キープアライブ。動的/非同期コンポーネント。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: ディレクティブ、レンダリング、テンプレート</tspan>
      <tspan x="60" dy="42">参照</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: Vue.js の基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-directives"><strong>1. 組み込みディレクティブ</strong></h2>
...
<h2 id="2-custom-directives"><strong>2. カスタムディレクティブ</strong></h2>
...
<h2 id="3-template-refs"><strong>3. テンプレート参照</strong></h2>
...
<h2 id="4-teleport"><strong>4. テレポーテーション</strong></h2>
...
<h2 id="5-keep-alive"><strong>5. キープアライブおよび動的コンポーネント</strong></h2>
...
<h2 id="6-suspense"><strong>6. サスペンス</strong></h2>
...
<p>次の記事: <strong>Vueルーターの詳細</strong> — ルーティング、ガード、遅延読み込み。</p>
