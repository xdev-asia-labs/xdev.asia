...
title: 'レッスン 9: Nuxt 3 とファイルベースのルーティング'
slug: bai-9-nuxt-3-va-file-based-routing
description: >-
  Nuxt 3 の概要、自動インポート、ファイルベースのルーティング。レイアウト、ページ、エラー処理。 nuxt.config.ts、ランタイム設定。
  Nuxt 開発ツール。ディレクトリ構造。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#38bdf8">💻 プログラミング — レッスン 9</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 9: Nuxt 3 とファイルベースのルーティング</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. Nuxt 3 プロジェクトの作成</strong></h2>
...
<h2 id="2-structure"><strong>2. ディレクトリ構造</strong></h2>
...
<h2 id="3-routing"><strong>3. ファイルベースのルーティング</strong></h2>
...
<h2 id="6-auto-imports"><strong>6. 自動インポート</strong></h2>
...
<h2 id="7-error"><strong>7. エラー処理</strong></h2>
...
<p>次の記事: <strong>データ取得とSSR</strong> — useFetch、useAsyncData、レンダリング モード。</p>
