...
title: 'レッスン 12: ミドルウェア、プラグイン、モジュール'
slug: bai-12-middleware-plugins-va-modules
description: >-
  ルートミドルウェア、サーバーミドルウェア。 Nuxt プラグイン、ライフサイクル。 Nuxt モジュール エコシステム
  (@nuxtjs/i18n、@nuxt/image、@nuxt/content)。カスタムモジュールの開発。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: ミドルウェア、プラグイン、モジュール</tspan>
  </text>
...
<h2 id="1-route-middleware"><strong>1.ルートミドルウェア</strong></h2>
...
<h2 id="2-plugins"><strong>2. Nuxtプラグイン</strong></h2>
...
<h2 id="3-modules"><strong>3. Nuxt モジュールのエコシステム</strong></h2>

<table>
<thead><tr><th>モジュール</th><th>機能</th></tr></thead>
<tbody>
<tr><td>@nuxtjs/tailwindcss</td><td>Tailwind CSS の統合</td></tr>
<tr><td>@ピニア/nuxt</td><td>ピニア州の管理</td></tr>
<tr><td>@nuxt/画像</td><td>画像の最適化</td></tr>
<tr><td>@nuxt/コンテンツ</td><td>ファイルベースのCMS</td></tr>
<tr><td>@nuxtjs/i18n</td><td>国際化</td></tr>
<tr><td>@sidebase/nuxt-auth</td><td>認証</td></tr>
<tr><td>nuxt-auth-utils</td><td>OAuth ヘルパー</td></tr>
<tr><td>@nuxt/フォント</td><td>フォントの最適化</td></tr>
<tr><td>@nuxt/スクリプト</td><td>サードパーティのスクリプト</td></tr>
</tbody>
</table>
...
<h2 id="4-custom-module"><strong>4. カスタムモジュール</strong></h2>
...
<p>次の記事: <strong>認証と認可</strong> — OAuth、セッション、RBAC。</p>
