...
title: 'レッスン 16: リアルタイム、WebSocket、i18n'
slug: bai-16-real-time-websockets-va-i18n
description: >-
  WebSocket 統合、Socket.IO。サーバー送信イベント、ポーリング。 @nuxtjs/i18n、ロケールルーティング、メッセージフォーマット。
  CMS の @nuxt/content。 PWAのサポート。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#c084fc">💻 プログラミング — レッスン 16</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: リアルタイム、WebSocket、i18n</tspan>
  </text>
...
<h2 id="1-sse"><strong>1. サーバー送信イベント</strong></h2>
...
<h2 id="2-websocket"><strong>2. Nitro を使用した WebSocket</strong></h2>
...
<h2 id="4-nuxt-content"><strong>4. @nuxt/コンテンツ</strong></h2>
...
<p>次の記事: <strong>アニメーションとトランジション</strong> — Vue トランジション、GSAP、ページトランジション。</p>
