...
title: 'レッスン 14: Nuxt のデータベースと ORM'
slug: bai-14-database-va-orm-trong-nuxt
description: >-
  Drizzle ORM、Nuxt の Prisma。データベースの移行、シード。 D1/R2 (Cloudflare) 用の nuxt-hub。リポジトリ
  パターン、サーバー側 CRUD。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 14: Nuxt のデータベースと ORM</tspan>
  </text>
...
<h2 id="1-drizzle-setup"><strong>1.霧雨ORMのセットアップ</strong></h2>
...
<h2 id="2-migrations"><strong>2. 移行</strong></h2>
...
<h2 id="3-crud"><strong>3. CRUD操作</strong></h2>
...
<h2 id="4-nuxthub"><strong>4.NuxtHub (クラウドフレア)</strong></h2>
...
<p>次の記事: <strong>ファイルのアップロード、画像、SEO</strong> — アップロード、@nuxt/image、メタデータ。</p>
