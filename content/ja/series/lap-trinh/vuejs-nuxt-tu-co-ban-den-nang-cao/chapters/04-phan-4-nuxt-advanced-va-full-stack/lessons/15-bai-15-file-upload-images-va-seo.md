...
title: 'レッスン 15: ファイルのアップロード、画像、SEO'
slug: bai-15-file-upload-images-va-seo
description: >-
  ファイルアップロード処理、S3ストレージ。 @nuxt/image、レスポンシブ画像、遅延読み込み。
  useSeoMeta、useHeadによるSEO。サイトマップ、OG タグ、構造化データ (JSON-LD)。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 15: ファイルのアップロード、画像、SEO</tspan>
  </text>
...
<h2 id="1-upload"><strong>1. ファイルのアップロード</strong></h2>
...
<h2 id="3-seo"><strong>3. useSeoMeta による SEO</strong></h2>
...
<h2 id="4-sitemap"><strong>4. サイトマップの生成</strong></h2>
...
<p>次の記事: <strong>リアルタイム、WebSocket、i18n</strong> — リアルタイムのインタラクションと多言語。</p>
