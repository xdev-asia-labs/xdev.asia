...
title: 'レッスン 6: Pinia による状態管理'
slug: bai-6-state-management-voi-pinia
description: >-
  ピニア対ビュークス。ストア、状態、ゲッター、アクションを定義します。ストア構成、プラグイン。永続的な状態、devtools の統合。ストア
  パターン、モジュール型ストア。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fbbf24">💻 プログラミング — レッスン 6</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 6: Pinia による状態管理</tspan>
  </text>
...
<h2 id="1-setup"><strong>1.ピニアのセットアップ</strong></h2>
...
<h2 id="2-define-store"><strong>2. 店舗の定義</strong></h2>
...
<h2 id="3-usage"><strong>3.ストアを利用する</strong></h2>
...
<h2 id="4-store-composition"><strong>4. 店舗構成</strong></h2>
...
<h2 id="5-plugins"><strong>5.ピニアプラグイン</strong></h2>
...
<h2 id="6-options-syntax"><strong>6. オプション構文 (代替)</strong></h2>
...
<p>次の記事: <strong>構成可能で再利用可能なロジック</strong> — カスタム コンポーザブル、VueUse。</p>
