...
title: 'レッスン 17: アニメーションとトランジション'
slug: bai-17-animations-va-transitions
description: >-
  Vue トランジション、TransitionGroup。ページ遷移、レイアウト遷移。 GSAP、Motion One の統合。遷移 API
  を表示します。スクロール駆動のアニメーション。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 17: アニメーションとトランジション</tspan>
  </text>
...
<h2 id="1-transition"><strong>1. Vueの遷移</strong></h2>
...
<h2 id="2-transition-group"><strong>2. 遷移グループ</strong></h2>
...
<h2 id="3-page-transitions"><strong>3. ページ遷移 (Nuxt)</strong></h2>
...
<h2 id="4-gsap"><strong>4. GSAPの統合</strong></h2>
...
<h2 id="5-view-transitions"><strong>5. 遷移 API の表示</strong></h2>
...
<p>次の記事: <strong>高度なパターンとカスタム モジュール</strong> — レンダリングレス、レンダリング関数、カスタム モジュール。</p>
