...
title: 'レッスン 19: Vue と Nuxt のテスト'
slug: bai-19-testing-vue-va-nuxt
description: >-
  単体テスト用の Vitest。 Vue Test Utils、コンポーネントのテスト。 @nuxt/test-utils、Playwright E2E
  テスト。 API モック用の MSW。コンポーザブルのテスト、Pinia ストア。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: Vue と Nuxt のテスト</tspan>
  </text>
...
<h2 id="1-vitest-setup"><strong>1. Vitestをセットアップする</strong></h2>
...
<h2 id="2-component-testing"><strong>2. Vue Test Utils を使用したコンポーネントのテスト</strong></h2>
...
<h2 id="3-composable-testing"><strong>3. コンポーザブルのテスト</strong></h2>
...
<h2 id="4-pinia-testing"><strong>4. Pinia ストアのテスト</strong></h2>
...
<h2 id="5-msw"><strong>5. MSW を使用した API モック</strong></h2>
...
<h2 id="7-e2e"><strong>7. Playwright による E2E テスト</strong></h2>
...
<p>次の記事: <strong>パフォーマンスの最適化</strong> — バンドル分析、コード分割、キャッシュ。</p>
