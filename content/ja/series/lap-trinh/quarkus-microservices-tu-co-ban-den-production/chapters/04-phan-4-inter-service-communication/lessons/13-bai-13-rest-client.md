...
title: 'レッスン 13: REST クライアント — サービス間の同期通信'
slug: bai-13-rest-client-giao-tiep-dong-bo
description: MicroProfile REST クライアント、タイプセーフな REST 呼び出し、例外処理、タイムアウト構成、応答キャッシュ、および再試行ポリシー。
duration_minutes: 90
is_free: false
video_url: null
sort_order: 12
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 13: REST クライアント — 同期通信</tspan>
      <tspan x="60" dy="42">サービス間</tspan>
  </text>
