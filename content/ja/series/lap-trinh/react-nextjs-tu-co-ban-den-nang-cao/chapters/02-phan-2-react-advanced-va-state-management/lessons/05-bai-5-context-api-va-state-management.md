...
title: 'レッスン 5: コンテキスト API と状態管理'
slug: bai-5-context-api-va-state-management
description: >-
  コンテキスト API、プロバイダー パターン。グローバルステートのズスタンド。 TanStack サーバーの状態をクエリします。 Redux vs
  Zustand vs Jotai vs Recoil を比較してください。状態管理戦略。
duration_minutes: 150
is_free: true
video_url: null
sort_order: 5
section_title: 'パート 2: React Advanced と状態管理'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 5: コンテキスト API と状態管理</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 2: React Advanced と状態管理</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-context-api"><strong>1.コンテキストAPI</strong></h2>
...
<h2 id="2-zustand"><strong>2. ズスタンド — グローバルステート</strong></h2>
...
<h2 id="3-tanstack-query"><strong>3. TanStack クエリ — サーバーの状態</strong></h2>
...
<h2 id="4-so-sanh"><strong>4. 状態管理の比較</strong></h2>

<table>
<thead><tr><th>図書館</th><th>種類</th><th>バンドル</th><th>学習</th><th>こんな方に最適</th></tr></thead>
<tbody>
<tr><td>コンテキスト</td><td>内蔵</td><td>0KB</td><td>簡単</td><td>テーマ、認証、単純なグローバル状態</td></tr>
<tr><td>ズスタンド</td><td>クライアントの状態</td><td>～1KB</td><td>簡単</td><td>グローバルなクライアント状態、任意のサイズ</td></tr>
<tr><td>Redux ツールキット</td><td>クライアントの状態</td><td>～11KB</td><td>中</td><td>大規模なアプリ、複雑な状態</td></tr>
<tr><td>常体</td><td>アトミック</td><td>～2KB</td><td>簡単</td><td>原子状態、派生値</td></tr>
<tr><td>TanStackQuery</td><td>サーバーの状態</td><td>～12KB</td><td>中</td><td>API データ、キャッシュ、同期</td></tr>
</tbody>
</table>

<p><strong>戦略</strong>: クライアント状態には Zustand を使用し、サーバー状態には TanStack Query を使用します。コンテキストは単純なテーマ/認証のみです。</p>

<p>次の記事: <strong>React パターンとパフォーマンス</strong> — HOC、複合コンポーネント、React.memo、およびパフォーマンスの最適化。</p>
