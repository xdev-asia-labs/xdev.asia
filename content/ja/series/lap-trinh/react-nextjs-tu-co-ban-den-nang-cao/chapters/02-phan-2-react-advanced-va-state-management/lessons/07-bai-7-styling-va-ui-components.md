...
title: 'レッスン 7: スタイルと UI コンポーネント'
slug: bai-7-styling-va-ui-components
description: >-
  Tailwind CSS 統合、CSS モジュール。コンポーネント ライブラリ (shadcn/ui、Radix
  UI)。フレーマーモーションによるアニメーション。レスポンシブ デザイン、テーマ (ダーク モード)。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 7: スタイルと UI コンポーネント</tspan>
  </text>
...
<h2 id="1-tailwind-css"><strong>1. 追い風CSS</strong></h2>
...
<h2 id="3-framer-motion"><strong>3. フレーマーモーション</strong></h2>
...
<h2 id="4-dark-mode"><strong>4. ダークモード</strong></h2>
...
<p>次の記事: <strong>Next.js とアプリルーター</strong> — ファイルベースのルーティング、レイアウト、テンプレート、プロジェクト構造。</p>
