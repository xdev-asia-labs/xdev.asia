...
title: 'レッスン 12: NextAuth.js による認証'
slug: bai-12-authentication-voi-nextauthjs
description: >-
  NextAuth.js (Auth.js) のセットアップ。 OAuth プロバイダー (Google、GitHub)。認証情報プロバイダー、JWT
  とセッション。ミドルウェア保護、ロールベースのアクセス制御。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 12: NextAuth.js による認証</tspan>
  </text>
...
<h2 id="1-setup-authjs"><strong>1. Auth.js のセットアップ (NextAuth v5)</strong></h2>
...
<h2 id="2-route-handler"><strong>2. ルートハンドラー</strong></h2>
...
<h2 id="3-middleware"><strong>3. ミドルウェアの保護</strong></h2>
...
<h2 id="4-server-component"><strong>4. サーバーコンポーネントでの使用</strong></h2>
...
<h2 id="5-client-component"><strong>5. クライアントコンポーネントでの使用</strong></h2>
...
<h2 id="6-rbac"><strong>6. 役割ベースのアクセス制御</strong></h2>
...
<h2 id="7-login-form"><strong>7. サーバーアクションを含むログインフォーム</strong></h2>
...
<p>次の記事: <strong>ミドルウェア、API ルート、ルート ハンドラー</strong> — 高度なリクエスト/レスポンス処理。</p>
