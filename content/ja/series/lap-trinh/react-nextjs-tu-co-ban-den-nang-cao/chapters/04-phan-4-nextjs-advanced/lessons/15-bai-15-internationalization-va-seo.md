...
title: 'レッスン 15: 国際化と SEO'
slug: bai-15-internationalization-va-seo
description: >-
  Next.js i18n ルーティング、next-intl。動的メタデータ API。 OpenGraph、Twitter カード。 JSON-LD
  構造化データ。サイトマップ、robots.txt の生成。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 プログラミング — レッスン 15</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 15: 国際化と SEO</tspan>
  </text>
...
<h2 id="1-i18n-routing"><strong>1. i18n ルーティング</strong></h2>
...
<h2 id="2-translations"><strong>2. 翻訳ファイル</strong></h2>
...
<h2 id="3-metadata"><strong>3. 動的メタデータ API</strong></h2>
...
<h2 id="4-json-ld"><strong>4. JSON-LD構造化データ</strong></h2>
...
<h2 id="5-sitemap"><strong>5. サイトマップとロボット</strong></h2>
...
<p>次の記事: <strong>ファイルのアップロードと画像の最適化</strong> — ファイル、次の画像、レスポンシブ画像をアップロードします。</p>
