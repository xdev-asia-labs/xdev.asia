...
title: 'レッスン 16: ファイルのアップロードと画像の最適化'
slug: bai-16-file-upload-va-image-optimization
description: >-
  サーバーアクションを使用したファイルのアップロード。 next/image コンポーネント、レスポンシブ画像。クラウドストレージ
  (S3、Cloudinary)。画像の最適化戦略。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: ファイルのアップロードと画像の最適化</tspan>
  </text>
...
<h2 id="1-upload-server-action"><strong>1. サーバーアクションによるファイルアップロード</strong></h2>
...
<h2 id="2-upload-form"><strong>2. フォームコンポーネントをアップロードする</strong></h2>
...
<h2 id="3-next-image"><strong>3. next/imageコンポーネント</strong></h2>
...
<h2 id="4-next-config"><strong>4. イメージコンフィグレーション</strong></h2>
...
<h2 id="5-s3-upload"><strong>5.S3にアップロードする</strong></h2>
...
<p>次の記事: <strong>リアルタイムと WebSocket</strong> — リアルタイムのインタラクション。</p>
