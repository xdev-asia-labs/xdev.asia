...
title: 'レッスン 18: 電子メール、支払い、サードパーティの統合'
slug: bai-18-email-payment-va-third-party
description: >-
  Resend & React Email を使用してメールを送信します。 Stripe
  決済の統合。チェックアウトの流れ、サブスクリプション。サードパーティの SDK パターン。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 18: 電子メール、支払い、サードパーティ</tspan>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 5: フルスタック機能</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-resend"><strong>1. 再送信付きメール</strong></h2>
...
<h2 id="2-stripe-setup"><strong>2. Stripe 支払いの設定</strong></h2>
...
<h2 id="3-checkout"><strong>3. チェックアウトの流れ</strong></h2>
...
<h2 id="4-webhook"><strong>4. ストライプ Webhook</strong></h2>
...
<h2 id="5-subscription"><strong>5. サブスクリプション管理</strong></h2>
...
<p>次の記事: <strong>React と Next.js のテスト</strong> — 単体テスト、統合テスト、E2E。</p>
