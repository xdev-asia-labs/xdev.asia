...
description: >-
  コア Web Vitals の最適化。 React.lazy、動的インポート。バンドル分析、ツリーシェイク。メモ化パターン。画像/フォントの最適化、CDN
  戦略。
...
<h2 id="1-core-web-vitals"><strong>1. コアウェブバイタル</strong></h2>

<table>
<thead><tr><th>メトリック</th><th>説明</th><th>良い</th><th>改善方法</th></tr></thead>
<tbody>
<tr><td>LCP</td><td>最大のコンテンツ豊富なペイント</td><td>< 2.5秒</td><td>優先画像、プリロードフォント</td></tr>
<tr><td>INP</td><td>次のペイントへのインタラクション</td><td>< 200ms</td><td>JS を減らし、トランジションを使用する</td></tr>
<tr><td>CLS</td><td>累積レイアウトシフト</td><td>< 0.1</td><td>画像サイズを設定し、FOUT を回避する</td></tr>
</tbody>
</table>

<h2 id="2-dynamic-import"><strong>2. 動的インポートとコード分割</strong></h2>
...
<h2 id="3-memoization"><strong>3. メモ化パターン</strong></h2>
...
<h2 id="4-bundle-analysis"><strong>4. バンドル分析</strong></h2>
...
<h2 id="5-font-optimization"><strong>5. フォントの最適化</strong></h2>
...
<h2 id="6-caching"><strong>6. ヘッダーのキャッシュ</strong></h2>
...
<h2 id="7-react-compiler"><strong>7. React コンパイラー (実験的)</strong></h2>
...
<p>次の記事: <strong>Docker と CI/CD</strong> — コンテナ化、GitHub Actions、Vercel デプロイメント。</p>
