...
title: 'レッスン 17: Livewire — フルスタック コンポーネント'
slug: bai-17-livewire-full-stack-components
description: >-
  Livewire
  3、ワイヤー:モデル、ワイヤー:クリック。コンポーネントのライフサイクル、リアクティブなプロパティ。ファイルのアップロード、ページネーション。遅延読み込み、ポーリング。
  Alpine.js の統合。スパのような体験。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 17: Livewire — フルスタック コンポーネント</tspan>
  </text>
...
<h2 id="1-setup"><strong>1. Livewire 3 のセットアップ</strong></h2>

<pre><code class="language-bash">composer require livewire/livewire
php artisan make:livewire ProductSearch
</code></pre>

<h2 id="2-component"><strong>2. ライブワイヤーコンポーネント</strong></h2>
...
<h2 id="3-actions"><strong>3. アクションとイベント</strong></h2>
...
<h2 id="4-file-upload"><strong>4. ファイルのアップロード</strong></h2>
...
<h2 id="5-alpine"><strong>5. Alpine.js の統合</strong></h2>
...
<p>次の記事: <strong>Inertia.js と Vue/React の統合</strong>。</p>
