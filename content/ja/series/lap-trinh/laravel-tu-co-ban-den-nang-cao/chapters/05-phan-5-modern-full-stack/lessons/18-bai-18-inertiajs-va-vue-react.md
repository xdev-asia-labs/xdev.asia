...
title: 'レッスン 18: Inertia.js と Vue/React の統合'
slug: bai-18-inertiajs-va-vue-react
description: >-
  Inertia.js モノリス アーキテクチャ。 Laravel + Vue/React
  SPA。共有データ、フォームヘルパー、ファイルアップロード。サーバー側のレンダリング。慣性対ライブワイヤー対従来の SPA。
duration_minutes: 120
is_free: true
video_url: null
sort_order: 18
section_title: 'パート 5: 最新のフルスタック'
course:
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#a78bfa">💻 プログラミング — レッスン 18</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 18: Inertia.js と Vue/React の統合</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 5: 最新のフルスタック</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-setup"><strong>1. Inertia.js のセットアップ</strong></h2>
...
<h2 id="2-vue-pages"><strong>2. Vue ページ</strong></h2>
...
<h2 id="3-forms"><strong>3. 慣性形式</strong></h2>
...
<h2 id="4-shared-data"><strong>4. 共有データ</strong></h2>
...
<h2 id="5-comparison"><strong>5. ライブワイヤー vs 慣性</strong></h2>

<table>
<thead><tr><th>特長</th><th>ライブワイヤー</th><th>慣性</th></tr></thead>
<tbody>
<tr><td>フロントエンド</td><td>ブレード + Alpine.js</td><td>Vue/React</td></tr>
<tr><td>スパフィール</td><td>良い</td><td>とても良い</td></tr>
<tr><td>学習曲線</td><td>低い</td><td>平均</td></tr>
<tr><td>JSエコシステム</td><td>制限事項</td><td>フル</td></tr>
<tr><td>SSR</td><td>自動的に</td><td>セットアップが必要です</td></tr>
</tbody>
</table>

<p>次の記事: <strong>Laravelでのテスト</strong>。</p>
