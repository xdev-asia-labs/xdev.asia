...
title: 'レッスン 16: キャッシュ、セッション、パフォーマンス'
slug: bai-16-caching-sessions-va-performance
description: >-
  キャッシュドライバー (Redis、Memcached、ファイル)。キャッシュタグ、アトミックロック。セッション管理。 N+1 クエリ防止、クエリ監視。
  Laravel デバッグバー、テレスコープ。オクタン (Swoole/FrankenPHP)。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#fb923c">💻 プログラミング — レッスン 16</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: キャッシュ、セッション、パフォーマンス</tspan>
  </text>
...
<h2 id="1-caching"><strong>1. キャッシング</strong></h2>
...
<h2 id="2-n1-prevention"><strong>2. N+1 クエリの防止</strong></h2>
...
<h2 id="3-telescope"><strong>3. Laravel Telescope とデバッグバー</strong></h2>
...
<h2 id="4-octane"><strong>4.Laravel オクタン</strong></h2>
...
<h2 id="5-optimization"><strong>5. 生産の最適化</strong></h2>
...
<p>次の記事: <strong>Livewire — フルスタック コンポーネント</strong>。</p>
