...
title: 'レッスン 14: イベント、リスナー、ブロードキャスト'
slug: bai-14-events-listeners-va-broadcasting
description: >-
  イベント システム、イベント サブスクライバー。 Pusher/Laravel Reverbを使用したブロードキャスト。プライベート/プレゼンス
  チャネル。リアルタイム通知、WebSocket 統合。ララベルエコー。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 14: イベント、リスナー、ブロードキャスト</tspan>
  </text>
...
<h2 id="1-events"><strong>1. イベントとリスナー</strong></h2>
...
<h2 id="2-broadcasting"><strong>2. 放送</strong></h2>
...
<h2 id="3-laravel-echo"><strong>3. Laravel Echo (フロントエンド)</strong></h2>
...
<p>次の記事: <strong>通知、メール、スケジューラー</strong>。</p>
