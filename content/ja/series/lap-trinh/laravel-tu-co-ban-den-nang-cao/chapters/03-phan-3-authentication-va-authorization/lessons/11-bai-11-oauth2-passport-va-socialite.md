...
title: 'レッスン 11: OAuth2、パスポート、社交家'
slug: bai-11-oauth2-passport-va-socialite
description: >-
  Laravelパスポート（OAuth2サーバー）。社交家 (Google、GitHub、Facebook
  ログイン)。アカウントリンク、カスタムプロバイダー。 JWT 対パスポート トークン。 API スコープ。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 11: OAuth2、パスポート、社交家</tspan>
  </text>
...
<h2 id="1-socialite"><strong>1. Laravel 社交家</strong></h2>
...
<h2 id="2-passport"><strong>2.Laravelパスポート</strong></h2>
...
<h2 id="3-comparison"><strong>3. サンクタム vs パスポート</strong></h2>

<table>
<thead><tr><th>特長</th><th>サンクタム</th><th>パスポート</th></tr></thead>
<tbody>
<tr><td>SPA認証</td><td>✅</td><td>✅</td></tr>
<tr><td>APIトークン</td><td>✅ (シンプル)</td><td>✅ (OAuth2 フル)</td></tr>
<tr><td>OAuth2サーバー</td><td>❌</td><td>✅</td></tr>
<tr><td>サードパーティのアプリ</td><td>❌</td><td>✅</td></tr>
<tr><td>複雑さ</td><td>低い</td><td>高</td></tr>
</tbody>
</table>
