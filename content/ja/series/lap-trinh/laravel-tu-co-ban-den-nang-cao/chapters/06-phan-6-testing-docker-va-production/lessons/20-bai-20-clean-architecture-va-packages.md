...
title: 'レッスン 20: クリーンなアーキテクチャとパッケージ'
slug: bai-20-clean-architecture-va-packages
description: >-
  リポジトリ パターン、サービス層、アクション クラス。ドメイン駆動設計の基本。 Laravelパッケージの作成。モジュールベースの構造
  (nwidart/laravel-modules)。堅実な原則。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 20: クリーンなアーキテクチャとパッケージ</tspan>
  </text>
...
<h2 id="1-service-layer"><strong>1. サービス層</strong></h2>
...
<h2 id="2-action-classes"><strong>2. アクションクラス</strong></h2>
...
<h2 id="4-modules"><strong>4. モジュールベースの構造</strong></h2>
...
<p>次の記事: <strong>Docker と CI/CD</strong>。</p>
