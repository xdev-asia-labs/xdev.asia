...
title: 'レッスン 19: Laravel でのテスト'
slug: bai-19-testing-trong-laravel
description: >-
  PHPUnit、ペスト テスト フレームワーク。機能テスト、単体テスト。データベースのテスト、工場。 HTTP テスト、モック。ブラウザのテスト
  (Laravel Dusk)。コードカバレッジ。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: Laravel でのテスト</tspan>
  </text>
...
<h2 id="1-pest"><strong>1. 害虫検査の枠組み</strong></h2>
...
<h2 id="2-http-tests"><strong>2.HTTPテスト</strong></h2>
...
<h2 id="3-mocking"><strong>3. 嘲笑する</strong></h2>
...
<h2 id="4-coverage"><strong>4. コードカバレッジ</strong></h2>

<pre><code class="language-bash">php artisan test --coverage --min=80
php artisan test --parallel
</code></pre>

<p>次の記事: <strong>クリーンなアーキテクチャとパッケージ</strong>。</p>
