...
title: 'レッスン 2: ルーティング、コントローラー、ミドルウェア'
slug: bai-2-routing-controllers-va-middleware
description: >-
  ルート タイプ (GET、POST、PUT、DELETE)、ルート パラメーター。リソース
  コントローラー、呼び出し可能なコントローラー。ミドルウェア、ミドルウェア グループ。ルートモデルのバインディング、レート制限。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 2
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 2: ルーティング、コントローラー、ミドルウェア</tspan>
  </text>
...
<h2 id="1-routing"><strong>1. ルーティング</strong></h2>
...
<h2 id="2-controllers"><strong>2. コントローラー</strong></h2>
...
<h2 id="3-resource"><strong>3. リソースコントローラー</strong></h2>
...
<p>次の記事: <strong>ブレードテンプレートとフロントエンド</strong>。</p>
