...
title: 'レッスン 3: ブレード テンプレートとフロントエンド'
slug: bai-3-blade-templates-va-frontend
description: >-
  ブレードの構文、コンポーネント、レイアウト。ブレード ディレクティブ、カスタム ディレクティブ。アセットのバンドル (Vite)。 Tailwind CSS
  の統合。匿名コンポーネント、動的コンポーネント。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 3
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 3: ブレード テンプレートとフロントエンド</tspan>
  </text>
...
<h2 id="1-blade-syntax"><strong>1. ブレードの構文</strong></h2>
...
<h2 id="2-layouts"><strong>2. レイアウトとコンポーネント</strong></h2>
...
<h2 id="3-components"><strong>3. ブレードのコンポーネント</strong></h2>
...
<p>次の記事: <strong>雄弁な ORM と関係</strong>。</p>
