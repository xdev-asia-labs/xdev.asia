...
title: 'レッスン 4: 雄弁な ORM と関係'
slug: bai-4-eloquent-orm-va-relationships
description: >-
  雄弁なモデル、一括割り当て、論理的な削除。関係
  (hasOne、hasMany、belongsTo、belongsToMany、morphMany)。積極的な読み込み、クエリ
  スコープ、アクセサ/ミューテーター。キャスト。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 4: 雄弁な ORM と関係</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 1: Laravel の基礎</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-eloquent-model"><strong>1. 雄弁なモデル</strong></h2>
...
<h2 id="2-relationships"><strong>2. 人間関係</strong></h2>
...
<h2 id="3-eager-loading"><strong>3. 熱心な読み込み</strong></h2>
...
<h2 id="4-scopes"><strong>4. クエリのスコープ</strong></h2>
...
<p>次の記事: <strong>移行、シーディング、クエリビルダー</strong>。</p>
