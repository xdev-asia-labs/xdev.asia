...
title: 'レッスン 6: 検証とフォームリクエスト'
slug: bai-6-validation-va-form-requests
description: 検証ルール、カスタム検証。フォームリクエストクラス、認可。エラーメッセージ、ローカリゼーション。ファイル検証、条件付き検証。カスタム検証ルール。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 6
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 6: 検証とフォームリクエスト</tspan>
  </text>
...
<h2 id="1-validation"><strong>1. 基本的な検証</strong></h2>
...
<h2 id="2-form-request"><strong>2. フォームリクエスト</strong></h2>
...
<h2 id="3-custom-rule"><strong>3. カスタム検証ルール</strong></h2>
...
<h2 id="4-conditional"><strong>4. 条件付き検証</strong></h2>
...
<p>次の記事: <strong>API リソースと応答</strong>。</p>
