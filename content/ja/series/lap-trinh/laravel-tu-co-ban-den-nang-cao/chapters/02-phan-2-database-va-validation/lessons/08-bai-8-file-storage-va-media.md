...
title: 'レッスン 8: ファイル ストレージとメディア'
slug: bai-8-file-storage-va-media
description: >-
  ファイルシステムの抽象化 (ローカル、S3、GCS)。ファイルのアップロード、検証。スパティメディアライブラリ。画像操作 (介入画像)。一時
  URL、ストリーミング ダウンロード。
duration_minutes: 90
is_free: true
video_url: null
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#818cf8">💻 プログラミング — レッスン 8</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 8: ファイル ストレージとメディア</tspan>
  </text>
...
<h2 id="1-filesystem"><strong>1. ファイルシステム</strong></h2>
...
<h2 id="2-upload"><strong>2. ファイルのアップロード</strong></h2>
...
<h2 id="3-spatie-media"><strong>3.スパティメディアライブラリ</strong></h2>
...
<h2 id="4-image-manipulation"><strong>4. 介入イメージ</strong></h2>
...
<p>次の記事: <strong>認証 — Sanctum & Fortify</strong>。</p>
