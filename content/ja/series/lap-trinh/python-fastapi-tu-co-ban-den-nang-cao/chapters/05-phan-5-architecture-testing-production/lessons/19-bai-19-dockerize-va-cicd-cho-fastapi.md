...
description: >-
  FastAPI 用の Docker マルチステージ ビルド。開発および実稼働用の Docker Compose。 GitHub アクション CI/CD
  パイプライン。自動化されたテスト、リンティング、展開のワークフロー。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: FastAPI の Dockerize と CI/CD</tspan>
  </text>
...
<h2 id="1-dockerfile"><strong>1. Dockerfile の多段階ビルド</strong></h2>
...
<h2 id="3-github-actions"><strong>3. GitHub アクション CI/CD</strong></h2>
...
<h2 id="4-makefile"><strong>4. 開発者エクスペリエンスのための Makefile</strong></h2>
...
<h2 id="5-pre-commit"><strong>5. 事前コミットフック</strong></h2>
...
<ul>
<li><strong>Dockerマルチステージ</strong>: 軽量ビルド、実稼働対応 (非ルート、ヘルスチェック)</li>
<li><strong>Docker Compose</strong>: フルスタック (アプリ + DB + Redis + Celery)</li>
<li><strong>GitHub アクション</strong>: Lint → テスト → ビルド → パイプラインのデプロイ</li>
<li><strong>メイクファイル</strong>: 開発者ショートカット</li>
<li><strong>事前コミット</strong>: コミットする前にコードの品質を確保する</li>
</ul>
