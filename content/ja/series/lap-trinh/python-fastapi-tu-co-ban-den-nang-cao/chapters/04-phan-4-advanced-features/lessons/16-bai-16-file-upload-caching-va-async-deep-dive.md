...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 プログラミング — レッスン 16</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 16: ファイルのアップロード、キャッシュ、非同期の詳細</tspan>
      <tspan x="60" dy="42">ダイブ</tspan>
  </text>
...
<h2 id="1-file-upload"><strong>1. ファイルのアップロード</strong></h2>
...
<h2 id="2-redis-caching"><strong>2. Redis キャッシュ</strong></h2>
...
<h3 id="custom-cache"><strong>カスタム キャッシュ ヘルパー</strong></h3>
...
<h2 id="3-async-deep-dive"><strong>3. 非同期の詳細な説明</strong></h2>

<h3 id="concurrent-tasks"><strong>同時タスク</strong></h3>
...
<h3 id="semaphore"><strong>セマフォ - 同時実行制限</strong></h3>
...
<h3 id="async-generator"><strong>ストリーミング用の非同期ジェネレーター</strong></h3>
...
<h2 id="4-httpx-client"><strong>4. httpx - 非同期 HTTP クライアント</strong></h2>
...
<p>この記事では、以下について詳しく説明します。</p>

<ul>
<li><strong>ファイルのアップロード</strong>: 単一、複数、ストリーミング アップロード</li>
<li><strong>Redis キャッシング</strong>: fastapi-cache2 およびカスタム キャッシュ サービス</li>
<li><strong>非同期の詳細</strong>: 収集、セマフォ、非同期ジェネレーター</li>
<li><strong>httpx</strong>: 再利用可能な非同期 HTTP クライアント</li>
</ul>

<p>次の記事では、大規模アプリのクリーン アーキテクチャとプロジェクト構造について説明します。</p>
