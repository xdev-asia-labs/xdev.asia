...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#34d399">💻 プログラミング — レッスン 6</text>

  <!-- Title -->
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 6: SQLAlchemy 2.0 と非同期データベース</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="246" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 2: Pydantic、データベース、ORM</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-sqlalchemy-2-overview"><strong>1. SQLAlchemy 2.0 - 概要</strong></h2>

<p>SQLAlchemy 2.0 は、ネイティブ非同期サポート、新しいスタイルのクエリ API、型ヒントの改善など、多くの重要な変更が加えられた新しいメジャー リリースです。これは、Python エコシステムで最も人気のある ORM です。</p>
...
<h2 id="2-database-setup"><strong>2. 非同期エンジンを使用したデータベースのセットアップ</strong></h2>
...
<h2 id="4-async-queries"><strong>4. 非同期クエリ</strong></h2>
...
<h2 id="5-fastapi-integration"><strong>5. FastAPIとの統合</strong></h2>
...
<h2 id="6-lifespan"><strong>6. ライフスパン イベント - データベースの初期化</strong></h2>
...
<ul>
<li><strong>非同期エンジン</strong>: asyncpg、接続プーリングを使用してデータベースを接続します</li>
<li><strong>宣言的モデル</strong>: 新しい Mapped[] スタイルと mapped_column() スタイル</li>
<li><strong>人間関係</strong>: 1対1、1対多、多対多</li>
<li><strong>非同期クエリ</strong>: select()、where()、join()、即時読み込み</li>
<li><strong>リポジトリパターン</strong>: 標準の CRUD 操作</li>
<li><strong>FastAPI統合</strong>: データベースセッションの depends()</li>
</ul>

<p>次の記事では、Alembic の移行とデータベースのシード処理について説明します。</p>
