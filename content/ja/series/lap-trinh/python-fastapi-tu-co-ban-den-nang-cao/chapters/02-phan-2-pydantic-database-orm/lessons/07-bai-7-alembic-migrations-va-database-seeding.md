...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="92" y="69" font-family="system-ui,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#2dd4bf">💻 プログラミング — レッスン 7</text>

  <!-- Title -->
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 7: Alembic の移行とデータベース</tspan>
      <tspan x="60" dy="42">種まき</tspan>
  </text>
...
<h2 id="1-alembic-setup"><strong>1. Alembic のインストールと設定</strong></h2>

<h3 id="cai-dat"><strong>インストール</strong></h3>
...
<h3 id="config-alembic-ini"><strong>alembic.ini を構成する</strong></h3>
...
<h3 id="env-py"><strong>非同期 SQLAlchemy 用に env.py を構成する</strong></h3>
...
<h2 id="2-tao-migrations"><strong>2. 移行の作成と実行</strong></h2>
...
<h3 id="migration-file"><strong>サンプルファイルの移行</strong></h3>
...
<h2 id="3-manual-migrations"><strong>3. 手動移行</strong></h2>
...
<h2 id="4-data-migrations"><strong>4. データの移行</strong></h2>
...
<h2 id="5-database-seeding"><strong>5. データベースのシード処理</strong></h2>
...
<h2 id="6-best-practices"><strong>6. 移行のベスト プラクティス</strong></h2>

<h3 id="naming-convention"><strong>命名規則</strong></h3>
...
<h3 id="tips"><strong>重要なヒント</strong></h3>

<ul>
<li>自動生成移行を実行する前に必ず確認してください</li>
<li>データ移行とスキーマ移行を個別に行う</li>
<li>アップグレードとダウングレードの両方の移行をテストする</li>
<li>実稼働環境ですでに実行されている移行は編集しないでください</li>
<li>使用する <code>--sql</code> 本番環境で実行する前に SQL をプレビューするためのフラグ</li>
</ul>
...
<ul>
<li><strong>アレンビックのセットアップ</strong>: 非同期 SQLAlchemy の構成</li>
<li><strong>自動生成</strong>: モデル変更からの移行を自動的に作成</li>
<li><strong>手動移行</strong>: カスタム移行の作成 (インデックス、生の SQL)</li>
<li><strong>データ移行</strong>: 移行中のシード データ</li>
<li><strong>データベースのシード処理</strong>：開発用スクリプトシードデータ</li>
</ul>

<p>次の記事では、リポジトリ パターンを使用して完全な CRUD API を構築します。</p>
