...
description: >-
  CORS 構成、SlowAPI によるレート制限、入力サニタイズ、SQL インジェクション防止。 HTTPS、セキュリティヘッダー、環境変数管理。
  FastAPI の OWASP トップ 10。
duration_minutes: 90
is_free: true
video_url: null
sort_order: 11
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 11: セキュリティのベスト プラクティス</tspan>
  </text>
...
<h2 id="1-cors"><strong>1. CORS の構成</strong></h2>
...
<h2 id="2-rate-limiting"><strong>2. レート制限</strong></h2>
...
<h2 id="3-security-headers"><strong>3. セキュリティヘッダーミドルウェア</strong></h2>
...
<h2 id="4-input-sanitization"><strong>4. 入力のサニタイズ</strong></h2>
...
<h2 id="5-sql-injection"><strong>5. SQL インジェクションの防止</strong></h2>
...
<h2 id="6-request-id-tracking"><strong>6. リクエストID追跡</strong></h2>
...
<h2 id="7-trusted-host"><strong>7. 信頼できるホストとHTTPS</strong></h2>
...
<h2 id="8-owasp-checklist"><strong>8. OWASP FastAPI のトップ 10 チェックリスト</strong></h2>

<table>
<thead>
<tr><th>#</th><th>脆弱性</th><th>FastAPI でのソリューション</th></tr>
</thead>
<tbody>
<tr><td>A01</td><td>壊れたアクセス制御</td><td>RBAC の依存関係、所有権のチェック</td></tr>
<tr><td>A02</td><td>暗号化の失敗</td><td>Bcrypt パスワード、強力な秘密を持つ JWT</td></tr>
<tr><td>A03</td><td>注射</td><td>Pydantic 検証、SQLAlchemy ORM</td></tr>
<tr><td>A04</td><td>安全でない設計</td><td>レート制限、入力検証</td></tr>
<tr><td>A05</td><td>セキュリティの構成ミス</td><td>セキュリティヘッダー、CORS、環境変数</td></tr>
<tr><td>A06</td><td>脆弱なコンポーネント</td><td>UV監査、依存関係の更新</td></tr>
<tr><td>A07</td><td>認証の失敗</td><td>OAuth2、JWT ローテーション、トークン ブラックリスト</td></tr>
<tr><td>A08</td><td>データ整合性の失敗</td><td>Pydantic バリデーター、CSRF 保護</td></tr>
<tr><td>A09</td><td>ログの失敗</td><td>構造化ロギング、リクエストID追跡</td></tr>
<tr><td>A10</td><td>SSRF</td><td>URL検証、許可リスト</td></tr>
</tbody>
</table>

<h2 id="tong-ket"><strong>概要</strong></h2>

<p>FastAPI のセキュリティのベスト プラクティス:</p>

<ul>
<li><strong>コルス</strong>: 厳密な構成。必要なオリジンのみを許可します。</li>
<li><strong>レート制限</strong>: API を悪用から保護する</li>
<li><strong>セキュリティヘッダー</strong>: すべての応答にセキュリティ ヘッダーを追加します</li>
<li><strong>入力のサニタイズ</strong>: 処理前にユーザー入力をサニタイズします</li>
<li><strong>SQLインジェクション</strong>: ORM またはパラメータ化されたクエリを使用する</li>
<li><strong>リクエスト追跡</strong>: システム全体でリクエストをトレースします。</li>
</ul>

<p>次の記事では、ソーシャル ログインと OAuth2 プロバイダーを実装します。</p>
