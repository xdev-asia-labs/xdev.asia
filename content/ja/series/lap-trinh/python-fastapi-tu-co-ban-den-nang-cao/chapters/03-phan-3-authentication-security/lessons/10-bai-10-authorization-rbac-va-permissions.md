...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 10: 認可 - RBAC とアクセス許可</tspan>
  </text>
...
<h2 id="1-rbac-overview"><strong>1. ロールベースのアクセス制御 (RBAC)</strong></h2>

<p>RBAC は最も一般的な権限モデルであり、権限がロールに割り当てられ、ユーザーにロールが割り当てられます。 FastAPI には RBAC が組み込まれていませんが、依存関係の注入を使用してデプロイするのは非常に簡単です。</p>

<h2 id="2-role-models"><strong>2. RBAC のデータベース モデル</strong></h2>
...
<h2 id="3-rbac-dependencies"><strong>3. RBAC の依存関係</strong></h2>
...
<h2 id="4-su-dung-rbac"><strong>4. ルートで RBAC を使用する</strong></h2>
...
<h2 id="5-resource-ownership"><strong>5. リソース所有権のチェック</strong></h2>
...
<h2 id="6-seed-permissions"><strong>6. シードの役割と権限</strong></h2>
...
<p>この記事では、完全な認証システムを構築しました。</p>

<ul>
<li><strong>RBACモデル</strong>: ユーザー → ロール → 権限 (多対多)</li>
<li><strong>ロールチェッカー</strong>: 依存関係チェックの役割</li>
<li><strong>許可チェッカー</strong>: 依存関係チェック権限</li>
<li><strong>リソースの所有権</strong>：所有者または管理者のみが編集/削除できます</li>
<li><strong>種まき</strong>: スクリプト シードの役割と権限</li>
</ul>

<p>次の記事では、セキュリティのベスト プラクティスに焦点を当てます。</p>
