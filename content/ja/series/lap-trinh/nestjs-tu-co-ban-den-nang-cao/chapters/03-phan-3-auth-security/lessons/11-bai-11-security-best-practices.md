...
<h2 id="1-helmet"><strong>1. ヘルメット — セキュリティヘッダー</strong></h2>
...
<h2 id="2-cors"><strong>2. CORS の構成</strong></h2>
...
<h2 id="3-rate-limiting"><strong>3. @nestjs/throttler によるレート制限</strong></h2>
...
<h2 id="4-config"><strong>4. @nestjs/config による環境変数</strong></h2>
...
<h2 id="5-input-sanitization"><strong>5. 入力のサニタイズ</strong></h2>
...
<h2 id="6-sql-injection"><strong>6. SQL インジェクションの防止</strong></h2>
...
<h2 id="7-other-practices"><strong>7. その他のベストプラクティス</strong></h2>
...
<table>
<thead>
<tr><th>脅威</th><th>解決策</th></tr>
</thead>
<tbody>
<tr><td>XSS</td><td>ヘルメット、入力サニタイズ、CSP ヘッダー</td></tr>
<tr><td>SQLインジェクション</td><td>パラメータ化されたクエリ (TypeORM/Prisma)</td></tr>
<tr><td>ブルートフォース</td><td>レート制限 (@nestjs/throttler)</td></tr>
<tr><td>CSRF</td><td>SameSite Cookie、CSRF トークン</td></tr>
<tr><td>機密データ</td><td>@nestjs/config、.env ファイル、パスワードをログに記録しない</td></tr>
<tr><td>クリックジャッキング</td><td>ヘルメット経由の X フレーム オプション</td></tr>
<tr><td>コルス</td><td>ホワイトリストの発信元</td></tr>
</tbody>
</table>

<p>次の記事で詳しく説明します <strong>セッション、Cookie、OAuth2</strong>。</p>
