...
description: >-
  Docker マルチステージ ビルド、Docker Compose、GitHub Actions CI/CD。自動テスト、コンテナー
  レジストリ、デプロイメント パイプライン。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="160" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 19: NestJS の Dockerize と CI/CD</tspan>
  </text>
...
<h2 id="4-env"><strong>4. 環境設定</strong></h2>
...
<ul>
<li><strong>多段施工</strong>: イメージ サイズを縮小します (コピー dist + プロダクション deps のみ)</li>
<li><strong>Docker Compose</strong>: アプリ + DB + Redis をオーケストレーションする</li>
<li><strong>CIパイプライン</strong>: Lint → テスト → ビルド → イメージのプッシュ</li>
<li><strong>CD パイプライン</strong>: メインにマージすると自動デプロイ</li>
<li><strong>セキュリティ</strong>: 非 root ユーザー、ヘルスチェック、.dockerignore</li>
</ul>

<p>次の記事で詳しく説明します <strong>実稼働環境の導入と監視</strong>。</p>
