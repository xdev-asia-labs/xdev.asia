...
description: >-
  PostgreSQL/MySQL を TypeORM と Prisma で接続します。エンティティ、リポジトリ、関係、移行、シード。 TypeORM と
  Prisma を比較し、いつどちらを使用するかを比較します。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 340" style="max-width: 100%; height: auto; border-radius: 12px; margin-bottom: 1.5rem;">
  ...
  <text x="60" y="140" font-family="system-ui,-apple-system,sans-serif" font-size="34" font-weight="700" fill="#f1f5f9">
      <tspan x="60" dy="0">レッスン 7: TypeORM と Prisma - 接続</tspan>
      <tspan x="60" dy="42">データベース</tspan>
  </text>
  ...
  <!-- Section -->
  <text x="60" y="268" font-family="system-ui,-apple-system,sans-serif" font-size="13" fill="#64748b" opacity="0.6">パート 2: プロバイダー、依存関係の注入、およびデータ層</text>

  <!-- xDev watermark -->
  <text x="1140" y="320" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="#475569" text-anchor="end" opacity="0.4">xdev.asia</text>
</svg>

<h2 id="1-typeorm-setup"><strong>1. TypeORM — NestJS を使用したセットアップ</strong></h2>
...
<h2 id="2-entities"><strong>2. エンティティの定義</strong></h2>
...
<h2 id="3-repository-pattern"><strong>3. リポジトリパターン</strong></h2>
...
<h2 id="4-migrations"><strong>4. 移行</strong></h2>
...
<h2 id="5-prisma-setup"><strong>5. Prisma — NestJS を使用したセットアップ</strong></h2>
...
<h3 id="prisma-service"><strong>NestJS の Prisma サービス</strong></h3>
...
<table>
<thead>
<tr><th>基準</th><th>TypeORM</th><th>プリズマ</th></tr>
</thead>
<tbody>
<tr><td>スキーマ定義</td><td>TypeScript デコレータ</td><td>Prisma スキーマ言語</td></tr>
<tr><td>タイプセーフティ</td><td>平均</td><td>非常に高い (自動生成)</td></tr>
<tr><td>クエリAPI</td><td>リポジトリ + クエリビルダー</td><td>Prisma クライアント (流暢な API)</td></tr>
<tr><td>移行</td><td>TypeORM の移行</td><td>プリズママイグレーション</td></tr>
<tr><td>生のSQL</td><td>簡単</td><td>$queryRaw / $executeRaw</td></tr>
<tr><td>関係</td><td>デコレータベース</td><td>スキーマベース</td></tr>
<tr><td>パフォーマンス</td><td>良い</td><td>非常に良い (錆びたエンジン)</td></tr>
<tr><td>GUIツール</td><td>いいえ</td><td>プリズマスタジオ</td></tr>
<tr><td>NestJS の統合</td><td>@nestjs/typebug (公式)</td><td>手動PrismaService</td></tr>
<tr><td>適切な</td><td>Active Record/Data Mapper に精通している</td><td>最新、タイプセーフ第一</td></tr>
</tbody>
</table>
...
<ul>
<li><strong>TypeORM</strong>: 公式統合、デコレータベースのエンティティ、複雑なクエリ用の QueryBuilder</li>
<li><strong>プリズマ</strong>: タイプセーフな自動生成クライアント、スキーマファースト、Prisma Studio GUI</li>
<li>どちらも PostgreSQL、MySQL、SQLite、SQL Server をサポートします</li>
<li>プロダクションでは常にそれを使用します <strong>移行</strong>使用しないでください。 <code>同期: true</code></li>
</ul>

<p>次の記事で詳しく説明します <strong>検証、パイプ、例外フィルター</strong>。</p>
