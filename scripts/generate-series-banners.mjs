...
const banners = [
  ...
  // ─── New AI Series ───
  {
    ...
    title: "Generative AI",
    subtitle: "Tạo Hình Ảnh và Video",
  ...
  },
  {
    ...
    title: "Speech và Audio AI",
    subtitle: "Xử Lý Giọng Nói",
  ...
  },
  {
    ...
    subtitle: "Dự Đoán Chuỗi Thời Gian",
    colors: ["#004D40", "#4DB6AC"],
    icon: "TS",
  },
  {
    filename: "machine-learning-tu-co-ban-den-nang-cao-cover.png",
    title: "Machine Learning",
    subtitle: "Từ Cơ Bản Đến Nâng Cao",
    colors: ["#0B1F3A", "#3B82F6"],
    icon: "ML",
  },
];
